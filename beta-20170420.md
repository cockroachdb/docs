...
- Bounds are now checked when converting [`FLOAT`](float.html) or [`DECIMAL`](decimal.html) values to [`INTEGER`](int.html). [#14967](https://github.com/cockroachdb/cockroach/pull/14967)
