...
$ cockroach quit --host=<node2-hostname> --ca-cert=ca.cert --cert=root.cert --key=node1.key
$ cockroach quit --host=<node3-hostname> --ca-cert=ca.cert --cert=root.cert --key=node1.key
~~~
