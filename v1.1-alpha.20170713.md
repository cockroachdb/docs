...
- C++ dependencies are now managed via submodules. [#16859](https://github.com/cockroachdb/cockroach/pull/16859)
...
- New statement `SHOW JOBS` can show the state of backups, restores, and schema changes. [#16733](https://github.com/cockroachdb/cockroach/pull/16733)
- The statement `DISCARD ALL` is now supported to reset all session state. [#16746](https://github.com/cockroachdb/cockroach/pull/16746)
- New session variable `node_id` contains the ID of the gateway node. [#16703](https://github.com/cockroachdb/cockroach/pull/16703)
- New setting `trace.zipkin.collector` can now be used to report trace data to Zipkin. [#16903](https://github.com/cockroachdb/cockroach/pull/16903)
- `SHOW CREATE TABLE` (and similar introspection mechanisms) now remember more precise type information, such as whether the column was created as `INT8` or `INT64`. [#16548](https://github.com/cockroachdb/cockroach/pull/16548)
...
- The SQL shell prints the client and server version number at startup. [#16703](https://github.com/cockroachdb/cockroach/pull/16703)
...
- Fixed a name escaping bug in `SHOW CREATE TABLE` and view definitions. [#16782](https://github.com/cockroachdb/cockroach/pull/16782) [#16815](https://github.com/cockroachdb/cockroach/pull/16815)
...
- A failed `BEGIN` statement no longer leaves the connection in a broken state. [#16863](https://github.com/cockroachdb/cockroach/pull/16863)
- `SHOW CREATE TABLE` no longer omits indexes that are used in foreign keys. [#16861](https://github.com/cockroachdb/cockroach/pull/16861)
...
- A sample [secure Kubernetes configuration](https://github.com/cockroachdb/cockroach/tree/master/cloud/kubernetes) is now available. [#16486](https://github.com/cockroachdb/cockroach/pull/16486)
