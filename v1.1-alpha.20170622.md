...
- The APD library has been updated, improving performance of `DECIMAL` operations. [#16520](https://github.com/cockroachdb/cockroach/pull/16520)

### SQL Language Changes

- New statements `SHOW SESSIONS` and `SHOW QUERIES` display active sessions and queries on a node or cluster. [#16072](https://github.com/cockroachdb/cockroach/pull/16072)
...
- The function `pg_catalog.pg_table_is_visible` is now implemented, improving compatibility with several ORMs. [#16410](https://github.com/cockroachdb/cockroach/pull/16410)
...
- `RESTORE` no longer attempts to split at invalid keys. [#16375](https://github.com/cockroachdb/cockroach/pull/16375)
...
- The system will try to avoid replicating to unstable two-replica configurations unless third candidate is also available. [#16411](https://github.com/cockroachdb/cockroach/pull/16411)
