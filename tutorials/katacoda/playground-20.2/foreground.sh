echo 'Downloading CockroachDB for Linux and supporting spatial libraries...'

wget -qO- https://binaries.cockroachdb.com/cockroach-v20.2.4.linux-amd64.tgz | tar  xvz

echo 'Moving CockroachDB and spatial libraries into expected locations...'
...
echo 'Starting a single-node cluster...'
