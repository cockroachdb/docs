...
| `METADATA` | Include the columns CockroachDB chooses to execute each processing step of the query in the **Columns** column of the output, as well as **Ordering** detail. |
