...
For information about how we use images in our docs, see the [Images](style-guide.html/images) in our [Style Guide](style-guide.html).
...
See [Style Guide](style-guide.html) for more details.
