...
`alternate_urls` | The URLs of other pages that should highlight this title in the sidebar, as a comma-separated list, e.g., `[/build-a-go-app-with-cockroachdb-pg.html, /build-a-go-app-with-cockroachdb-gorm.html]`.
