...
|-------------------------------------+---------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `experimental_enable_primary_key_changes`       | `'false'`       | <span class="version-tag">New in v20.1:</span> If set to `'true'`, enables online primary key changes with [`ALTER TABLE ... ALTER PRIMARY KEY`](alter-primary-key.html).                                                                                                                                                                                   |
...
| `experimental_enable_hash_sharded_indexes`       | `'off'`       | <span class="version-tag">New in v20.1:</span> If set to `on`, enables [hash-sharded indexes](hash-sharded-index.html) syntax in [`CREATE INDEX`](create-index.html), [`CREATE TABLE`](create-table.html), and [`ALTER PRIMARY KEY`](alter-primary-key.html) statements.                                                                                                                                                                                   |
