...
{% include_cached copy-clipboard.html %}
~~~ shell
$ cockroach auth-session login web_user --certs-dir=certs --only-cookie > ~/.cockroachdb_api_key
$ curl --cookie '~/.cockroachdb_api_key' https://localhost:8080/_status/logfiles/local
~~~
