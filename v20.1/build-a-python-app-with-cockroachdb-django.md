...
## Step 2. Create the `bank` database
...
In the SQL shell, issue the following statements to create the `bank` database:
...
To perform a simple insert to the database, use `curl`. For example:
