---
title: SQL Feature Support in CockroachDB v20.1
...
-----------|-----------|------|---------
 ...
 `SAVEPOINT` | ✓ | CockroachDB Extension | <span class="version-tag">New in v20.1:</span> CockroachDB supports nested sub-transactions using [`SAVEPOINT`](savepoint.html)
