...
You cannot start an online schema change if another schema change (e.g., a [primary key change](alter-primary-key.html)) is currently in progress on the same table.
{{site.data.alerts.end}}
