...
<div class="filters filters-big clearfix">
    ...
    <a href="build-a-python-app-with-cockroachdb-sqlalchemy.html"><button style="width: 20%" class="filter-button current">Use <strong>SQLAlchemy</strong></button></a>
    ...
    <a href="build-a-python-app-with-cockroachdb-pony.html"><button style="width: 20%" class="filter-button">Use <strong>PonyORM</strong></button></a>
</div>
