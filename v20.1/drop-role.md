...
<span class="version-tag">New in v20.1</span>: The <code>DROP ROLE</code> statement is now freely available in the core version of CockroachDB and no longer requires an enterprise license.
