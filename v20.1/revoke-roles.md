...
<span class="version-tag">New in v20.1</span>: The <code>REVOKE &lt;roles&gt;</code> statement is now freely available in the core version of CockroachDB and no longer requires an enterprise license.
