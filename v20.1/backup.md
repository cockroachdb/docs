...
For an example of an incremental backups, see the [Create incremental backups](#create-incremental-backups) section.
...
<span class="version-tag">New in v20.1:</span> To create a [encrypted backup](#encrypted-backups), use the `encryption_passphrase` option:
