...
`--locality` | Arbitrary key-value pairs that describe the location of the node. Locality might include country, region, availability zone, rack, etc. For more details, see [Locality](#locality) below.
