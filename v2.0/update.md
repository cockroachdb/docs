...
`select_stmt` | A [statement-like query](relational-expressions.html#statement-like-queries). Each value must match the [data type](data-types.html) of its column on the left side of `=`.
