...
Statement | Usage
----------|------------
[`CREATE TABLE AS`](create-table-as.html) | Create a new table in a database using the results from a [statement-like query](relational-expressions.html#statement-like-queries).
...
[`TABLE`](selection-clauses.html#table-clause) | Select all rows and columns from a table.
...
[`VALUES`](selection-clauses.html#values-clause) | Return rows containing specific values.
