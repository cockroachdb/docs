...
In this example, we create two secondary indexes and an inverted index during table creation. [Secondary indexes](indexes.html) allow efficient access to data with keys other than the primary key.

<span class="version-tag">New in v2.0:</span> [Inverted indexes](inverted-indexes.html) allow efficient access to schemaless data.
...
> CREATE TABLE product_information (
    ...
    INVERTED INDEX details (misc_info)
);
~~~
...
| product_information | details                              | false  |   1 | misc_info      | ASC       |  false  |  false   |
...
- Learn more about [indexes](indexes.html) and [inverted indexes](inverted-indexes.html).
