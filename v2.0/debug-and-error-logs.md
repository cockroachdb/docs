---
title: Understand Debug, Error, and Audit Logs
summary: Learn how to find and read CockroachDB debug, error, and audit logs
toc: false
---
...
`--sql-audit-dir` | Write the [SQL audit log](experimental-audit.html) to this directory. Defaults to use the standard log directory.

The `--log-backtrace-at`, `--verbosity`, and `--v` flags are intended for internal debugging by CockroachDB contributors.

## Audit and Execution Log File Format
