...
<div style="text-align: center;"><img src="{{ 'images/v2.0/before-decommission2.png' | relative_url }}" alt="Decommission a single live node" style="border:1px solid #eee;max-width:100%" /></div>
