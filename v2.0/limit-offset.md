...
- A [statement-like query](relational-expressions.html#statement-like-queries), including when it occurs
...
Pagination](relational-expressions.html#limiting-row-count-and-pagination).
