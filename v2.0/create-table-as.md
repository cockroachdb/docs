...
The `CREATE TABLE ... AS` statement creates a new table from a [statement-like query](relational-expressions.html#statement-like-queries).
...
| `select_stmt` | A [statement-like query](relational-expressions.html#statement-like-queries) to provide the data. |
