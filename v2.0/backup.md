...
~~~ sql
> BACKUP DATABASE bank to 'gs://acme-co-backup/db/bank/2017-03-29-nightly' AS OF SYSTEM TIME '2017-03-28 23:59:00' INCREMENTAL FROM 'gs://acme-co-backup/database-bank-2017-03-27-weekly', 'gs://acme-co-backup/database-bank-2017-03-28-nightly'; 
~~~

### Create Incremental Backups with Revision History

~~~ sql
> BACKUP DATABASE bank to 'gs://acme-co-backup/database-bank-2017-03-29-nightly' AS OF SYSTEM TIME '2017-03-28 23:59:00' INCREMENTAL FROM 'gs://acme-co-backup/database-bank-2017-03-27-weekly', 'gs://acme-co-backup/database-bank-2017-03-28-nightly' WITH revision_history; 
~~~
