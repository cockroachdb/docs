...
<span class="version-tag">New in v2.0:</span> You can create full or incremental backups with revision history:
...
| `WITH revision_history` | <span class="version-tag">New in v2.0:</span> Create a backup with full [revision history](backup.html#backups-with-revision-history) that records every change made to the cluster within the garbage collection period leading up to and including the given timestamp. |
