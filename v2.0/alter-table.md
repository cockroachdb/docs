...
[`PARTITION BY`](partition-by.html) ([Enterprise-only](enterprise-licensing.html)) Repartition or unpartition a table with partitions. <span class="version-tag">New in v2.0</span>
