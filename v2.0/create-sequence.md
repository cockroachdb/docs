...
- `nextval('seq_name')`
    {{site.data.alerts.callout_info}}If <code>nextval()</code> is used in conjunction with <code>RETURNING NOTHING</code> statements, the sequence increments can be reordered. For more information, see <a href="https://www.cockroachlabs.com/blog/how-online-schema-changes-are-possible-in-cockroachdb/">Parallel Statement Execution</a>.{{site.data.alerts.end}}
- `currval('seq_name')`
- `lastval()`
