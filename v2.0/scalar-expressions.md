...
[table expressions](table-expressions.html) and [relational expressions](relational-expressions.html), which produce results
...
[statement-like query](relational-expressions.html#statement-like-queries) can be used.
...
any row (for `NOT EXISTS`). Any [statement-like query](relational-expressions.html#statement-like-queries)
...
and then evaluates to the value of that single cell. Any [statement-like query](relational-expressions.html#statement-like-queries)
can be used as subquery.
