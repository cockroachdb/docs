...
| `AS OF SYSTEM TIME timestamp` | Retrieve data as it existed as of `timestamp`. {% include aost-v1.0.md %}<br/><br/>For more information, see [this example](#select-historical-data-time-travel) or our blog post [Time-Travel Queries](https://www.cockroachlabs.com/blog/time-travel-queries-select-witty_subtitle-the_future/). |
