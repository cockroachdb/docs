...
3. Select the type of **Workload** you would like to run against the cluster in the **Load Generators** section.
...
You can use the cluster's [Admin UI](explore-the-admin-ui.html) to monitor the `rand` workload and overall cluster behavior.
