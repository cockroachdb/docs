...
Users that [own objects](authorization.html#object-ownership) cannot be dropped until the [ownership is transferred to another user](owner-to.html#change-a-databases-owner).
