...
<img src="{{ 'images/v20.2/topology-patterns/topology_geo-partitioned_leaseholders_reads.png' | relative_url }}" alt="Geo-partitoned leaseholders topology" style="max-width:100%" />
...
<img src="{{ 'images/v20.2/topology-patterns/topology_geo-partitioned_leaseholders_writes.gif' | relative_url }}" alt="Geo-partitoned leaseholders topology" style="max-width:100%" />
