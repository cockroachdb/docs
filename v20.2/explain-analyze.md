...
You can obtain this ZIP file by following the link provided in the `EXPLAIN ANALYZE (DEBUG)` output, or by navigating to **Advanced Debug** -> **Statement Diagnostics History** in the [Admin UI](admin-ui-overview.html).
