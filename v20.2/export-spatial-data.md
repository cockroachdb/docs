...
2. Edit the SQL column name output above into header columns in CSV format, and save the header columns in your target output CSV file.  For the tornadoes database, the header columns will look like the following:
