...
You'll be importing a large TPC-C data set. To speed that up, you can tweak some cluster settings. You'll also need to enable the {{ site.data.products.enterprise }} license you requested earlier.
