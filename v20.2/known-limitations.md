...
### Partitioning on `ENUM`s

[Partitions](partitioning.html) cannot be created on columns of type [`ENUM`](enum.html). See [tracking issue](https://github.com/cockroachdb/cockroach/issues/55342).
