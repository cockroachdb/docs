...
A `GEOMETRYCOLLECTION` is a "box" or "bag" used for gathering 1 or more of the other types of [spatial objects](spatial-features.html#spatial-objects) into a group: namely, [Points](point.html), [Linestrings](linestring.html), or [Polygons](polygon.html). It provides a way of referring to a group of spatial objects as one "thing" so that you can operate on it/them more conveniently using various SQL functions.
