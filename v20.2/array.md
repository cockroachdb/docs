...
CockroachDB supports implicit casting from string literals to arrays of all data types except [`BYTES`](bytes.html), [`ENUM`](enum.html), [`JSONB`](jsonb.html), and [`SERIAL`](serial.html).
