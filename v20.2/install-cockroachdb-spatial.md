...
Next, to test that the spatial libraries have loaded properly, run the following command:
...
{{site.data.alerts.callout_info}}
If you are having a hard time installing CockroachDB Spatial, please see our [Support Resources](support-resources.html).
{{site.data.alerts.end}}
