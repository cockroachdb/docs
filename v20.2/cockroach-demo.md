...
#
# Server version: CockroachDB CCL v20.2.0-alpha.1-3586-g298c8c8805 (x86_64-apple-darwin19.6.0, built , go1.14.4) (same version as client)
# Cluster ID: a11c5de9-8937-4a7d-b7bf-b187b5b809de
...
To list the connection parameters for all nodes of a multi-node demo cluster, use the `\demo ls` command:
