...
----------------------------------------+-------------------------------------------------------------------------------------------------------------------------
`label`                                 | The name used to identify the backup schedule. This does not need to be unique.
...
`location`                              | The [URL](use-cloud-storage-for-bulk-operations.html) where you want to store the backup. The backup files will be stored in to be year > month > day subdirectories.
