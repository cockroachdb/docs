...
In this example we will import a specific data set that is available as a [Shapefile](https://en.wikipedia.org/wiki/Shapefile). To import a different spatial data set that is already available in a SQL file, try starting at [Step 2](#step-2-edit-the-generated-sql-so-it-can-be-imported) below.
