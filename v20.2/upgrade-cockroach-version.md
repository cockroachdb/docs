...
This will be fixed in a later v20.2 testing release. For more context, see [Known Limitations in CockroachDB v20.2](known-limitations.html#upgrading-to-v20-2-with-more-than-100-non-terminal-jobs).
{{site.data.alerts.end}}
