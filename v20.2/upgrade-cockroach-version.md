...
If you started a schema change job in v19.2 that is ongoing at the time of the upgrade, the job must be migrated to run in v20.1. This migration is automatically run shortly *after* upgrading to v20.1. In case you are upgrading from v19.2 to v20.2 or later, we advise waiting for v19.2 schema change jobs to complete in v20.1 before upgrading further. Schema change jobs that were started but were not progressing in v19.2 (i.e., due to bugs) will be marked as `failed`.
