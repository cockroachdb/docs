...
-----------|-----------|------|---------
 ...
 Geospatial indexes | ✓ | Common Extension | <span class="version-tag">New in v20.2:</span> [Spatial indexes documentation](spatial-indexes.html)
...
-----------|-----------|------|---------
 ...
 Converting a database to a user-defined schema | ✓ | CockroachDB Extension | <span class="version-tag">New in v20.2:</span> [`CONVERT TO` documentation](convert-to.html)
