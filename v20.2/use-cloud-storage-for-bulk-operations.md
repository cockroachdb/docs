...
Google Cloud           | `gs`        | Bucket name                                      | `AUTH` (optional; can be `default`, `implicit`, or `specified`), `CREDENTIALS` For more information, see [Authentication - GCS](#google-cloud-storage).
