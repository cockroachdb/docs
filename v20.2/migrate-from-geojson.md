...
~~~ shell
wget https://geodata.vermont.gov/datasets/986155613c5743239e7b1980b45bbf36_162.geojson
~~~

Next, rename the file to something a bit easier to remember:

{% include copy-clipboard.html %}
~~~ shell
mv 986155613c5743239e7b1980b45bbf36_162.geojson tanks.geojson
~~~
...
{% include copy-clipboard.html %}
~~~ shell
ogr2ogr -f PGDUMP tanks.sql -lco LAUNDER=NO tanks.geojson
~~~
