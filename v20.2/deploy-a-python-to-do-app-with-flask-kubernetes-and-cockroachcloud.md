...
2. Click the **Add Network** button in the top right corner.
    ...
    <img src="{{ 'images/v20.2/cockroachcloud/add-network-modal.png' | relative_url }}" alt="Add network" style="border:1px solid #eee;max-width:100%" />
...
2. Click the **Add User** button in the top right corner.
    ...
    <img src="{{ 'images/v20.2/cockroachcloud/add-user-modal.png' | relative_url }}" alt="Add user" style="border:1px solid #eee;max-width:100%" />
...
1. In the top right corner of the Console, click the **Connect** button.
    ...
    <img src="{{ 'images/v20.2/cockroachcloud/connect-modal.png' | relative_url }}" alt="Connect to cluster" style="border:1px solid #eee;max-width:100%" />
...
### Step 5. Generate the application connection string
  ...
  1. In the top right corner of the Console, click the **Connect** button.
      ...
      The **Connect** modal displays.
        ...
        <img src="{{ 'images/v20.2/cockroachcloud/connect-from-app.png' | relative_url }}" alt="Connect from app" style="border:1px solid #eee;max-width:100%" />
