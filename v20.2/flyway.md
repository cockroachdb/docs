...
1. Download the latest version of the [Flyway comand-line tool](https://flywaydb.org/documentation/commandline/#download-and-installation). CockroachDB v20.2 is fully compatible with Flyway versions 7.1.0 and greater. 
