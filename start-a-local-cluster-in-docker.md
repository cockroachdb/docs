...
cockroachdb/cockroach:v1.0 <span class="nb">start</span> --insecure</code></pre></div>
...
cockroachdb/cockroach:v1.0 <span class="nb">start</span> --insecure --join<span class="o">=</span>roach1
...
cockroachdb/cockroach:v1.0 <span class="nb">start</span> --insecure --join<span class="o">=</span>roach1</code></pre></div>
