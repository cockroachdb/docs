...
Flag | Description
-----|------------
`--alsologtostderr` | Copy log messages at or above this level to the standard error stream in addition to log files. Possible values: `INFO`, `WARNING`, `ERROR`, and `FATAL`. <br><br>**Default:** `ERROR`
