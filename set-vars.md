...
{% include sql/diagrams/set_var.html %}
...
| Variable                        | Description  | Initial value | Can be viewed with [`SHOW`](show-vars.html)? |
|---------------------------------|--------------|---------------|----------------------------------------------|
...
The following demonstrates how to assign a list of values, which
is e.g. relevant for `search_path`:
