...
- <sup>4</sup> A custom root CA can be appended to the system's default CAs by setting the `cloudstorage.http.custom_ca` setting, which will be used when verifying certificates from an S3-compatible service.
