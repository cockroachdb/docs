1. [Install CockroachDB](../{{site.versions["cloud"]}}/install-cockroachdb.html).
1. Start up a [secure](../{{site.versions["cloud"]}}/secure-a-cluster.html) or [insecure](../{{site.versions["cloud"]}}/start-a-local-cluster.html) local cluster.
