The destination file URL does _not_ require the [`ADMIN` role](authorization.html#admin-role) in the following scenarios:
...
The destination file URL _does_ require the `ADMIN` role in the following scenarios:
