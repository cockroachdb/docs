...
- Show a warning for Statement Insights when we reach a "max size exceed" error from the sql api. [#97153][#97153]
- Show a warning for Transaction Insights when we reach a "max size exceed" error from the sql api. [#97277][#97277]
- Show a warning for Schema Insights when we reach a "max size exceed" error from the sql api. [#97312][#97312]
...
- Users can now go to the next page of results when there are >20 active statements or transactions in the Active Execution page. [#97122][#97122]
