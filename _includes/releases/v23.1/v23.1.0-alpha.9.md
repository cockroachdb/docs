...
- The new `prepared_statements_cache_size` [session setting](../v22.2/set-vars.html) helps to prevent [prepared statement](../v23.1/savepoint.html#savepoints-and-prepared-statements) leaks by automatically deallocating the least-recently-used prepared statements when the cache reaches a given size. [#99254][#99254]
...
- Fixed a bug in the [**Insights** page](../v23.1/ui-insights-page.html#schema-insights-tab) that prevented a recommendation to drop an index from being executed if the index's name contained a space. [#100023][#100023]
