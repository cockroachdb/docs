{% if include.major_version.release_date == "N/A" or include.major_version.release_date < "now" %}{% comment %} check if a release date has been set or if it's in the future {% endcomment %}
