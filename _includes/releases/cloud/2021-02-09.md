...
- An email will now be sent to [org admins](../cockroachcloud/authorization.html#org-administrator-legacy) when a [30-day free trial of {{ site.data.products.db }}](../cockroachcloud/quickstart-trial-cluster.html) is nearing its end and once it has expired.
