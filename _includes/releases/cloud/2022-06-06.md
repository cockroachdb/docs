...
- When creating a [SQL user](../cockroachcloud/managing-access.html#create-a-sql-user) or [changing a SQL user's password](../cockroachcloud/managing-access.html#change-a-sql-users-password), the generated password is now hidden until the user clicks **Reveal password**.
