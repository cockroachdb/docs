...
Check out a comprehensive [summary of the most significant user-facing changes](#v19-1-0-summary) and then [upgrade to CockroachDB v19.1](../v19.1/upgrade-cockroach-version.html). You can also read more about these changes in the [v19.1 blog post](https://www.cockroachlabs.com/blog/cockroachdb-19dot1-release/).
...
**Security** | Added an [overview of CockroachDB security](../v19.1/index.html), with a dedicated page on [authentication](../v19.1/authentication.html), [encryption](../v19.1/encryption.html), [authorization](../v19.1/authorization.html), and [SQL audit logging](../v19.1/sql-audit-logging.html).
