...
<h3 id="v20-1-7-downloads">Downloads</h3>
...
<h3 id="v20-1-7-docker-image">Docker image</h3>
...
- Reduced the memory overhead of rangefeeds (i.e., long-lived requests) which reduces the memory overhead for running [`CHANGEFEED`](../v20.2/stream-data-out-of-cockroachdb-using-changefeeds.html)s over large tables. [#54632][#54632]
