...
- [**Easier PostgreSQL migration**](../v2.1/migration-overview.html) - We’ve made further enhancements to reduce PostgreSQL migration friction. Notable improvements include support for foreign keys, sequences, and `COPY` in `IMPORT ... PGDUMP`.
