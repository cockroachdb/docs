...
- [**Get up and running faster with `IMPORT MYSQLDUMP/PGDUMP`**](../v2.1/migration-overview.html) - It is now much easier to transfer existing databases to CockroachDB.
...
- Added instructions for [importing data from Postgres dump files](../v2.1/migration-overview.html). [#3306][#3306]
