...
- Unified the syntax for defining the behavior of initial scans on [changefeeds](../v22.1/change-data-capture-overview.html) by extending the [`initial_scan`](../v22.1/create-changefeeds.html#initial-scan) option to accept three possible values: `yes`, `no`, or `only`. [#79471][#79471]
