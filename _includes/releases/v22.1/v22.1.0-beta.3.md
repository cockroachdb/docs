...
- [Changefeed](../v22.1/change-data-capture-overview.html) creation and failure event logs are now emitted to the [`TELEMETRY` logging channel](../v22.1/eventlog.html#telemetry-events). [#79749][#79749]
