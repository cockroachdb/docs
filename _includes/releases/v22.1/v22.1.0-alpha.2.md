...
- The default SQL statistics flush interval is now 10 minutes. A new cluster setting `sql.stats.aggregation.interval` controls the aggregation interval of SQL stats, with a default value of 1 hour. [#74831][#74831]
