...
- Added support for `DECLARE`, `FETCH`, and `CLOSE` commands for creating, using, and deleting [SQL cursors](../v22.1/cursors.html). [#74006][#74006]
- [SQL cursors](../v22.1/cursors.html) now appear in `pg_catalog.pg_cursors`. [#74006][#74006]
