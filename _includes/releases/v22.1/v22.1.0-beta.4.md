...
- A user can no longer define the subdirectory of their full backup. This deprecated syntax can be enabled by changing the new `bulkio.backup.deprecated_full_backup_with_subdir` cluster setting to true. [#80145][#80145]
...
<h3 id="v22-1-0-beta-4-miscellaneous">Miscellaneous</h3>

<h4 id="v22-1-0-beta-4-backup-change">Backup change</h4>

- The `sql.multi_region.allow_abstractions_for_secondary_tenants.enabled` [cluster setting](../v22.1/cluster-settings.html) is now consulted when a secondary tenant tries to restore a multi-region database. [#80013][#80013]
