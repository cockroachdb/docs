...
- Fixes a bug where a [database restore](../v22.1/restore.html) would not grant [`CREATE`](../v22.1/create.html) and `USAGE` on the public schema to the public role. [#95537][#95537]
