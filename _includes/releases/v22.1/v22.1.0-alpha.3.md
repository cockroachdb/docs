...
- [DB Console](../v22.1/ui-overview.html) now displays locality information in [problem ranges](../v22.1/ui-debug-pages.html#reports) and [range status](../v22.1/ui-replication-dashboard#ranges). [#76892][#76892]
...
- Previously, a bug caused the Open Transaction chart in the [Metrics Page](../v22.1/ui-overview-dashboard.html#metrics) to constantly increase for empty transactions. This issue has now been fixed. [#77237][#77237]
