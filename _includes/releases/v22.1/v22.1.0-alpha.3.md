...
- Added a [statement details](../v22.1/ui-statements-page.html#statement-details-page) endpoint that returns the details for a selected statement, and its execution separated by aggregation timestamp `(statementsPerAggregatedTs)` and by plan hash `(statementsPerPlanHash)`. [#76592][#76592]
