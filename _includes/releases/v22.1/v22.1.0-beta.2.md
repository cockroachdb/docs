...
- On the [Statement Details](../v22.1/ui-statements-page.html#statement-details-page) page, changed the order of tabs to Overview, Explain Plan, Diagnostics, and Execution Stats and changed the Explain Plan tab to Explain Plans (plural). [#79234][#79234]
