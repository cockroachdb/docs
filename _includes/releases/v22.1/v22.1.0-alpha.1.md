...
- In the experimental [`RELOCATE`](../v22.1/cockroachdb-feature-availability.html) syntax forms, the positional keyword that indicates that the statement should move non-voter replicas is now spelled `NONVOTERS`, instead of `NON_VOTERS`. [#73803][#73803]
