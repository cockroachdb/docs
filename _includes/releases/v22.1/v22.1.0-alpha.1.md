...
- Added an [**Index Stats**](../{site.versions["dev"]}}/ui-databases-page.html#index-details) table and a button to clear index usage stats on the [Table Details](../{{site.versions["dev"]}}/ui-databases-page.html#table-details) page for each table. [#72948][#72948]
...
- Previously, [`IMPORT TABLE ... PGDUMP`](../{{site.versions["dev"]}}/import.html#import-a-table-from-a-postgresql-database-dump) with a `COPY FROM` statement in the dump file that has less target columns than the `CREATE TABLE` schema definition would result in a nil pointer exception. This is now fixed. [#74601][#74601]
