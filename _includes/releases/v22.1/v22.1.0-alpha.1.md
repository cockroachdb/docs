...
- The [cluster settings](../{{site.versions["dev"]}}/cluster-settings.html) affecting the admission control system enablement are now set to defaults that enable [admission control](../{{site.versions["dev"]}}/admission-control.html). [#68535][#68535]
