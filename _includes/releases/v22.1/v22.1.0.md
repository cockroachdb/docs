...
- [Changefeeds](../dev/change-data-capture-overview.html) will now filter out [virtual computed columns](../dev/computed-columns.html) from events by default. [#74916][#74916]
