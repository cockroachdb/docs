...
| Version    | Feature                                       | Description |
-------------+-----------------------------------------------+------------
| Support for Prisma | CockroachDB now supports the [Prisma ORM](https://www.prisma.io/blog/prisma-preview-cockroach-db-release). A new [tutorial and example app](https://www.cockroachlabs.com/docs/v22.1/build-a-nodejs-app-with-cockroachdb-prisma.html) are available. |
| Lightweight `cockroach-sql` executable | A new client-only SQL shell for users who do not operate the cluster themselves. |
