...
- The [`CREATE EXTERNAL CONNECTION`](../v22.2/create-external-connection.html) statement can be used to represent an underlying [`userfile`](../v22.2/use-userfile.html) resource. [#86006][#86006]
...
- [`SHOW EXPERIMENTAL_FINGERPRINTS FROM TABLE`](../v22.2/features-in-preview.html#show-table-fingerprints) now works on tables with partial indexes. [#80539][#80539]
