...
Docs                 | **CockroachDB Cloud Guidance** | Added Node.js, Go, Python, and Java sample app code and connection guidance to the [CockroachDB Serverless Quickstart](../cockroachcloud/quickstart.html), as well as docs explaining the [CockroachDB Serverless Architecture](../cockroachcloud/architecture.html), important concepts for [planning/managing a Serverless cluster](../cockroachcloud/plan-your-cluster.html) (e.g., request units, cluster scaling), and how to run [bulk operations on CockroachDB Dedicated and Serverless clusters](../cockroachcloud/run-bulk-operations.html).
