...
public class BasicSample {
    public static void main(String[] args)
        ...
        props.setProperty("sslrootcert", "/tmp/certs/ca.crt");
        props.setProperty("sslkey", "/tmp/certs/client.maxroach.pk8");
        props.setProperty("sslcert", "/tmp/certs/client.maxroach.crt");
