...
var config = {
    ...
    port: 26257,
    ssl: {
        ca: fs.readFileSync('/tmp/certs/ca.crt').toString(),
        key: fs.readFileSync('/tmp/certs/client.maxroach.key').toString(),
        cert: fs.readFileSync('/tmp/certs/client.maxroach.crt').toString()
    }
};
