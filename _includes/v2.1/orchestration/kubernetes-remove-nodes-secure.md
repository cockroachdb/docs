...
1. Get a shell into the `cockroachdb-client-secure` pod you created in [step 3](#step-3-use-the-built-in-sql-client) and use the `cockroach node status` command to get the internal IDs of nodes:
