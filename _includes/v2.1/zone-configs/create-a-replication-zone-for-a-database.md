To control replication for a specific database, use the `CONFIGURE ZONE` statement to define the values you want to change (other values will not be affected):
