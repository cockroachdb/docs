...
<span class="version-tag">New in v22.1</span> To filter the sessions, click the **Filters** field.
...
<span class="version-tag">New in v22.1</span> Click <img src="{{ 'images/common/ui-columns-button.png' | relative_url }}" alt="Column selector" /> to select the columns to display in the table.
...
- **Session Details**
  ...
  - **Application name** <span class="version-tag">New in v22.1</span> shows the name of the application connected to the session.
  ...
  - **User name** <span class="version-tag">New in v22.1</span> displays the name of the user that started the session.
