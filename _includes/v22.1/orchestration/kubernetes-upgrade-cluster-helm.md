1. Verify that you can upgrade.
    ...
    1. If you are upgrading to {{ page.version.version }} from a production release earlier than {{ page.version.previous_version }}, or from a testing release (alpha/beta), first [upgrade to a production release of {{ page.version.previous_version }}](../{{ page.version.previous_version }}/operate-cockroachdb-kubernetes.html?filters=helm#upgrade-the-cluster). Be sure to complete all the steps.
