...
<code>replace(input: <a href="string.html">string</a>, from: <a href="string.html">string</a>, to: <a href="string.html">string</a>)</code> <br /> <span class="desc">Replace all occurrences of 'from' with 'to' in 'input'</span> | <a href="string.html">string</a>
