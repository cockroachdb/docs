...
| Go | [pgx](https://github.com/jackc/pgx/releases)<hr>[pq](https://github.com/lib/pq) | {% remote_include https://raw.githubusercontent.com/cockroachdb/cockroach/master/pkg/cmd/roachtest/tests/pgx.go |var supportedPGXTag = "|"\n\n  %}<hr>{% remote_include https://raw.githubusercontent.com/cockroachdb/cockroach/master/pkg/cmd/roachtest/tests/libpq.go |var libPQSupportedTag = "|"\n\n %} | Full<hr>Full | [Build a Go App with CockroachDB (pgx)](build-a-go-app-with-cockroachdb.html)<hr>[Build a Go App with CockroachDB (pq)](build-a-go-app-with-cockroachdb-pq.html) |
...
|----------+-----------+-----------------------+---------------+----------|
| Go | [GORM](https://github.com/jinzhu/gorm/releases)<hr>[go-pg](https://github.com/go-pg/pg)<hr>[upper/db](https://github.com/upper/db) | {% remote_include https://raw.githubusercontent.com/cockroachdb/cockroach/master/pkg/cmd/roachtest/tests/gorm.go |var gormSupportedTag = "|"\n\n %} <hr>{% remote_include https://raw.githubusercontent.com/cockroachdb/cockroach/master/pkg/cmd/roachtest/tests/gopg.go |var gopgSupportedTag = "|"\n\n %}<hr>v4 | Full<hr>Full<hr>Full | [Build a Go App with CockroachDB (GORM)](build-a-go-app-with-cockroachdb-gorm.html)<hr>N/A<hr>[Build a Go App with CockroachDB (upper/db)](build-a-go-app-with-cockroachdb-upperdb.html) |
