...
<div class="filters filters-big clearfix">
  <button class="filter-button" data-scope="gce-hosted">Hosted GCE</button>
  <button class="filter-button" data-scope="gce-manual">Manual GCE</button>
  <button class="filter-button" data-scope="aws">AWS</button>
</div>

The instructions below will change slightly depending on your choice.
...
2. From your local workstation, start the Kubernetes cluster:
    ...
    The process can take a while, so don't move on to the next step until you see a `Creating cluster cockroachdb...done` message and details about your cluster.
