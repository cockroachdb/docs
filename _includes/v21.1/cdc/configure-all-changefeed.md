...
This will change the status for each of the running changefeeds to `paused`, which can be verified with [`SHOW JOBS`](../{{site.versions["stable"]}}/stream-data-out-of-cockroachdb-using-changefeeds.html#using-show-jobs).
