...
def transfer_funds(conn, frm, to, amount):
    ...
    with conn.cursor() as cur:
        logging.debug("transfer_funds(): status message 'BEGIN': {}".format(cur.statusmessage))
...
def main():
    ...
    # Turn on logging to the console.  This is just to make the example easier
    # to understand.  It is not necessary for production code.
