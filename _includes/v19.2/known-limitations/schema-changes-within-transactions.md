...
- [Schema change DDL inside a multi-statement transaction can fail while other statements succeed](#schema-change-ddl-inside-a-multi-statement-transaction-can-fail-while-other-statements-succeed)
