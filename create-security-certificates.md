...
`create-client` | Create a certificate and key for a [specific user](create-users.html) accessing the cluster from a client. You specify the username of the user who will use the certificate and pass appropriate flags.
