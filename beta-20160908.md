...
- [Mac](https://d3a3ys8r4slo6p.cloudfront.net/cockroach-beta-20160908.darwin-10.9-amd64.tgz)
- [Linux](https://d3a3ys8r4slo6p.cloudfront.net/cockroach-beta-20160908.linux-amd64.tgz)
...
- CockroachDB now builds correctly when Git worktrees are used; as a consequence Git version 2.5 or newer is now required when [building from source](install-cockroachdb.html). [#9072](https://github.com/cockroachdb/cockroach/pull/9072)
...
- If any [environment variables](cockroach-commands.html#environment-variables) are used to configure the server, the names of those variables are printed to the logs. [#9069](https://github.com/cockroachdb/cockroach/pull/9069)
...
- [`CREATE TABLE`](create-table.html) now reports errors correctly instead of failing silently. [#9011](https://github.com/cockroachdb/cockroach/pull/9011)
...
- Added docs on [deploying CockroachDB on Google Cloud Platform GCE](deploy-cockroachdb-on-google-cloud-platform.html). [#574](https://github.com/cockroachdb/docs/pull/574)
- Added docs on [orchestrating CockroachDB with Kubernetes](orchestrate-cockroachdb-with-kubernetes.html). [#584](https://github.com/cockroachdb/docs/pull/584)
- Updated [troubleshooting](troubleshoot.html) docs to cover cases when nodes won't join a cluster. [#610](https://github.com/cockroachdb/docs/pull/610) 
...
- Updated docs on [secure local](secure-a-cluster.html) and [secure distributed](manual-deployment.html) deployment to show how to stop nodes. [#619](https://github.com/cockroachdb/docs/pull/619)  
