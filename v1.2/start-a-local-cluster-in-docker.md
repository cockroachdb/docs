...
{% include start_in_docker/v2.0/mac-linux-steps.md %}
</div>
...
cockroachdb/cockroach-unstable <span class="nb">start</span> --insecure</code></pre></div>
...
- `cockroachdb/cockroach-unstable start --insecure`: The CockroachDB command to [start a node](start-a-node.html) in the container in insecure mode.
...
cockroachdb/cockroach-unstable <span class="nb">start</span> --insecure --join<span class="o">=</span>roach1
...
cockroachdb/cockroach-unstable <span class="nb">start</span> --insecure --join<span class="o">=</span>roach1</code></pre></div>
