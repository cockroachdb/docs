...
1. Follow Kubernetes' [documentation](https://kubernetes.io/docs/tasks/tools/install-minikube/) to install `minikube`, the tool used to run Kubernetes locally for your OS. This includes installing a hypervisor and `kubeclt`, the command-line tool used to managed Kubernetes from your local workstation.
