...
standard-build: bootstrap
	...
	bundle exec jekyll $(jekyll-action) --incremental --config _config.yml$(extra-config)
...
managed-build: bootstrap
	...
	bundle exec jekyll $(jekyll-action) --incremental --config _config.yml,_config_managed.yml$(extra-config)
