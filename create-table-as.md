...
This can be more efficient than a [view](create-view.html) when the following two conditions are met:
...
A view is also advisable when the results must be up-to-date: q view
...
[interleaved](interleave-in-parent.html) with other tables.
