...
- Added a new [SQL Feature Support](sql-feature-support.html) page, which explains which standard SQL features are supported by CockroachDB. [#550](https://github.com/cockroachdb/docs/pull/550)
- Added a page to track [features available on the `develop` branch](develop-branch.html). [#552](https://github.com/cockroachdb/docs/pull/552) 
- Added documentation on [foreign key constraints](constraints.html#foreign-keys). [#528](https://github.com/cockroachdb/docs/pull/528)
- Updated the [Recommended Production Settings](recommended-production-settings.html) page to include cache size recommendations for machines running multiple applications and `systemd`-specific instructions for increasing the file descriptors limit. [#532](https://github.com/cockroachdb/docs/pull/532), [#554](https://github.com/cockroachdb/docs/pull/554)
