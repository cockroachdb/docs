...
- [Foreign keys](foreign-key.html) can now use a prefix of an index. [#8059](https://github.com/cockroachdb/cockroach/pull/8059)
...
- Added docs on [foreign key constraints](foreign-key.html). [#528](https://github.com/cockroachdb/docs/pull/528)
