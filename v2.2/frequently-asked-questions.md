...
For more details, see our documentation on [privileges](authorization.html#assign-privileges) and the [`GRANT`](grant.html) statement.
...
For more details, see the [Managed CockroachDB](../managed/v2.2/) docs.
