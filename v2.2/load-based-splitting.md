...
CockroachDB creates a relatively even distribution of leaseholders throughout your cluster (leaseholders are a single replica of a range that both serve reads and coordinate writes operations; [learn more about leaseholders](architecture/replication-layer.html#leases)).
