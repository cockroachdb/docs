...
{{site.data.alerts.callout_info}}The <code>SET CLUSTER SETTING</code> statement is unrelated to the other <a href="set-transaction.html"><code>SET TRANSACTION</code></a> and <a href="set-var.html"><code>SET (session variable)</code></a> statements.{{site.data.alerts.end}}
