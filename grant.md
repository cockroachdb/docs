...
The `GRANT` [statement](sql-statements.html) lets you control each [user's](create-users.html) SQL [privileges](privileges.html) for interacting with specific databases and tables.
