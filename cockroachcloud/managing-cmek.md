...
See the [API specification](../api/cloud/v1.html#post-/api/v1/clusters/-cluster_id-/cmek).
...
See the [API specification](../api/cloud/v1.html#get-/api/v1/clusters/-cluster_id-/cmek).
...
1. Update your cluster with the the Cloud API as follows:
    ...
    See the [API specification](../api/cloud/v1.html#patch-/api/v1/clusters/-cluster_id-/cmek).
