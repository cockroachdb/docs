...
Now that [CockroachDB v22.1](../releases/v22.1.html) is available, an [org admin](authorization.html#org-administrator-legacy) can upgrade your {{ site.data.products.dedicated }} cluster from the {{ site.data.products.db }} Console. This page guides you through the process for an Admin.
