...
{{ site.data.products.serverless }} only support full backups. [Incremental](../{{site.versions["stable"]}}/take-full-and-incremental-backups.html) and [revision history](../{{site.versions["stable"]}}/take-backups-with-revision-history-and-restore-from-a-point-in-time.html) backups are not supported.
...
{{ site.data.products.serverless }} does not support [multi-region](../{{site.versions["stable"]}}/multiregion-overview.html) features.
...
## CockroachDB Cloud Console features
