...
<div class="container">
  ...
  <div class="row display-flex pb-4">
    ...
    <div class="col-6 col-lg-3">
      ...
      <div class="landing-column-content">
      <ul>
        <li><a href="../{{site.versions["cloud"]}}/migration-overview.html">Migrate Data</a></li>
        <li><a href="../{{site.versions["cloud"]}}/performance-best-practices-overview.html">Tune Performance</a></li>
    ...
    <div class="col-6 col-lg-3">
      ...
      <div class="landing-column-content">
      <ul>
        <li><a href="../{{site.versions["cloud"]}}/developer-guide-overview.html">Common Dev Tasks</a></li>
        <li><a href="../{{site.versions["cloud"]}}/example-apps.html">Sample Apps</a></li>
        <li><a href="../{{site.versions["cloud"]}}/sql-feature-support.html">SQL Reference</a></li>
        <li><a href="../{{site.versions["cloud"]}}/performance-best-practices-overview.html">SQL Best Practices</a></li>
        <li><a href="../{{site.versions["cloud"]}}/error-handling-and-troubleshooting.html">SQL Troubleshooting</a></li>
        </ul>
      </div>
    </div>
    <div class="col-6 col-lg-3">
      ...
      <ul>
        ...
        <li><a href="../{{site.versions["cloud"]}}/frequently-asked-questions.html">CockroachDB FAQs</a></li>
