...
If you [require SSO authentication](configure-cloud-org-sso.html#require-sso), then when you deprovision a member from your IdP, they can no longer access your {{ site.data.products.db }} organization and there is no need to manually remove them from your {{ site.data.products.db }} organization.
