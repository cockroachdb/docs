...
Logs exported in this fashion retain [`redactable`](/docs/{{site.versions["stable"]}}/configure-logs.html#redact-logs) markers, but are **not** themselves redacted. Based on your needs, you could optionally redact sensitive data in the logs at your end by making use of `redactable` markers, before the logs are consumed by your team.
