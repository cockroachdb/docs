...
If you created a {{ site.data.products.dedicated }} cluster before December 1, 2021, you may have different machine types, IOPS, and pricing. Your cluster will be updated automatically by the end of the month, and your next invoice will reflect the new pricing.
{{site.data.alerts.end}}
