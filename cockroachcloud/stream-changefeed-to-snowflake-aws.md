...
Be sure to replace the placeholders with your AWS access key ID and AWS secret access key. See [Cloud Storage Authentication](../{{site.versions["stable"]}}/use-cloud-storage-for-bulk-operations.html#authentication) for more detail on authenticating to Amazon S3.
