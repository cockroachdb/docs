...
Be sure to replace the placeholders with your AWS access key ID and AWS secret access key. See [Use Cloud Storage for Bulk Operations — Authentication](https://www.cockroachlabs.com/docs/stable/use-cloud-storage-for-bulk-operations.html#amazon-s3) for more detail on authenticating to Amazon S3.
