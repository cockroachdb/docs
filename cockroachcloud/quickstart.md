...
- To watch a video walkthrough of connecting to a cluster, see [Setting Up a CockroachDB Serverless Cluster](https://www.youtube.com/watch?v=6CIDXdlnwHk).
- To watch a video walkthrough of running queries against a cluster, see [Using a CockroachDB Serverless Cluster](https://www.youtube.com/watch?v=VCuTmvKXjP0).
