...
**Projected usage** | The amount of usage that Cockroach Labs projects a cluster will consume during a billing period. This is important for setting a cluster’s spend limit, because users must leave enough budget to pay for storage for the rest of the billing period.
