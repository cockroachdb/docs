...
- Unlike Amazon S3, Google Cloud Storage, and Azure storage options, the usage of [S3-compatible services](use-cloud-storage-for-bulk-operations.html) is **not** actively tested by Cockroach Labs.
...
<div>
{% remote_include https://raw.githubusercontent.com/cockroachdb/generated-diagrams/release-{{ remote_include_version }}/grammar_svg/backup.html %}
</div>
