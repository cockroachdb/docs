...
{{site.data.alerts.callout_info}}
If you are using super regions with the [secondary region](#secondary-regions) feature, the secondary region must be inside or outside of the same super region as the [primary region](set-primary-region.html).
{{site.data.alerts.end}}
...
{{site.data.alerts.callout_info}}
If you are using a secondary region and a [super region](#super-regions), the secondary region must be inside or outside of the same super region as the [primary region](set-primary-region.html).
{{site.data.alerts.end}}
