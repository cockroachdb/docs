...
| [`crdb_internal` system catalog](crdb-internal.html)                    | Reserved | Versioned concurrently with CockroachDB.                                               | A [subset](crdb-internal.html#tables) of the `crdb_internal` system catalog is stable.                                                                                                                    | All products                                                      |
