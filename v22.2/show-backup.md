...
`size_bytes` | The size of the backup objects, in bytes. Note that `size_bytes` indicates the logical size of the table objects, the sum of the size of each key value pair. See `file_bytes` in this table for more detail.
