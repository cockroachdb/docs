...
- A new distributed SQL execution engine is now used for some `SELECT` statements, significantly improving performance of queries using aggregation functions or joins.
