...
- The [`SHOW ALL`](show-vars.html) statement is now supported. [#10195](https://github.com/cockroachdb/cockroach/pull/10195)
...
- [`SET TIME ZONE 0`](set-vars.html#set-time-zone) now sets the session time zone to UTC (other numbers already worked). [#9992](https://github.com/cockroachdb/cockroach/pull/9992)
