...
<div>
{% dynamic_include page.version.version, "/backups/show-backup-replace-diagram.html" %}
</div>
...
{% dynamic_include page.version.version, "/backups/locality-aware-backups.md" %}
...
{% dynamic_include page.version.version, "/backups/check-files-validate.md" %}
