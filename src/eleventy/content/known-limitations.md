...
{% dynamic_include page.version.version, "/known-limitations/view-limitations.md" %}
...
{% dynamic_include page.version.version, "/known-limitations/jsonpath-limitations.md" %}

#### `AS OF SYSTEM TIME` limitations

- {% dynamic_include page.version.version, "/known-limitations/aost-limitations.md" %}
- {% dynamic_include page.version.version, "/known-limitations/create-statistics-aost-limitation.md" %}

#### `COPY` syntax not supported by CockroachDB

{% dynamic_include page.version.version, "/known-limitations/copy-syntax.md" %}

#### `IMPORT INTO` limitations

{% dynamic_include page.version.version, "/known-limitations/import-into-limitations.md" %}

#### `ALTER VIEW` limitations

{% dynamic_include page.version.version, "/known-limitations/alter-view-limitations.md" %}

#### Row-Level TTL limitations

{% dynamic_include page.version.version, "/known-limitations/row-level-ttl-limitations.md" %}
...
{% dynamic_include page.version.version, "/known-limitations/like-escape-performance.md" %}
...
{% dynamic_include page.version.version, "/known-limitations/plpgsql-limitations.md" %}

#### UDF and stored procedure support

{% dynamic_include page.version.version, "/known-limitations/routine-limitations.md" %}
{% dynamic_include page.version.version, "/known-limitations/stored-proc-limitations.md" %}
{% dynamic_include page.version.version, "/known-limitations/udf-limitations.md" %}

### Triggers

{% dynamic_include page.version.version, "/known-limitations/trigger-limitations.md" %}
...
{% dynamic_include page.version.version, "/known-limitations/read-committed-limitations.md" %}

#### Follower reads

{% dynamic_include page.version.version, "/known-limitations/follower-reads-limitations.md" %}

#### `SELECT FOR UPDATE` locks are dropped on lease transfers and range splits/merges

{% dynamic_include page.version.version, "/known-limitations/select-for-update-limitations.md" %}

#### `SET` does not `ROLLBACK` in a transaction

{% dynamic_include page.version.version, "/known-limitations/set-transaction-no-rollback.md" %}
...
{% dynamic_include page.version.version, "/known-limitations/cancel-job-limitations.md" %}

#### SQL cursor support

{% dynamic_include page.version.version, "/known-limitations/sql-cursors.md" %}

#### Materialized views inside transactions

{% dynamic_include page.version.version, "/known-limitations/cannot-refresh-materialized-views-inside-transactions.md" %}

### Schemas and indexes

#### Vector index limitations

{% dynamic_include page.version.version, "/known-limitations/vector-limitations.md" %}

#### Online schema change limitations

{% dynamic_include page.version.version, "/known-limitations/online-schema-changes-limitations.md" %}
...
{% dynamic_include page.version.version, "/known-limitations/drop-column-partial-index.md" %}

#### Schema change DDL statements inside a multi-statement transaction can fail while other statements succeed

{% dynamic_include page.version.version, "/known-limitations/schema-change-ddl-inside-multi-statement-transactions.md" %}

#### Schema changes between executions of prepared statements

{% dynamic_include page.version.version, "/known-limitations/schema-changes-between-prepared-statements.md" %}
...
{% dynamic_include page.version.version, "/known-limitations/alter-column-limitations.md" %}

#### `CREATE TABLE AS` limitations

{% dynamic_include page.version.version, "/known-limitations/create-table-as-limitations.md" %}

#### Remove a `UNIQUE` index created as part of `CREATE TABLE`

{% dynamic_include page.version.version, "/known-limitations/drop-unique-index-from-create-table.md" %}
...
{% dynamic_include page.version.version, "/known-limitations/drop-single-partition.md" %}

#### Placeholders in `PARTITION BY`

{% dynamic_include page.version.version, "/known-limitations/partitioning-with-placeholders.md" %} [#19464](https://github.com/cockroachdb/cockroach/issues/19464)
...
{% dynamic_include page.version.version, "/known-limitations/trigram-unsupported-syntax.md" %}
...
{% dynamic_include page.version.version, "/known-limitations/full-text-search-unsupported.md" %}
...
{% dynamic_include page.version.version, "/known-limitations/multiple-arbiter-indexes.md" %}

#### Expression index limitations

{% dynamic_include page.version.version, "/known-limitations/expression-index-limitations.md" %}

### Data types

#### `CITEXT` limitations

{% dynamic_include page.version.version, "/known-limitations/citext-limitations.md" %}
...
- {% dynamic_include page.version.version, "/known-limitations/srid-4326-limitations.md" %}

- {% dynamic_include page.version.version, "/known-limitations/geospatial-heterogeneous-architectures.md" %}
...
- {% dynamic_include page.version.version, "/cdc/types-udt-composite-general.md" %} The following limitations apply:
    - {% dynamic_include page.version.version, "/cdc/avro-udt-composite.md" %}
    - {% dynamic_include page.version.version, "/cdc/csv-udt-composite.md" %}
...
{% dynamic_include page.version.version, "/known-limitations/alter-type-limitations.md" %}

#### `JSONB` limitations

{% dynamic_include page.version.version, "/known-limitations/jsonb-limitations.md" %}

### Security and privileges

#### Row-level security

- {% dynamic_include page.version.version, "/known-limitations/rls-values-on-conflict-do-nothing.md" %}
- {% dynamic_include page.version.version, "/known-limitations/rls-update-set-where-returning.md" %}

#### `GRANT`/`REVOKE` limitations

{% dynamic_include page.version.version, "/known-limitations/grant-revoke-schema-changes.md" %}

#### `DROP OWNED BY` limitations

{% dynamic_include page.version.version, "/known-limitations/drop-owned-by-limitations.md" %}
...
{% dynamic_include page.version.version, "/known-limitations/admission-control-limitations.md" %}

#### Data domiciling

{% dynamic_include page.version.version, "/known-limitations/data-domiciling-limitations.md" %}

#### DistSQL

{% dynamic_include page.version.version, "/known-limitations/distsql-heterogeneous-endianness.md" %}
...
{% dynamic_include page.version.version, "/sql/server-side-connection-limit.md" %} This may be useful in addition to your memory monitoring.
...
{% dynamic_include page.version.version, "/known-limitations/logging-limitations.md" %}

#### Per-replica circuit breaker limitations

{% dynamic_include page.version.version, "/known-limitations/per-replica-circuit-breaker-limitations.md" %}
...
{% dynamic_include page.version.version, "/known-limitations/datadog-self-hosted-limitations.md" %}
...
{% dynamic_include page.version.version, "/misc/available-capacity-metric.md" %}

### Disaster recovery

#### Physical cluster replication

{% dynamic_include page.version.version, "/known-limitations/physical-cluster-replication.md" %}
- {% dynamic_include page.version.version, "/known-limitations/failover-stop-application.md" %}

#### `RESTORE` limitations

- {% dynamic_include page.version.version, "/known-limitations/restore-udf.md" %}
- {% dynamic_include page.version.version, "/known-limitations/restore-tables-non-multi-reg.md" %}
- {% dynamic_include page.version.version, "/known-limitations/restore-multiregion-match.md" %}
...
{% dynamic_include page.version.version, "/known-limitations/show-backup-symlink.md" %}

### High Availability

#### Logical data replication (LDR)

- {% dynamic_include page.version.version, "/known-limitations/ldr-triggers.md" %}
- {% dynamic_include page.version.version, "/known-limitations/ldr-udfs.md" %}
- {% dynamic_include page.version.version, "/known-limitations/ldr-sequences.md" %}
- {% dynamic_include page.version.version, "/known-limitations/ldr-indexes.md" %}
- {% dynamic_include page.version.version, "/known-limitations/ldr-column-families.md" %}
- {% dynamic_include page.version.version, "/known-limitations/ldr-composite-primary.md" %}
...
{% dynamic_include page.version.version, "/known-limitations/cdc.md" %}
{% dynamic_include page.version.version, "/known-limitations/cdc-queries.md" %}
- {% dynamic_include page.version.version, "/known-limitations/cdc-queries-column-families.md" %}
- {% dynamic_include page.version.version, "/known-limitations/changefeed-column-family-message.md" %}

#### `ALTER CHANGEFEED` limitations

{% dynamic_include page.version.version, "/known-limitations/alter-changefeed-limitations.md" %}
- {% dynamic_include page.version.version, "/known-limitations/alter-changefeed-cdc-queries.md" %}

### Performance optimization

#### Generic query plan limitations

{% dynamic_include page.version.version, "/known-limitations/generic-query-plan-limitations.md" %}
...
{% dynamic_include page.version.version, "/known-limitations/stats-refresh-upgrade.md" %}
{% dynamic_include page.version.version, "/known-limitations/forecasted-stats-limitations.md" %}
...
{% dynamic_include page.version.version, "/known-limitations/vectorized-engine-limitations.md" %}
...
{% dynamic_include page.version.version, "/known-limitations/import-high-disk-contention.md" %}
...
{% dynamic_include page.version.version, "/known-limitations/locality-optimized-search-virtual-computed-columns.md" %}
{% dynamic_include page.version.version, "/known-limitations/locality-optimized-search-limited-records.md" %}

#### Query plans for materialized views

{% dynamic_include page.version.version, "/known-limitations/materialized-views-no-stats.md" %}
