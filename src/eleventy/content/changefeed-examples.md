...
{% dynamic_include page.version.version, "/cdc/sql-cluster-settings-example.md" %}

{% dynamic_include page.version.version, "/cdc/create-example-db-cdc.md" %}
...
1. In a new terminal, move into the extracted `confluent-<version>` directory and start watching the Kafka topics:
    ...
    {% dynamic_include page.version.version, "/cdc/print-key.md" %}
...
1. Start the changefeed:
    ...
    {% dynamic_include page.version.version, "/cdc/confluent-cloud-sr-url.md" %}
...
{% dynamic_include page.version.version, "/cdc/examples-license-workload.md" %}
...
{% dynamic_include page.version.version, "/cdc/create-sinkless-changefeed.md" %}

## Create a sinkless changefeed using Avro

{% dynamic_include page.version.version, "/cdc/create-sinkless-changefeed-avro.md" %}
