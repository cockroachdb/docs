...
{% include "youtube.html", video_id: "IXFTojYfA5A" %}
...
{{site.data.alerts.callout_info}}
{% dynamic_include page.version.version, "/sql/super-regions-for-domiciling-with-region-survivability.md" %}
{{site.data.alerts.end}}
...
{% dynamic_include page.version.version, "/known-limitations/secondary-regions-with-regional-by-row-tables.md" %}
{{site.data.alerts.end}}
...
{% dynamic_include page.version.version, "/performance/lease-preference-system-database.md" %}
