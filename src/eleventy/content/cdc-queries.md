...
{% dynamic_include page.version.version, "/cdc/composite-key-delete-insert.md" %}
...
{% dynamic_include page.version.version, "/cdc/bare-envelope-cdc-queries.md" %} Refer to the [Changefeed Message Envelopes]({% link "{{ page.version.version }}/changefeed-message-envelopes.md" %}#bare) page for more detail.
...
{{site.data.alerts.callout_info}}
{% dynamic_include page.version.version, "/sql/row-level-ttl-prefer-ttl-expiration-expressions.md" %}
...
{% dynamic_include page.version.version, "/cdc/schedule-query-example.md" %}
...
{% include "youtube.html", video_id: "mea4czXi7tI" %}
