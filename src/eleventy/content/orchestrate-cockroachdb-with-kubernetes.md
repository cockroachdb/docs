...
{% dynamic_include page.version.version, "/orchestration/kubernetes-limitations.md" %}

## Step 1. Start Kubernetes

{% dynamic_include page.version.version, "/orchestration/start-kubernetes.md" %}
...
{% dynamic_include page.version.version, "/orchestration/start-cockroachdb-operator-secure.md" %}
</section>

<section class="filter-content" markdown="1" data-scope="manual">
{% dynamic_include page.version.version, "/orchestration/start-cockroachdb-secure.md" %}
</section>

<section class="filter-content" markdown="1" data-scope="helm">
{% dynamic_include page.version.version, "/orchestration/start-cockroachdb-helm-secure.md" %}
</section>

## Step 3. Use the built-in SQL client

{% dynamic_include page.version.version, "/orchestration/test-cluster-secure.md" %}

## Step 4. Access the DB Console

{% dynamic_include page.version.version, "/orchestration/monitor-cluster.md" %}

## Step 5. Simulate node failure

{% dynamic_include page.version.version, "/orchestration/kubernetes-simulate-failure.md" %}

## Step 6. Monitor the cluster

{% dynamic_include page.version.version, "/orchestration/kubernetes-prometheus-alertmanager.md" %}
...
{% dynamic_include page.version.version, "/orchestration/kubernetes-scale-cluster.md" %}

### Remove nodes

{% dynamic_include page.version.version, "/orchestration/kubernetes-remove-nodes-secure.md" %}
...
{% dynamic_include page.version.version, "/orchestration/kubernetes-expand-disk-size.md" %}

### Upgrade the cluster

{% dynamic_include page.version.version, "/orchestration/kubernetes-upgrade-cluster.md" %}

### Stop the cluster

{% dynamic_include page.version.version, "/orchestration/kubernetes-stop-cluster.md" %}
