...
{% dynamic_include page.version.version, "/backups/scheduled-backups-tip.md" %}

{% dynamic_include page.version.version, "/backups/old-syntax-removed.md" %}
...
- {% dynamic_include page.version.version, "/backups/zone-configs-overwritten-during-restore.md" %}
...
{% dynamic_include page.version.version, "/backups/external-storage-check-tip.md" %}
{{site.data.alerts.end}}

## Required privileges

{% dynamic_include page.version.version, "/backups/updated-backup-privileges.md" %}
...
{% dynamic_include page.version.version, "/backups/destination-privileges.md" %}

{% dynamic_include page.version.version, "/misc/s3-compatible-warning.md" %}
...
----------------+-------+------------
`ASSUME_ROLE` | [`STRING`]({% link "{{ page.version.version }}/string.md" %}) |{% dynamic_include page.version.version, "/misc/assume-role-description.md" %} Refer to [Cloud Storage Authentication]({% link "{{ page.version.version }}/cloud-storage-authentication.md" %}) for setup details.
...
{% dynamic_include page.version.version, "/backups/cap-parameter-ext-connection.md" %}

### Options

{% dynamic_include page.version.version, "/backups/backup-options.md" %}
...
{% dynamic_include page.version.version, "/misc/external-connection-note.md" %}
...
{% dynamic_include page.version.version, "/backups/object-dependency.md" %}
...
{% dynamic_include page.version.version, "/backups/retry-failure.md" %}
...
{% dynamic_include page.version.version, "/backups/bulk-auth-options.md" %}
...
{% dynamic_include page.version.version, "/backups/backup-storage-collision.md" %}
...
{% dynamic_include page.version.version, "/misc/storage-classes.md" %}

{% dynamic_include page.version.version, "/misc/storage-class-glacier-incremental.md" %}

### Advanced examples

{% dynamic_include page.version.version, "/backups/advanced-examples-list.md" %}
