...
- {% dynamic_include page.version.version, "/cdc/tutorial-privilege-check.md" %}

{{site.data.alerts.callout_info}}
{% dynamic_include page.version.version, "/cdc/msk-dedicated-support.md" %}
...
{% dynamic_include page.version.version, "/cdc/msk-iam-policy-role-step.md" %}
...
{% dynamic_include page.version.version, "/cdc/cluster-iam-role-step.md" %}
...
{% dynamic_include page.version.version, "/cdc/msk-tutorial-crdb-setup.md" %}
