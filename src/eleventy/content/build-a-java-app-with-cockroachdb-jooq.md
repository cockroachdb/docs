...
{% dynamic_include page.version.version, "/filter-tabs/crud-java.md" %}
...
{% dynamic_include page.version.version, "/app/java-version-note.md" %}
...
{% include "copy-clipboard.html" %}
~~~ java
{% dynamic_include page.version.version, "/app/jooq-basic-sample/Sample.java" %}
~~~
...
{% include "copy-clipboard.html" %}
~~~ java
{% dynamic_include page.version.version, "/app/insecure/jooq-basic-sample/Sample.java" %}
~~~
