...
{% dynamic_include page.version.version, "/sql/session-variable-precedence-order.md" %}
...
- For [per-database defaults](#set-default-session-variable-values-for-a-specific-database), the [owner]({% link "{{ page.version.version }}/security-reference/authorization.md" %}#object-ownership) of a database can execute `ALTER ROLE ALL IN DATABASE ... {SET|RESET}` for that database (in addition to users who meet the general requirements above).
...
{% dynamic_include page.version.version, "/sql/role-options.md" %}
...
{% dynamic_include page.version.version, "/sql/show-default-session-variables-for-role.md" %}
...
The [owner]({% link "{{ page.version.version }}/security-reference/authorization.md" %}#object-ownership) of a database can also execute `ALTER ROLE ALL IN DATABASE ... {SET|RESET}` for that database.
...
{% dynamic_include page.version.version, "/sql/role-subject-option.md" %}
