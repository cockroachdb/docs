...
{% dynamic_include page.version.version, "/cdc/recommendation-monitoring-pts.md" %}

## Required privileges

{% dynamic_include page.version.version, "/cdc/privilege-model.md" %}
...
<a name="confluent-schema-registry"></a>`confluent_schema_registry` | Schema Registry address | The [Schema Registry](https://docs.confluent.io/current/schema-registry/docs/index.html#sr) address is required to use `avro`.<br><br>{% dynamic_include page.version.version, "/cdc/schema-registry-timeout.md" %}<br><br>{% dynamic_include page.version.version, "/cdc/confluent-cloud-sr-url.md" %}<br><br>{% dynamic_include page.version.version, "/cdc/schema-registry-metric.md" %}
...
{{site.data.alerts.callout_info}}
{% dynamic_include page.version.version, "/cdc/changefeed-number-limit.md" %}
{{site.data.alerts.end}}
...
{% dynamic_include page.version.version, "/cdc/disable-replication-ttl.md" %}
...
{% dynamic_include page.version.version, "/cdc/cdc-schema-locked-example.md" %}
...
{% dynamic_include page.version.version, "/cdc/modify-changefeed.md" %}

#### Configuring all changefeeds

{% dynamic_include page.version.version, "/cdc/configure-all-changefeed.md" %}
