...
{% dynamic_include page.version.version, "/misc/schema-change-view-job.md" %}
...
{% dynamic_include page.version.version, "/see-zone-config-troubleshooting-guide.md" %}
...
{% dynamic_include page.version.version, "/sql/row-level-security-enabled.md" %}
...
{% dynamic_include page.version.version, "/misc/table-storage-parameters.md" %}
...
{% dynamic_include page.version.version, "/sql/range-splits.md" %}
...
{% dynamic_include page.version.version, "/sql/movr-statements.md" %}
...
{% dynamic_include page.version.version, "/sql/indexes-regional-by-row.md" %}
...
{% dynamic_include page.version.version, "/sql/locality-optimized-search.md" %}
...
{% dynamic_include page.version.version, "/computed-columns/convert-computed-column.md" %}

#### Alter the formula for a computed column

{% dynamic_include page.version.version, "/computed-columns/alter-computed-column.md" %}
...
{% include "youtube.html", video_id: "MPx-LXY2D-c" %}
...
{% dynamic_include page.version.version, "/performance/alter-primary-key-hash-sharded.md" %}
...
{% dynamic_include page.version.version, "/sql/movr-statements-geo-partitioned-replicas.md" %}

#### Create a replication zone for a table

{% dynamic_include page.version.version, "/zone-configs/create-a-replication-zone-for-a-table.md" %}
...
{% dynamic_include page.version.version, "/zone-configs/reset-a-replication-zone.md" %}

#### Remove a replication zone

{% dynamic_include page.version.version, "/zone-configs/remove-a-replication-zone.md" %}
...
{{site.data.alerts.callout_success}}
CockroachDB can also [infer a row's home region from a foreign key constraint](#infer-a-rows-home-region-from-a-foreign-key).
{{site.data.alerts.end}}
...
{% dynamic_include page.version.version, "/sql/modify-region-column-or-its-expression.md" %}
