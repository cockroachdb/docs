...
{% dynamic_include page.version.version, "/upgrade-requirements.md" %}
...
{% include "common/upgrade/patch-upgrade-self-hosted.md" %}

### Roll back a patch upgrade

{% include "common/upgrade/patch-rollback-self-hosted.md" %}

## Perform a major-version upgrade

{% include "common/upgrade/major-version-upgrade-self-hosted.md" %}
...
{% include "common/upgrade/rollback-self-hosted.md" %}
