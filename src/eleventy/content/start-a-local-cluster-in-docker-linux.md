...
{% dynamic_include page.version.version, "/start-in-docker/mac-linux-steps.md" %}

## Start a single-node cluster

{% dynamic_include page.version.version, "/start-in-docker/mac-linux-steps-single-node.md" %}
