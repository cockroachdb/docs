...
<img src="{{ 'images/v26.1/contention-1.png' | relative_url }}" alt="DB Console SQL Statement Contention graph" style="border:1px solid #eee;max-width:100%" />
...
<img src="{{ 'images/v26.1/contention-2.png' | relative_url }}" alt="Statements page by Contention Time" style="border:1px solid #eee;max-width:100%" />
...
<img src="{{ 'images/v26.1/contention-3.png' | relative_url }}" alt="Transactions page by Contention Time" style="border:1px solid #eee;max-width:100%" />
...
{% dynamic_include page.version.version, "/crdb-internal-transaction-contention-events-warning.md" %}
...
{% dynamic_include page.version.version, "/transaction-contention-events-columns.md" %}
...
- [`crdb_internal.cluster_locks`]({% link "{{ page.version.version }}/crdb-internal.md" %}#cluster_locks)
    ...
    {% dynamic_include page.version.version, "/crdb-internal-cluster-locks-warning.md" %}
...
<img src="{{ 'images/v26.1/contention-4.png' | relative_url }}" alt="DB Console SQL Statement Errors graph" style="border:1px solid #eee;max-width:100%" />
...
<img src="{{ 'images/v26.1/contention-5.png' | relative_url }}" alt="DB Console SQL Statement Contention graph" style="border:1px solid #eee;max-width:100%" />
...
<img src="{{ 'images/v26.1/contention-6.png' | relative_url }}" alt="DB Console Transaction Restarts graph" style="border:1px solid #eee;max-width:100%" />
