...
{% dynamic_include page.version.version, "/faq/auto-generate-unique-ids.md" %}
...
{% dynamic_include page.version.version, "/faq/simulate-key-value-store.md" %}
...
{% dynamic_include page.version.version, "/computed-columns/simple.md" %}

### Create a table with a hash-sharded primary index

{% dynamic_include page.version.version, "/performance/use-hash-sharded-indexes.md" %}

{% dynamic_include page.version.version, "/performance/create-table-hash-sharded-primary-index.md" %}

### Create a table with a hash-sharded secondary index

{% dynamic_include page.version.version, "/performance/create-table-hash-sharded-secondary-index.md" %}
