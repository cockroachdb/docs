...
{% dynamic_include page.version.version, "/cdc/sink-list.md" %}
...
{% dynamic_include page.version.version, "/cdc/sink-URI-external-connection.md" %}
...
{% dynamic_include page.version.version, "/misc/note-egress-perimeter-cdc-backup.md" %}
...
{% dynamic_include page.version.version, "/cdc/oauth-description.md" %}
...
{% dynamic_include page.version.version, "/cdc/kafka-vpc-limitation.md" %}
...
`client_key`       | The base64-encoded private key for the PEM certificate. This is used with `client_cert`.<br><br>{% dynamic_include page.version.version, "/cdc/client-key-encryption.md" %}
...
{% dynamic_include page.version.version, "/cdc/options-table-note.md" %}
...
- `"ALL"`: A quorum must be reached (that is, most Kafka brokers have committed the message) before the leader can acknowledge. This is the highest consistency level. {% dynamic_include page.version.version, "/cdc/kafka-acks.md" %}
...
{% dynamic_include page.version.version, "/cdc/note-changefeed-message-page.md" %}
...
{% dynamic_include page.version.version, "/cdc/sink-configuration-detail.md" %}
...
`AZURE_ENVIRONMENT` | Azure Blob Storage | {% dynamic_include page.version.version, "/misc/azure-env-param.md" %}
...
{% dynamic_include page.version.version, "/cdc/azure-event-hubs-uri.md" %}
...
{% dynamic_include page.version.version, "/cdc/apache-pulsar-uri.md" %}
...
{% dynamic_include page.version.version, "/cdc/apache-pulsar-unsupported.md" %}
