...
{% dynamic_include page.version.version, "/sql/select-lock-strengths.md" %}
...
{% dynamic_include page.version.version, "/sql/select-for-update-overview.md" %}
...
{% include "youtube.html", video_id: "vfq3o5yG-PU" %}
