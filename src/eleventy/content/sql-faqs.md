...
{% dynamic_include page.version.version, "/faq/sequential-numbers.md" %}

## What are the differences between `UUID`, sequences, and `unique_rowid()`?

{% dynamic_include page.version.version, "/faq/differences-between-numberings.md" %}

## How do I order writes to a table to closely follow time in CockroachDB?

{% dynamic_include page.version.version, "/faq/sequential-transactions.md" %}
...
{% dynamic_include page.version.version, "/sql/use-case-trigram-indexes.md" %}
