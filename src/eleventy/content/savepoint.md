...
{% dynamic_include page.version.version, "/sql/savepoint-ddl-rollbacks.md" %}
...
{% dynamic_include page.version.version, "/sql/savepoints-and-row-locks.md" %}

## Savepoints and high priority transactions

{% dynamic_include page.version.version, "/sql/savepoints-and-high-priority-transactions.md" %}
...
{% dynamic_include page.version.version, "/sql/retry-savepoints.md" %}
...
{% dynamic_include page.version.version, "/misc/customizing-the-savepoint-name.md" %}
