...
{% dynamic_include page.version.version, "/sql/physical-plan-url.md" %}
...
If you use the [`DISTSQL` option](#distsql-option), the statement will also return a URL generated for a physical statement plan that provides high level information about how a statement will be executed. {% dynamic_include page.version.version, "/sql/physical-plan-url.md" %} For details about reading the physical statement plan, see [DistSQL plan diagram](#distsql-plan-diagram).
