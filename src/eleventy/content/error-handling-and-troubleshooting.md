...
{% dynamic_include page.version.version, "/prod-deployment/check-sql-query-performance.md" %}
...
{% dynamic_include page.version.version, "/misc/client-side-intervention-example.md" %}
