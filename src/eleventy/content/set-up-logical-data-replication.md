...
<image src="{{ 'images/v26.1/bidirectional-stream.svg' | relative_url }}" alt="Diagram showing bidirectional LDR from cluster A to B and back again from cluster B to A." style="width:70%" />
...
- {% dynamic_include page.version.version, "/ldr/multiple-tables.md" %}
