...
{% dynamic_include page.version.version, "/filter-tabs/crdb-kubernetes.md" %}
...
To orchestrate a physically distributed cluster in production, see [Orchestrated Deployments]({% link "{{ page.version.version }}/kubernetes-overview.md" %}). To deploy a 30-day free CockroachDB {{ site.data.products.advanced }} cluster instead of running CockroachDB yourself, see the [Quickstart]({% link "cockroachcloud/quickstart.md" %}).
...
{% dynamic_include page.version.version, "/orchestration/local-start-kubernetes.md" %}
...
{% dynamic_include page.version.version, "/orchestration/start-cockroachdb-local-insecure.md" %}
</section>

<section class="filter-content" markdown="1" data-scope="helm">
{% dynamic_include page.version.version, "/orchestration/start-cockroachdb-local-helm-insecure.md" %}
</section>
...
{% dynamic_include page.version.version, "/misc/explore-benefits-see-also.md" %}
