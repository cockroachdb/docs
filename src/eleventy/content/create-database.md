...
{% dynamic_include page.version.version, "/sql/server-side-connection-limit.md" %} This setting may be useful until the `CONNECTION LIMIT` syntax is fully supported.
