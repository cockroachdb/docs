...
<section class="filter-content" markdown="1" data-scope="manual">
{% dynamic_include page.version.version, "/orchestration/kubernetes-upgrade-cluster-manual.md" %}
</section>

<section class="filter-content" markdown="1" data-scope="helm">
{% dynamic_include page.version.version, "/orchestration/kubernetes-upgrade-cluster-helm.md" %}
</section>
