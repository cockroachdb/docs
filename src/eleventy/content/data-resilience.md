...
<image src="{{ 'images/v26.1/resilience.svg' | relative_url }}" alt="Diagram showing how HA features and DR tools create a resilient CockroachDB deployment." style="width:80%" />
...
{% dynamic_include page.version.version, "/resilience/recovery-objectives-definition.md" %}
...
{% dynamic_include page.version.version, "/resilience/dr-feature-table.md" %}
