...
**Solution:** [Check LSM health]({% link "{{ page.version.version }}/common-issues-to-monitor.md" %}#lsm-health). {% dynamic_include page.version.version, "/prod-deployment/resolution-inverted-lsm.md" %}
