...
{% dynamic_include page.version.version, "/zone-configs/avoid-manual-zone-configs.md" %}
{{site.data.alerts.end}}
...
<img src="{{ 'images/v26.1/zone-config-inheritance-diagram.png' | relative_url }}" alt="zone config inheritance diagram" style="border:1px solid #eee;max-width:100%" />
...
{% dynamic_include page.version.version, "/zone-configs/variables.md" %}
...
{% dynamic_include page.version.version, "/sql/crdb-internal-partitions.md" %}
...
{% dynamic_include page.version.version, "/zone-configs/view-all-replication-zones.md" %}
...
{% dynamic_include page.version.version, "/zone-configs/view-the-default-replication-zone.md" %}

For more information, see [`SHOW ZONE CONFIGURATIONS`]({% link "{{ page.version.version }}/show-zone-configurations.md" %}).

### Edit the default replication zone

{% dynamic_include page.version.version, "/zone-configs/edit-the-default-replication-zone.md" %}

### Create a replication zone for a system range

{% dynamic_include page.version.version, "/zone-configs/create-a-replication-zone-for-a-system-range.md" %}

For more information, see [`ALTER RANGE ... CONFIGURE ZONE`]({% link "{{ page.version.version }}/alter-range.md" %}#configure-zone).

### Create a replication zone for a database

{% dynamic_include page.version.version, "/zone-configs/create-a-replication-zone-for-a-database.md" %}
...
{% dynamic_include page.version.version, "/zone-configs/create-a-replication-zone-for-a-secondary-index.md" %}

For more information, see [`ALTER INDEX ... CONFIGURE ZONE`]({% link "{{ page.version.version }}/alter-index.md" %}#configure-zone).

### Create a replication zone for a partition

{% dynamic_include page.version.version, "/zone-configs/create-a-replication-zone-for-a-table-partition.md" %}
...
{% dynamic_include page.version.version, "/zone-configs/constrain-leaseholders-to-specific-datacenters.md" %}
