...
{% dynamic_include page.version.version, "/misc/external-io-privilege.md" %}
...
{% dynamic_include page.version.version, "/misc/bulk-permission-note.md" %}
...
- A restore job will pause if a node in the cluster runs out of disk space. See [Viewing and controlling restore jobs](#viewing-and-controlling-restore-jobs) for information on resuming and showing the progress of restore jobs. {% dynamic_include page.version.version, "/storage/free-up-disk-space.md" %}
...
{% dynamic_include page.version.version, "/backups/no-incremental-restore.md" %}
