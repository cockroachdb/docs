...
{% dynamic_include page.version.version, "/admin-ui/admin-ui-metrics-navigation.md" %}
...
{{site.data.alerts.callout_info}}
{% dynamic_include page.version.version, "/admin-ui/logical-bytes.md" %}
{{site.data.alerts.end}}
...
{% dynamic_include page.version.version, "/admin-ui/admin-ui-summary-events.md" %}
