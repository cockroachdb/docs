...
{% dynamic_include page.version.version, "/misc/logging-flags.md" %}
...
{% dynamic_include page.version.version, "/prod-deployment/join-flag-single-region.md" %}

{{site.data.alerts.callout_info}}
{% dynamic_include page.version.version, "/prod-deployment/join-flag-multi-region.md" %}
{{site.data.alerts.end}}
