...
| Available in all products. | Available in CockroachDB {{ site.data.products.dedicated }} and CockroachDB {{ site.data.products.dedicated }} or with an [Enterprise license](enterprise-licensing.html) in CockroachDB. |
...
{% dynamic_include page.version.version, "/cdc/create-core-changefeed.md" %}

### Create a core changefeed using Avro

{% dynamic_include page.version.version, "/cdc/create-core-changefeed-avro.md" %}
...
{% dynamic_include page.version.version, "/misc/experimental-warning.md" %}
