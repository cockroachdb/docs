...
{% dynamic_include page.version.version, "/backups/external-io-implicit-flag.md" %}
...
{% dynamic_include page.version.version, "/backups/existing-operation-service-account.md" %}
...
{% dynamic_include page.version.version, "/backups/azure-storage-tier-support.md" %}
...
- Specify your container name with:
    ...
    {{site.data.alerts.callout_info}}
    {% dynamic_include page.version.version, "/misc/azure-blob.md" %}
    {{site.data.alerts.end}}
