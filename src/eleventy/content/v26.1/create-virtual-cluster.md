...
{% dynamic_include page.version.version, "/physical-replication/phys-rep-sql-pages.md" %}
...
<div>
{% dynamic_include page.version.version, "/physical-replication/create-virtual-cluster-diagram.html" %}
</div>
...
{% dynamic_include page.version.version, "/physical-replication/failover-read-virtual-cluster.md" %} Use [`DROP VIRTUAL CLUSTER`]({% link "{{ page.version.version }}/drop-virtual-cluster.md" %}) to remove the `readonly` virtual cluster.
