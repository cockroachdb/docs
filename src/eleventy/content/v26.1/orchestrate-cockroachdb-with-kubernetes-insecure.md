...
{% dynamic_include page.version.version, "/orchestration/start-cockroachdb-insecure.md" %}
</section>

<section class="filter-content" markdown="1" data-scope="helm">
{% dynamic_include page.version.version, "/orchestration/start-cockroachdb-helm-insecure.md" %}
</section>

## Step 3. Use the built-in SQL client

{% dynamic_include page.version.version, "/orchestration/test-cluster-insecure.md" %}
...
{% dynamic_include page.version.version, "/orchestration/kubernetes-remove-nodes-insecure.md" %}
