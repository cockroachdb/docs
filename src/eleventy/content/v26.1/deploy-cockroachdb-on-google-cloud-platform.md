...
{% dynamic_include page.version.version, "/prod-deployment/secure-requirements.md" %}
...
{% dynamic_include page.version.version, "/prod-deployment/secure-recommendations.md" %}
...
1. [Configure TCP Proxy Load Balancing](https://cloud.google.com/load-balancing/docs/tcp/setting-up-tcp#configure_load_balancer).
...
{% dynamic_include page.version.version, "/prod-deployment/secure-generate-certificates.md" %}
...
{% dynamic_include page.version.version, "/prod-deployment/secure-start-nodes.md" %}

## Step 7. Initialize the cluster

{% dynamic_include page.version.version, "/prod-deployment/secure-initialize-cluster.md" %}

## Step 8. Test the cluster

{% dynamic_include page.version.version, "/prod-deployment/secure-test-cluster.md" %}

## Step 9. Run a sample workload

{% dynamic_include page.version.version, "/prod-deployment/secure-test-load-balancing.md" %}
...
{% dynamic_include page.version.version, "/prod-deployment/secure-scale-cluster.md" %}

## Step 12. Use the database

{% dynamic_include page.version.version, "/prod-deployment/use-cluster.md" %}
