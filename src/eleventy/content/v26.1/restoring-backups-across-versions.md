...
{% dynamic_include page.version.version, "/backups/recommend-backups-for-upgrade.md" %} See [how to upgrade to the latest version of CockroachDB]({% link "{{ page.version.version }}/upgrade-cockroach-version.md" %}).
