...
<div>
{% dynamic_include page.version.version, "/physical-replication/alter-virtual-cluster-diagram.html" %}
</div>
...
{{site.data.alerts.callout_info}}
{% dynamic_include page.version.version, "/physical-replication/failover-read-virtual-cluster.md" %}
{{site.data.alerts.end}}
