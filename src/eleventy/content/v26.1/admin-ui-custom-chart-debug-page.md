...
<img src="{{ 'images/v20.1/admin-ui-custom-chart-debug-00.png' | relative_url }}" alt="CockroachDB Admin UI" style="border:1px solid #eee;max-width:100%" />
...
{% dynamic_include page.version.version, "/admin-ui-custom-chart-debug-page-00.html" %}

## Examples

### Query user and system CPU usage

<img src="{{ 'images/v20.1/admin-ui-custom-chart-debug-01.png' | relative_url }}" alt="CockroachDB Admin UI" style="border:1px solid #eee;max-width:100%" />
...
{% dynamic_include page.version.version, "/metric-names.md" %}
