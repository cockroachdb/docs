...
{% dynamic_include page.version.version, "/sql/super-region-considerations.md" %}

## Examples

The examples in this section use the following setup.

{% dynamic_include page.version.version, "/sql/multiregion-example-setup.md" %}

#### Set up movr database regions

{% dynamic_include page.version.version, "/sql/multiregion-movr-add-regions.md" %}

#### Set up movr global tables

{% dynamic_include page.version.version, "/sql/multiregion-movr-global.md" %}

#### Set up movr regional tables

{% dynamic_include page.version.version, "/sql/multiregion-movr-regional-by-row.md" %}

### Enable super regions

{% dynamic_include page.version.version, "/sql/enable-super-regions.md" %}
...
{% dynamic_include page.version.version, "/sql/enable-super-region-primary-region-changes.md" %}
