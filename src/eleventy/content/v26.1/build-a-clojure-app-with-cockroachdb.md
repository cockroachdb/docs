...
{% dynamic_include page.version.version, "/app/before-you-begin.md" %}
...
{% dynamic_include page.version.version, "/app/create-maxroach-user-and-bank-database.md" %}
...
2. Create a file `myapp/project.clj` and populate it with the following code, or <a href="https://raw.githubusercontent.com/cockroachdb/docs/master/_includes/{{ page.version.version }}/app/project.clj" download>download it directly</a>.
    ...
    ~~~ clojure
    {% dynamic_include page.version.version, "/app/project.clj" %}
    ~~~
...
~~~ clojure
{% dynamic_include page.version.version, "/app/basic-sample.clj" %}
~~~
...
~~~ clojure
{% dynamic_include page.version.version, "/app/txn-sample.clj" %}
~~~
...
{% dynamic_include page.version.version, "/app/insecure/create-maxroach-user-and-bank-database.md" %}
...
~~~ clojure
{% dynamic_include page.version.version, "/app/insecure/basic-sample.clj" %}
~~~
...
~~~ clojure
{% dynamic_include page.version.version, "/app/insecure/txn-sample.clj" %}
~~~
