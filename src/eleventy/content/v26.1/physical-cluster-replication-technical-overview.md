...
{% dynamic_include page.version.version, "/physical-replication/interface-virtual-cluster.md" %}
...
<img src="{{ 'images/v26.1/failover.svg' | relative_url }}" alt="Timeline showing how the failover window is between the retained time and replicated time." style="border:0px solid #eee;width:100%" />
