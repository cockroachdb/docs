...
<div id="download-the-binary-linux" class="install-option">
  ...
  <ol>
    <li>
      ...
      <ol>
        <li>
          Download the binary you want from the <a href="/docs/releases/index.html">Releases</a> page. In the following commands, replace <code>{VERSION}</code> with the version of CockroachDB you are installing (e.g., {{ page.version.version }}), and replace <code>{ARCHITECTURE}</code> with <code>linux-amd64</code> for Intel, or with <code>linux-arm64</code> for ARM.
        </li>
...
{% dynamic_include page.version.version, "/install-docker-steps.md" %}
...
{% include "common/numa_and_go.md" %}

<h2 id="whats-next">What&#39;s next?</h2>

{% dynamic_include page.version.version, "/misc/install-next-steps.html" %}

{% dynamic_include page.version.version, "/misc/diagnostics-callout.html" %}
