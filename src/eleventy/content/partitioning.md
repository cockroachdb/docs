...
{% dynamic_include page.version.version, "/sql/querying-partitions.md" %}
...
- {% dynamic_include page.version.version, "/known-limitations/partitioning-with-placeholders.md" %}
