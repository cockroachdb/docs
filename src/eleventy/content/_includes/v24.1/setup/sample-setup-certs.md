...
You can create a CockroachDB {{ site.data.products.standard }} cluster using either the CockroachDB Cloud Console, a web-based graphical user interface (GUI) tool, or <code>ccloud</code>, a command-line interface (CLI) tool.
...
{% dynamic_include page.version.version, "/setup/create-first-sql-user.md" %}
...
{% dynamic_include page.version.version, "/setup/start-single-node-insecure.md" %}
