...
**Metric**
<br>[`sys.cpu.combined.percent-normalized`]({% link "{{ page.version.version }}/essential-metrics-{{ deployment }}.md" %}#sys-cpu-combined-percent-normalized)
<br>[`sys.cpu.host.combined.percent-normalized`]({% link "{{ page.version.version }}/essential-metrics-{{ deployment }}.md" %}#sys-cpu-host-combined-percent-normalized)
...
**Metric**
<br>[`sys.cpu.combined.percent-normalized`]({% link "{{ page.version.version }}/essential-metrics-{{ deployment }}.md" %}#sys-cpu-host-combined-percent-normalized)
<br>[`sys.cpu.host.combined.percent-normalized`]({% link "{{ page.version.version }}/essential-metrics-{{ deployment }}.md" %}#sys-cpu-host-combined-percent-normalized)
...
**Metric**
<br>[`sys.rss`]({% link "{{ page.version.version }}/essential-metrics-{{ deployment }}.md" %}#sys-rss)
...
**Metric**
<br>[`sys.host.disk.iopsinprogress`]({% link "{{ page.version.version }}/essential-metrics-{{ deployment }}.md" %}#sys-host-disk-iopsinprogress)
...
**Metric**
<br>[`capacity`]({% link "{{ page.version.version }}/essential-metrics-{{ deployment }}.md" %}#capacity)
<br>[`capacity.available`]({% link "{{ page.version.version }}/essential-metrics-{{ deployment }}.md" %}#capacity-available)
...
**Metric**
<br>[`storage.write-stalls`]({% link "{{ page.version.version }}/essential-metrics-{{ deployment }}.md" %}#storage-write-stalls)
...
**Metric**
<br>[`sys.uptime`]({% link "{{ page.version.version }}/essential-metrics-{{ deployment }}.md" %}#sys-uptime)
...
**Metric**
<br>[`seconds.until.enterprise.license.expiry`]({% link "{{ page.version.version }}/essential-metrics-{{ deployment }}.md" %}#seconds-until-enterprise-license-expiry)
...
**Metric**
<br>[`security.certificate.expiration.ca`]({% link "{{ page.version.version }}/essential-metrics-{{ deployment }}.md" %}#security-certificate-expiration-ca)
<br>[`security.certificate.expiration.client-ca`]({% link "{{ page.version.version }}/essential-metrics-{{ deployment }}.md" %}#security-certificate-expiration-client-ca)
<br>[`security.certificate.expiration.ui`]({% link "{{ page.version.version }}/essential-metrics-{{ deployment }}.md" %}#security-certificate-expiration-ui)
<br>[`security.certificate.expiration.ui-ca`]({% link "{{ page.version.version }}/essential-metrics-{{ deployment }}.md" %}#security-certificate-expiration-ui-ca)
<br>[`security.certificate.expiration.node`]({% link "{{ page.version.version }}/essential-metrics-{{ deployment }}.md" %}#security-certificate-expiration-node)
<br>[`security.certificate.expiration.node-client`]({% link "{{ page.version.version }}/essential-metrics-{{ deployment }}.md" %}#security-certificate-expiration-node-client)
...
**Metric**
<br>[`liveness.heartbeatlatency`]({% link "{{ page.version.version }}/essential-metrics-{{ deployment }}.md" %}#liveness-heartbeatlatency)
...
**Metric**
<br>[`liveness.livenodes`]({% link "{{ page.version.version }}/essential-metrics-{{ deployment }}.md" %}#liveness-livenodes)
...
**Metric**
<br>[`ranges.unavailable`]({% link "{{ page.version.version }}/essential-metrics-{{ deployment }}.md" %}#ranges-unavailable)
...
**Metric**
<br>[`ranges.underreplicated`]({% link "{{ page.version.version }}/essential-metrics-{{ deployment }}.md" %}#ranges-underreplicated)
...
**Metric**
<br>[`sql.conns`]({% link "{{ page.version.version }}/essential-metrics-{{ deployment }}.md" %}#sql-conns)
<br>`sql.query.count`
...
**Metric**
<br>[`sql.failure.count`]({% link "{{ page.version.version }}/essential-metrics-{{ deployment }}.md" %}#sql-failure-count)
...
**Metric**
<br>[`sql.service.latency`]({% link "{{ page.version.version }}/essential-metrics-{{ deployment }}.md" %}#sql-service-latency)
<br>[`sql.conn.latency`]({% link "{{ page.version.version }}/essential-metrics-{{ deployment }}.md" %}#sql-conn-latency)
...
**Metric**
<br>[`schedules.BACKUP.failed`]({% link "{{ page.version.version }}/essential-metrics-{{ deployment }}.md" %}#schedules-BACKUP-failed)
...
**Metric**
<br>[`changefeed.failures`]({% link "{{ page.version.version }}/essential-metrics-{{ deployment }}.md" %}#changefeed-failures)
...
**Metric**
<br>[`changefeed.error_retries`]({% link "{{ page.version.version }}/essential-metrics-{{ deployment }}.md" %}#changefeed-error-retries)
...
**Metric**
<br>[`changefeed.commit_latency`]({% link "{{ page.version.version }}/essential-metrics-{{ deployment }}.md" %}#changefeed-commit-latency)
...
**Metric**
<br>[`jobs.changefeed.currently_paused`]({% link "{{ page.version.version }}/essential-metrics-{{ deployment }}.md" %}#jobs-changefeed-currently-paused)
