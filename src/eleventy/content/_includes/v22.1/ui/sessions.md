...
{% include "new-in.html", version: "v22.1" %} To filter the sessions, click the **Filters** field.
...
{% include "new-in.html", version: "v22.1" %} Click <img src="{{ 'images/common/ui-columns-button.png' | relative_url }}" alt="Column selector" /> to select the columns to display in the table.
...
- **Session Details**
  ...
  - **Application Name** {% include "new-in.html", version: "v22.1" %} shows the name of the application connected to the session.
  ...
  - **User Name** {% include "new-in.html", version: "v22.1" %} displays the name of the user that started the session.
