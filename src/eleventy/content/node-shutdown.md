...
{% dynamic_include page.version.version, "/prod-deployment/decommission-pre-flight-checks.md" %}
...
{% dynamic_include page.version.version, "/prod-deployment/process-termination.md" %}
