...
1. Select the number of nodes:
    ...
    - For single-region production deployments, we recommend a minimum of 3 nodes. The number of nodes also relates to your storage capacity and performance requirements. See the [example](plan-your-cluster.html?filters=dedicated#dedicated-example) on [Plan a CockroachDB Cloud cluster](plan-your-cluster.html?filters=dedicated) for further guidance.
