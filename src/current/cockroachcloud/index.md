...
- [Understand CockroachDB Cloud Costs](costs.md)
- [Plan a CockroachDB {{ site.data.products.basic }} cluster](plan-your-cluster-basic.md) and [Create a CockroachDB {{ site.data.products.basic }} cluster](create-a-basic-cluster.md).
- [Plan a CockroachDB {{ site.data.products.standard }} cluster](plan-your-cluster.md) and [Create a CockroachDB {{ site.data.products.standard }} cluster](create-your-cluster.md)
- [Plan a CockroachDB {{ site.data.products.advanced }} cluster](plan-your-cluster-advanced.md) and [Create a CockroachDB {{ site.data.products.advanced }} cluster](create-an-advanced-cluster.md)
