...
After migrating the schema and creating the new database, you can [load some test data](../{{version_prefix}}migration-overview.html#load-test-data) and [validate your queries](../{{version_prefix}}migration-overview.html#validate-queries).
