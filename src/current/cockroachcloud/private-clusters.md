...
Private CockroachDB {{ site.data.products.dedicated }} clusters are not available for [CockroachDB {{ site.data.products.dedicated }} on Azure]({% link cockroachcloud/cockroachdb-advanced-on-azure.md %}).
