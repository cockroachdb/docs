...
You can view managed backups through the **Backup and Restore** menu in the Cloud Console and configure managed backups with the [CockroachDB Cloud API]({% link cockroachcloud/cloud-api.md %}).
