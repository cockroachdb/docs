...
1. If you [established a private connection](#authorize-your-network), change **Connection type** from **Public connection** to **Private connection** to connect privately.
