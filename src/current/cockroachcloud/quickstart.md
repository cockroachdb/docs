...
This page shows you how to use free trial credit to deploy a CockroachDB cluster on CockroachDB {{ site.data.products.standard }} (Preview), connect to it using a sample workload, and run your first query.
