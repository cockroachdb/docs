...
summary: Learn how to use free trial credits to deploy a CockroachDB cluster on CockroachDB Standard (Preview), then use sample code to run your first queries.
toc: true
cloud: true
