...
- [Create a CockroachDB {{ site.data.products.basic }} cluster](create-a-basic-cluster.md).
- [Create a new SQL user](managing-access.md#create-a-sql-user).
...
1. Select your cluster to navigate to the cluster [**Overview** page](cluster-overview-page.md).
...
1. Add your copied connection string to your application code. For information about connecting to your cluster with a [supported client]({{ site.current_cloud_version }}/third-party-database-tools.md), see [Connect to a CockroachDB Cluster]({{ site.current_cloud_version }}/connect-to-the-database.md).
...
- [Build a Ruby App with CockroachDB]({{site.current_cloud_version}}/build-a-ruby-app-with-cockroachdb.md)
- [Build a Javascript App with CockroachDB]({{site.current_cloud_version}}/build-a-nodejs-app-with-cockroachdb.md)
...
You can connect to your cluster with any [supported version](releases/release-support-policy.md#supported-versions) of the full CockroachDB binary or the [built-in SQL client]({{site.current_cloud_version}}/cockroach-sql.md). To download the full binary and connect to your cluster, follow these steps.
