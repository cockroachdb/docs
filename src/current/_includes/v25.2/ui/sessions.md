{% if page.cloud != true %}
<img src="{{ 'images/{{ page.version.version }}/ui-sessions-page.png' | relative_url }}" alt="Sessions Page" style="border:1px solid #eee;max-width:100%" />
{% endif %}

To filter the sessions, click the **Filters** field.

<img src="{{ 'images/{{ page.version.version }}/ui-session-filter.png' | relative_url }}" alt="Session filter" />
