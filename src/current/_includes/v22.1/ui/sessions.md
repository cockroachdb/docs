{% if page.cloud != true %}
![Sessions Page](/images/v22.1/ui-sessions-page.png)
{% endif %}

{% include "_includes/new-in.html" version="v22.1" %} To filter the sessions, click the **Filters** field.

![Session filter](/images/v22.1/ui-session-filter.png)
...
{% include "_includes/new-in.html" version="v22.1" %} Click ![Column selector](/images/common/ui-columns-button.png) to select the columns to display in the table.
...
{% if page.cloud != true %}
![Sessions Details Page](/images/v22.1/ui-sessions-details-page.png)
{% endif %}
...
- **Session Details**
  ...
  - **Application Name** {% include "_includes/new-in.html" version="v22.1" %} shows the name of the application connected to the session.
  ...
  - **User Name** {% include "_includes/new-in.html" version="v22.1" %} displays the name of the user that started the session.
