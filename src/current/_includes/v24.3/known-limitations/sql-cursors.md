CockroachDB implements SQL {% if page.name == "known-limitations.md" %} [cursor]({{ page.version.version }}/cursors.md) {% else %} cursor {% endif %} support with the following limitations:
