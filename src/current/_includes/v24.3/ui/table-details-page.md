...
{% include "_includes/new-in.html" version="v24.3" %} The **Last updated** timestamp is the actual time the [metadata was last refreshed](#refresh-data) for the selected table.
