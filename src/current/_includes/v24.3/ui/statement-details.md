...
![Statement fingerprint overview](/images/v24.2/ui_statement_fingerprint_overview.png)
...
![Statement fingerprint overview](/images/v24.2/ui_statement_fingerprint_insights.png)
...
![Statement fingerprint charts](/images/v24.2/ui_statement_fingerprint_charts.png)
...
![Plan table](/images/v24.2/ui_plan_table.png)
...
![Plan table](/images/v24.2/ui_statement_plan.png)
...
![Plan with insight](/images/v24.2/plan_with_insight.png)
...
![Plan table after index](/images/v24.2/ui_statement_plan_2.png)
...
![Activate statement diagnostics](/images/v24.2/ui_activate_diagnostics.png)
...
1. {% include "_includes/new-in.html" version="v24.3.1" %}Choose to **Redact** sensitive user data, such as histograms, placeholders, statements, and traces that have real data which can contain PII information.
1. Click **Activate**.
...
![Statement diagnostics table](/images/v24.2/ui_statement_diagnostics.png)

The collection status values are:

- **READY**: indicates that the diagnostics have been collected. To download the diagnostics bundle, click ![Down arrow](/images/v24.2/ui-download-button.png) **Bundle (.zip)**.
...
Click ![Down arrow](/images/v24.2/ui-download-button.png) **Bundle (.zip)** to download any diagnostics bundle.
