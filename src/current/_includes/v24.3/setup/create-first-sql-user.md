...
1. Click **Next**.
    ...
    Currently, all new SQL users are created with admin privileges. For more information and to change the default settings, see [Manage SQL users on a cluster](managing-access.md#manage-sql-users-on-a-cluster).
