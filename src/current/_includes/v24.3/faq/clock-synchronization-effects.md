...
- {% include "_includes/25.1/misc/multiregion-max-offset.md" %}
...
------------|---------------------
[On-Premises]({{ page.version.version }}/deploy-cockroachdb-on-premises.md#step-1-synchronize-clocks) | Use NTP with Google's external NTP service.
