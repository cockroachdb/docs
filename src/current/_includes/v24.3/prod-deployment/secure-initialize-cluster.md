On your local machine, run the [`cockroach init`]({{ page.version.version }}/cockroach-init.md) command to complete the node startup process and have them join together as a cluster:
