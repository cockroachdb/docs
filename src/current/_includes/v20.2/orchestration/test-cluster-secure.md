...
1. From your local workstation, use our [`client-secure.yaml`]({% link files/cockroach/cloud/kubernetes/client-secure.yaml %}) file to launch a pod and keep it running indefinitely.
