...
<img src="{{ 'images/v26.2/ui-sessions-page.png' | relative_url }}" alt="Sessions Page" style="border:1px solid #eee;max-width:100%" />
{% endif %}

To filter the sessions, click the **Filters** field.

<img src="{{ 'images/v26.2/ui-session-filter.png' | relative_url }}" alt="Session filter" />
