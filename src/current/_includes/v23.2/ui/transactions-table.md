...
Regions/Nodes | The region and nodes in which the transaction was executed. <br><br>Nodes are not visible for CockroachDB {{ site.data.products.standard }} clusters.
