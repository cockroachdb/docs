...
`VIEWSYSTEMTABLE` | System | Grants read-only access (`SELECT`) on all tables in the cluster, without granting the ability to modify the cluster. This privilege was introduced in v23.1.11.
