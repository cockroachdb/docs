...
Regions/Nodes | The regions and nodes on which statements with this fingerprint executed. <br><br>Nodes are not visible for {{ site.data.products.serverless }} clusters.
