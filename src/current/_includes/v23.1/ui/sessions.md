{% if page.cloud != true %}
![Sessions Page](/images/v23.1/ui-sessions-page.png)
{% endif %}

To filter the sessions, click the **Filters** field.

![Session filter](/images/v23.1/ui-session-filter.png)
...
{% if page.cloud != true %}
![Sessions Details Page](/images/v23.1/ui-sessions-details-page.png)
{% endif %}
