...
Capacity Used | The storage capacity used as a percentage of [usable capacity]({{ page.version.version }}/ui-cluster-overview-page.md#capacity-metrics) allocated across all nodes.
...
![DB Console Events](/images/v23.1/ui_events.png)
