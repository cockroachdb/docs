...
Note that the phrase "synthetic privileges" in the above error message refers to [system-level privileges]({% link {{ page.version.version }}/security-reference/authorization.md %}#supported-privileges).