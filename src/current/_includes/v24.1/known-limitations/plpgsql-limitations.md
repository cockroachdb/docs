...
- When coercing a PL/pgSQL expression into a type that is too narrow, CockroachDB truncates values. This differs from PostgreSQL, where PL/pgSQL type coercion does not truncate the value. [#115385](https://github.com/cockroachdb/cockroach/issues/115385)
