...
* The `RETURNING` clause of [`INSERT`](https://www.cockroachlabs.com/docs/v1.0/insert), [`DELETE`](https://www.cockroachlabs.com/docs/v1.0/delete), and [`UPDATE`](../v1.0/update.html)
