...
- Bounds are now checked when converting [`FLOAT`](https://www.cockroachlabs.com/docs/v1.0/float) or [`DECIMAL`](https://www.cockroachlabs.com/docs/v1.0/decimal) values to [`INTEGER`](../v1.0/int.html). [#14967](https://github.com/cockroachdb/cockroach/pull/14967)
