...
- Updated the [SQL Feature Support](https://www.cockroachlabs.com/docs/v1.0/sql-feature-support) page to reflect support for [views](https://www.cockroachlabs.com/docs/v1.0/views) (SQL standard) and [interleaved tables](../v1.0/interleave-in-parent.html) (CockroachDB extensions).
