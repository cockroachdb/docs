...
- [`CREATE TABLE`](https://www.cockroachlabs.com/docs/v1.0/create-table), [`ALTER TABLE`](https://www.cockroachlabs.com/docs/v1.0/alter-table), and [`DROP INDEX`](../v1.0/drop-index.html) now do more validation of their arguments. [#6492](https://github.com/cockroachdb/cockroach/pull/6492)
