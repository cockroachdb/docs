...
- Fixed a bug that was introduced in [v21.1.5](releases/v21.1.md#v21-1-5), which prevented [nodes from being decommissioned](https://www.cockroachlabs.com/docs/v21.1/remove-nodes) in a cluster if the cluster had multiple nodes intermittently miss their liveness heartbeat. [#68552][#68552]
...
- Added backwards compatibility between v21.1.x cluster versions and the [v21.1.8 cluster version](releases/v21.1.md#v21-1-8). [#69894][#69894]
