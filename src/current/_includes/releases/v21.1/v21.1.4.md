...
- Fixed a bug where using [`ADD COLUMN UNIQUE`](https://www.cockroachlabs.com/docs/v21.1/add-column) on [`REGIONAL BY ROW` tables](https://www.cockroachlabs.com/docs/v21.1/set-locality#regional-by-row) did not correctly add the [zone configs](../v21.1/configure-replication-zones.html) for the newly created column index. [#66696][#66696]
