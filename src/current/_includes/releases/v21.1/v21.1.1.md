...
- [`BACKUP`](https://www.cockroachlabs.com/docs/v21.1/backup), [`RESTORE`](https://www.cockroachlabs.com/docs/v21.1/restore), and [`IMPORT`](../v21.1/import.html) are now more resilient to node failures and will retry automatically. [#65391][#65391]
