...
- [Changefeeds](https://www.cockroachlabs.com/docs/v21.1/stream-data-out-of-cockroachdb-using-changefeeds) now reliably fail when [`IMPORT INTO`](https://www.cockroachlabs.com/docs/v21.1/import-into) is run against a targeted table, as change data capture is [not supported](../v21.1/known-limitations.html#change-data-capture) for this action. [#64372][#64372]
