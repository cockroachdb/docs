...
- [`ALTER TABLE`](https://www.cockroachlabs.com/docs/v21.1/alter-table), [`ALTER VIEW`](https://www.cockroachlabs.com/docs/v21.1/alter-view), and [`ALTER SEQUENCE`](../v21.1/alter-sequence.html) can no longer be used to incorrectly create cross-DB references. [#62341][#62341]
