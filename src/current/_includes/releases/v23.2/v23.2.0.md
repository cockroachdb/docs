...
<h4>Observability (Sample Table)</h4>
<table>
    <tr>
    ...
    <tr>
        ...
        <td>23.2</td>
        <td class="icon-center"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/3b/Eo_circle_green_checkmark.svg/64px-Eo_circle_green_checkmark.svg.png"></td>
        <td class="icon-center"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/3b/Eo_circle_green_checkmark.svg/64px-Eo_circle_green_checkmark.svg.png"></td>
        <td class="icon-center"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b9/Eo_circle_grey_white_no-entry.svg/64px-Eo_circle_grey_white_no-entry.svg.png"></td>
    </tr>
    <!-- ... -->
</table>
