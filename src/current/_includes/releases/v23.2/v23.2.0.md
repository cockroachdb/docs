...
<table>
    ...
    <tr>
        ...
        <td>23.2</td>
        <td class="icon-center"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/3b/Eo_circle_green_checkmark.svg/64px-Eo_circle_green_checkmark.svg.png" alt="Green checkmark (Yes)"></td>
        <td class="icon-center"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/3b/Eo_circle_green_checkmark.svg/64px-Eo_circle_green_checkmark.svg.png" alt="Green checkmark (Yes)"></td>
        <td class="icon-center"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b9/Eo_circle_grey_white_no-entry.svg/64px-Eo_circle_grey_white_no-entry.svg.png" alt="Gray circle with horizontal white line (No)"></td>
    </tr>
    <!-- ... -->
</table>

<strong>Note: <a href="https://docs.google.com/document/d/1q64FNkYx49GaKEZ8ze6ByNqf4C6cYxXqHZYiMR0fRTw/edit">Draft feature highlights</a> will be migrated to tables on this page in the above format.</strong>
