...
- Performance improvements to [admission control](https://www.cockroachlabs.com/docs/{{ page.version.version }}/admission-control#operations-subject-to-admission-control). [#98308][#98308]
...
- The new system observability tables `system.transaction_exec_insights`, `system.statement_exec_insights`, and `system.mvcc_statistics`. [#104714][#104714]
