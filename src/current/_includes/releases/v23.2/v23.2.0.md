...
- When a deployment is configured to use a time zone for log file output using formats `crdb-v1` or `crdb-v2`, new output log entries cannot be processed by notes that have not been upgraded to v23.2. [#104265][#104265]
