...
<table>
    <tr>
        ...
        <td colspan="4" rowspan="1">Availability</td>
    </tr>
    <tr>
        <td colspan="1" rowspan="1">Ver.</td>
        <td colspan="1" rowspan="1">Self-Hosted</td>
        <td colspan="1" rowspan="1">Dedicated</td>
        <td colspan="1" rowspan="1">Serverless</td>
    </tr>
    <!-- Rows for each feature -->
    <!-- Example Row -->
    <tr>
        <td><p><strong>Identify network partitions using updating metrics in the Network page</strong></p>
        <p>The Network page in the DB console has been updated with additional metrics that surface when the cluster is unstable due to network partitions.</p>
        </td>
        <td>23.2</td>
        <td><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/3b/Eo_circle_green_checkmark.svg/64px-Eo_circle_green_checkmark.svg.png"></td>
        <td><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/3b/Eo_circle_green_checkmark.svg/64px-Eo_circle_green_checkmark.svg.png"></td>
        <td><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b9/Eo_circle_grey_white_no-entry.svg/64px-Eo_circle_grey_white_no-entry.svg.png"></td>
    </tr>
    <!-- ... -->
</table>
