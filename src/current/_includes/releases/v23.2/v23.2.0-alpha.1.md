...
- The new new cluster setting `server.hot_ranges_request.node.timeout` controls the maximum amount of time that a hot ranges request will spend waiting for a node to provide a response. It defaults to 5 minutes. To disable timeouts, set it to `0`. [#107796][#107796]
...
- A selection box displays in DB Console Metrics pages when you are connected to the system interface, and allows you to view metrics for a specific virtual cluster. [#103308][#103308]
