...
[`CANCEL JOB`](https://www.cockroachlabs.com/docs/v1.1/cancel-job)<br>[`PAUSE JOB`](https://www.cockroachlabs.com/docs/v1.1/pause-job)<br>[`RESUME JOB`](../v1.1/resume-job.html) | Use these new statements to cancel, pause, or resume enterprise backups and restores.
