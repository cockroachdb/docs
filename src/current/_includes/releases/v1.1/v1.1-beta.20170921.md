...
- Documented the new `--echo-sql` flag for the [`cockroach sql`](https://www.cockroachlabs.com/docs/v1.1/use-the-built-in-sql-client), [`cockroach dump`](https://www.cockroachlabs.com/docs/v1.1/sql-dump), [`cockroach user`](../v1.1/create-and-manage-users.html), and [`cockroach zone`](../v1.1/configure-replication-zones.html) commands. [#1905](https://github.com/cockroachdb/docs/pull/1905)
