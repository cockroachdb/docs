...
- It is now possible to use AWS S3 buckets in any region for [`IMPORT`](https://www.cockroachlabs.com/docs/v1.1/import) and enterprise [`BACKUP`](https://www.cockroachlabs.com/docs/v1.1/backup) and [`RESTORE`](../v1.1/restore.html). [#19473](https://github.com/cockroachdb/cockroach/pull/19473)
