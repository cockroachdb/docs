...
- Improved Kubernetes guidance:
    - Added a tutorial on [orchestrating a secure CockroachDB cluster with Kubernetes](https://www.cockroachlabs.com/docs/v1.1/orchestrate-cockroachdb-with-kubernetes), improved the tutorial for [insecure orchestrations](https://www.cockroachlabs.com/docs/v1.1/orchestrate-cockroachdb-with-kubernetes-insecure), and added a [local cluster tutorial using `minikube`](../v1.1/orchestrate-a-local-cluster-with-kubernetes-insecure.html). [#2147](https://github.com/cockroachdb/docs/pull/2147)
