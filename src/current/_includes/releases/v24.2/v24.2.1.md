...
- Hover behavior on graphs on the [Metrics dashboards]({% link v24.2/ui-overview.md %}#metrics) in the [DB Console]({% link v24.2/ui-overview.md %}) now focuses on individual lines and shows values under the cursor. [#128412][#128412]
