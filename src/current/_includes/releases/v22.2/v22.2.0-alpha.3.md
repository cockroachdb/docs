...
- A bug has been fixed that caused internal errors like `"unable to [vectorize](https://www.cockroachlabs.com/docs/v22.2/vectorized-execution) execution plan: unhandled expression type"` in rare cases. [#86816][#86816]
