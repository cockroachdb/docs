...
- Added replanning functionality for [changefeeds](https://www.cockroachlabs.com/docs/v22.2/change-data-capture-overview) when topology changes by adding a new replanning counter metric. This functionality is only supported for {{ site.data.products.serverless }} clusters.. [#83143][#83143]
