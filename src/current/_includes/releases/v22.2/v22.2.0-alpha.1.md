...
- [`BACKUP`](https://www.cockroachlabs.com/docs/v22.2/backup), [`RESTORE`](../{{site.versions["dev"]}}/restore.html), and [backup schedule creation](../{{site.versions["dev"]}}/create-schedule-for-backup.html) now have corresponding events that emit to the telemetry channel. [#82463][#82463]
