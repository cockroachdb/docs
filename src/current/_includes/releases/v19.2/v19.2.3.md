...
- Fixed a bug that prevented `admin` users from using [`BACKUP`](https://www.cockroachlabs.com/docs/v19.2/backup), [`RESTORE`](https://www.cockroachlabs.com/docs/v19.2/restore), and [`IMPORT`](../v19.2/import.html). [#44456][#44456]
