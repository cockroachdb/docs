...
- Previously, [`PARTITION BY`](https://www.cockroachlabs.com/docs/v19.2/partition-by) and [`ORDER BY`](https://www.cockroachlabs.com/docs/v19.2/query-order) columns in window specifications lost qualifications when used inside [views](../v19.2/views.html). This bug has been fixed. [#47716][#47716]
