...
- The [vectorized execution engine](https://www.cockroachlabs.com/docs/v19.2/vectorized-execution) now supports the [`UUID`](https://www.cockroachlabs.com/docs/v19.2/uuid) and [`TIMESTAMP`](../v19.2/timestamp.html) data types. [#42414][#42414] [#42416][#42416] {% comment %}doc{% endcomment %}
