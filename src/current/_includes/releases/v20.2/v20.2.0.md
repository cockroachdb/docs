...
- [Add or remove nodes](https://www.cockroachlabs.com/docs/cockroachcloud/cluster-management#add-or-remove-nodes-from-a-cluster) through the {{ site.data.products.db }} Console.
...
- The [`cockroach dump`](https://www.cockroachlabs.com/docs/v20.2/cockroach-dump) command is now deprecated. Instead, back up your data in a [full backup](https://www.cockroachlabs.com/docs/v20.2/take-full-and-incremental-backups), [export](../v20.2/export.html) your data in plain text format, or view table schema in plaintext with [`SHOW CREATE TABLE`](../v20.2/show-create.html).
