...
- New [cluster settings]({% link {{ page.version.version }}/cluster-settings.md %}) have been added which control the refresh behavior for the cached data in Databases pages of the [DB Console]():
