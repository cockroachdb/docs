...
Docs                 | [Architecture Overview]({% link v24.3/architecture/overview.md %}) | This page provides a starting point for understanding the architecture and design choices that enable CockroachDB's scalability and consistency capabilities.
