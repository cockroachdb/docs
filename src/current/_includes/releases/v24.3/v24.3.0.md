...
- **Additional information**
    - [Backward-incompatible changes and deprecations](#v24-3-0-backward-incompatible-changes-and-deprecations)
...
{% include releases/v24.3/feature-highlights-migrations.html %}
...
{% include releases/v24.3/feature-highlights-operations.html %}
...
<h4 id="v24-3-0-backward-incompatible-changes-and-deprecations">Backward-incompatible changes and deprecations</h4>

CockroachDB v24.3.0 includes no backward-incompatible changes or deprecations.
