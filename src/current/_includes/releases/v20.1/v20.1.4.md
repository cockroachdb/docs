...
- Fixed incorrect results in some cases involving [joins](https://www.cockroachlabs.com/docs/v20.1/joins) on [interleaved tables](https://www.cockroachlabs.com/docs/v20.1/interleave-in-parent) with [limits](../v20.1/limit-offset.html). [#51432][#51432]
