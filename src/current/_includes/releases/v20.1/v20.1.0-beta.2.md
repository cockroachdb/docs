...
- Overhauled the documentation on [authorization](https://www.cockroachlabs.com/docs/v20.1/authorization), [roles](https://www.cockroachlabs.com/docs/v20.1/create-role), and [grants](../v20.1/grant.html). [#6332][#6332]
