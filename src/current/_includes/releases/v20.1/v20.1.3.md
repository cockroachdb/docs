...
<h3 id="v20-1-3-downloads">Downloads</h3>
...
<h3 id="v20-1-3-docker-image">Docker image</h3>
...
- Limited [`SELECT`](https://www.cockroachlabs.com/docs/v20.1/select-clause) statements now do a better job avoiding unnecessary contention with [`UPDATE`](https://www.cockroachlabs.com/docs/v20.1/update) and [`SELECT FOR UPDATE`](../v20.1/select-for-update.html) statements. [#50119][#50119]
