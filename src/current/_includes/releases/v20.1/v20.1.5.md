...
- Fixed a bug causing the Google Cloud API client used by [`BACKUP`](https://www.cockroachlabs.com/docs/v20.1/backup), [`RESTORE`](https://www.cockroachlabs.com/docs/v20.1/restore) and [`IMPORT`](../v20.1/import.html) to leak memory when interacting with Google Cloud Storage. [#53229][#53229]
