...
{{site.data.alerts.callout_danger}}
CockroachDB introduced a critical bug in the [v20.1.4 release](releases/v20.1.md#v20-1-4) that affects [`UPSERT`](https://www.cockroachlabs.com/docs/v20.1/upsert) and [`INSERT … ON CONFLICT DO UPDATE SET x = excluded.x`](https://www.cockroachlabs.com/docs/v20.1/insert#on-conflict-clause) statements involving more than 10,000 rows. All deployments running CockroachDB v20.1.4 and v20.1.5 are affected. A fix is included in [v20.1.6](releases/v20.1.md#v20-1-6).
