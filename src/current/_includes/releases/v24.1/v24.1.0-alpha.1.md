...
- Sorting by [locality]({% link v23.2/table-localities.md}) can improve the performance and predictability of [follower reads]({% link v23.2/follower-reads.md}). [#112993][#112993]
...
- Statements from internal executors now correctly display when filtering by application name `$ internal` on the Statements page in [SQL Activity]({% link v23.2/ui-overview.md}#sql-activity). Such statements are hidden when `$ internal` is not specified. [#114498][#114498]
