...
<h3 id="v26-1-0-bug-fixes">Bug fixes</h3>
...
- Fixed a bug introduced in v26.1.0-beta.1 in which row-level TTL jobs could encounter GC threshold errors if each node had a large number of spans to process. [#161991][#161991]
...
- Fixes a bug where generating a debug zip causes
  ...
  log and is using json (or json-compact) formatting. [#163803][#163803]
...
[#163803]: https://github.com/cockroachdb/cockroach/pull/163803
