...
- **Feature categories**
    - [CockroachDB Cloud](#v24-1-0-cloud)
    - [Change Data Capture](#v25-1-0-change-data-capture)
    - [Disaster Recovery](#v25-1-0-disaster-recovery)
    - [SQL](#v25-1-0-sql)
    - [KV](#25-1-0-kv)
    - [Security](#v25-1-0-security)
    - [Observability](#v25-1-0-observability)
...
<h4 id="v25-1-0-disaster-recovery">Disaster Recovery</h4>
...
<h4 id="v25-1-0-sql">KV</h4>

{% include releases/v25.1/feature-highlights-sql.html %}

<h4 id="v24-3-0-security">Security</h4>

{% include releases/v25.1/feature-highlights-security.html %}

<h4 id="v24-3-0-observability">Observability</h4>

{% include releases/v25.1/feature-highlights-observability.html %}
...
<h5 id="v25-1-0-additional-cluster-setting-changes">Additional cluster setting changes</h5>
