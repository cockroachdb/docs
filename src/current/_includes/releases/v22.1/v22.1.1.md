...
- The [`cockroach debug zip`](https://www.cockroachlabs.com/docs/v22.1/cockroach-debug-zip) and [`cockroach debug merge-logs`](https://www.cockroachlabs.com/docs/v22.1/cockroach-debug-merge-logs) commands will now work with [JSON-formatted logs](../v22.1/log-formats.html#format-json). [#81469][#81469]
