...
- Fixed a bug introduced in [v22.1.9](releases/v22.1.md#v22-1-9) that caused nodes to refuse to run [jobs](https://www.cockroachlabs.com/docs/v22.1/show-jobs) under rare circumstances. [#90265][#90265]
