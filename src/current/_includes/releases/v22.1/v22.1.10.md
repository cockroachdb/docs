...
- Excluded [check constraints](https://www.cockroachlabs.com/docs/v22.1/check) of [hash-sharded indexes](https://www.cockroachlabs.com/docs/v22.1/hash-sharded-indexes) from being invalidated when executing [`IMPORT INTO`](../v22.1/import-into.html). [#89528][#89528]
