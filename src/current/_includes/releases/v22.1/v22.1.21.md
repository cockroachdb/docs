...
- If a page crashes, a force refresh is no longer required to be able to see the other pages on DB Console. [#103326][#103326]
...
- The value of `pg_constraint.conparentid` is now `0` rather than `NULL`. CockroachDB does not support constraints on partitions. [#103230][#103230]
