...
- Multiplication between [`INTERVAL`](https://www.cockroachlabs.com/docs/v2.0/interval) and [`FLOAT`](https://www.cockroachlabs.com/docs/v2.0/float) values, and between `INTERVAL` and [`DECIMAL`](../v2.0/decimal.html) values, is now fully supported. [#21292]
...
- Added docs on the [`CREATE SEQUENCE`](https://www.cockroachlabs.com/docs/v2.0/create-sequence), [`ALTER SEQUENCE`](https://www.cockroachlabs.com/docs/v2.0/alter-sequence), and [`DROP SEQUENCE`](../v2.0/drop-sequence.html) statements. [#2292](https://github.com/cockroachdb/docs/pull/2292)
