...
- Fixed a bug where [`INSERT`](https://www.cockroachlabs.com/docs/v2.0/insert)/[`DELETE`](https://www.cockroachlabs.com/docs/v2.0/delete)/[`UPDATE`](../v2.0/update.html)/[`UPSERT`](../v2.0/upsert.html) may lose updates if run using `WITH` or the `[ ... ]` syntax. [#23895][#23895]
