...
Feature | Description
--------|------------
[JSON Support](https://www.cockroachlabs.com/docs/v2.0/demo-json-support) | The [`JSONB`](https://www.cockroachlabs.com/docs/v2.0/jsonb) data type and [inverted indexes](../v2.0/inverted-indexes.html) give you the flexibility to store and efficiently query  semi-structured data.
...
[`IMPORT`](https://www.cockroachlabs.com/docs/v2.0/import) | The `IMPORT` statement now imports tabular data in a fully distributed fashion, and import jobs can now be [paused](https://www.cockroachlabs.com/docs/v2.0/pause-job), [resumed](../v2.0/resume-job.html), and [cancelled](../v2.0/cancel-job.html).
