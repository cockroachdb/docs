...
- Fixed rare deadlocks during [`IMPORT`](https://www.cockroachlabs.com/docs/v2.1/import), [`RESTORE`](https://www.cockroachlabs.com/docs/v2.1/restore), and [`BACKUP`](../v2.1/backup.html). [#32016][#32016]
