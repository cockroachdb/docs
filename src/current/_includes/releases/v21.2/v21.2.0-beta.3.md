...
- Fixed a bug where [`EXPLAIN (VEC)`](https://www.cockroachlabs.com/docs/v21.2/explain#vec-option) on some queries could lead to a crash. The bug was present only in v21.2 [testing releases](releases/index.md#testing-releases). [#70524][#70524]
