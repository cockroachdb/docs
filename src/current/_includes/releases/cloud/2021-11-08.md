...
- The PowerShell command to [download the CockroachDB binary](../cockroachcloud/connect-to-your-cluster.html?filters=windows#connect-to-your-cluster) is now improved for Windows users.
...
- A more descriptive error message is now displayed when attempting to create or edit a [SQL user](../cockroachcloud/managing-access.html#manage-sql-users-on-a-cluster) with an invalid username.
