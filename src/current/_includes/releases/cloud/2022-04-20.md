...
- [SQL user passwords](../cockroachcloud/managing-access.html#change-a-sql-users-password) are now generated and saved automatically to simplify the connection experience.
