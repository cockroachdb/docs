...
- {{ site.data.products.dedicated }} contract customers can now [scale clusters](https://www.cockroachlabs.com/docs/cockroachcloud/cluster-management) through the Console.
