...
- CockroachCloud users who are not a member of an existing Organization can now create an Organization when they log into the CockroachDB {{ site.data.products.cloud }} Console.

<h3>Doc changes</h3>

- Documented the [upgrade policy](https://www.cockroachlabs.com/docs/cockroachcloud/upgrade-policy) for CockroachDB upgrades for CockroachCloud clusters.
