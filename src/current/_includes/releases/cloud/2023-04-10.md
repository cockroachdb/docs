...
- {{ site.data.products.dedicated }} clusters now [export the following metrics](https://www.cockroachlabs.com/docs/cockroachcloud/export-metrics#the-metricexport-endpoint) to third-party monitoring tools such as [Datadog](../cockroachcloud/export-metrics.html?filters=datadog-metrics-export) and [Amazon CloudWatch](../cockroachcloud/export-metrics.html?filters=aws-metrics-export):
