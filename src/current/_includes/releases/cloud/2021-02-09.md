...
- An email will now be sent to [org admins](https://www.cockroachlabs.com/docs/cockroachcloud/authorization#org-administrator-legacy) when a [30-day free trial of {{ site.data.products.db }}](https://www.cockroachlabs.com/docs/cockroachcloud/quickstart-trial-cluster) is nearing its end and once it has expired.
