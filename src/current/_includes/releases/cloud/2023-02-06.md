...
- The following features are now available for {{ site.data.products.serverless }} clusters running CockroachDB [v22.2.0](v22.2.html) or later:
  ...
  - [`EXPLAIN ANALYZE`](../{{site.versions["stable"]}}/explain-analyze.html) now gives an estimate of the [Request Units (RUs)](../cockroachcloud/plan-your-cluster-serverless.html#request-units) a query consumes.
