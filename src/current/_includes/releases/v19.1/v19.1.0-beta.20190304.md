...
To upgrade a running cluster to the latest version of CockroachDB, see [Cluster Upgrade](https://www.cockroachlabs.com/docs/v19.1/upgrade-cockroach-version).
