...
- Fixed incorrect results that could occur when casting negative [intervals](https://www.cockroachlabs.com/docs/v19.1/interval) or [timestamps](https://www.cockroachlabs.com/docs/v19.1/timestamp) to type [decimal](../v19.1/decimal.html). [#47524][#47524]
