...
v23.1.11 is currently available only on select CockroachDB {{ site.data.products.dedicated }} clusters. If you wish to upgrade your {{ site.data.products.dedicated }} cluster to v23.1.11, please submit a [https://support.cockroachlabs.com/hc/en-us/requests/new?](support request).
