...
- Users with the `CONTROLJOB` [role option](https://www.cockroachlabs.com/docs/v23.1/create-role#role-options) can now [view jobs]({% link v23.1/show-jobs.md %}) owned by admins. [#96382][#96382]
- Users with the `VIEWJOB` [role option](https://www.cockroachlabs.com/docs/v23.1/create-role#role-options) can now [view all jobs]({% link v23.1/show-jobs.md %}). This role can be revoked by granting the `NOVIEWJOB` role option. [#96382][#96382]
