...
- Fixed a bug where, on long-running [sessions](https://www.cockroachlabs.com/docs/v23.1/show-sessions) that issue many (hundreds of thousands or more) [transactions](https://www.cockroachlabs.com/docs/v23.1/transactions), CockroachDB could previously "leak" reported memory usage (as accounted by the internal memory accounting system, the limit for which is configured via the [`--max-sql-memory` flag](https://www.cockroachlabs.com/docs/v23.1/cockroach-start#general)). This, in turn, could result in the error message `"root: memory budget exceeded"` for other queries. The bug was present in version 23.1.17 and is now fixed. [#121874][#121874]
