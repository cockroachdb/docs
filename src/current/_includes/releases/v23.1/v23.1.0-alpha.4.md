...
- Add support for referencing [user defined functions (UDFs)](/docs/v23.1/user-defined-functions.md) from other objects. Backup and restore operations can now read and write UDF descriptors. [#97038][#97038]
