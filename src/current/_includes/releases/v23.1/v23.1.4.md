...
- The new log config option [`buffering`](../v23.1/configure-logs.html#log-buffering-for-network-sinks) allows you to [format buffer output as JSON arrays](../v23.1/configure-logs.html#file-logging-format). This is useful for APIs that consume JSON arrays, such as the Datadog logs API. [#104790][#104790]
