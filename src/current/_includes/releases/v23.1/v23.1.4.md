...
- Users with [`MODIFYSQLCLUSTERSETTING`](../v23.1/security-reference/authorization.html#supported-privileges) will no longer be able to view non-`sql.defaults` [cluster settings](../v23.1/cluster-settings.html). [#104542][#104542]
...
- Fixed a bug where admin or root user privileges were required to use [`SHOW SYSTEM GRANTS`](../v23.1/show-system-grants.html). [#104732][#104732]
