...
- Added the `SHOW FUNCTIONS` and `SHOW FUNCTIONS FROM <schema>` statements, which list [user-defined functions]({% link v23.1/user-defined-functions.md %}). [#89557][#89557]
...
- Implemented the [`ALTER TABLE ... ADD CHECK`]({% link v23.1/alter-table.md %}) statement in the [declarative schema changer](https://www.cockroachlabs.com/docs/v23.1/online-schema-changes#declarative-schema-changer). [#91153][#91153]
...
- The [optimizer]({% link v23.1/cost-based-optimizer.md %}) now explores plans with a single [lookup join](https://www.cockroachlabs.com/docs/v23.1/joins#lookup-joins) expressions in rare cases where it previously planned two lookup join expressions. [#88491][#88491]
