...
v23.1.12 is currently available only on select CockroachDB {{ site.data.products.dedicated }} clusters. If you wish to upgrade your {{ site.data.products.dedicated }} cluster to v23.1.12, please submit a [support request](https://support.cockroachlabs.com/hc/en-us/requests/new).
