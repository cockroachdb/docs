...
- Fixed a bug that caused CockroachDB to stop collecting new statistics about [Statement fingerprints](https://www.cockroachlabs.com/docs/v23.1/ui-statements-page#statement-fingerprint-page) and [Transaction fingerprints]({% link v23.1/ui-transactions-page.md %}). [#111641][#111641]
