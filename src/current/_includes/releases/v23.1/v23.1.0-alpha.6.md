...
- Added a new [built-in function](https://www.cockroachlabs.com/docs/v23.1/functions-and-operators#trigrams-functions) `tenants_span_stats`, which retrieves the span statistics for the current tenant. [#97534][#97534]
