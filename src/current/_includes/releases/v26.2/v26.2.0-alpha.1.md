...
- Added a new metric
  `sql.rls.policies_applied.count` that tracks the number of SQL
  statements where row-level security policies were applied during
  query planning. [#164405][#164405]
