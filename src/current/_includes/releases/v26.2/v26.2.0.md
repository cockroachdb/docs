 ...
 <tbody>
  <tr>
   <td>
    ...
    <p class="feature-description">CockroachDB now supports mapping SQL user roles to distinguished name attributes in the Subject field of X.509 certificates, including <code>OU</code>, <code>UID</code>, and <code>CN</code>. The cluster setting <code>security.client_cert.san_required.enabled</code> optionally allows <a href="{% link v26.2/certificate-based-authentication-using-the-x509-subject-field.md %}#optional-enable-the-cluster-setting-to-map-users-to-subject-alternative-name-san-fields">mapping to Subject Alternative Name (SAN) fields</a> instead. This enables authentication using your existing Certificate Authority infrastructure without requiring <code>CommonName</code>-based restrictions.</p>
   </td>
