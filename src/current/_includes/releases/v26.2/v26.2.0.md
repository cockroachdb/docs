 ...
 <tbody>
  <tr>
   <td>
    ...
    <p class="feature-description"><a href="{% link v26.2/restore.md %}#run-faster-restores">Restore operations</a> are now up to four times faster using <code>WITH EXPERIMENTAL COPY</code>, significantly reducing recovery time objectives (RTO) for large-scale disaster recovery scenarios.</p>
   </td>
   <td class="icon-center">Preview</td>
   <td class="icon-center">{% include icon-yes.html %}</td>
