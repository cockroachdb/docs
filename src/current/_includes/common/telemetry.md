This page documents the telemetry data that is collected by CockroachDB from clusters with telemetry enabled. For more information, see the [Licensing FAQs]({% link {{ page.version.version }}/licensing-faqs.md %}).
