...
<img src="{{ 'images/v25.4/statement-fingerprint.png' | relative_url }}" alt="Statement fingerprint" style="border:1px solid #eee;max-width:100%" />
...
<img src="{{ 'images/v25.4/statement-details.png' | relative_url }}" alt="Statement details" style="border:1px solid #eee;max-width:100%" />
...
<img src="{{ 'images/v25.4/statement-execution.png' | relative_url }}" alt="Statement execution" style="border:1px solid #eee;max-width:100%" />
...
<img src="{{ 'images/v25.4/statement-execution-details.png' | relative_url }}" alt="Statement execution details" style="border:1px solid #eee;max-width:100%" />
