To alter the formula for a computed column, you must [`DROP`]({{ page.version.version }}/alter-table.md#drop-column) and [`ADD`]({{ page.version.version }}/alter-table.md#add-column) the column back with the new definition. Take the following table for instance:
