...
- Routine parameters and return types cannot be declared using the `ANYENUM` polymorphic type, which is able to match any [`ENUM`]({{ page.version.version }}/enum.md) type. [123048](https://github.com/cockroachdb/cockroach/issues/123048)