...
Click on the **Grants** tab [Database Details Page](#database-details-page) to show the [privileges]({{ version_prefix }}/security-reference/authorization.md#managing-privileges) granted to users and roles on the database.
