...
<img src="{{ 'images/v26.3/geospatial/st_coveredby_true.png' | relative_url }}" alt="ST_CoveredBy - true" style="border:1px solid #eee;max-width:100%" />
...
<img src="{{ 'images/v26.3/geospatial/st_coveredby_false.png' | relative_url }}" alt="ST_CoveredBy - false" style="border:1px solid #eee;max-width:100%" />
