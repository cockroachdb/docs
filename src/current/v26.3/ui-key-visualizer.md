...
<img src="{{ 'images/v26.3/key-visualizer-hot-range.png' | relative_url }}" alt="Key Visualizer showing hot range" style="max-width:80%" />
...
<img src="{{ 'images/v26.3/key-visualizer-range-split.png' | relative_url }}" alt="Key Visualizer showing range split" style="max-width:80%" />
...
<img src="{{ 'images/v26.3/key-visualizer-table-scan.png' | relative_url }}" alt="Key Visualizer showing table scan" style="max-width:80%" />
