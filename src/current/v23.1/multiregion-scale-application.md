...
- For managed {{ site.data.products.db }} deployments, see [Cluster Management]({% link cockroachcloud/cluster-management.md %}).
...
- For connecting to managed, {{ site.data.products.db }} deployments, see [Connect to Your {{ site.data.products.dedicated }} Cluster]({% link cockroachcloud/connect-to-your-cluster.md %}) and [Connect to the Database ({{ site.data.products.dedicated }})]({% link {{ page.version.version }}/connect-to-the-database.md %}?filters=dedicated).
