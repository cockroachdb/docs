...
<table class="comparison-chart">
  ...
  <tr>
    ...
    <td>All products</td>
    <td>CockroachDB {{ site.data.products.standard }}, {{ site.data.products.advanced }}, and {{ site.data.products.basic }}, {{ site.data.products.cloud }} clusters, or with an <a href="enterprise-licensing.html">{{ site.data.products.enterprise }} license</a> in CockroachDB {{ site.data.products.core }}.</td>
  </tr>
