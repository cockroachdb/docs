...
To orchestrate a physically distributed cluster in production, refer to [Orchestrated Deployments]({% link {{ page.version.version }}/kubernetes-overview.md %}). To deploy a CockroachDB {{ site.data.products.dedicated }} cluster instead of running CockroachDB yourself, refer to the [Quickstart](https://www.cockroachlabs.com/docs/cockroachcloud/quickstart).
