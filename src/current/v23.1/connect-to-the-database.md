...
To connect to CockroachDB with [SQLAlchemy](http://docs.sqlalchemy.org/latest/), [create an `Engine` object](https://docs.sqlalchemy.org/14/core/engines.html) by passing the connection string to the `create_engine` function.
...
For more information about connecting with SQLAlchemy, see the [official SQLAlchemy documentation](https://docs.sqlalchemy.org/14/core/engines_connections.html).
