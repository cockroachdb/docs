...
<img src="/docs/images/{{ page.version.version }}/topology-patterns/topology_follower_reads1.png" alt="Follow-the-workload table replication" style="max-width:100%" />
...
<img src="/docs/images/{{ page.version.version }}/topology-patterns/topology_follow_the_workload_reads.png" alt="Follow-the-workload topology reads" style="max-width:100%" />
...
<img src="/docs/images/{{ page.version.version }}/topology-patterns/topology_follow_the_workload_writes.gif" alt="Follow-the-workload topology writes" style="max-width:100%" />
...
<img src="/docs/images/{{ page.version.version }}/topology-patterns/topology_follower_reads_resiliency.png" alt="Follow-the-workload topology region failure" style="max-width:100%" />
...
<img src="/docs/images/{{ page.version.version }}/topology-patterns/topology_follower_reads3.png" alt="Follow-the-workload topology" style="max-width:100%" /> {% endcomment %}
