...
Defining a custom SRID by inserting rows into [`spatial_ref_sys`]({% link {{ page.version.version }}/architecture/glossary.md %}#spatial_ref_sys) is not currently supported.  For more information, see the tracking issue .
{{site.data.alerts.end}}
