...
|------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Pre-{{ page.version.version }} testing release | Upgrade to a corresponding production release; then upgrade through each subsequent major release, ending with a {{ previous_version }} production release. See the [archived version documentation]({% link releases/unsupported-versions.md %}). |
| Pre-{{ previous_version }} production release  | Upgrade through each subsequent major release, ending with a {{ previous_version }} production release. See the [archived version documentation]({% link releases/unsupported-versions.md %}).                                                     |
| {{ previous_version}} testing release          | Upgrade to a {{ previous_version }} production release. See the [archived version documentation]({% link releases/unsupported-versions.md %}).                                                                                                     |
...
1. Upgrade to {{ previous_version }}, if you haven't already. See the [archived version documentation]({% link releases/unsupported-versions.md %}) for upgrade instructions.
