...
- After you restore from a full-cluster backup, changefeed jobs will **not** resume on the new cluster. It is necessary to manually start changefeeds after a [full cluster restore](restore.html#full-cluster).
