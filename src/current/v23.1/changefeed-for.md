...
{{site.data.alerts.callout_info}}
In v22.2 and above, CockroachDB introduces a new [system-level privilege model](security-reference/authorization.html#supported-privileges) that provides more fine-grained control over a user's privilege to work with the database, including the ability to create and manage changefeeds.
