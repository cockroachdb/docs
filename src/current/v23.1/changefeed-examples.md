...
For a summary of Core and {{ site.data.products.enterprise }} changefeed features, refer to the [Change Data Capture Overview](change-data-capture-overview.html) page.
