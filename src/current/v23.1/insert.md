...
<div>
{% capture diagram_include %}cockroach-generated/{{ page.release_info.crdb_branch_name }}/sql-diagrams/insert.html{% endcapture %}{% include {{ diagram_include }} %}
</div>
...
<div>
{% capture diagram_include %}cockroach-generated/{{ page.release_info.crdb_branch_name }}/sql-diagrams/on_conflict.html{% endcapture %}{% include {{ diagram_include }} %}
</div>
