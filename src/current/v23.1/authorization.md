...
Procedures for managing access are covered in [Managing Access in {{ site.data.products.db }}]({% link cockroachcloud/managing-access.md %}).
...
Learn more: [Overview of the CockroachDB Cloud two-level authorization model]({% link cockroachcloud/authorization.md %}#overview-of-the-cockroachdb-cloud-two-level-authorization-model)
