...
Choose whether to run a local cluster or a free cluster on CockroachDB {{ site.data.products.cloud }}.

<div class="filters clearfix">
  <button class="filter-button page-level" data-scope="cockroachcloud">Use CockroachDB {{ site.data.products.cloud }}</button>
