...
This page explains the `cockroach start` [command]({% link {{ page.version.version }}/cockroach-commands.md %}#bad-anchor), which you use to start a new multi-node cluster or add nodes to an existing cluster.
