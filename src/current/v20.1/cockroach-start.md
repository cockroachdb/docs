...
Clusters using this configuration with client certificate authentication may also wish to use [split client CA certificates](create-security-certificates-custom-ca.html#split-ca-certificates).
