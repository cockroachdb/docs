...
<img src="{{ 'images/v20.1/sysbench-throughput.png' | relative_url }}" alt="Sysbench Throughput" style="max-width:100%" />
...
<img src="{{ 'images/v20.1/sysbench-latency.png' | relative_url }}" alt="Sysbench Latency" style="max-width:100%" />
