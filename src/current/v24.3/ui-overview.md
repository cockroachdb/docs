...
The DB Console supports username/password login and single sign-on (SSO) for {{ site.data.products.dedicated }} and {{ site.data.products.core }} {{ site.data.products.enterprise }} clusters.
