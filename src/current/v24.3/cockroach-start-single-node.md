...
{% include_cached new-in.html version="v24.3" %} `--locality-file` | A file that contains arbitrary key-value pairs that describe the location of the node, as an alternative to the `--locality` flag.
