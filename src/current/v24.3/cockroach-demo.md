...
`\demo decommission <node number>` | Decommissions a node in a multi-node demo cluster.<br><br>This command simulates [decommissioning a node]({% link {{ page.version.version }}/decommission-a-node.md %}).
