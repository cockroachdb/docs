...
Flag | Description
-----|-----------
`--tenant-name-scope` | {% include_cached new-in.html version="v24.3" %} Allows you to use the tenant name when creating a client certificate and key pair, in addition to the tenant ID.
