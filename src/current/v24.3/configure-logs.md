...
{% include_cached new-in.html version="v24.3" %}If CockroachDB is managed using `systemd` and log buffering is enabled, logs are flushed automatically when CockroachDB starts.
