...
- {% include new-in.md version="v21.2" %} [`ON UPDATE` expressions](#on-update-expressions)
- {% include new-in.md version="v21.2" %} [Identity columns](#identity-columns) (sequence-populated columns)

### `ON UPDATE` expressions

{% include new-in.md version="v21.2" %} `ON UPDATE` expressions update column values in the following cases:
...
{% include new-in.md version="v21.2" %} [Identity columns](#identity-columns) define a sequence from which to populate a column when a new row is inserted.
