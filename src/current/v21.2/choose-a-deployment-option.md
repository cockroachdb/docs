...
<table>
  ...
  <tr>
      ...
      <td><ul>
        ...
        <li><b>Cost</b>: Free for 10 GiB of storage and 50M Request Units. Consumption based billing and resource limits enforce budget requirements.</li>
  ...
  <tr>
      ...
      <td><ul>
        <li><b><a href="../cockroachcloud/quickstart-trial-cluster.html">CockroachDB {{ site.data.products.dedicated }}</a></b>: A fully managed, single tenant CockroachDB deployment in a single region or multi-region cloud (AWS or GCP).</li>
      </ul></td>
      <td><ul>
