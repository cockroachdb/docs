...
This tutorial explores the CockroachDB {{ site.data.products.core }} integration with Datadog. For the CockroachDB {{ site.data.products.cloud }} integration with Datadog, refer to [Monitor CockroachDB Cloud with Datadog](../cockroachcloud/tools-page.html#monitor-cockroachdb-cloud-with-datadog)
