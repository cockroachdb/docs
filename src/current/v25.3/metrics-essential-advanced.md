...
* [Datadog integration]({% link cockroachcloud/tools-page.md %}#monitor-cockroachdb-cloud-with-datadog) - The [**Datadog Integration Metric Name**](https://docs.datadoghq.com/integrations/cockroach-cloud/#metrics) column lists the corresponding Datadog metric which requires the `crdb_dedicated.` prefix.
...
{% if essential_metrics.size > 0 and category.name != "NETWORKING" %}
...
<table markdown="1">
    <thead>
        <tr>
            ...
            <th>[Datadog Integration Metric Name](https://docs.datadoghq.com/integrations/cockroach-cloud/#metrics)<br>(add `crdb_dedicated.` prefix)</th>
            <th>Description</th>
            <th>Usage</th>
        </tr>
    </thead>
