...
<image src="/docs/images/{{ page.version.version }}/resilience.svg" alt="Diagram showing how HA features and DR tools create a resilient CockroachDB deployment." style="width:80%" />
