...
<img src="/docs/images/{{ page.version.version }}/cutover-window.png" alt="Timeline showing how the failover window is between the retained time and replicated time." style="border:0px solid #eee;max-width:100%" />
