...
<img src="{{ 'images/v24.1/tpcc140k.png' | relative_url }}" alt="TPC-C 140,000" style="border:1px solid #eee;max-width:100%" />
...
<img src="{{ 'images/v24.1/linearscale.png' | relative_url }}" alt="CRDB Linear Scale" style="max-width:100%" />
...
<img src="{{ 'images/v24.1/sysbench-throughput.png' | relative_url }}" alt="Sysbench Throughput" style="max-width:100%" />
...
<img src="{{ 'images/v24.1/sysbench-latency.png' | relative_url }}" alt="Sysbench Latency" style="max-width:100%" />
