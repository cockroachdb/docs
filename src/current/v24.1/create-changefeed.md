...
In CockroachDB v23.2 and later, changefeeds will emit to Pub/Sub v2 by default. For details on the changes to the message format, refer to [Pub/Sub sink messages]({% link {{ page.version.version }}/changefeed-sinks.md %}#pub-sub-sink-messages).
