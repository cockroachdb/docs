...
- For managed CockroachDB {{ site.data.products.dedicated }} deployments, see [Cluster Management](../cockroachcloud/cluster-management.html).
...
- For connecting to CockroachDB {{ site.data.products.dedicated }} deployments, see [Connect to Your CockroachDB {{ site.data.products.dedicated }} Cluster](../cockroachcloud/connect-to-your-cluster.html) and [Connect to the Database (CockroachDB {{ site.data.products.dedicated }})](connect-to-the-database-cockroachcloud.html).
