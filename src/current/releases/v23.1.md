...
toc: true
toc_not_nested: true
summary: Additions and changes in CockroachDB version v23.1 since version v22.2
major_version: v23.1
docs_area: releases
---
...
{% unless release_names contains "v23.1.12" %}
{% include releases/{{ page.major_version }}/v23.1.12.md %}
{% endunless %}

{% unless release_names contains "v23.1.11" %}
{% include releases/{{ page.major_version }}/v23.1.11.md %}
{% endunless %}
