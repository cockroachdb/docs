...
[`SHOW STATEMENT HINTS`]({% link {{ page.version.version }}/show-statement-hints.md %}) | List [statement hints]({% link {{ page.version.version }}/cost-based-optimizer.md %}#statement-hints) for a SQL statement fingerprint.
