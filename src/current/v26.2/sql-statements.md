...
[`SHOW STATEMENT HINTS`]({% link {{ page.version.version }}/show-statement-hints.md %}) | List [injected hints]({% link {{ page.version.version }}/cost-based-optimizer.md %}#hint-injection) for a SQL statement fingerprint.
