...
The `cockroach debug list-files` [command]({{ page.version.version }}/cockroach-commands.md) shows the files that will be collected by using [`cockroach debug zip`]({{ page.version.version }}/cockroach-debug-zip.md).

{{site.data.alerts.callout_info}}
The files listed include logs, heap profiles, goroutine dumps, and CPU profiles. Other [files]({{ page.version.version }}/cockroach-debug-zip.md#files) generated by `cockroach debug zip` are not listed by `cockroach debug list-files`.
