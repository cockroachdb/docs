...
A _hot node_ is the most common indicator of a hotspot, as the [DB Console Metrics page]({% link {{ page.version.version }}/ui-overview.md %}#metrics) shows resource utilization per node by default.
