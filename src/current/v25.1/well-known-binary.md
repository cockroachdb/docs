...
- Allow shapes to be transferred between CockroachDB and a [SQL client]({{ page.version.version }}/cockroach-sql.md) or [application]({{ page.version.version }}/build-a-java-app-with-cockroachdb.md).
...
The Extended Well Known Binary (_EWKB_) format is the same as WKB, with an [SRID]({{ page.version.version }}/architecture/glossary.md#srid) representation prepended to the data structure.
