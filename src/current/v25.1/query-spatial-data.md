...
If your application needs support for functions that are not yet implemented, check the , which describes how to find an issue for the built-in function(s) you need.
...
<img width="100%" src="{{ 'images/v25.1/geospatial/1999-oklahoma-tornado-outbreak-map.png' | relative_url }}" alt="1999 Oklahoma tornado outbreak map view">
