...
<img width="100%" src="{{ 'images/' | append: page.version.version | append: '/geospatial/1999-oklahoma-tornado-outbreak-map.png' | relative_url }}" alt="1999 Oklahoma tornado outbreak map view">
