...
![Development topology](/images/v24.2/topology-patterns/topology_development1.png)

For this pattern, you can either [run CockroachDB locally]({{ page.version.version }}/start-a-local-cluster.md) or [deploy a single-node cluster on a cloud VM]({{ page.version.version }}/manual-deployment.md).
...
![Development topology read and write latency](/images/v24.2/topology-patterns/topology_development_latency.png)
...
![Development topology single failure](/images/v24.2/topology-patterns/topology_development2.png)
