...
For a simple but complete example app, see [Build a Node.js App with CockroachDB and the Node.js pg Driver]({{ page.version.version }}/build-a-nodejs-app-with-cockroachdb.md).
...
For a simple but complete example app, see [Build a Node.js App with CockroachDB and Sequelize]({{ page.version.version }}/build-a-nodejs-app-with-cockroachdb-sequelize.md).
...
For a simple but complete example app, see [Build a Simple CRUD Node.js App with CockroachDB and Knex.js]({{ page.version.version }}/build-a-nodejs-app-with-cockroachdb-knexjs.md).
...
For a simple but complete example app, see [Build a TypeScript App with CockroachDB and TypeORM]({{ page.version.version }}/build-a-typescript-app-with-cockroachdb.md).
...
For a simple but complete example app, see [Build a Simple CRUD Node.js App with CockroachDB and Prisma]({{ page.version.version }}/build-a-nodejs-app-with-cockroachdb-prisma.md).
...
For a simple but complete example app, see [Build a Python App with CockroachDB and psycopg3]({{ page.version.version }}/build-a-python-app-with-cockroachdb-psycopg3.md).
...
For a simple but complete example app, see [Build a Python App with CockroachDB and psycopg2]({{ page.version.version }}/build-a-python-app-with-cockroachdb.md).
...
For a simple but complete example app, see [Build a Python App with CockroachDB and SQLAlchemy]({{ page.version.version }}/build-a-python-app-with-cockroachdb-sqlalchemy.md).
...
For a simple but complete example app, see [Build a Python App with CockroachDB and Django]({{ page.version.version }}/build-a-python-app-with-cockroachdb-django.md).
...
For a simple but complete example app, see [Build a Go App with CockroachDB and the Go pgx Driver]({{ page.version.version }}/build-a-go-app-with-cockroachdb.md).
...
For a simple but complete example app, see [Build a Go App with CockroachDB and the Go pq Driver]({{ page.version.version }}/build-a-go-app-with-cockroachdb.md).
...
For a simple but complete example app, see [Build a Go App with CockroachDB and GORM]({{ page.version.version }}/build-a-go-app-with-cockroachdb-gorm.md).
...
For a simple but complete example app, see [Build a Java App with CockroachDB and JDBC]({{ page.version.version }}/build-a-java-app-with-cockroachdb.md).
...
For a simple but complete example app that uses Gradle for dependency management, see [Build a Java App with CockroachDB and Hibernate]({{ page.version.version }}/build-a-java-app-with-cockroachdb-hibernate.md).
...
For a complete example app that uses Maven for dependency management, see [Build a Spring App with CockroachDB and Spring Data JPA (Hibernate)]({{ page.version.version }}/build-a-spring-app-with-cockroachdb-jpa.md).
...
For a simple but complete example app that uses Maven for dependency management, see [Build a Java App with CockroachDB and jOOQ]({{ page.version.version }}/build-a-java-app-with-cockroachdb-jooq.md).
...
For a simple but complete example app, see [Build a Ruby App with CockroachDB and the Ruby pg Driver]({{ page.version.version }}/build-a-ruby-app-with-cockroachdb.md).
...
For a simple but complete example app, see [Build a Ruby App with CockroachDB and Active Record]({{ page.version.version }}/build-a-ruby-app-with-cockroachdb-activerecord.md).
...
For a simple but complete example app, see [Build a C# App with CockroachDB and the .NET Npgsql Driver]({{ page.version.version }}/build-a-csharp-app-with-cockroachdb.md).
...
For a simple but complete example app, see [Build a Rust App with CockroachDB and the Rust-Postgres Driver]({{ page.version.version }}/build-a-rust-app-with-cockroachdb.md).

</section>

## What's next?

- [Connect to CockroachDB]({{ page.version.version }}/connect-to-the-database.md)
- [Design a Database Schema]({{ page.version.version }}/schema-design-overview.md)
