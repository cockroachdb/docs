...
Once you set the application name, the [DB Console]({{ page.version.version }}/ui-overview.md) lets you [filter database workloads by application name]({{ page.version.version }}/ui-statements-page.md#filter).

![Movr app filter](/images/v24.2/movr-app.png)
...
Often signals to problems start at high-level metrics. The [SQL dashboard]({{ page.version.version }}/ui-sql-dashboard.md) has metrics for [SQL sessions]({{ page.version.version }}/ui-sql-dashboard.md#open-sql-sessions), [SQL statements]({{ page.version.version }}/ui-sql-dashboard.md#active-sql-statements), [SQL statement errors]({{ page.version.version }}/ui-sql-dashboard.md#sql-statement-errors), etc., that can quickly signify potential issues with your application.
...
- [SQL Activity]({{ page.version.version }}/ui-overview.md#sql-activity)
- [SQL Performance Best Practices]({{ page.version.version }}/performance-best-practices-overview.md)
- [Troubleshoot Statement Behavior]({{ page.version.version }}/query-behavior-troubleshooting.md)