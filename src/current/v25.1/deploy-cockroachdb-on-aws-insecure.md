...
1. [Connect your application]({{ page.version.version }}/install-client-drivers.md). Be sure to connect your application to the AWS load balancer, not to a CockroachDB node.
