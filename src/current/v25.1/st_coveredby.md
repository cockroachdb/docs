...
{{site.data.alerts.callout_info}}
This function is the inverse of [`ST_Covers`]({{ page.version.version }}/st_covers.md).
{{site.data.alerts.end}}
...
![ST_CoveredBy - true](/images/v24.2/geospatial/st_coveredby_true.png)
...
![ST_CoveredBy - false](/images/v24.2/geospatial/st_coveredby_false.png)
