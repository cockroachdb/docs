...
- [Distributed dashboard]({{ page.version.version }}/ui-distributed-dashboard.md) has metrics about distribution tasks across the cluster, including RPCs, transactions, and node heartbeats.
