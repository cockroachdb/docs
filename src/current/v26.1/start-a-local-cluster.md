...
1. In the DB Console, despite one node being "suspect", notice the continued SQL traffic:
    ...
    <img src="{{ 'images/v26.1/ui_overview_dashboard_1_suspect.png' | relative_url }}" alt="DB Console" style="border:1px solid #eee;max-width:100%" />
...
1. In the DB Console **Cluster Overview** page, confirm that the cluster now has five nodes.
    ...
    <img src="{{ 'images/v26.1/ui_cluster_overview_5_nodes.png' | relative_url }}" alt="DB Console" style="border:1px solid #eee;max-width:100%" />
