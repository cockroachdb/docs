...
For examples of retrying transactions in an application, check out the tutorials in the [Develop with CockroachDB]({% link {{ page.version.version }}/developer-guide-overview.md %}) section.
