...
<img src="{{ 'images/v26.1/ui_mvcc_gc_queue.png' | relative_url }}" alt="DB Console GC queue graph" style="border:1px solid #eee;max-width:100%" />
...
<img src="{{ 'images/v26.1/ui_protected_timestamp_records.png' | relative_url }}" alt="DB Console GC queue graph" style="border:1px solid #eee;max-width:100%" />
