...
<img src="/docs/images/{{ page.version.version }}/ui_queue_failures.png" alt="DB Console queue failures graph" style="border:1px solid #eee;max-width:100%" />
...
<img src="/docs/images/{{ page.version.version }}/ui_queue_time.png" alt="DB Console queue processing time graph" style="border:1px solid #eee;max-width:100%" />
...
<img src="/docs/images/{{ page.version.version }}/ui_replicagc_queue.png" alt="DB Console replica GC queue graph" style="border:1px solid #eee;max-width:100%" />
...
<img src="/docs/images/{{ page.version.version }}/ui_replication_queue.png" alt="DB Console replication queue graph" style="border:1px solid #eee;max-width:100%" />
...
<img src="/docs/images/{{ page.version.version }}/ui_split_queue.png" alt="DB Console split queue graph" style="border:1px solid #eee;max-width:100%" />
...
<img src="/docs/images/{{ page.version.version }}/ui_merge_queue.png" alt="DB Console merge queue graph" style="border:1px solid #eee;max-width:100%" />
...
<img src="/docs/images/{{ page.version.version }}/ui_raftlog_queue.png" alt="DB Console Raft log queue graph" style="border:1px solid #eee;max-width:100%" />
...
<img src="/docs/images/{{ page.version.version }}/ui_raftsnapshot_queue.png" alt="DB Console Raft snapshot queue graph" style="border:1px solid #eee;max-width:100%" />
...
<img src="/docs/images/{{ page.version.version }}/ui_consistencychecker_queue.png" alt="DB Console consistency checker queue graph" style="border:1px solid #eee;max-width:100%" />
...
<img src="/docs/images/{{ page.version.version }}/ui_tsmaintenance_queue.png" alt="DB Console time series maintenance queue graph" style="border:1px solid #eee;max-width:100%" />
