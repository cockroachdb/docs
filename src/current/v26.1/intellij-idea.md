...
<img src="/docs/images/{{ page.version.version }}/intellij/XX000_error_could_not_decorrelate_subquery.png" alt="DBeaver - Select CockroachDB" style="border:1px solid #eee;max-width:100%" />
...
<img src="/docs/images/{{ page.version.version }}/intellij/42883_error_pg_function_is_visible.png" alt="DBeaver - Select CockroachDB" style="border:1px solid #eee;max-width:100%" />
...
<img src="/docs/images/{{ page.version.version }}/intellij/42073_error_column_n_xmin_does_not_exist.png" alt="DBeaver - Select CockroachDB" style="border:1px solid #eee;max-width:100%" />
...
1. Launch the **Database** tool window. (**View** > **Tool Windows** > **Database**) <img src="/docs/images/{{ page.version.version }}/intellij/01_database_tool_window.png" alt="DBeaver - Select CockroachDB" style="border:1px solid #eee;max-width:100%" />
1. Add a PostgreSQL data source. (**New (+)** > **Data Source** > **PostgreSQL**)<img src="/docs/images/{{ page.version.version }}/intellij/02_postgresql_data_source.png" alt="DBeaver - Select CockroachDB" style="border:1px solid #eee;max-width:100%" />
1. On the **General** tab, enter your database's connection string:
	...
	**Driver** | Select or install **PostgreSQL** using a version greater than or equal to 41.1. (Older drivers have not been tested.)
	...
	<img src="/docs/images/{{ page.version.version }}/intellij/03_general_tab.png" alt="DBeaver - Select CockroachDB" style="border:1px solid #eee;max-width:100%" />
...
1. Go to the **Options** tab, and then select **Introspect using JDBC metadata**.<img src="/docs/images/{{ page.version.version }}/intellij/04_options_tab.png" alt="DBeaver - Select CockroachDB" style="border:1px solid #eee;max-width:100%" />
1. Click **OK**.
