...
CockroachDB versions 19.2, 20.1, 20.2, and 21.1 are affected by this bug. Version 20.2 is only affected until maintenance version 20.2.18. Versions 19.2 and 20.1 are no longer eligible for [maintenance support](https://www.cockroachlabs.com/releases/release-support-policy), so there will be no patches for these versions.
