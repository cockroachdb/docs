...
This is resolved in CockroachDB by , which fixes the optimizer to always fetch the required columns and avoid simplifying predicate evaluation for mutation indexes.
...
This public issue is tracked by.
