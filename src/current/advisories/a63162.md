...
These versions are available on [CockroachDB Releases Overview](https://www.cockroachlabs.com/docs/releases).
...
The issue is resolved in CockroachDB v20.1.15, v20.2.8 and the forthcoming v21.0.0. They are available on [CockroachDB Releases Overview](https://www.cockroachlabs.com/docs/releases). Users are advised to upgrade.
