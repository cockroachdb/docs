...
These versions are available on our [releases page](https://www.cockroachlabs.com/releases/index).
...
The issue is resolved in CockroachDB v20.1.15, v20.2.8 and the forthcoming v21.0.0. They are available on our [releases page](https://www.cockroachlabs.com/releases/index). Users are advised to upgrade.
