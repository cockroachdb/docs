...
This is resolved in CockroachDB by PR , which disables the incorrect planning of locality-optimized semi-joins with ON-conditions.

The fix has been applied to [21.2.1](https://www.cockroachlabs.com/docs/releases/v21.2#v21-2-1).

This issue is tracked by public issue .
