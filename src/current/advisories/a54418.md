...
This bug was introduced in, which was intended to correct a previously-identified error in `UPSERT` handling. A fix ([#54418][#54418]) is available in the [v20.1.6 release](https://www.cockroachlabs.com/docs/releases/v20.1#v20-1-6).

## Statement

To track this issue, see, the pull request correcting the aforementioned bugs.
