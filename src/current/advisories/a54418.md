...
This bug was introduced in #51944, which was intended to correct a previously-identified error in `UPSERT` handling. A fix (#54418) is available in the [v20.1.6 release](https://www.cockroachlabs.com/docs/releases/v20.1#v20-1-6).
