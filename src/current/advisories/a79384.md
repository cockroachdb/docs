...
This is resolved in CockroachDB by PR 79389.

The fix has been applied to maintenance versions [v21.1.18](https://www.cockroachlabs.com/docs/releases/v21.1#v21-1-18) and [v21.2.9](https://www.cockroachlabs.com/docs/releases/v21.2#v21-2-9) of CockroachDB.

This public issue is tracked by 79384.
