...
In 20.2, the implementation of [`TRUNCATE`](https://www.cockroachlabs.com/stable/truncate) changed to keep the table ID stable.
Its new behavior is to replace the existing [indexes](https://www.cockroachlabs.com/stable/indexes) with new, empty indexes.
