...
In 20.2, the implementation of [`TRUNCATE`](https://www.cockroachlabs.com/docs/v20.2/truncate) changed to keep the table ID stable.
Its new behavior is to replace the existing [indexes](https://www.cockroachlabs.com/docs/v20.2/indexes) with new, empty indexes.
...
This issue affects CockroachDB [v20.2.0 to v20.2.8.](https://www.cockroachlabs.com/docs/releases/v20.2)
