...
Additionally, users of CockroachDB [v22.2.0–v22.2.11](../releases/v22.2.html) are encouraged to upgrade to v22.2.12 once it has released. Similarly, users of [v23.1.0—v23.1.5](../releases/v23.1.html) are encouraged to update to v23.1.6 once it has released.
