...
This issue is resolved in CockroachDB by. The fix has been applied to maintenance versions [v21.1.16](https://www.cockroachlabs.com/docs/releases/v21.1#v21-1-16) and v21.2.7 of CockroachDB.

This public issue is tracked as.
