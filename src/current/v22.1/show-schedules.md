...
{% include new-in.md version="v22.1" %} It also lists all of the currently active scheduled jobs for [Row-Level TTL](row-level-ttl.html).
...
- {% include new-in.md version="v22.1" %} [Row-Level TTL](row-level-ttl.html)
