...
<img src="{{ 'images/v22.1/sst.png' | relative_url }}" alt="Structure of an SST file" style="max-width:100%" />
...
<img src="{{ 'images/v22.1/lsm-with-ssts.png' | relative_url }}" alt="LSM tree with SST files" style="max-width:100%" />
...
<img src="{{ 'images/v22.1/memtable-wal-sst.png' | relative_url }}" alt="Relationship between memtable, WAL, and SSTs" style="max-width:100%" />
...
Now that you've learned about our architecture, [start up a CockroachDB {{ site.data.products.serverless }} cluster](../../cockroachcloud/quickstart.html) or [local cluster](../install-cockroachdb.html) and start [building an app with CockroachDB](../example-apps.html).
