...
~~~ python
{% include example-apps/cockroachlabs/movr-flask/v2-doc-includes/movr/models__front.py %}
~~~
...
~~~ python
{% include example-apps/cockroachlabs/movr-flask/v2-doc-includes/movr/models__user.py %}
~~~
...
~~~ python
{% include example-apps/cockroachlabs/movr-flask/v2-doc-includes/movr/models__vehicle.py %}
~~~
...
~~~ python
{% include example-apps/cockroachlabs/movr-flask/v2-doc-includes/movr/models__ride.py %}
~~~
...
~~~ python
{% include example-apps/cockroachlabs/movr-flask/v2-doc-includes/movr/transactions__front.py %}
~~~
...
~~~ python
{% include example-apps/cockroachlabs/movr-flask/v2-doc-includes/movr/transactions__get-rides-txn.py %}
~~~
...
~~~ python
{% include example-apps/cockroachlabs/movr-flask/v2-doc-includes/movr/transactions__get-vehicles-txn.py %}
~~~
...
~~~ python
{% include example-apps/cockroachlabs/movr-flask/v2-doc-includes/movr/transactions__start-ride-txn.py %}
~~~
...
~~~ python
{% include example-apps/cockroachlabs/movr-flask/v2-doc-includes/movr/movr__front.py %}
~~~
...
~~~ python
{% include example-apps/cockroachlabs/movr-flask/v2-doc-includes/movr/movr__start-ride.py %}
~~~
...
~~~ python
{% include example-apps/cockroachlabs/movr-flask/v2-doc-includes/web/config.py %}
~~~
...
~~~ python
{% include example-apps/cockroachlabs/movr-flask/v2-doc-includes/web/forms__credentialform.py %}
~~~
...
~~~ python
{% include example-apps/cockroachlabs/movr-flask/v2-doc-includes/web/forms__vehicleform.py %}
~~~
...
~~~ python
{% include example-apps/cockroachlabs/movr-flask/v2-doc-includes/server__front.py %}
~~~
...
~~~ python
{% include example-apps/cockroachlabs/movr-flask/v2-doc-includes/server__init.py %}
~~~
...
~~~ python
{% include example-apps/cockroachlabs/movr-flask/v2-doc-includes/server__connect.py %}
~~~
...
~~~ python
{% include example-apps/cockroachlabs/movr-flask/v2-doc-includes/server__user-loader.py %}
~~~
...
~~~ python
{% include example-apps/cockroachlabs/movr-flask/v2-doc-includes/server__login-page.py %}
~~~
