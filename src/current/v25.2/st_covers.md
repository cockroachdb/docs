...
<img src="{{ 'images/{{ page.version.version }}/geospatial/st_covers_true.png' | relative_url }}" alt="ST_Covers - true" style="border:1px solid #eee;max-width:100%" />
...
<img src="{{ 'images/{{ page.version.version }}/geospatial/st_covers_false.png' | relative_url }}" alt="ST_Covers - false" style="border:1px solid #eee;max-width:100%" />
