...
- Higher project risk: The project **must** be completed to meet a given [downtime / service degradation window]({% link molt/migration-strategy.md %}#approach-to-downtime).
