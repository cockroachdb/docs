---
title: Cluster Monitoring with the Kubernetes Operator
summary: How to monitor a secure CockroachDB cluster deployed with the Kubernetes operator.
toc: true
toc_not_nested: true
docs_area: deploy
---
...
```json
...
# HELP node_decommissioning Whether a CRDB node is decommissioning.
