...
<img src="/docs/images/{{ page.version.version }}/topology-patterns/topology_follower_reads1.png" alt="Follower reads table replication" style="max-width:100%" />
...
<img src="/docs/images/{{ page.version.version }}/topology-patterns/topology_follower_reads_reads.png" alt="Follower reads topology reads" style="max-width:100%" />
...
<img src="/docs/images/{{ page.version.version }}/topology-patterns/topology_follower_reads_writes.gif" alt="Follower reads topology writes" style="max-width:100%" />
...
<img src="/docs/images/{{ page.version.version }}/topology-patterns/topology_follower_reads_resiliency.png" alt="Follower reads topology region failure" style="max-width:100%" />
