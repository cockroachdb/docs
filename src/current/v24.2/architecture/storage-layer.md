...
<img src="{{ 'images/v24.2/sst.png' | relative_url }}" alt="Structure of an SST file" style="max-width:100%" />
...
<img src="{{ 'images/v24.2/lsm-with-ssts.png' | relative_url }}" alt="LSM tree with SST files" style="max-width:100%" />
...
<img src="{{ 'images/v24.2/memtable-wal-sst.png' | relative_url }}" alt="Relationship between memtable, WAL, and SSTs" style="max-width:100%" />
