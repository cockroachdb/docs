...
CockroachDB {{ site.data.products.core }} supports [Online Certificate Status Protocol (OCSP)](https://en.wikipedia.org/wiki/Online_Certificate_Status_Protocol) for certificate revocation.
