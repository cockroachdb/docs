...
Azure        | `azure://acme-co/employees?AZURE_ACCOUNT_NAME=acme-co&AZURE_ACCOUNT_KEY=url-encoded-123`<br><br>**Note:** {% include {{ page.version.version }}/misc/azure-external-conn.md %}
...
Azure        | `azure://acme-co/employees.sql?AZURE_ACCOUNT_NAME=acme-co&AZURE_ACCOUNT_KEY=url-encoded-123`<br><br>**Note:** {% include {{ page.version.version }}/misc/azure-external-conn.md %}
