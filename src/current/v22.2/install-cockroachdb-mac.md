...
<div id="download-the-binary" class="install-option">
  ...
  <ol>
    <li>
      <p>Visit <a href="https://www.cockroachlabs.com/docs/releases">Releases</a> to download the CockroachDB archive for the architecture of your macOS host. The archive contains the <code>cockroach</code> binary and the supporting libraries that are used to provide <a href="spatial-features.html">spatial features</a>.</p>
