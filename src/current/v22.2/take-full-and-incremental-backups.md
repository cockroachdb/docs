...
Cockroach Labs recommends taking incremental backups every 10 minutes. CockroachDB supports up to 48 incremental backups between full backups. This may vary based on your specific use-case, so we recommend testing within your own environment and workloads. This can look like:
