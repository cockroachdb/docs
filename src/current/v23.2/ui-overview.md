...
The DB Console supports username/password login, as well as single sign-on (SSO) ({{ site.data.products.advanced }} and {{ site.data.products.core }} {{ site.data.products.enterprise }} clusters only).
