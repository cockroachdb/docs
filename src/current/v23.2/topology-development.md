...
<img src="{{ 'images/v23.2/topology-patterns/topology_development1.png' | relative_url }}" alt="Development topology" style="max-width:100%" />
...
<img src="{{ 'images/v23.2/topology-patterns/topology_development_latency.png' | relative_url }}" alt="Development topology read and write latency" style="max-width:100%" />
...
<img src="{{ 'images/v23.2/topology-patterns/topology_development2.png' | relative_url }}" alt="Development topology single failure" style="max-width:100%" />
