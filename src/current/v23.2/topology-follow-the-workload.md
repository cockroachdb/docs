...
<img src="{{ 'images/v23.2/topology-patterns/topology_follower_reads1.png' | relative_url }}" alt="Follow-the-workload table replication" style="max-width:100%" />
...
<img src="{{ 'images/v23.2/topology-patterns/topology_follow_the_workload_reads.png' | relative_url }}" alt="Follow-the-workload topology reads" style="max-width:100%" />
...
<img src="{{ 'images/v23.2/topology-patterns/topology_follow_the_workload_writes.gif' | relative_url }}" alt="Follow-the-workload topology writes" style="max-width:100%" />
...
<img src="{{ 'images/v23.2/topology-patterns/topology_follower_reads_resiliency.png' | relative_url }}" alt="Follow-the-workload topology region failure" style="max-width:100%" />
...
<img src="{{ 'images/v23.2/topology-patterns/topology_follower_reads3.png' | relative_url }}" alt="Follow-the-workload topology" style="max-width:100%" /> {% endcomment %}
