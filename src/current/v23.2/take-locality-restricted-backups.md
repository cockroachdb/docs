...
<img src="/docs/images/{{ page.version.version }}/network-restriction.png" alt="Using execution locality when there is a network restriction between locality requirements" style="border:0px solid #eee;max-width:100%" />
...
<img src="/docs/images/{{ page.version.version }}/background-work.png" alt="Using execution locality to create a non-primary region for backup jobs" style="border:0px solid #eee;max-width:100%" />
