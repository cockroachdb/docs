...
<img src="{{ 'images/v23.2/tpcc140k.png' | relative_url }}" alt="TPC-C 140,000" style="border:1px solid #eee;max-width:100%" />
...
<img src="{{ 'images/v23.2/linearscale.png' | relative_url }}" alt="CRDB Linear Scale" style="max-width:100%" />
