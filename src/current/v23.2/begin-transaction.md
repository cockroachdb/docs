...
{{site.data.alerts.callout_danger}}This example assumes you're using <a href="{% link {{ page.version.version }}/transaction-retry-error-reference.md %}#client-side-retry-handling">client-side retry handling</a>.{{site.data.alerts.end}}
