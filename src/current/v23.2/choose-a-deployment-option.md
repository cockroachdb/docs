...
<table>
  ...
  <tr>
      ...
      <td><ul>
        ...
        <li><b><a href="enterprise-licensing.html">Enterprise Features</a></b>: Enabled (excluding features that are currently <a href="../cockroachcloud/serverless-unsupported-features">unsupported</a>). </li>
      </ul></td>
  </tr>
  <tr>
      <td><ul>
