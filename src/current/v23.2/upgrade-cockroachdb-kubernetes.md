...
1. Verify that you can upgrade.
    ...
    1. If you are upgrading to {{ page.version.version }} from a production release earlier than {{ previous_version }}, or from a testing release (alpha/beta), first [upgrade to a production release of {{ previous_version }}]({% link v21.1/operate-cockroachdb-kubernetes.md %}#upgrade-the-cluster). Be sure to complete all the steps.
