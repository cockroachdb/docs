...
Because the `SERIAL` data type represents values automatically generated CockroachDB to uniquely identify rows, you cannot meaningfully cast `SERIAL` into other data types.
