...
parser.add_argument(
    "--check_existing",
    default=False,
    help="""If on, checks if the issue exists, and attempts to update the GitHub issue instead if it exists.""",
    action='store_true',
)
parser.add_argument(
    "--dry_run",
...
# update_issue updates the issue on github.
...
print("Docs issues updatd:", github_issues_updated)
