...
[Replication Zone for "Liveness" Range](../v2.0/configure-replication-zones.html#edit-the-replication-zone-for-a-system-range) | Clusters now come with a pre-defined replication zone for the "liveness" range, which contains the authoritative information about which nodes are live at any given time.
