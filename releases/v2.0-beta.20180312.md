...
- Simplified the [Test Deployment tutorial](../v2.0/deploy-a-test-cluster.html) to cover pre-defined load generators. [#2640](https://github.com/cockroachdb/docs/pull/2640)
...
- Define "range lease" in the [CockroachDB architecture overview](../v2.0/architecture/overview.html#terms). [#2625](https://github.com/cockroachdb/docs/pull/2625)
