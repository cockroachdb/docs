...
- Fixed the [JavaScript code sample for connecting to a CockroachCloud cluster](../cockroachcloud/cockroachcloud-connect-to-your-cluster.html#use-a-postgres-driver-or-orm). [#6393](https://github.com/cockroachdb/docs/pull/6393)
