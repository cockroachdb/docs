...
You can now [add or remove nodes](../cockroachcloud/cockroachcloud-cluster-management.html#add-or-remove-nodes-from-a-cluster) from your cluster through the Console.
