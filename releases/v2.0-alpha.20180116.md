...
- **Capacity Used** is now shown as "-" instead of 100% when the UI can't load the real data from the server. [#20824](https://github.com/cockroachdb/cockroach/pull/20824)
