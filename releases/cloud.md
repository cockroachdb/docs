...
- You no longer need to download a CA certificate to [connect to a {{ site.data.products.serverless }}](../cockroachcloud/connect-to-a-severless-cluster.html) cluster running [v21.2.5](v21.2.html) or later.
