...
redirect_from: /beta-20161013.html
---
...
- New [date/time functions](../v1.0/functions-and-operators.html#date-and-time-functions), `extract_duration()`, `experimental_strptime()` and `experimental_strftime()`, are now supported. [#9734](https://github.com/cockroachdb/cockroach/pull/9734), [#9762](https://github.com/cockroachdb/cockroach/pull/9762)
