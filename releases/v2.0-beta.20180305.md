...
- [`IMPORT`](../v2.0/import.htmal) jobs can no longer be started if the target table already exists. [#22627][#22627]
...
- Clarified that [password creation](create-and-manage-users.html#user-authentication) is only supported in secure clusters. [#2567](https://github.com/cockroachdb/docs/pull/2567)
