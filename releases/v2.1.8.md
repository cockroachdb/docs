...
~~~shell
$ docker pull cockroachdb/cockroach-unstable:v2.1.8
~~~
...
- Prevent a possible missing row from queries that involved iterator reuse and seeking into the gap between stables bridged by a range tombstone. [#37694][#37694]
