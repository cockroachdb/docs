...
- The hardware options displayed while [creating a cluster](../stable/cockroachcloud-create-your-cluster.html#step-4-select-the-hardware-configuration) have been renamed as "Option 1" and "Option 2".
...
- Documented the [upgrade policy](../stable/cockroachcloud-upgrade-policy.html) for CockroachDB upgrades for CockroachCloud clusters.
