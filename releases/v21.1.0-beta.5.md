...
- The internal representation of the `voter_constraints` [zone configuration](https://www.cockroachlabs.com/docs/v21.1/configure-replication-zones) attribute (new in 21.1) has been altered in a way that is partially incompatible with the representation used by previous 21.1 betas (and the alphas that include this attribute). This means that users who directly set the `voter_constraints` attribute to an empty list will lose those constraints and will have to reset them. [#63674][#63674]
