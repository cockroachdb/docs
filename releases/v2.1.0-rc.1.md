...
- CockroachDB no longer incorrectly and silently accepts a [computed column](../v2.1/computed-columns.html) on the left side of the assignment in a [`ON CONFLICT DO UPDATE SET`](../v2.1/insert.html#on-conflict-clause) clause. [#31280][#31280]
- CockroachDB no longer incorrectly and silently accept a not-fully-added-yet column on the left side of the assignment in a [`ON CONFLICT DO UPDATE SET`](../v2.1/insert.html#on-conflict-clause) clause. [#31280][#31280]
