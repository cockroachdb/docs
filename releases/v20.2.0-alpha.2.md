...
- The docker image available with CockroachDB now includes the GEOS files required to work with [Geospatial types](../v20.2/spatial-data.html) in CockroachDB. [#50362][#50362]
