...
- Implemented a `CREATE SCHEDULE FOR` statement which allows the creation of periodic backup schedules. [#51308][#51308]
...
- Added a `CREATE SCHEDULE FOR` statement. This statement can be used to specify a recurring backup schedule. [#50631][#50631]
