...
~~~ shell
$ docker pull cockroachdb/cockroach-unstable:v20.2.1
~~~

### SQL language changes

- Made a fix that prevents a crash, introduced in the v20.2 series, caused by range scans over virtual tables with virtual indexes.
