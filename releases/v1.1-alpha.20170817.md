...
- New statements `PAUSE JOB`, `RESUME JOB`, and `CANCEL JOB` can be used to control long-running jobs (schema changes and enterprise backup/restore). [#17434](https://github.com/cockroachdb/cockroach/pull/17434)
...
- Updated the [Go-specific transaction code sample](build-a-go-app-with-cockroachdb.html#transaction-with-retry-logic). [#1816](https://github.com/cockroachdb/docs/pull/1816)
