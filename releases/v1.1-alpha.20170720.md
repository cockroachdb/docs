...
- CockroachDB has reverted from `jemalloc` 5.0.1 to 4.5 due to observed memory leaks. [#17016](https://github.com/cockroachdb/cockroach/pull/17016)
...
- The text format of `DECIMAL` values now uses scientific notation when appropriate. [#17029](https://github.com/cockroachdb/cockroach/pull/17029)

### Command-Line Interface Changes

- The `cockroach sql` shell now correctly handles errors that occur once some results have been received. [#17042](https://github.com/cockroachdb/cockroach/pull/17042)
...
- Fixed issues with diagnostic reporting. [#16955](https://github.com/cockroachdb/cockroach/pull/16955)
- Fixed a race in distsql draining. [#17012](https://github.com/cockroachdb/cockroach/pull/17012)

### Performance Improvements

- The `DROP TABLE` command now returns as soon as the table name is no longer in use, instead of waiting for all data to be deleted. [#17016](https://github.com/cockroachdb/cockroach/pull/17016)
...
- The sample [secure Kubernetes configuration](https://github.com/cockroachdb/cockroach/tree/master/cloud/kubernetes) has been updated. [#16740](https://github.com/cockroachdb/cockroach/pull/16740)
