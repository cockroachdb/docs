...
- Added docs on the [cluster and version details](../v1.1/use-the-built-in-sql-client.html#sql-shell-welcome) that are printed upon connecting the built-in SQL shell to a node. [#1714](https://github.com/cockroachdb/docs/pull/1714)
