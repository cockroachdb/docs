...
- The maximum number of nodes was raised to 50 nodes per region and 150 nodes per cluster.
- Updated the **Statements** and **Sessions** pages for 21.1 clusters that are supported by protobufs in v21.1.0.
