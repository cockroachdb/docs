...
This release includes general usability enhancements and bug fixes as well as one main benefit:

- **Easier data migrations from MySQL**: The [`IMPORT`](../v2.1/import.html) feature now supports a subset of MySQL export formats. We will continue to make migrations easier in the alphas leading up to 2.1.
...
- It is now possible to use `ALTER TABLE ... `
