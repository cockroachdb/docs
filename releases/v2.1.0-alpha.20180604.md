...
- [**Easier data migrations from MySQL**](../v2.1/import-data.html#import-from-mysql-dump): The `IMPORT` feature now supports a subset of MySQL export formats. We will continue to make migrations easier in the alphas leading up to 2.1.
