...
- Called out performance-optimized configuration files for [Kubernetes single-cluster deployments](../v2.1/orchestrate-cockroachdb-with-kubernetes.html). [#3827](https://github.com/cockroachdb/docs/pull/3827)
...
- Clarified that [per-replica constraints in replication zones](../v2.1/configure-replication-zones.html#scope-of-constraints) don't need to add up to total replicas. [#3812](https://github.com/cockroachdb/docs/pull/3812)
