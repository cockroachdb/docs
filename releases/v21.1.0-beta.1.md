...
- [`EXPLAIN`](../v21.1/explain.html) now shows estimated row counts for all operators even without `VERBOSE` (except when we don't have statistics for the tables). [#61344][#61344] {% comment %}doc{% endcomment %}
