...
~~~shell
$ docker pull cockroachdb/cockroach:v21.1.0-beta.1
~~~
...
- Added `WITH avro_schema_prefix` option to Avro [changefeeds](../v21.1/create-changefeed.html) to prevent collisions in a shared schema registry [#59710][#59710]
