...
- For a comprehensive summary of features in v20.2, see the [v20.2 GA release notes](../v20.2/v20.2.0.html).
- To upgrade to v20.2, see [Upgrade to CockroachDB v20.2](../v20.2/../v20.2/upgrade-cockroach-version.html).
...
- Fix a bug where [full cluster restore](../v20.2/restore#full-cluster) would sometimes (very rarely) fail after retrying. [#61217][#61217]
