...
**Slow Query Log** | You can now enable a [slow query log](../v20.1/query-behavior-troubleshooting.html#using-the-slow-query-log) to record SQL queries whose service latency exceeds a specified threshold.
...
**Improved follower reads** | [Follower reads](../v20.1/follower-reads.html) are now available for `AS OF SYSTEM TIME` queries at least 4.8 seconds in the past, a much shorter window than the previous 48 seconds.
