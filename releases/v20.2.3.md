...
- Updated design for custom date range selector on the [Cluster > Node Map](../v20.2/ui-cluster-overview-page#node-map-enterprise) and [Metrics](../v20.2/ui-overview-dashboard.html) pages. [#57115][#57115]
...
- Fixed an internal error that could occur when using aggregate and window functions in an [`ORDER BY`](query-order.html) for a `UNION` or `VALUES` clause. [#57521][#57521]
