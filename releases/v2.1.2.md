...
- The type OID "bpchar" is now allowed to provide placeholder string values, for compatibility with PostgreSQL clients that use them. [#32661][#32661]
...
- [`CHANGEFEED`s](../v2.1/create-changefeed.html) with the `experimental-avro` option now work with column `WIDTH`s and `PRECISION`s. [#32484][#32484] {% comment %}doc{% endcomment %}
