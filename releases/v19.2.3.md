...
- The output of [`EXPLAIN`](../v19.2/explain.html) now shows joins where there are no equality columns as "cross" instead of "hash". The hash join can be very expensive and should be avoided. [#43239][#43239]
