...
- Added `localtime`, which by default returns the current time as the [`TIME`](../v20.1/time.html) data type (as opposed to `current_time`, which returns the `TIMETZ` data type). [#44042][#44042]
...
- The CLI commands [`cockroach node decommission`](../v20.1/cockroach-node.html#node-decommission) and [`cockroach node recommission`](cockroach-node.html#node-recommission) now produce a warning on the standard error if one of the node(s) specified is already (d/r)ecommissioned. [#43915][#43915]
...
- [#44617][#44617] [f80ed601c][f80ed601c] util/interval/generic: avoid new allocations in btree benchmarks (Nathan VanBenschoten <nvanbenschoten@gmail.com>)
- [#44452][#44452] [1648b6cad][1648b6cad] roachtest: set MinVersion on tpccbench/nodes=9/cpu=4/chaos/partition (Nathan VanBenschoten <nvanbenschoten@gmail.com>)
- [#43288][#43288] [45e256410][45e256410] ui: network latency page (Vlad Artamonov <carrott9@gmail.com>)
- [#43288][#43288] [edde82247][edde82247] ui: network latency page (Vlad Artamonov <carrott9@gmail.com>)
- [#43288][#43288] [aa9637496][aa9637496] ui: network latency page (Vlad Artamonov <carrott9@gmail.com>)
- [#43288][#43288] [effe1af5b][effe1af5b] ui: network latency page (Vlad Artamonov <carrott9@gmail.com>)
- [#43288][#43288] [545b1e880][545b1e880] ui: network latency page (Vlad Artamonov <carrott9@gmail.com>)
- [#43288][#43288] [cb5e195ba][cb5e195ba] ui: network latency page (Vlad Artamonov <carrott9@gmail.com>)
- [#43288][#43288] [72c530f64][72c530f64] ui: network latency page (Vlad Artamonov <carrott9@gmail.com>)
- [#44381][#44381] [4fb952b3e][4fb952b3e] storage: revert remaining bits of 42969 (Andrei Matei <andrei@cockroachlabs.com>)
- [#44381][#44381] [769511918][769511918] storage: revert remaining bits of 42969 (Andrei Matei <andrei@cockroachlabs.com>)
- [#44381][#44381] [73b0f1a59][73b0f1a59] storage: revert remaining bits of 42969 (Andrei Matei <andrei@cockroachlabs.com>)
- [#44381][#44381] [c05398720][c05398720] storage: revert remaining bits of 42969 (Andrei Matei <andrei@cockroachlabs.com>)
- [#44381][#44381] [c13ade5e3][c13ade5e3] storage: revert remaining bits of 42969 (Andrei Matei <andrei@cockroachlabs.com>)
- [#44381][#44381] [2508dffc0][2508dffc0] storage: revert remaining bits of 42969 (Andrei Matei <andrei@cockroachlabs.com>)
- [#44350][#44350] [3a4b90598][3a4b90598] storage: revert "storage: rationalize server-side refreshes and fix bugs" (Andrei Matei <andrei@cockroachlabs.com>)
- [#44246][#44246] [33b9b4fa8][33b9b4fa8] build: fix teamcity-compose script (Matt Jibson <matt.jibson@gmail.com>)
- [#44224][#44224] [1142d0440][1142d0440] sql/sqlbase: avoid various allocations during column family span splitting (Nathan VanBenschoten <nvanbenschoten@gmail.com>)
- [#44224][#44224] [54865759a][54865759a] sql/sqlbase: avoid various allocations during column family span splitting (Nathan VanBenschoten <nvanbenschoten@gmail.com>)
- [#44172][#44172] [be5389306][be5389306] Include "/cockroach" into PATH in Docker image (Vlad Artamonov <carrott9@gmail.com>)
- [#42644][#42644] [5c7ebc14f][5c7ebc14f] ui: fix mixed units in tooltips (Vlad Artamonov <carrott9@gmail.com>)
- [#43914][#43914] [b2203f131][b2203f131] ui: date picker follow up (Vlad Artamonov <carrott9@gmail.com>)
- [#43914][#43914] [9918f7078][9918f7078] ui: date picker follow up (Vlad Artamonov <carrott9@gmail.com>)
- [#43914][#43914] [fb55f0cd7][fb55f0cd7] ui: date picker follow up (Vlad Artamonov <carrott9@gmail.com>)
- [#43941][#43941] [6b25d5578][6b25d5578] sql: add ZONECONFIG privilege for allowing users to edit zone config at the database level (richardjcai <caioftherichard@gmail.com>)
- [#43948][#43948] [5fb421662][5fb421662] sql/opt/memo: avoid bytes.Equal in hasher.IsStringEqual (Nathan VanBenschoten <nvanbenschoten@gmail.com>)
- [#43815][#43815] [50c61deda][50c61deda] storage: remove unnecessary flaky cases in TestPushTxnHeartbeatTimeout (Nathan VanBenschoten <nvanbenschoten@gmail.com>)
