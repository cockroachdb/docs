...
-  Cleanup partially restored data when an enterprise [RESTORE](../v1.2/restore.html) fails or is canceled. [#19578](https://github.com/cockroachdb/cockroach/pull/19578)
