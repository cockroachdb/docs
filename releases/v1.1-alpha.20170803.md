...
- Retryable errors that were encountered by the first batch of statements in a transaction but were deferred and only returned to the client at COMMIT time are now handled transparently by no longer deferring them and automatically retrying the first batch. [#16874](https://github.com/cockroachdb/cockroach/pull/16874)
