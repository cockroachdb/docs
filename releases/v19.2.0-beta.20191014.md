...
- Documented the [`--watch` flag for the `cockroach sql` cli command](../v19.2/use-the-built-in-sql-client.html#repeat-a-sql-statement), which repeats the SQL statements specified with `--execute` or `-e` until a SQL error occurs or the process is terminated. [#5543][#5543]
