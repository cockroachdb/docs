---
title: What&#39;s New in v20.1.0-alpha.20200113
toc: true
summary: Additions and changes in CockroachDB version v20.1.0-alpha.20200113 since version v20.1.0-alpha20191216
---
...
<div id="os-tabs" class="clearfix">
    <a href="https://binaries.cockroachdb.com/cockroach-v20.1.0-alpha.20200113.darwin-10.9-amd64.tgz"><button id="mac" data-eventcategory="mac-binary-release-notes">Mac</button></a>
    <a href="https://binaries.cockroachdb.com/cockroach-v20.1.0-alpha.20200113.linux-amd64.tgz"><button id="linux" data-eventcategory="linux-binary-release-notes">Linux</button></a>
    <a href="https://binaries.cockroachdb.com/cockroach-v20.1.0-alpha.20200113.windows-6.2-amd64.zip"><button id="windows" data-eventcategory="windows-binary-release-notes">Windows</button></a>
    <a href="https://binaries.cockroachdb.com/cockroach-v20.1.0-alpha.20200113.src.tgz"><button id="source" data-eventcategory="source-release-notes">Source</button></a>
</div>
...
~~~shell
$ docker pull cockroachdb/cockroach-unstable:v20.1.0-alpha.20200113
~~~
...
- Users [`GRANT`ing](../v20.1/grant.html) and [`REVOKE`ing](../v20.1/revoke.html) admin roles must be a member of the admin role with `ADMIN OPTION` now. This check was previously bypassed. [#41218][#41218]
