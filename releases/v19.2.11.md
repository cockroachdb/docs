...
- The [Cluster Node Map](../v19.2/admin-ui-cluster-overview-page.html#node-map-enterprise) and the [Debug Page](../v19.2/admin-ui-debug-pages.html) that lists cluster localities are now again available to non-admin users. This fixes a bug introduced in v19.2.3. [#53332][#53332]
