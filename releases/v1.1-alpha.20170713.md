...
redirect_from: /v1.1-alpha.20170713.html
---
...
- Improved the certificate generation workflow in the [Manual Deployment](../v1.1/manual-deployment.html) and [Cloud Deployment](../v1.1/cloud-deployment.html) tutorials. [#1691](https://github.com/cockroachdb/docs/pull/1691)
