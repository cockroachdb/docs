...
- [Backups](../v21.2/backup.html) taken while a cluster contains a mix of v21.2 and v21.1 nodes may fail. Upgrading the entire cluster to v21.2 should resolve the issues. See [technical advisory 72839](../advisories/a72839.html) for more information about possible remediations. The error returned in this case now also directs the user to the technical advisory. [#72880][#72880]
