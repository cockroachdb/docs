...
- Added the [Build a Python app with Kubernetes on Managed CockroachDB](..managed/v19.1/managed-build-a-python-app-with-kubernetes.html) tutorial for running a Python app on a Managed CockroachDB cluster using a local Kubernetes cluster. [#4918](https://github.com/cockroachdb/docs/pull/4918)
