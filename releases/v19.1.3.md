...
- Added the [Build a Python app with Kubernetes on CockroachCloud](../managed/v19.1/cockroachcloud-build-a-python-app-with-kubernetes.html) tutorial for running a Python app on a CockroachCloud cluster using a local Kubernetes cluster. [#4918](https://github.com/cockroachdb/docs/pull/4918)
