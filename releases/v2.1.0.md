...
With the release of CockroachDB v2.1, we've made significant performance improvements, enhanced our troubleshooting workflows in the Web UI, and made it easier to migrate to CockroachDB from MySQL and Postgres.
