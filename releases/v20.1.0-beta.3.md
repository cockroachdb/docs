...
- It is now possible to use [`GRANT`](../v20.1/grant.html) and [`REVOKE`](../v20.1/revoke.html) to add users to roles without a valid license. This change aims to enable use of the Admin UI and other privileged features without a license. [#45325][#45325] {% comment %}doc{% endcomment %}
