...
- The `pg_backend_pid`, `obj_description`, and `shobj_description` [functions](../v1.0/functions-and-operators.html) and the `pg_inherits`, `pg_foreign_table`, and `pg_foreign_server` tables now have dummy implementations for compatibility with some clients. [#13097](https://github.com/cockroachdb/cockroach/pull/13097) [#13181](https://github.com/cockroachdb/cockroach/pull/13181)
