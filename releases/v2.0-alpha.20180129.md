...
<div id="os-tabs" class="clearfix">
    ...
    <a href="https://binaries.cockroachdb.com/cockroach-v2.0-alpha.20180129.windows-6.2-amd64.zip"><button id="windows" data-eventcategory="windows-binary-release-notes">Windows</button></a>
...
- `DROP SEQUENCE` cannot drop a `SEQUENCE` that is currently in use. [#21364][#21364]
...
- Speed up the performance of low-level delete operations. [#21507][#21507]
