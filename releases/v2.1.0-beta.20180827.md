...
- Added a tutorial on [orchestrating CockroachDB across multiple Kubernetes clusters in different regions](../v2.1/orchestrate-cockroachdb-with-kubernetes-multi-region.html). [#3558](https://github.com/cockroachdb/docs/pull/3558) 
