...
- Fixed a bug that caused the [optimizer](../v21.1/cost-based-optimizer.html) to erroneously discard [`WHERE` filters](../v21.1/selection-queries.html) when executing prepared statements, causing incorrect results to be returned. This bug was present since [version 21.1.9](v21.1.9.html). [#71116][#71116].
