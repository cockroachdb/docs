...
~~~shell
$ docker pull cockroachdb/cockroach-unstable:v20.1.15
~~~
...
- Fixed a rare issue that caused [replica divergence](../v20.1/architecture/replication-layer). When it occurred, it was reported by the replica consistency checker, typically within 24 hours of occurrence, which would terminate the nodes. [#63475][#63475]
