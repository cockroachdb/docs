...
redirect_from: /beta-20160714.html
---
...
- Docs on [installing CockroachDB in Docker](../v1.0/install-cockroachdb.html) now recommend using the new native Docker applications for Mac and Windows.
