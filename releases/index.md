        ...
        {% else %} {% comment %} Add download links for all non-withdrawn versions. {% endcomment %}
            <td class="os-release-cell">
                ...
                <section class="filter-content" data-scope="mac">
                    <a class="os-release-link" href="https://binaries.cockroachdb.com/cockroach-{{ r.version }}.darwin-10.9-amd64.tgz">Precompiled 64-bit Binary (full)</a>
                    {% if r.has_sql_only != "false" %}
                ...
                {% if r.no_windows == "true" %}
                    N/A
                {% else %}
                    <a class="os-release-link" href="https://binaries.cockroachdb.com/cockroach-{{ r.version }}.windows-6.2-amd64.zip">Precompiled 64-bit Binary (full)</a>
                    {% if r.has_sql_only != "false" %}
