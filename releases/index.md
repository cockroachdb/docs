...
Cockroach Labs uses a three-place numbering scheme to designate [production releases](#production-releases) of CockroachDB. The format is `YY.R.PP`, where `YY` indicates the year, `R` indicates release with “1” for Spring and “2” for Fall, and `PP` indicates the patch release version. An example would be Version 20.1.1 (abbreviated v20.1.1).
