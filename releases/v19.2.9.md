...
- [Schema changes](schema-changes.html) are now logged in greater detail. [#50375][#50375]

### Bug fixes

- Fixed a bug that occurred during [incremental backups](backup.html#incremental-backups) with revision history on a database (or full cluster) when a table in the database being backed up was dropped. When other tables were later created, dropped, or altered, future incremental backups would return an error. This is now fixed. [#50208][#50208]
- Fixed a bug in [`TRUNCATE`](truncate.html) that could leave tables in a state where they cannot be renamed. [#50714][#50714] [#50756][#50756]#50756]
