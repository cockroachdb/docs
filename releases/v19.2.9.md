...
- [Schema changes](../v19.2/schema-changes.html) are now logged in greater detail. [#50375][#50375]
...
- Fixed a bug in [`TRUNCATE`](../v19.2/truncate.html) that could leave tables in a state where they cannot be renamed. [#50714][#50714] [#50756][#50756]#50756]
