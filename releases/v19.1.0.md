...
Feature | Description
--------|------------
[**Managed CockroachDB Console**](../cockroachcloud/v19.1/cockroachcloud-sign-up-for-a-cluster.html) | Paid managed CockroachDB customers can now sign into their organization's account, view the connection string details, add and edit their IP whitelists on the management console.
