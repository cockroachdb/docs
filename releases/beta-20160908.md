...
redirect_from: /beta-20160908.html
---
...
- Updated [troubleshooting](../v1.0/troubleshoot.html) docs to cover cases when nodes won't join a cluster. [#610](https://github.com/cockroachdb/docs/pull/610) 
