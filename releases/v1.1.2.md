...
- Added a [known limitation](known-limitations.html#downgrading-to-v1-1-0-from-a-later-v1-1-x-patch-release) about downgrading to v1.1.0 from a later v1.1.x patch release. [#2095](https://github.com/cockroachdb/docs/pull/2095)
