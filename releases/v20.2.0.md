...
- [Interleaved tables](../v20.2/interleave-in-parent.html) will be deprecated in a future release.
    ...
    After upgrading to v20.2, we recommend that you de-interleave any existing interleaved tables and replace any existing interleaved secondary indexes. For instructions, see [De-interleave tables](../v20.2/interleave-in-parent.html#de-interleave-tables).
