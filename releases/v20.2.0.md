...
With the release of CockroachDB v20.2, we've made a variety of productivity, management, and performance improvements. Check out a comprehensive [summary of the most significant user-facing changes](#summary) and then [upgrade to CockroachDB v20.2](../v20.2/upgrade-cockroach-version.html).
...
## Download CockroachDB v20.2 Core
...
## Try v20.2 on CockroachCloud

[Get a free cluster](https://cockroachlabs.cloud/signup)

## v20.2 Feature Summary
