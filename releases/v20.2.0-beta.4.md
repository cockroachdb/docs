...
- The display of statement timings in the SQL shell ([`cockroach sql`](../v20.2/cockroach-sql.html) and [`cockroach demo`](../v20.2/cockroach-demo.html)) has been further simplified. [#54765][#54765]
