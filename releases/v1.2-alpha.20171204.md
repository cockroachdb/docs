...
- "nodelocal://" paths in `IMPORT` now default to relative within the "extern" subdirectory of the first store directory, configurable via the new `--external-io-dir` flag. [#19865](https://github.com/cockroachdb/cockroach/pull/19865)
...
- On table creation, [`DEFAULT`](../v1.2/default-value.html) expressions no longer get evaulated. [#20031](https://github.com/cockroachdb/cockroach/pull/20031)
...
- The new `--external-io-dir` flag in [`cockroach start`](../v1.2/start-a-node.html) can be used to configure the location of "nodelocal://" paths in `BACKUP`, `RESTORE`, and `IMPORT`. [#19725](https://github.com/cockroachdb/cockroach/pull/19725)
...
- Avoid overloading the system during cleanup of large transactions. [#19538](https://github.com/cockroachdb/cockroach/pull/19538)
...
- "nodelocal://" paths in `BACKUP`/`RESTORE` now default to relative within the "extern" subdirectory of the first store directory, configurable via the new `--external-io-dir` flag. [#19865](https://github.com/cockroachdb/cockroach/pull/19865)
