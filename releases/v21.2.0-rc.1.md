...
- Non-Admin users of the [DB Console](../v21.2/ui-overview.html) have regained the ability to view the [Cluster Overview page](../v21.2/cluster-overview-page.html). Users without the [Admin role](../v21.2/authorization.html#admin-role) will still see most data about their nodes, but information such as command-line arguments, environment variables, and IP addresses and DNS names of nodes will be hidden. [#71383][#71383]
