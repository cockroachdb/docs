...
- Made the Kafka library used in [change-feeds](../v21.1/stream-data-out-of-cockroachdb-using-changefeeds) configurable using the `kafka_sink_config` option to enable latency versus throughput configurations. [#63361][#63361]
