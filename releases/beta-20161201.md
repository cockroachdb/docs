...
redirect_from: /beta-20161201.html
---
...
- Added interactive asciicasts to getting started tutorials: [#861](https://github.com/cockroachdb/docs/pull/861) [#865](https://github.com/cockroachdb/docs/pull/865) [#888](https://github.com/cockroachdb/docs/pull/888)
    - [Start a Local Insecure Cluster from Binary](../v1.0/start-a-local-cluster.html)
    - [Start a Local Secure Cluster](../v1.0/secure-a-cluster.html)
    - [Start a Local Insecure Cluster in Docker](../v1.0/start-a-local-cluster-in-docker.html)
...
- Updated `RENAME` statement documentation to clarify that you can't rename a [database](../v1.0/rename-database.html), [table](../v1.0/rename-table.html), [column](../v1.0/rename-column.html), or [index](../v1.0/rename-index.html) reference by a [view](../v1.0/views.html). [#873](https://github.com/cockroachdb/docs/pull/873)
