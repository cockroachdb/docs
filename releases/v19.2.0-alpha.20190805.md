...
- Updated the [`BACKUP`](../v19.2/backup.html) and [`RESTORE`](../v19.2/backup.html) docs to specify that the `system.users` table is not included with a backup. To restore the table, you must explicitly include it. [#5072](https://github.com/cockroachdb/docs/pull/5072)
