...
- Improved the output of [`cockroach node status`](../v2.1/view-node-status.html) to include separate `is_available` and `is_live` columns. [#30268][#30268]
...
- Bilal Akhtar
- Ridwan Sharif (first-time contributor)
