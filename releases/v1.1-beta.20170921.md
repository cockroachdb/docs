...
- Fixed bugs in sideloaded raft storage (used by [`RESTORE`](../v1.1/restore.html) and `IMPORT`). [#18409](https://github.com/cockroachdb/cockroach/pull/18409) [#18466](https://github.com/cockroachdb/cockroach/pull/18466) [#18481](https://github.com/cockroachdb/cockroach/pull/18481)
...
- Documentated how to [perform a rolling upgrade from v1.0.x to v1.1](../v1.1/upgrade-cockroach-version.html). [#1899](https://github.com/cockroachdb/docs/pull/1899)
