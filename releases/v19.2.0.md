...
In addition to v19.2, we're launching **Cockroach University**, with our first entirely self-paced, video-based course on getting started with CockroachDB. [Sign up now](https://university.cockroachlabs.com/catalog) to spin up a cluster on your computer, learn many of the features that set us apart from other databases, and use tools like our Admin UI and SQL shell to solve a set of challenging hands-on exercises.<br><br>
