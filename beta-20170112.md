...
- Added a Java code sample for transaction retry logic to the [Build a Java App with CockroachDB](build-a-java-app-with-cockroachdb.html) tutorial. [#987](https://github.com/cockroachdb/docs/pull/987)
