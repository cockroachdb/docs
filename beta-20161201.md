...
- The `current_schema` [function](functions-and-operators.html)n is now supported. [#10707](https://github.com/cockroachdb/cockroach/pull/10707)
...
- Expanded the [cloud deployment](cloud-deployment.html) documentation to cover secure clusters: 
