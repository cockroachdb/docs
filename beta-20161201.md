...
- Adding a [`FOREIGN KEY`](constraints.html#foreign-keys) constraint now automatically creates necessary indexes. [#9572](https://github.com/cockroachdb/cockroach/pull/9572)
...
- Added interactive asciicasts to getting started tutorials: [#861](https://github.com/cockroachdb/docs/pull/861) [#865](https://github.com/cockroachdb/docs/pull/865) [#888](https://github.com/cockroachdb/docs/pull/888)
    - [Start a Local Cluster from Binary](start-a-local-cluster.html) 
    - [Start a Local Cluster in Docker](start-a-local-cluster-in-docker.html) 
    - [Secure a Local Cluster](secure-a-cluster.html)
...
- Updated [`FOREIGN KEY`](constraints.html#foreign-keys) constraint documentation to clarify that creating a table with a foreign key now automatically creates an index for you. [#895](https://github.com/cockroachdb/docs/pull/895)
...
- Fixed the Rust code samples on [Build a Test App](build-a-test-app.html). [#863](https://github.com/cockroachdb/docs/pull/863) 
