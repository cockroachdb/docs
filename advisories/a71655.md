...
The fix has been applied to maintenance version 20.2.18. The fix will be applied to an upcoming patch to 21.1. See [Mitigation](#mitigation) for the steps to avoid the issue until a patch is released.
