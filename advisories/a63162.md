...
In addition to resolving the issue when creating incremental backups, this fix can detect invalid indexes at restore time, and in many cases, correct them automatically. Users may see a performance impact in this case.
