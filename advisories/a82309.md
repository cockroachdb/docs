...
Cockroach Labs has discovered a bug that results in changefeeds failing to emit data during or after an upgrade to v22.1.0. This failure may be relatively silent, in that no errors will appear in the logs.
