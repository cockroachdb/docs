...
{{site.data.alerts.callout_info}}<span id="party">🎉</span>CockroachDB 1.0 is now available! Click <a href="url-to-blog-post">here</a> for details.{{site.data.alerts.end}}
