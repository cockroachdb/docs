...
- `FILTER` clauses for [aggregate functions](functions-and-operators.html#aggregate-functions) are now supported. [#10146](https://github.com/cockroachdb/cockroach/pull/10146)
