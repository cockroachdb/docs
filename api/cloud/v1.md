...
<div class="apidocs">
  ...
  <rapi-doc spec-url = "api-spec.json"
    ...
    <div slot="nav-logo" style="display: flex; align-items: center; justify-content: center;"> 
      <img src = "https://d33wubrfki0l68.cloudfront.net/1c17b3053b29646cdddc53965186a02179b59842/69991/docs/images/cockroachlabs-logo-170.png" style="width:170px; margin-right: 20px"> <span style="color:#fff"> <b>nav-logo</b> slot </span>
    </div>
  </rapi-doc>
</div>
