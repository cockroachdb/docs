...
<Tabs>
    ...
    <Note>
    To connect to CockroachDB with Hibernate, you must specify the [CockroachDB Hibernate dialect](/docs/v25.4/install-client-drivers?filters=java#hibernate) in your `hibernate.cfg.xml` configuration file.
    </Note>
