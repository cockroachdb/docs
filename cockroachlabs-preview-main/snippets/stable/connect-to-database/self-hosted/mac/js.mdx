...
<Tabs>
    ...
    <Tab title="TypeORM">
        ...
        - `CA_CERT` is an environment variable set to the root certificate. You can generate this certificate with [`cockroach cert create-ca`](/docs/v26.1/cockroach-cert#subcommands), or you can use a [custom CA cert](/docs/v26.1/create-security-certificates-custom-ca).
        - `CLIENT_KEY` is an environment variable set to the [client key](/docs/v26.1/cockroach-cert#client-key-and-certificates) for the user connecting to the cluster. You can generate this key with [`cockroach cert create-client`](/docs/v26.1/cockroach-cert#subcommands).
        - `CLIENT_CERT` is an environment variable set to the [client certificate](/docs/v26.1/cockroach-cert#client-key-and-certificates) for the user connecting to the cluster. You can generate this certificate with [`cockroach cert create-client`](/docs/v26.1/cockroach-cert#subcommands).
