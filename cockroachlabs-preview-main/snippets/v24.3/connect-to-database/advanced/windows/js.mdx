...
<Tabs>
    ...
    <Tab title="TypeORM">
        ...
        - `CA_CERT` is an environment variable set to the root certificate [downloaded from the CockroachDB Cloud Console](/docs/v24.3/cockroachcloud/authentication#node-identity-verification).
