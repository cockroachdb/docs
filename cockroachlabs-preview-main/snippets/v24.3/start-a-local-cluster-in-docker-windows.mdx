...
- For quick SQL testing or app development, consider [running a single-node cluster](/docs/v24.3/cockroach-start-single-node) instead.
...
The CockroachDB [DB Console](/docs/v24.3/ui-overview) gives you insight into the overall health of your cluster as well as the performance of the client workload.
