...
<Tabs>
    <Tab title="Psycopg2">
        ...
        For instructions on downloading a CA certificate from the CockroachDB Cloud Console, see [Connect to a CockroachDB Basic Cluster](/docs/v24.1/cockroachcloud/connect-to-a-basic-cluster) or [Connect to a CockroachDB Standard Cluster](/docs/v24.1/cockroachcloud/connect-to-your-cluster).
        </Note>
