...
<Note>
Configurable managed backup settings are available in all <a href="/docs/VERSION_PLACEHOLDER/releases/release-support-policy#supported-versions" data-versioned="true">supported versions</a> of CockroachDB on Standard and Advanced clusters.
</Note>
...
3. You can restore a backup to the same cluster.
    ...
    <Note>
    If you need to restore data into a new or different cluster, use <a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/take-and-restore-self-managed-backups" data-versioned="true">self-managed backups</a> or <a href="/docs/VERSION_PLACEHOLDER/support-resources" data-versioned="true">contact support</a>.
    </Note>
4. Click **Restore**.
...
You can use the <a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/provision-a-cluster-with-terraform" data-versioned="true">CockroachDB Cloud Terraform provider</a> to specify managed backup settings in Standard clusters.
