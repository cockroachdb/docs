...
- <a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/plan-your-cluster-basic" data-versioned="true">
    Plan a CockroachDB Basic cluster
  </a>
- <a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/plan-your-cluster" data-versioned="true">
    Plan a CockroachDB Standard cluster
  </a>
- <a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/plan-your-cluster-advanced" data-versioned="true">
    Plan a CockroachDB Advanced cluster
  </a>
...
A CockroachDB Standard cluster maintains a minimum of three <a href="/docs/VERSION_PLACEHOLDER/architecture/replication-layer" data-versioned="true">replicas</a> of your data. The second and third replicas are included, with no additional storage charge. If you add further replicas, each will incur a storage cost equal to that of the first replica—the logical database size.
...
are charged per-GiB storage rates that vary per cloud provider, region, and backup
<a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/managed-backups#frequency" data-versioned="true">
  frequency
</a>
(daily vs. more than daily). The per-GiB unit prices are tiered, based on the amount of backup data stored: Less than 5
GiB-Month, 5 to 100 GiB-Month, 100 to 500 GiB-Month, 500 to 1000 GiB-Month, or 1000 GiB-Month and higher.

When you delete a cluster, Cockroach Labs will retain the backups for the <a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/managed-backups#retention" data-versioned="true">configured retention time</a>, during which backup storage costs will still apply. If you want to delete retained managed backups, contact the <a href="/docs/VERSION_PLACEHOLDER/support-resources" data-versioned="true">Cockroach Labs Support team</a>.

<a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/take-and-restore-self-managed-backups" data-versioned="true">
  Self-managed backups
</a>
to your own object storage are charged a per-GiB fee for the data transferred. This option provides an advanced backup
scheduler and additional control over backup storage placement.
...
- Data egress from the CockroachDB Cloud cluster via supported <a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/connect-to-your-cluster#establish-private-connectivity" data-versioned="true">private connectivity</a> services to a private endpoint in another region.
- <a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/backup-and-restore-overview#managed-backups" data-versioned="true">
    Managed backup
  </a>
  and
  <a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/take-and-restore-self-managed-backups" data-versioned="true">
  ...
  data transfer to another region.
...
For change data capture (CDC), all CockroachDB Cloud clusters can use <a href="/docs/VERSION_PLACEHOLDER/how-does-a-changefeed-work" data-versioned="true">changefeeds</a>.

The main feature of <a href="/docs/VERSION_PLACEHOLDER/change-data-capture-overview" data-versioned="true">CockroachDB CDC</a> is the _changefeed_, which targets an allowlist of tables, known as _watched tables_.
...
are charged per-GiB storage rates that vary per cloud provider, region, backup
<a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/managed-backups#frequency" data-versioned="true">
  frequency
</a>
(daily vs. more than daily), and whether the Advanced security add-on is enabled. The per-GiB unit prices are tiered,
based on the amount of backup data stored: Less than 5 GiB-Month, 5 to 100 GiB-Month, 100 to 500 GiB-Month, 500 to 1000
GiB-Month, or 1000 GiB-Month and higher.

<a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/take-and-restore-self-managed-backups" data-versioned="true">
  Self-managed backups
</a>
to your own object storage are charged a per-GiB fee for the data transferred. The rate varies depending on whether the
Advanced security add-on is enabled. Self-managed backups offer additional control over backup storage placement, and an
...
- Data transfer required to support queries that involve lookups on nodes in another region.
- CockroachDB replication across nodes that are in different regions.
- Data egress, including <a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/egress-private-endpoints" data-versioned="true">changefeed and backup traffic egress</a>, from the CockroachDB Cloud cluster via supported <a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/connect-to-your-cluster#establish-private-connectivity" data-versioned="true">private connectivity</a> services to a private endpoint in another region.
- <a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/backup-and-restore-overview#managed-backups" data-versioned="true">
    Managed backup
  </a>
  and
...
Data sent from a CockroachDB Advanced cluster over an <a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/egress-private-endpoints" data-versioned="true">egress connection to a private endpoint</a>, such as changefeeds and logs, are charged according to [data transfer costs](#data-transfer).
...
For CockroachDB Basic, compute cost is usage-based through its consumption of <a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/resource-usage-basic#understand-resource-consumption" data-versioned="true">Request Units</a>. For customers who pay monthly, the first <a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/plan-your-cluster-basic#free-vs-paid-usage" data-versioned="true">&#36;15 of resource consumption</a> (equivalent to 50 million Request Units and 10 GiB of storage) spent each month is free and credited back on their monthly invoice.
