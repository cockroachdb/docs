...
When you sign up for CockroachDB Cloud, your new organization's account starts with $400 in free credits, allowing you to try the product at no cost. Pay-as-you-go accounts with CockroachDB Basic clusters are also elegible for an additional $15 per month of resource utilization.
...
Free trial credits are applied to the first $400 in costs for all clusters created in your organization, regardless of the plan: CockroachDB Standard, CockroachDB Advanced, or CockroachDB Basic.
...
## Monthly free Basic credits

Accounts with CockroachDB Basic clusters receive $15 of free resource utilization (equivalent to 50 million <a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/plan-your-cluster-basic#request-units" data-versioned="true">Request Units</a> and 10 GiB storage) across all clusters. This benefit applies as a $15 credit on their monthly invoice.
...
To understand how costs vary per tier and begin to estimate future expenses, refer to <a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/costs" data-versioned="true">CockroachDB Cloud Costs</a>.

## Add payment methods

During the free trial, a <a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/authorization" data-versioned="true">Billing Coordinator</a> can <a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/billing-management" data-versioned="true">add a credit card</a> in the CockroachDB Cloud Console or subscribe through the <a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/billing-management?filters=aws" data-versioned="true">AWS Marketplace</a> or <a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/billing-management?filters=gcp" data-versioned="true">Google Cloud Marketplace</a> for monthly, pay-as-you-go payment. You can also [contact Sales](https://cockroachlabs.com/contact-sales) during the trial to learn more about CockroachDB and consider an initial purchse of credits as part of an annual or multi-year contract.
...
<a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/create-an-account" data-versioned="true">Create an Account</a> or learn more about <a href="/docs/VERSION_PLACEHOLDER/cockroachcloud" data-versioned="true">CockroachDB Cloud</a>.