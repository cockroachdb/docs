...
CockroachDB Cloud captures audit logs when many types of events occur, such as when a cluster is created or when a user is added to or removed from an organization. Any user in an organization with a <a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/managing-access#manage-service-accounts" data-versioned="true">service account</a> assigned the <a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/authorization#organization-admin" data-versioned="true">Organization Admin role</a> can export these audit logs using the <a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/cloud-api#cloud-audit-logs" data-versioned="true">`auditlogevents` endpoint</a> of the <a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/cloud-api" data-versioned="true">Cloud API</a>.

This page provides some examples of exporting CockroachDB Cloud organization audit logs. For details about each parameter and its defaults, refer to the API specification for the <a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/cloud-api#cloud-audit-logs" data-versioned="true">`auditlogevents` endpoint</a>.
...
- Learn more about the <a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/cloud-api" data-versioned="true">Cloud API</a>
