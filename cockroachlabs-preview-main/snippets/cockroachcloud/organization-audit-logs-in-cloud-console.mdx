...
1.  Navigate to the [CockroachDB Cloud Console](https://cockroachlabs.cloud/) and log in as a user with the <a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/authorization#organization-admin" data-versioned="true">Organization Admin role</a>.
2.  In the top navigation bar, open the **Organization** menu and select **Audit Logs**.
...
-   **User email**: Select one or more email addresses from the list of <a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/managing-access#manage-an-organizations-users" data-versioned="true">organization members</a> (optional).
...
-   **User**: Displays the following:
    ...
    -   <a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/managing-access#manage-service-accounts" data-versioned="true">Service account name</a> if **Source** is `API`. _(Note: You cannot filter by service account name.)_
    -   `CRL User` if **Source** is `CRL`. _(Note: You cannot filter by `CRL User`.)_
-   **Action name**
...
-   **Source**: Displays the following:
    ...
    -   `UI` for actions executed in the Cloud Console.
    -   `API` for actions executed via the <a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/cloud-api" data-versioned="true">Cloud API</a>.
...
-   <a href="/docs/VERSION_PLACEHOLDER/cockroachcloud/cloud-org-audit-logs" data-versioned="true">Export CockroachDB Cloud Organization Audit Logs</a>