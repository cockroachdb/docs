export const SelectionQueries25 = () => {
  return (
    <Frame>
      <div
        className="not-prose"
...
<text class="terminal" x="341" y="97">DISTINCT</text><a xlink:href="/docs/v25.2/sql-grammar#select_clause" xlink:title="select_clause">
