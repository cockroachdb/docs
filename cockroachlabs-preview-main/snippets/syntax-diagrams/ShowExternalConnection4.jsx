export const ShowExternalConnection4 = () => {
  return (
    <Frame>
      <div
        className="not-prose"
...
<text class="terminal" x="253" y="65">CONNECTION</text><a xlink:href="/docs/v25.4/sql-grammar#string_or_placeholder" xlink:title="string_or_placeholder">
