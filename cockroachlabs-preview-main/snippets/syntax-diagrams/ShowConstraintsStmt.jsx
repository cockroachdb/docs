export const ShowConstraintsStmt = () => {
  return (
    <Frame>
      <div
        className="not-prose"
...
<text class="terminal" x="303" y="21">FROM</text><a xlink:href="#table_name" xlink:title="table_name">
<rect height="32" width="96" x="375" y="3"></rect>
<rect class="nonterminal" height="32" width="96" x="373" y="1"></rect>
<text lengthAdjust="spacingAndGlyphs" textLength="72" font-size="11" class="nonterminal" x="385" y="21">table_name</text></a><a xlink:href="#with_comment" xlink:title="with_comment">
