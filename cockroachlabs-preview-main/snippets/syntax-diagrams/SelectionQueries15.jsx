export const SelectionQueries15 = () => {
  return (
    <Frame>
      <div
        className="not-prose"
...
<text class="terminal" x="341" y="97">DISTINCT</text><a xlink:href="/docs/v24.1/sql-grammar#select_clause" xlink:title="select_clause">
