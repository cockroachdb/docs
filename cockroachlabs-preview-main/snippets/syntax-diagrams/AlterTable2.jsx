...
<text class="terminal" x="447" y="131">EXISTS</text><a xlink:href="/docs/stable/sql-grammar#column_name" xlink:title="column_name">
<rect height="32" width="108" x="549" y="81"></rect>
<rect class="nonterminal" height="32" width="108" x="547" y="79"></rect>
<text lengthAdjust="spacingAndGlyphs" textLength="84" font-size="12" class="nonterminal" x="559" y="99">column_name</text></a><a xlink:href="/docs/stable/sql-grammar#typename" xlink:title="typename">
<rect height="32" width="84" x="677" y="81"></rect>
<rect class="nonterminal" height="32" width="84" x="675" y="79"></rect>
<text lengthAdjust="spacingAndGlyphs" textLength="60" font-size="12" class="nonterminal" x="687" y="99">typename</text></a><a xlink:href="/docs/stable/sql-grammar#col_qualification" xlink:title="col_qualification">
...
<text lengthAdjust="spacingAndGlyphs" textLength="102" font-size="10" class="nonterminal" x="571" y="207">constraint_name</text><a xlink:href="/docs/stable/sql-grammar#constraint_elem" xlink:title="constraint_elem">
...
<text class="terminal" x="215" y="315">COLUMN</text><a xlink:href="/docs/stable/sql-grammar#column_name" xlink:title="column_name">
...
<text class="terminal" x="201" y="435">COLUMN</text><a xlink:href="/docs/stable/sql-grammar#column_name" xlink:title="column_name">
...
<text class="terminal" x="631" y="447">UPDATE</text><a xlink:href="/docs/stable/sql-grammar#a_expr" xlink:title="a_expr">
...
<text class="terminal" x="467" y="875">ADD</text><a xlink:href="/docs/stable/sql-grammar#generated_always_as" xlink:title="generated_always_as">
<rect height="32" width="160" x="547" y="857"></rect>
<rect class="nonterminal" height="32" width="160" x="545" y="855"></rect>
<text lengthAdjust="spacingAndGlyphs" textLength="136" font-size="11" class="nonterminal" x="557" y="875">generated_always_as</text></a><a xlink:href="/docs/stable/sql-grammar#generated_by_default_as" xlink:title="generated_by_default_as">
...
<text class="terminal" x="905" y="907">(</text><a xlink:href="/docs/stable/sql-grammar#opt_sequence_option_list" xlink:title="opt_sequence_option_list">
...
<text class="terminal" x="1155" y="907">)</text><a xlink:href="/docs/stable/sql-grammar#set_generated_always" xlink:title="set_generated_always">
<rect height="32" width="164" x="459" y="945"></rect>
<rect class="nonterminal" height="32" width="164" x="457" y="943"></rect>
<text lengthAdjust="spacingAndGlyphs" textLength="140" font-size="11" class="nonterminal" x="469" y="963">set_generated_always</text></a><a xlink:href="/docs/stable/sql-grammar#set_generated_default" xlink:title="set_generated_default">
<rect height="32" width="166" x="459" y="989"></rect>
<rect class="nonterminal" height="32" width="166" x="457" y="987"></rect>
<text lengthAdjust="spacingAndGlyphs" textLength="142" font-size="10" class="nonterminal" x="469" y="1007">set_generated_default</text></a><a xlink:href="/docs/stable/sql-grammar#identity_option_list" xlink:title="identity_option_list">
...
<text class="terminal" x="647" y="1095">TYPE</text><a xlink:href="/docs/stable/sql-grammar#typename" xlink:title="typename">
...
<text class="terminal" x="845" y="1127">COLLATE</text><a xlink:href="/docs/stable/sql-grammar#collation_name" xlink:title="collation_name">
...
<text class="terminal" x="1123" y="1127">USING</text><a xlink:href="/docs/stable/sql-grammar#a_expr" xlink:title="a_expr">
...
<text class="terminal" x="543" y="1215">(</text><a xlink:href="/docs/stable/sql-grammar#index_params" xlink:title="index_params">
...
<text class="terminal" x="1045" y="1215">(</text><a xlink:href="/docs/stable/sql-grammar#storage_parameter_key" xlink:title="storage_parameter_key">
...
<text class="terminal" x="389" y="1323">EXISTS</text><a xlink:href="/docs/stable/sql-grammar#column_name" xlink:title="column_name">
...
<text class="terminal" x="471" y="1575">(</text><a xlink:href="/docs/stable/sql-grammar#name_list" xlink:title="name_list">
...
<text class="terminal" x="665" y="1575">(</text><a xlink:href="/docs/stable/sql-grammar#list_partitions" xlink:title="list_partitions">
...
<text class="terminal" x="485" y="1619">(</text><a xlink:href="/docs/stable/sql-grammar#name_list" xlink:title="name_list">
...
<text class="terminal" x="679" y="1619">(</text><a xlink:href="/docs/stable/sql-grammar#range_partitions" xlink:title="range_partitions">
...
<text class="terminal" x="163" y="1751">(</text><a xlink:href="/docs/stable/sql-grammar#storage_parameter_key" xlink:title="storage_parameter_key">
...
<text class="terminal" x="181" y="1839">(</text><a xlink:href="/docs/stable/sql-grammar#storage_parameter_key" xlink:title="storage_parameter_key">
...
<text class="terminal" x="587" y="1751">)</text><a xlink:href="/docs/stable/sql-grammar#table_rls_mode" xlink:title="table_rls_mode">
