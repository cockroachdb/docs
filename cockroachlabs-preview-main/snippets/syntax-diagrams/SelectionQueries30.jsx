export const SelectionQueries30 = () => {
  return (
    <Frame>
      <div
        className="not-prose"
...
<polygon points="17 17 9 13 9 21"></polygon><a xlink:href="/docs/v25.4/sql-grammar#select_clause" xlink:title="select_clause">
...
<text class="terminal" x="341" y="97">DISTINCT</text><a xlink:href="/docs/v25.4/sql-grammar#select_clause" xlink:title="select_clause">
