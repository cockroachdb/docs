...
<text class="terminal" x="169" y="53">ALL</text><a xlink:href="/docs/v25.4/sql-grammar#opt_target_list" xlink:title="opt_target_list">
...
<text class="terminal" x="335" y="141">(</text><a xlink:href="/docs/v25.4/sql-grammar#a_expr" xlink:title="a_expr">
...
<text class="terminal" x="505" y="141">)</text><a xlink:href="/docs/v25.4/sql-grammar#target_elem" xlink:title="target_elem">
...
<text class="terminal" x="78" y="267">FROM</text><a xlink:href="/docs/v25.4/sql-grammar#table_ref" xlink:title="table_ref">
...
<text class="terminal" x="526" y="299">TIME</text><a xlink:href="/docs/v25.4/sql-grammar#a_expr" xlink:title="a_expr">
...
<text class="terminal" x="148" y="397">WHERE</text><a xlink:href="/docs/v25.4/sql-grammar#a_expr" xlink:title="a_expr">
...
<text class="terminal" x="450" y="397">BY</text><a xlink:href="/docs/v25.4/sql-grammar#group_by_list" xlink:title="group_by_list">
...
<text class="terminal" x="219" y="483">HAVING</text><a xlink:href="/docs/v25.4/sql-grammar#a_expr" xlink:title="a_expr">
...
<text class="terminal" x="437" y="483">WINDOW</text><a xlink:href="/docs/v25.4/sql-grammar#window_definition_list" xlink:title="window_definition_list">
