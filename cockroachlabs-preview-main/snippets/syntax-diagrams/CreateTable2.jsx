...
<text class="terminal" x="39" y="21">CREATE</text><a xlink:href="/docs/stable/sql-grammar#opt_persistence_temp_table" xlink:title="opt_persistence_temp_table">
...
<text class="terminal" x="579" y="53">EXISTS</text><a xlink:href="/docs/stable/sql-grammar#table_name" xlink:title="table_name">
...
<text class="terminal" x="157" y="163">(</text><a xlink:href="/docs/stable/sql-grammar#column_table_def" xlink:title="column_table_def">
<rect height="32" width="134" x="255" y="145"></rect>
<rect class="nonterminal" height="32" width="134" x="253" y="143"></rect>
<text lengthAdjust="spacingAndGlyphs" textLength="110" font-size="11" class="nonterminal" x="265" y="163">column_table_def</text></a><a xlink:href="/docs/stable/sql-grammar#index_def" xlink:title="index_def">
<rect height="32" width="82" x="255" y="189"></rect>
<rect class="nonterminal" height="32" width="82" x="253" y="187"></rect>
<text lengthAdjust="spacingAndGlyphs" textLength="58" font-size="10" class="nonterminal" x="265" y="207">index_def</text></a><a xlink:href="/docs/stable/sql-grammar#family_def" xlink:title="family_def">
<rect height="32" width="86" x="255" y="233"></rect>
<rect class="nonterminal" height="32" width="86" x="253" y="231"></rect>
<text lengthAdjust="spacingAndGlyphs" textLength="62" font-size="10" class="nonterminal" x="265" y="251">family_def</text></a><a xlink:href="/docs/stable/sql-grammar#table_constraint" xlink:title="table_constraint">
<rect height="32" width="124" x="255" y="277"></rect>
<rect class="nonterminal" height="32" width="124" x="253" y="275"></rect>
<text lengthAdjust="spacingAndGlyphs" textLength="100" font-size="10" class="nonterminal" x="265" y="295">table_constraint</text></a><a xlink:href="/docs/stable/sql-grammar#opt_validate_behavior" xlink:title="opt_validate_behavior">
...
<text class="terminal" x="263" y="339">LIKE</text><a xlink:href="/docs/stable/sql-grammar#table_name" xlink:title="table_name">
<rect height="32" width="96" x="327" y="321"></rect>
<rect class="nonterminal" height="32" width="96" x="325" y="319"></rect>
<text lengthAdjust="spacingAndGlyphs" textLength="72" font-size="11" class="nonterminal" x="337" y="339">table_name</text></a><a xlink:href="/docs/stable/sql-grammar#like_table_option_list" xlink:title="like_table_option_list">
...
<text class="terminal" x="687" y="163">)</text><a xlink:href="/docs/stable/sql-grammar#opt_partition_by_table" xlink:title="opt_partition_by_table">
<rect height="32" width="166" x="25" y="403"></rect>
<rect class="nonterminal" height="32" width="166" x="23" y="401"></rect>
<text lengthAdjust="spacingAndGlyphs" textLength="142" font-size="10" class="nonterminal" x="35" y="421">opt_partition_by_table</text></a><a xlink:href="/docs/stable/sql-grammar#opt_with_storage_parameter_list" xlink:title="opt_with_storage_parameter_list">
...
<text class="terminal" x="541" y="487">ROWS</text><a xlink:href="/docs/stable/sql-grammar#opt_locality" xlink:title="opt_locality">
