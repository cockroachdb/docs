export const ChangefeedTargets = () => {
  return (
    <Frame>
      <div
        className="not-prose"
...
<polygon points="17 61 9 57 9 65"></polygon><a xlink:href="#changefeed_target" xlink:title="changefeed_target">
<rect height="32" width="142" x="51" y="47"></rect>
<rect class="nonterminal" height="32" width="142" x="49" y="45"></rect>
<text lengthAdjust="spacingAndGlyphs" textLength="118" font-size="11" class="nonterminal" x="61" y="65">changefeed_target</text></a><rect height="32" rx="10" width="24" x="51" y="3"></rect>
