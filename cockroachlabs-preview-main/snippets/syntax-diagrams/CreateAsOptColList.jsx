export const CreateAsOptColList = () => {
  return (
    <Frame>
      <div
        className="not-prose"
...
<text class="terminal" x="59" y="41">(</text><a xlink:href="#create_as_table_defs" xlink:title="create_as_table_defs">
<rect height="32" width="158" x="97" y="23"></rect>
<rect class="nonterminal" height="32" width="158" x="95" y="21"></rect>
<text lengthAdjust="spacingAndGlyphs" textLength="134" font-size="10" class="nonterminal" x="107" y="41">create_as_table_defs</text></a><rect height="32" rx="10" width="26" x="275" y="23"></rect>
