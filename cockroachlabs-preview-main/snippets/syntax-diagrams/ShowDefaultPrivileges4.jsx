export const ShowDefaultPrivileges4 = () => {
  return (
    <Frame>
      <div
        className="not-prose"
...
<text class="terminal" x="475" y="141">GRANTEE</text><a xlink:href="/docs/v24.3/sql-grammar#role_spec_list" xlink:title="role_spec_list">
...
<text class="terminal" x="397" y="295">SCHEMA</text><a xlink:href="/docs/v24.3/sql-grammar#qualifiable_schema_name" xlink:title="qualifiable_schema_name">
