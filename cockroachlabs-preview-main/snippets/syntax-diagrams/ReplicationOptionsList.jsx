export const ReplicationOptionsList = () => {
  return (
    <Frame>
      <div
        className="not-prose"
...
<polygon points="17 61 9 57 9 65"></polygon><a xlink:href="#replication_options" xlink:title="replication_options">
<rect height="32" width="142" x="51" y="47"></rect>
<rect class="nonterminal" height="32" width="142" x="49" y="45"></rect>
<text lengthAdjust="spacingAndGlyphs" textLength="118" font-size="10" class="nonterminal" x="61" y="65">replication_options</text></a><rect height="32" rx="10" width="24" x="51" y="3"></rect>
