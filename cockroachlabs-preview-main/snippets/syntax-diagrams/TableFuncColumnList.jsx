export const TableFuncColumnList = () => {
  return (
    <Frame>
      <div
        className="not-prose"
...
<polygon points="17 61 9 57 9 65"></polygon><a xlink:href="#table_func_column" xlink:title="table_func_column">
<rect height="32" width="140" x="51" y="47"></rect>
<rect class="nonterminal" height="32" width="140" x="49" y="45"></rect>
<text lengthAdjust="spacingAndGlyphs" textLength="116" font-size="11" class="nonterminal" x="61" y="65">table_func_column</text></a><rect height="32" rx="10" width="24" x="51" y="3"></rect>
...
<polygon points="229 61 221 57 221 65"></polygon></svg>`,
        }}
      />
    </Frame>
  );
