export const CreateChangefeed4 = () => {
  return (
    <Frame>
      <div
        className="not-prose"
...
<text class="terminal" x="53" y="131">FOR</text><a xlink:href="/docs/v24.3/sql-grammar#changefeed_target" xlink:title="changefeed_target">
...
<text class="terminal" x="653" y="273">SELECT</text><a xlink:href="/docs/v24.3/sql-grammar#target_list" xlink:title="target_list">
...
<text class="terminal" x="849" y="273">FROM</text><a xlink:href="/docs/v24.3/sql-grammar#changefeed_target_expr" xlink:title="changefeed_target_expr">
<rect height="32" width="178" x="921" y="255"></rect>
<rect class="nonterminal" height="32" width="178" x="919" y="253"></rect>
<text lengthAdjust="spacingAndGlyphs" textLength="154" font-size="11" class="nonterminal" x="931" y="273">changefeed_target_expr</text></a><a xlink:href="/docs/v24.3/sql-grammar#opt_where_clause" xlink:title="opt_where_clause">
