export const WindowFunctions12 = () => {
  return (
    <Frame>
      <div
        className="not-prose"
...
<text class="terminal" x="197" y="53">BETWEEN</text><a xlink:href="/docs/v25.4/sql-grammar#frame_bound" xlink:title="frame_bound">
...
<text class="terminal" x="427" y="53">AND</text><a xlink:href="/docs/v25.4/sql-grammar#frame_bound" xlink:title="frame_bound">
<rect height="32" width="104" x="507" y="3"></rect>
<rect class="nonterminal" height="32" width="104" x="505" y="1"></rect>
<text lengthAdjust="spacingAndGlyphs" textLength="80" font-size="11" class="nonterminal" x="517" y="21">frame_bound</text></a><a xlink:href="/docs/v25.4/sql-grammar#opt_frame_exclusion" xlink:title="opt_frame_exclusion">
