export const AlterColumnDefault = () => {
  return (
    <Frame>
      <div
        className="not-prose"
        ...
        dangerouslySetInnerHTML={{
          __html: `<svg height="81" width="327" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><style>svg {
...
<text class="terminal" x="123" y="21">DEFAULT</text><a xlink:href="#a_expr" xlink:title="a_expr">
<rect height="32" width="64" x="215" y="3"></rect>
<rect class="nonterminal" height="32" width="64" x="213" y="1"></rect>
<text lengthAdjust="spacingAndGlyphs" textLength="40" font-size="10" class="nonterminal" x="225" y="21">a_expr</text></a><rect height="32" rx="10" width="58" x="51" y="47"></rect>
<rect class="terminal" height="32" rx="10" width="58" x="49" y="45"></rect>
<text class="terminal" x="59" y="65">DROP</text>
<rect height="32" rx="10" width="80" x="129" y="47"></rect>
<rect class="terminal" height="32" rx="10" width="80" x="127" y="45"></rect>
