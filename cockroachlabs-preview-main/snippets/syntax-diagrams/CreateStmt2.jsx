    ...
    <Frame>
      <div
        ...
        dangerouslySetInnerHTML={{
          __html: `<svg height="301" width="333" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><style>svg {
...
<text lengthAdjust="spacingAndGlyphs" textLength="210" font-size="10" class="nonterminal" x="61" y="241">create_external_connection_stmt</text></a><a xlink:href="#create_schedule_stmt" xlink:title="create_schedule_stmt">
<rect height="32" width="160" x="51" y="267"></rect>
<rect class="nonterminal" height="32" width="160" x="49" y="265"></rect>
<text lengthAdjust="spacingAndGlyphs" textLength="136" font-size="10" class="nonterminal" x="61" y="285">create_schedule_stmt</text></a><path class="line" d="m17 17 h2 m20 0 h10 m128 0 h10 m0 0 h106 m-274 0 h20 m254 0 h20 m-294 0 q10 0 10 10 m274 0 q0 -10 10 -10 m-284 10 v24 m274 0 v-24 m-274 24 q0 10 10 10 m254 0 q10 0 10 -10 m-264 10 h10 m124 0 h10 m0 0 h110 m-264 -10 v20 m274 0 v-20 m-274 20 v24 m274 0 v-24 m-274 24 q0 10 10 10 m254 0 q10 0 10 -10 m-264 10 h10 m136 0 h10 m0 0 h98 m-264 -10 v20 m274 0 v-20 m-274 20 v24 m274 0 v-24 m-274 24 q0 10 10 10 m254 0 q10 0 10 -10 m-264 10 h10 m178 0 h10 m0 0 h56 m-264 -10 v20 m274 0 v-20 m-274 20 v24 m274 0 v-24 m-274 24 q0 10 10 10 m254 0 q10 0 10 -10 m-264 10 h10 m166 0 h10 m0 0 h68 m-264 -10 v20 m274 0 v-20 m-274 20 v24 m274 0 v-24 m-274 24 q0 10 10 10 m254 0 q10 0 10 -10 m-264 10 h10 m234 0 h10 m-264 -10 v20 m274 0 v-20 m-274 20 v24 m274 0 v-24 m-274 24 q0 10 10 10 m254 0 q10 0 10 -10 m-264 10 h10 m160 0 h10 m0 0 h74 m23 -264 h-3"></path>
<polygon points="323 17 331 13 331 21"></polygon>
<polygon points="323 17 315 13 315 21"></polygon></svg>`,
        }}
      />
    </Frame>
  );
