export const ShowDefaultSessionVariablesForRole = () => {
  return (
    <Frame>
      <div
        className="not-prose"
...
<text class="terminal" x="443" y="21">FOR</text><a xlink:href="/docs/stable/sql-grammar#role_or_group_or_user" xlink:title="role_or_group_or_user">
<rect height="32" width="168" x="187" y="69"></rect>
<rect class="nonterminal" height="32" width="168" x="185" y="67"></rect>
<text lengthAdjust="spacingAndGlyphs" textLength="144" font-size="11" class="nonterminal" x="197" y="87">role_or_group_or_user</text></a><a xlink:href="/docs/stable/sql-grammar#role_spec" xlink:title="role_spec">
