export const CreateScheduleForChangefeed3 = () => {
  return (
    <Frame>
      <div
        className="not-prose"
...
<text class="terminal" x="627" y="21">CHANGEFEED</text><a xlink:href="/docs/v24.1/sql-grammar#changefeed_target" xlink:title="changefeed_target">
...
<text class="terminal" x="655" y="273">SELECT</text><a xlink:href="/docs/v24.1/sql-grammar#target_list" xlink:title="target_list">
...
<text class="terminal" x="851" y="273">FROM</text><a xlink:href="/docs/v24.1/sql-grammar#insert_target" xlink:title="insert_target">
<rect height="32" width="104" x="923" y="255"></rect>
<rect class="nonterminal" height="32" width="104" x="921" y="253"></rect>
<text lengthAdjust="spacingAndGlyphs" textLength="80" font-size="10" class="nonterminal" x="933" y="273">insert_target</text></a><a xlink:href="/docs/v24.1/sql-grammar#where_clause" xlink:title="where_clause">
