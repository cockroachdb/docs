export const DbObjectNameComponent = () => {
  return (
    <Frame>
      <div
        className="not-prose"
...
<text class="terminal" x="59" y="65">FAMILY</text><a xlink:href="#cockroachdb_extra_reserved_keyword" xlink:title="cockroachdb_extra_reserved_keyword">
