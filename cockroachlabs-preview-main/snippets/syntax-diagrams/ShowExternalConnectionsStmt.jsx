export const ShowExternalConnectionsStmt = () => {
  return (
    <Frame>
      <div
        className="not-prose"
...
<text class="terminal" x="253" y="65">CONNECTION</text><a xlink:href="#string_or_placeholder" xlink:title="string_or_placeholder">
