...
<text lengthAdjust="spacingAndGlyphs" textLength="72" font-size="11" class="nonterminal" x="759" y="163">table_name</text></a><a xlink:href="/docs/v25.2/sql-grammar#opt_index_access_method" xlink:title="opt_index_access_method">
...
<text class="terminal" x="1083" y="163">(</text><a xlink:href="/docs/v25.2/sql-grammar#func_expr_windowless" xlink:title="func_expr_windowless">
...
<text class="terminal" x="1169" y="207">(</text><a xlink:href="/docs/v25.2/sql-grammar#a_expr" xlink:title="a_expr">
...
<text class="terminal" x="1299" y="207">)</text><a xlink:href="/docs/v25.2/sql-grammar#name" xlink:title="name">
<rect height="32" width="56" x="1161" y="233"></rect>
<rect class="nonterminal" height="32" width="56" x="1159" y="231"></rect>
<text lengthAdjust="spacingAndGlyphs" textLength="32" font-size="12" class="nonterminal" x="1171" y="251">name</text></a><a xlink:href="/docs/v25.2/sql-grammar#index_elem_options" xlink:title="index_elem_options">
...
<text class="terminal" x="1559" y="163">)</text><a xlink:href="/docs/v25.2/sql-grammar#opt_hash_sharded" xlink:title="opt_hash_sharded">
<rect height="32" width="140" x="1597" y="145"></rect>
<rect class="nonterminal" height="32" width="140" x="1595" y="143"></rect>
<text lengthAdjust="spacingAndGlyphs" textLength="116" font-size="11" class="nonterminal" x="1607" y="163">opt_hash_sharded</text></a><rect height="32" rx="10" width="90" x="65" y="321"></rect>
<rect class="terminal" height="32" rx="10" width="90" x="63" y="319"></rect>
<text class="terminal" x="73" y="339">INVERTED</text>
<rect height="32" rx="10" width="74" x="65" y="365"></rect>
<rect class="terminal" height="32" rx="10" width="74" x="63" y="363"></rect>
<text class="terminal" x="73" y="383">VECTOR</text>
<rect height="32" rx="10" width="64" x="195" y="321"></rect>
<rect class="terminal" height="32" rx="10" width="64" x="193" y="319"></rect>
<text class="terminal" x="203" y="339">INDEX</text>
<rect height="32" rx="10" width="130" x="299" y="353"></rect>
<rect class="terminal" height="32" rx="10" width="130" x="297" y="351"></rect>
<text class="terminal" x="307" y="371">CONCURRENTLY</text><a xlink:href="/docs/v25.2/sql-grammar#opt_index_name" xlink:title="opt_index_name">
<rect height="32" width="126" x="489" y="321"></rect>
<rect class="nonterminal" height="32" width="126" x="487" y="319"></rect>
<text lengthAdjust="spacingAndGlyphs" textLength="102" font-size="11" class="nonterminal" x="499" y="339">opt_index_name</text></a><rect height="32" rx="10" width="34" x="489" y="365"></rect>
<rect class="terminal" height="32" rx="10" width="34" x="487" y="363"></rect>
<text class="terminal" x="497" y="383">IF</text>
<rect height="32" rx="10" width="48" x="543" y="365"></rect>
<rect class="terminal" height="32" rx="10" width="48" x="541" y="363"></rect>
<text class="terminal" x="551" y="383">NOT</text>
<rect height="32" rx="10" width="70" x="611" y="365"></rect>
<rect class="terminal" height="32" rx="10" width="70" x="609" y="363"></rect>
<text class="terminal" x="619" y="383">EXISTS</text><a xlink:href="/docs/v25.2/sql-grammar#index_name" xlink:title="index_name">
<rect height="32" width="98" x="701" y="365"></rect>
<rect class="nonterminal" height="32" width="98" x="699" y="363"></rect>
<text lengthAdjust="spacingAndGlyphs" textLength="74" font-size="11" class="nonterminal" x="711" y="383">index_name</text></a><rect height="32" rx="10" width="40" x="839" y="321"></rect>
<rect class="terminal" height="32" rx="10" width="40" x="837" y="319"></rect>
<text class="terminal" x="847" y="339">ON</text><a xlink:href="/docs/v25.2/sql-grammar#table_name" xlink:title="table_name">
<rect height="32" width="96" x="899" y="321"></rect>
<rect class="nonterminal" height="32" width="96" x="897" y="319"></rect>
<text lengthAdjust="spacingAndGlyphs" textLength="72" font-size="11" class="nonterminal" x="909" y="339">table_name</text></a><rect height="32" rx="10" width="26" x="1015" y="321"></rect>
<rect class="terminal" height="32" rx="10" width="26" x="1013" y="319"></rect>
<text class="terminal" x="1023" y="339">(</text><a xlink:href="/docs/v25.2/sql-grammar#func_expr_windowless" xlink:title="func_expr_windowless">
<rect height="32" width="162" x="1101" y="321"></rect>
<rect class="nonterminal" height="32" width="162" x="1099" y="319"></rect>
<text lengthAdjust="spacingAndGlyphs" textLength="138" font-size="11" class="nonterminal" x="1111" y="339">func_expr_windowless</text></a><rect height="32" rx="10" width="26" x="1101" y="365"></rect>
<rect class="terminal" height="32" rx="10" width="26" x="1099" y="363"></rect>
<text class="terminal" x="1109" y="383">(</text><a xlink:href="/docs/v25.2/sql-grammar#a_expr" xlink:title="a_expr">
<rect height="32" width="64" x="1147" y="365"></rect>
<rect class="nonterminal" height="32" width="64" x="1145" y="363"></rect>
<text lengthAdjust="spacingAndGlyphs" textLength="40" font-size="10" class="nonterminal" x="1157" y="383">a_expr</text></a><rect height="32" rx="10" width="26" x="1231" y="365"></rect>
<rect class="terminal" height="32" rx="10" width="26" x="1229" y="363"></rect>
<text class="terminal" x="1239" y="383">)</text><a xlink:href="/docs/v25.2/sql-grammar#name" xlink:title="name">
<rect height="32" width="56" x="1101" y="409"></rect>
<rect class="nonterminal" height="32" width="56" x="1099" y="407"></rect>
<text lengthAdjust="spacingAndGlyphs" textLength="32" font-size="12" class="nonterminal" x="1111" y="427">name</text></a><a xlink:href="/docs/v25.2/sql-grammar#index_elem_options" xlink:title="index_elem_options">
<rect height="32" width="148" x="1303" y="321"></rect>
<rect class="nonterminal" height="32" width="148" x="1301" y="319"></rect>
<text lengthAdjust="spacingAndGlyphs" textLength="124" font-size="11" class="nonterminal" x="1313" y="339">index_elem_options</text></a><rect height="32" rx="10" width="24" x="1081" y="277"></rect>
<rect class="terminal" height="32" rx="10" width="24" x="1079" y="275"></rect>
<text class="terminal" x="1089" y="295">,</text>
<rect height="32" rx="10" width="26" x="1491" y="321"></rect>
<rect class="terminal" height="32" rx="10" width="26" x="1489" y="319"></rect>
<text class="terminal" x="1499" y="339">)</text>
...
<text class="terminal" x="888" y="509">(</text><a xlink:href="/docs/v25.2/sql-grammar#name_list" xlink:title="name_list">
...
<text class="terminal" x="851" y="695">BY</text><a xlink:href="/docs/v25.2/sql-grammar#partition_by_inner" xlink:title="partition_by_inner">
...
<text class="terminal" x="1163" y="663">(</text><a xlink:href="/docs/v25.2/sql-grammar#storage_parameter" xlink:title="storage_parameter">
