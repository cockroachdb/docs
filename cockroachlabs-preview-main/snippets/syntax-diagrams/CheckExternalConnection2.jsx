export const CheckExternalConnection2 = () => {
  return (
    <Frame>
      <div
        className="not-prose"
...
<text class="terminal" x="99" y="107">WITH</text><a xlink:href="/docs/v25.2/sql-grammar#check_external_connection_options_list" xlink:title="check_external_connection_options_list">
