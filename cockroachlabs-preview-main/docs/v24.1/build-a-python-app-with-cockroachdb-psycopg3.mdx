...
old_description: "Learn how to use CockroachDB from a simple Python application with the Psycopg 3 driver."
---

import { LinkedPageTabs } from "/snippets/LinkedPageTabs.jsx";

<LinkedPageTabs
  currentPath="/docs/v24.1/build-a-python-app-with-cockroachdb-psycopg3"
  items={[
    {
      title: "Use psycopg3",
