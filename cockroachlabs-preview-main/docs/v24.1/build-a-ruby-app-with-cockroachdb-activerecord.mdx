...
old_description: "Learn how to use CockroachDB from a simple Ruby script with the Active Record gem."
---

import { LinkedPageTabs } from "/snippets/LinkedPageTabs.jsx";

<LinkedPageTabs
  currentPath="/docs/v24.1/build-a-ruby-app-with-cockroachdb-activerecord"
  items={[
    {
      title: "Use pg",
      href: "/docs/v24.1/build-a-ruby-app-with-cockroachdb",
    },
    {
      title: "Use ActiveRecord",
      href: "/docs/v24.1/build-a-ruby-app-with-cockroachdb-activerecord",
    },
  ]}
/>

This tutorial shows you how build a simple Ruby application with CockroachDB and [Active Record](http://guides.rubyonrails.org/active_record_basics). CockroachDB provides an Active Record adapter for CockroachDB as a [RubyGem](https://rubygems.org/gems/activerecord-cockroachdb-adapter).
...
Read more about using [Active Record](http://guides.rubyonrails.org/active_record_basics), or check out a more realistic implementation of Active Record with CockroachDB in a Rails app in our [`examples-orms`](https://github.com/cockroachdb/examples-orms) repository.
