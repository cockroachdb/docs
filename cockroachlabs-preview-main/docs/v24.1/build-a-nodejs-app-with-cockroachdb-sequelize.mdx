...
old_description: "Learn how to use CockroachDB from a simple Node.js application with the Sequelize ORM."
---

import { LinkedPageTabs } from "/snippets/LinkedPageTabs.jsx";

<LinkedPageTabs
  currentPath="/docs/v24.1/build-a-nodejs-app-with-cockroachdb-sequelize"
  items={[
    {
