...
2. Start the [built-in SQL shell](/docs/v24.1/cockroach-sql) using the connection string you got from the CockroachDB Cloud Console earlier:
...
- [Build a Simple Django App with CockroachDB](/docs/v24.1/build-a-python-app-with-cockroachdb-django)
- [Deploy a Global, Serverless Application](/docs/v24.1/movr-flask-deployment)
