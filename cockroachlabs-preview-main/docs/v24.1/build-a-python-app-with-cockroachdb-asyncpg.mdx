...
<LinkedPageTabs
  currentPath="/docs/v24.1/build-a-python-app-with-cockroachdb-asyncpg"
  items={[
    {
      title: "Use psycopg3",
...
2. Run the code:
    ...
    <Note>
    The example code sets the [`multiple_active_portals_enabled` session variable](/docs/v24.1/postgresql-compatibility#multiple-active-portals) to `true`, a requirement for using `asyncpg` with CockroachDB.
    </Note>
