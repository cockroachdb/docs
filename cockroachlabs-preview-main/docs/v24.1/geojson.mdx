...
GeoJSON can be used to represent the following spatial objects, which also have [Well Known Text (WKT)](/docs/v24.1/well-known-text) and [Well Known Binary (WKB)](/docs/v24.1/well-known-binary) representations:
...
<Note>
GeoJSON should only be used for spatial data that uses the [WGS84](/docs/v24.1/architecture/glossary) geographic spatial reference system. For more information, see [SRID 4326](/docs/v24.1/srid-4326).
</Note>

## Example

In the example below, we will convert a shape represented in [Well Known Text](/docs/v24.1/well-known-text) to GeoJSON using the `ST_AsGeoJSON` [function](/docs/v24.1/functions-and-operators#spatial-functions).
...
<Frame>
  ![GeoJSON.io output](/images/v24.1/geospatial/geojson_example.png)
</Frame>
