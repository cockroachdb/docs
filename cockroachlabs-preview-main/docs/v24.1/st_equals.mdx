...
<Note>
`ST_Equals` will attempt to use any available [spatial index](/docs/v24.1/spatial-indexes) to speed up its operation. Use the prefixed variant `_ST_Equals` if you do not want any spatial indexes to be used.
</Note>
...
<Frame>
  ![ST_Equals - true](/images/v24.1/geospatial/st_equals_true.png)
</Frame>
...
<Frame>
  ![ST_Equals - false](/images/v24.1/geospatial/st_equals_false.png)
</Frame>
