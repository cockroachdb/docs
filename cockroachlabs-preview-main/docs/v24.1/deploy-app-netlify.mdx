...
3. Run the app server locally to preview your site:
    ...
    Interacting with the site triggers the Netlify functions defined in the `netlify/functions` directory. These functions use Prisma Client to run [`SELECT`](/docs/v24.1/selection-queries) and [`INSERT`](/docs/v24.1/insert) queries against the database:
