...
import { ShowIndex3 } from "/snippets/syntax-diagrams/ShowIndex3.jsx";

The `SHOW INDEX` [statement](/docs/v24.1/sql-statements) returns index information for a table or database.

## Required privileges

The user must have any [privilege](/docs/v24.1/security-reference/authorization#managing-privileges) on the target table or database.
