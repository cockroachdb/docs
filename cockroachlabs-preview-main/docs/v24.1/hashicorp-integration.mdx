...
Refer to [Transport Layer Security (TLS) and Public Key Infrastructure (PKI)](/docs/v24.1/security-reference/transport-layer-security) for an overview.
...
Refer to [Manage PKI certificates for a CockroachDB deployment with HashiCorp Vault](/docs/v24.1/manage-certs-vault) for procedures in involved in administering PKI for a CockroachDB self-hosted cluster.
...
Try the tutorial: [Using HashiCorp Vault's Dynamic Secrets for Enhanced Database Credential Security in CockroachDB](/docs/v24.1/vault-db-secrets-tutorial)
...
When deploying Enterprise, customers can provide their own externally managed encryption keys for use as the *store key* for CockroachDB's [Enterprise Encryption At Rest](/docs/v24.1/security-reference/encryption#encryption-at-rest-enterprise).
...
- [CMEK overview](/docs/cockroachcloud/cmek)
- [Manage Customer-Managed Encryption Keys (CMEK) for CockroachDB Advanced](/docs/cockroachcloud/managing-cmek)
- [Transport Layer Security (TLS) and Public Key Infrastructure (PKI)](/docs/v24.1/security-reference/transport-layer-security)
...
- [Using HashiCorp Vault's Dynamic Secrets for Enhanced Database Credential Security in CockroachDB](/docs/v24.1/vault-db-secrets-tutorial)
- [Roles](/docs/v24.1/security-reference/authorization#roles)
