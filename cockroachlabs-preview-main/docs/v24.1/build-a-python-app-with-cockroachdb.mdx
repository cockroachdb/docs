...
old_description: "Learn how to use CockroachDB from a simple Python application with the psycopg2 driver."
---

import { LinkedPageTabs } from "/snippets/LinkedPageTabs.jsx";

<LinkedPageTabs
  currentPath="/docs/v24.1/build-a-python-app-with-cockroachdb"
  items={[
    {
      title: "Use psycopg3",
