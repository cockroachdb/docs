...
<Note>
`ST_Disjoint` does not make use of [spatial indexes](/docs/v24.1/spatial-indexes).
</Note>

<Note>
This function is the inverse of [`ST_Intersects`](/docs/v24.1/st_intersects).
</Note>
...
<Frame>
  ![ST_Disjoint - true](/images/v24.1/geospatial/st_disjoint_true.png)
</Frame>
...
<Frame>
  ![ST_Disjoint - false](/images/v24.1/geospatial/st_disjoint_false.png)
</Frame>
