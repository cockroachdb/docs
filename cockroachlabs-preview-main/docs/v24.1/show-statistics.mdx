...
import { ShowStatistics3 } from "/snippets/syntax-diagrams/ShowStatistics3.jsx";

The `SHOW STATISTICS` [statement](/docs/v24.1/sql-statements) lists [table statistics](/docs/v24.1/create-statistics) used by the [cost-based optimizer](/docs/v24.1/cost-based-optimizer).

By default, CockroachDB [automatically generates statistics](/docs/v24.1/cost-based-optimizer#table-statistics) on all indexed columns and up to 100 non-indexed columns, and automatically collects [multi-column statistics](/docs/v24.1/create-statistics#create-statistics-on-multiple-columns) on the columns that prefix each index.
...
To list table statistics, the user must have any [privilege](/docs/v24.1/security-reference/authorization#managing-privileges) on the table being inspected.
...
The `WITH FORECAST` option calculates and displays [forecasted statistics](/docs/v24.1/cost-based-optimizer#forecasted-statistics) along with the existing table statistics.
