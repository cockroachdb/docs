...
Your CockroachDB Dedicated cluster needs to be configured to [allow incoming client connections](/docs/cockroachcloud/network-authorization#ip-allowlisting) from Hasura Cloud.
