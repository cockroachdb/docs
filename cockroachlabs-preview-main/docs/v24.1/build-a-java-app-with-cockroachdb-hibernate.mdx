...
<LinkedPageTabs
  currentPath="/docs/v24.1/build-a-java-app-with-cockroachdb-hibernate"
  items={[
    {
      title: "Use JDBC",
...
<Tip>
For a sample app and tutorial that uses Spring Data JPA (Hibernate) and CockroachDB, see [Build a Spring App with CockroachDB and JPA](/docs/v24.1/build-a-spring-app-with-cockroachdb-jpa).
...
<Note>
The version of the CockroachDB Hibernate dialect in `hibernate.cfg.xml` corresponds to a version of CockroachDB. For more information, see [Install Client Drivers: Hibernate](/docs/v24.1/install-client-drivers).
</Note>
