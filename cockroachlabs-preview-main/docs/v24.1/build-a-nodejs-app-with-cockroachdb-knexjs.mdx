...
old_description: "Learn how to use CockroachDB from a simple CRUD application that uses the Knex.js query builder."
---

import { LinkedPageTabs } from "/snippets/LinkedPageTabs.jsx";

<LinkedPageTabs
  currentPath="/docs/v24.1/build-a-nodejs-app-with-cockroachdb-knexjs"
  items={[
    {
