...
Users with the [`admin` role](/docs/v24.1/security-reference/authorization#admin-role) can view all external connections with `SHOW CREATE EXTERNAL CONNECTION`.

## Synopsis

<Frame>
  ![SQL syntax diagram](/images/generated/docs/v24.1/show-create-external-connection/syntax-diagram-68422502540d.svg)
</Frame>
