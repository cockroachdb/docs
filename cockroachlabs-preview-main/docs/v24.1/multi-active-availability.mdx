...
old_description: "Learn about CockroachDB's high availability model, known as Multi-Active Availability."
---
...
<Note>
In this example, the cluster remained active the entire time. But in terms of the [CAP theorem](https://wikipedia.org/wiki/CAP_theorem), this is an AP system; it favored being available instead of consistent when partitions occur.
</Note>
...
<Note>
In this example, if nodes **B** or **C** failed at any time, the cluster would have stopped responding. In terms of the [CAP theorem](https://wikipedia.org/wiki/CAP_theorem), this is a CP system; it favored being consistent instead of available when partitions occur.
</Note>

## What's next?

To get a greater understanding of how CockroachDB is a survivable system that enforces strong consistency, check out our [architecture documentation](/docs/v24.1/architecture/overview).

To see Multi-Active Availability in action, see this [availability demo](/docs/v24.1/demo-fault-tolerance-and-recovery).
