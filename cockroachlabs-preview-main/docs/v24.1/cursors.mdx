...
import { Cursors7 } from "/snippets/syntax-diagrams/Cursors7.jsx";
import { Cursors8 } from "/snippets/syntax-diagrams/Cursors8.jsx";
import { Cursors9 } from "/snippets/syntax-diagrams/Cursors9.jsx";
...
<Tip>
This document describes cursor usage within SQL transactions. For information about using cursors in PL/pgSQL functions and procedures, see [PL/pgSQL](/docs/v24.1/plpgsql#declare-cursor-variables).
</Tip>

Cursors differ from [keyset pagination](/docs/v24.1/pagination) and [`LIMIT`/`OFFSET`](/docs/v24.1/limit-offset) in that:

- Each cursor is a stateful SQL object that is referred to by a unique name.
- Each cursor requires holding open its own dedicated (read-only) [transaction](/docs/v24.1/transactions).
...
- [`DECLARE`](/docs/v24.1/sql-grammar#declare_cursor_stmt)
- [`FETCH`](/docs/v24.1/sql-grammar#fetch_cursor_stmt)
- [`CLOSE`](/docs/v24.1/sql-grammar#close_cursor_stmt)
...
These examples assume the presence of the [MovR data set](/docs/v24.1/movr).
...
- [Keyset pagination](/docs/v24.1/pagination)
- [`LIMIT`/`OFFSET`](/docs/v24.1/limit-offset)
