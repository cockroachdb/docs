...
<LinkedPageTabs
  currentPath="/docs/v24.1/deploy-cockroachdb-with-kubernetes"
  items={[
    {
      title: "Secure",
      href: "/docs/v24.1/deploy-cockroachdb-with-kubernetes",
    },
    {
      title: "Insecure",
      href: "/docs/v24.1/deploy-cockroachdb-with-kubernetes-insecure",
    },
  ]}
/>
...
- [CockroachDB Kubernetes Operator](https://github.com/cockroachdb/cockroach-operator)
    ...
    <Note>
    The CockroachDB Kubernetes Operator is also available on platforms such as [Red Hat OpenShift](/docs/v24.1/deploy-cockroachdb-with-kubernetes-openshift) and [IBM Cloud Pak for Data](https://www.ibm.com/products/cloud-pak-for-data).
    </Note>
...
The Operator does not provision or apply an Enterprise license key. To use CockroachDB with the Operator, [set a license](/docs/v24.1/licensing-faqs#set-a-license) in the SQL shell.
</Note>
...
<Note>
If you want to continue using this cluster, refer the documentation on [configuring](/docs/v24.1/configure-cockroachdb-kubernetes), [scaling](/docs/v24.1/scale-cockroachdb-kubernetes), [monitoring](/docs/v24.1/monitor-cockroachdb-kubernetes), and [upgrading](/docs/v24.1/upgrade-cockroachdb-kubernetes) the cluster.
</Note>
...
- [Resource management](/docs/v24.1/configure-cockroachdb-kubernetes)
- [Certificate management](/docs/v24.1/secure-cockroachdb-kubernetes)
- [Cluster monitoring](/docs/v24.1/monitor-cockroachdb-kubernetes)
- [Kubernetes Multi-Cluster Deployment](/docs/v24.1/orchestrate-cockroachdb-with-kubernetes-multi-cluster)
- [Optimize Performance on Kubernetes](/docs/v24.1/kubernetes-performance)
