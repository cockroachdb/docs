...
- Allow shapes to be transferred between CockroachDB and a [SQL client](/docs/v24.1/cockroach-sql) or [application](/docs/v24.1/build-a-java-app-with-cockroachdb).
...
The Extended Well Known Binary (*EWKB*) format is the same as WKB, with an [SRID](/docs/v24.1/architecture/glossary#srid) representation prepended to the data structure.
