...
This page has instructions for migrating data from ESRI [Shapefiles](/docs/v24.1/architecture/glossary#shapefile) into CockroachDB using [`ogr2ogr`](https://gdal.org/programs/ogr2ogr) and [`IMPORT INTO`](/docs/v24.1/import-into).
