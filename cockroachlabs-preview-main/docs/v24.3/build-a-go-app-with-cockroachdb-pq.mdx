...
<LinkedPageTabs
  currentPath="/docs/v24.3/build-a-go-app-with-cockroachdb-pq"
  items={[
    {
      title: "Use pgx",
      href: "/docs/v24.3/build-a-go-app-with-cockroachdb",
    },
    {
      title: "Use GORM",
      href: "/docs/v24.3/build-a-go-app-with-cockroachdb-gorm",
    },
    {
      title: "Use lib/pq",
      href: "/docs/v24.3/build-a-go-app-with-cockroachdb-pq",
    },
    {
      title: "Use upper/db",
      href: "/docs/v24.3/build-a-go-app-with-cockroachdb-upperdb",
    },
  ]}
/>
...
1. If you haven't already, [sign up for a CockroachDB Cloud account](https://cockroachlabs.cloud/signup?referralId=docs_go_pq).
...
- Execute a batch of statements as an atomic [transaction](/docs/v24.3/transactions).

    Note that CockroachDB may require the [client to retry a transaction](/docs/v24.3/transactions#transaction-retries) in the case of read/write [contention](/docs/v24.3/performance-best-practices-overview#transaction-contention). The [CockroachDB Go client](https://github.com/cockroachdb/cockroach-go) includes a generic **retry function** (`ExecuteTx()`) that runs inside a transaction and retries it as needed. The code sample shows how you can use this function to wrap SQL statements.
