...
<Note>
  `ST_Equals` will attempt to use any available [spatial index](/docs/v24.3/spatial-indexes) to speed up its operation.
...
<Frame>![ST_Equals - true](/images/v24.3/geospatial/st_equals_true.png)</Frame>
...
<Frame>![ST_Equals - false](/images/v24.3/geospatial/st_equals_false.png)</Frame>
