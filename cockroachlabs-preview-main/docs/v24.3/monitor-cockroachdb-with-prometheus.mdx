...
- Make sure you have already started a CockroachDB cluster, either [locally](/docs/v24.3/start-a-local-cluster) or in a [production environment](/docs/v24.3/manual-deployment).
...
7. Now that Alertmanager is configured and running, you can optionally [import pre-existing rules or create your own](/docs/v24.3/monitoring-and-alerting#alertmanager) if you prefer.
