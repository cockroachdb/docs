...
<LinkedPageTabs
  currentPath="/docs/v24.3/deploy-cockroachdb-on-microsoft-azure"
  items={[
    {
      title: "Secure",
      href: "/docs/v24.3/deploy-cockroachdb-on-microsoft-azure",
    },
    {
      title: "Insecure",
      href: "/docs/v24.3/deploy-cockroachdb-on-microsoft-azure-insecure",
    },
  ]}
/>
...
<Note>
If you would prefer to use HAProxy instead of Azure's managed load balancing, see the [On-Premises](/docs/v24.3/deploy-cockroachdb-on-premises) tutorial for guidance.
</Note>
