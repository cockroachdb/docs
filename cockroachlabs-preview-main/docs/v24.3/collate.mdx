...
The `COLLATE` feature lets you sort [`STRING`](/docs/v24.3/string) values according to language- and country-specific rules, known as collations.
...
- **Column syntax**: `STRING COLLATE <collation>`. For example:
    ...
    <Note>
    You can also use any of the [aliases for `STRING`](/docs/v24.3/string#aliases).
    </Note>
...
You can use the `pg_collation_for` [built-in function](/docs/v24.3/functions-and-operators#string-and-byte-functions), or its alternative [syntax form](/docs/v24.3/functions-and-operators#special-syntax-forms) `COLLATION FOR`, to return the locale name of a collated string.
