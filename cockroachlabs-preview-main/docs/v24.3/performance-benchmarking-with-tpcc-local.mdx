...
<LinkedPageTabs
  currentPath="/docs/v24.3/performance-benchmarking-with-tpcc-local"
  items={[
    {
      title: "Local",
...
1. In separate terminal windows, use the [`cockroach start`](/docs/v24.3/cockroach-start) command to start 3 nodes:
...
Use [`cockroach workload`](/docs/v24.3/cockroach-workload) to load the initial schema and data:
