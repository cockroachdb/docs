...
1. Using the Netlify CLI, start the app server locally to preview your site:
   ...
   Interacting with the site triggers the Netlify functions defined in the `netlify/functions` directory. These functions use Prisma Client to run [`SELECT`](/docs/v24.3/selection-queries) and [`INSERT`](/docs/v24.3/insert) queries against the database:
...
- [Build a Simple CRUD Node.js App with CockroachDB and Prisma Client](/docs/v24.3/build-a-nodejs-app-with-cockroachdb-prisma)
