...
<LinkedPageTabs
  currentPath="/docs/v24.3/build-a-nodejs-app-with-cockroachdb-knexjs"
  items={[
    {
...
1. If you haven't already, [sign up for a CockroachDB Cloud account](https://cockroachlabs.cloud/signup?referralId=docs_node_knexjs).
