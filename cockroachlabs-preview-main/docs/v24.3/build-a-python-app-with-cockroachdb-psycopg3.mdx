...
<LinkedPageTabs
  currentPath="/docs/v24.3/build-a-python-app-with-cockroachdb-psycopg3"
  items={[
    {
      title: "Use psycopg3",
...
1. If you haven't already, [sign up for a CockroachDB Cloud account](https://cockroachlabs.cloud/signup?referralId=docs_python_psycopg3).
