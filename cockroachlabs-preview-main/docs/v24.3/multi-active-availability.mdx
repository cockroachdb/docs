...
To get a greater understanding of how CockroachDB is a survivable system that enforces strong consistency, check out our [architecture documentation](/docs/v24.3/architecture/overview).

To see Multi-Active Availability in action, see this [availability demo](/docs/v24.3/demo-cockroachdb-resilience).
