...
1. Create an [AWS](https://aws.amazon.com/) account and log in, then:
    1. Create an [AWS user](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_users) with administrator permissions.
...
This repo includes samples for Node.js and Python [Lambda runtimes](https://docs.aws.amazon.com/lambda/latest/dg/lambda-runtimes). Select either node.js or Python to continue.
