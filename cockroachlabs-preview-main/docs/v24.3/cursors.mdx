...
import { Cursors10 } from "/snippets/syntax-diagrams/Cursors10.jsx";
import { Cursors11 } from "/snippets/syntax-diagrams/Cursors11.jsx";
import { Cursors12 } from "/snippets/syntax-diagrams/Cursors12.jsx";
...
<Tip>
This document describes cursor usage within SQL transactions. For information about using cursors in PL/pgSQL functions and procedures, see [PL/pgSQL](/docs/v24.3/plpgsql#declare-cursor-variables).
</Tip>

Cursors differ from [keyset pagination](/docs/v24.3/pagination) and [`LIMIT`/`OFFSET`](/docs/v24.3/limit-offset) in that:

- Each cursor is a stateful SQL object that is referred to by a unique name.
- Each cursor requires holding open its own dedicated (read-only) [transaction](/docs/v24.3/transactions).
...
- [`DECLARE`](/docs/v24.3/sql-grammar#declare_cursor_stmt)
- [`FETCH`](/docs/v24.3/sql-grammar#fetch_cursor_stmt)
- [`CLOSE`](/docs/v24.3/sql-grammar#close_cursor_stmt)
...
These examples assume the presence of the [MovR data set](/docs/v24.3/movr).
...
- [Keyset pagination](/docs/v24.3/pagination)
- [`LIMIT`/`OFFSET`](/docs/v24.3/limit-offset)
