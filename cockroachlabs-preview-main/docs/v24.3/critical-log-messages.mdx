...
old_description: "Critical logs messages to externalize and how to interpret them."
---
...
- **Message**: `disk stall detected: unable to sync log files within`
    ...
    - **See also**: [Disk stalls](/docs/v24.3/cluster-setup-troubleshooting#disk-stalls)
...
- **Message**: `possible decommission stall detected`
    ...
    - **See also**:
        - [Node decommission](/docs/v24.3/cockroach-node#node-decommission)
        - [Decommissioning issues](/docs/v24.3/cluster-setup-troubleshooting#decommissioning-issues)
- **Message**: One or more of the following: `ERROR: drain timeout` `error releasing lease`
    - **Severity**: Medium
    ...
    - **Related metrics**: NONE
    - **See also**: [Drain timeout](/docs/v24.3/node-shutdown#drain-timeout)
...
- **Message**: `slow heartbeat took %s; err=context deadline exceeded`
    ...
    - **See also**:
        - [Node liveness issues](/docs/v24.3/cluster-setup-troubleshooting#node-liveness-issues)
        - [`context deadline exceeded`](/docs/v24.3/common-errors#context-deadline-exceeded)
- **Message**: `unable to connect to n%d: failed to connect to n%d at ‹hostname:port›: ‹initial connection heartbeat failed›`
    ...
    - **Related metrics**: NONE
    - **See also**: [Network partition](/docs/v24.3/cluster-setup-troubleshooting#network-partition)
- **Message**: One or more of the following: `slow range RPC: have been waiting %.2fs (%d attempts) for RPC Scan` `retrying liveness update after ‹×›: ‹×›` `slow heartbeat took %s; err=context deadline exceeded` `failed node liveness heartbeat: ‹×›: context deadline exceeded`
    - **Severity**: High
...
- **Message**: `clock synchronization error: this node is more than 500ms away from at least half of the known nodes`
    ...
    - **See also**: [`clock synchronization error: this node is more than 500ms away from at least half of the known nodes`](/docs/v24.3/common-errors#clock-synchronization-error-this-node-is-more-than-500ms-away-from-at-least-half-of-the-known-nodes)
...
- **Message**: `WARNING: The server appears to be unable to contact the other nodes in the cluster.`
    ...
    - **See also**: [Troubleshoot Self-Hosted Setup](/docs/v24.3/cluster-setup-troubleshooting)
...
- **Message**: `transport: Error while dialing cannot reuse client connection`
    ...
    - **Related metrics**: NONE
    - **See also**: NONE
- **Message**: One or more of the following: `first range unavailable; trying remaining addresses` `first range unavailable; resolvers exhausted`
    - **Severity**: High
...
- **Message**: `raft receive queue for r{nn} is full`
    ...
    - **Related metrics**: NONE
    - **See also**: [Hot Ranges page](/docs/v24.3/ui-hot-ranges-page)
...
- **Message**: `range unavailable: have been waiting 60.00s for proposing command RequestLease`
    ...
    - **See also**:
        - [KV replication](/docs/v24.3/essential-metrics-self-hosted#kv-replication)
        - [Replication issues](/docs/v24.3/cluster-setup-troubleshooting#replication-issues)

## See also

- [Logging Best Practices](/docs/v24.3/logging-best-practices)
