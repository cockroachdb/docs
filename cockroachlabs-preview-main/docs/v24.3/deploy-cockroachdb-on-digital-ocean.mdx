...
<LinkedPageTabs
  currentPath="/docs/v24.3/deploy-cockroachdb-on-digital-ocean"
  items={[
    {
      title: "Secure",
...
<Note>
If you would prefer to use HAProxy instead of Digital Ocean's managed load balancing, see the [On-Premises](/docs/v24.3/deploy-cockroachdb-on-premises) tutorial for guidance.
</Note>
