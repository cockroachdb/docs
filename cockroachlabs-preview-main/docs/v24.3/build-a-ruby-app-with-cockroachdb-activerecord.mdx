...
<LinkedPageTabs
  currentPath="/docs/v24.3/build-a-ruby-app-with-cockroachdb-activerecord"
  items={[
    {
      title: "Use pg",
      href: "/docs/v24.3/build-a-ruby-app-with-cockroachdb",
    },
    {
      title: "Use ActiveRecord",
      href: "/docs/v24.3/build-a-ruby-app-with-cockroachdb-activerecord",
    },
  ]}
/>
