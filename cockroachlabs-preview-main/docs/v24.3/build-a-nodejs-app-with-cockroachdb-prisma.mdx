...
<LinkedPageTabs
  currentPath="/docs/v24.3/build-a-nodejs-app-with-cockroachdb-prisma"
  items={[
    {
...
<Note>
In [production](/docs/v24.3/recommended-production-settings#transaction-retries), we recommend implementing [client-side retry handling](/docs/v24.3/transaction-retry-error-reference#client-side-retry-handling) for all database operations.
</Note>
