...
<LinkedPageTabs
  currentPath="/docs/v24.3/build-a-python-app-with-cockroachdb-asyncpg"
  items={[
    {
      title: "Use psycopg3",
...
1. If you haven't already, [sign up for a CockroachDB Cloud account](https://cockroachlabs.cloud/signup?referralId=docs_python_asyncpg).
...
2. Run the code:
    ...
    <Note>
    The example code sets the [`multiple_active_portals_enabled` session variable](/docs/v24.3/postgresql-compatibility#multiple-active-portals) to `true`, a requirement for using `asyncpg` with CockroachDB.
    </Note>
