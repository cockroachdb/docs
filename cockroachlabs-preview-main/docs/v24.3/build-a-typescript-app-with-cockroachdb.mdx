...
<LinkedPageTabs
  currentPath="/docs/v24.3/build-a-typescript-app-with-cockroachdb"
  items={[
    {
...
1. If you haven't already, [sign up for a CockroachDB Cloud account](https://cockroachlabs.cloud/signup?referralId=docs_typescript_typeorm).
