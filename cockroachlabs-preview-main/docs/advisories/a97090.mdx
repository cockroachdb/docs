...
old_description: "Queries planned with a zigzag join could produce incorrect results if the two indexes used for the join had a matching suffix of index key columns where the ..."
---
...
The fix has been applied to maintenance releases of CockroachDB [v22.1.16](/docs/releases/v22.1#v22-1-16) and [v22.2.6](/docs/releases/v22.2#v22-2-6).

This public issue is tracked by [#97090](https://github.com/cockroachdb/cockroach/issues/97090).

## Mitigation

Users of CockroachDB [v19.1](/docs/releases#v19-1) to [v22.1.15](/docs/releases/v22.1#v22-1-15) and [v22.2.0](/docs/releases/v22.2#v22-2-0) to [v22.2.5](/docs/releases/v22.2#v22-2-5) are encouraged to upgrade to [v22.1.16](/docs/releases/v22.1#v22-1-16), [v22.2.6](/docs/releases/v22.2#v22-2-6), or a later version.
...
The best mitigation, however, is to upgrade to [v22.1.16](/docs/releases/v22.1#v22-1-16) or [v22.2.6](/docs/releases/v22.2#v22-2-6) as soon as possible.

## Impact

Some queries planned with a zigzag join could produce incorrect results if the two indexes used for the zigzag join had a matching suffix of index key columns where the direction (`ASC`/`DESC`) was different between the two indexes. Versions affected include all versions of CockroachDB [v19.1](/docs/releases#v19-1) to [v22.1.15](/docs/releases/v22.1#v22-1-15) and [v22.2.0](/docs/releases/v22.2#v22-2-0) to [v22.2.5](/docs/releases/v22.2#v22-2-5).
