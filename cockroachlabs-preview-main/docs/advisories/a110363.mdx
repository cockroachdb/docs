...
old_description: "Clusters using row-level TTL and upgraded from v22.2.x to 23.1.9 may experience nodes crashing due to the erroneous deletion of a necessary metadata field."
---
