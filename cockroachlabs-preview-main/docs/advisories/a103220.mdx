...
old_description: "Inserting rows into a multi-column-family table with COPY can corrupt the table, making future reads fail with internal errors."
---
...
This fix has been applied to maintenance releases of CockroachDB [v23.1.1](/docs/releases/v23.1#v23-1-1) and later.
