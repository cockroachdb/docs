...
old_description: "Clusters that are upgraded to v22.2.4 when a previous upgrade to v22.2.x  has not been finalized exhibit a bug that prevents non-admin users from connecting ..."
---
...
Users of CockroachDB 22.2.4 that experience this issue should either [finalize the upgrade](/docs/stable/upgrade-cockroach-version#step-5-finish-the-upgrade) or roll back to the version that they were using before the upgrade.
