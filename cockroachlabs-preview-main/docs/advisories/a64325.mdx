...
old_description: "Race condition between reads and replica removal"
---
...
This is resolved in CockroachDB by PR [#64324](https://github.com/cockroachdb/cockroach/pull/64324), which fixes the race condition between read requests and replica removal.

The fix has been applied to maintenance releases of CockroachDB v20.1, v20.2, and v21.1.

This public issue is tracked by [#64325](https://github.com/cockroachdb/cockroach/issues/64325).
