...
old_description: "During or after an upgrade from CockroachDB v21.2.x to v22.1.0, existing changefeeds will stop emitting data."
---
...
This bug has been fixed in CockroachDB [v22.1.1](/docs/releases/v22.1#v22-1-1).
...
The fix has been applied to maintenance version [v22.1.1](/docs/releases/v22.1#v22-1-1) of CockroachDB.

This public issue is tracked by [#82309](https://github.com/cockroachdb/cockroach/issues/82309).

## Mitigation

If you have not yet upgraded to a v22.1 major version, upgrade to the [v22.1.1](/docs/releases/v22.1#v22-1-1) patch release or later.
