...
old_description: "CockroachDB may display higher than expected values for histogram metrics when calculating quantiles."
---
...
In CockroachDB [v22.2.0](/docs/releases/v22.2#v22-2-0), [v22.2.1](/docs/releases/v22.2#v22-2-1), [v22.2.2](/docs/releases/v22.2#v22-2-2), and [v22.2.3](/docs/releases/v22.2#v22-2-3), new Prometheus histogram buckets were defined for metrics to reduce the overall number of timeseries metrics generated per Prometheus histogram to 15, from a previously dynamically generated number of buckets exceeding 100 buckets. We had received feedback from customers that prior versions of CockroachDB generated an unmanageable number of histogram buckets, which is what led to this change.
...
This issue is resolved in the CockroachDB [v22.2.5](/docs/releases/v22.2#v22-2-5) maintenance release, by increasing the fidelity of the histogram buckets.
