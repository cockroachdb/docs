...
old_description: "When adding a new column using the new declarative schema changer, CockroachDB retrieves a unique secondary index mistakenly, assuming it to be a primary index."
---
...
The fix has been applied to [v22.2.12](/docs/releases/v22.2#v22-2-12) and [v23.1.6](/docs/releases/v23.1#v23-1-6).
...
Additionally, users of CockroachDB [v22.2.0–v22.2.11](/docs/releases/v22.2) are encouraged to upgrade to [v22.2.12](/docs/releases/v22.2#v22-2-12). Similarly, users of [v23.1.0—v23.1.5](/docs/releases/v23.1) are encouraged to update to [v23.1.6](/docs/releases/v23.1#v23-1-6).
