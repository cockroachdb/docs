...
old_description: "Importing duplicate keys can cause violations of UNIQUE constraints"
---
...
This is resolved in CockroachDB by [PR 79293](https://github.com/cockroachdb/cockroach/pull/79293). The fix was applied in the maintenance release of [CockroachDB v21.2.8](/docs/releases/v21.2#v21-2-8).
