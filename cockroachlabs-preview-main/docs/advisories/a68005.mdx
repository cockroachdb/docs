...
old_description: "sql.trace.txn.enable_threshold cluster setting causes crash loops"
---
...
This is resolved in CockroachDB by PR [#68002](https://github.com/cockroachdb/cockroach/pull/68002), which fixes the miuse of the tracing API.

The fix has been applied to maintenance releases of CockroachDB v21.1, and is available in v21.1.7+.

This bug is publicly tracked as [#68005](https://github.com/cockroachdb/cockroach/issues/68005).
