...
old_description: "Backups fail during upgrade process"
---
...
You can track releases on [CockroachDB Releases Overview](/docs/releases).
...
- Finalizing the upgrade. Note: You cannot roll back after finalization is complete.
...
Please review our upgrade documentation for details on the upgrade process.
