...
old_description: "HTTP authentication for non-Enterprise users"
---
...
Following the fix for [Advisory 42567](/docs/advisories/a42567), CockroachDB from versions v2.1.10, v19.1.6, and v19.2.2 onward now limit access to privileged HTTP endpoints (privileged Admin UI pages and monitoring APIs) to authenticated admin users. However, the SQL root user specifically is currently not able to log in via HTTP.
