...
old_description: "Altering a non-empty table to add a column with a DEFAULT expression in which the type of the expression did not match the type of the new column could cause..."
---
...
The fix has been applied to the maintenance release of CockroachDB [v22.2.5](/docs/releases/v22.2#v22-2-5).

This public issue is tracked by [#93398](https://github.com/cockroachdb/cockroach/issues/93398).

## Mitigation

We encourage users of CockroachDB [v22.2.0-alpha.1](/docs/releases/v22.2#v22-2-0-alpha-1) to [v22.2.3](/docs/releases/v22.2#v22-2-3) to upgrade to [v22.2.5](/docs/releases/v22.2#v22-2-5) or a later version.
