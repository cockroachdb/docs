...
old_description: "HTTP requests can cause full-cluster denial of service (DoS)"
---
...
This is resolved in CockroachDB by PR [#58716](https://github.com/cockroachdb/cockroach/pull/58716) which fixes the decoding routine of protobuf payloads.

The fix has been applied to maintenance releases of CockroachDB v19.2, v20.1, and v21.1.

This public issue is tracked as [#58932](https://github.com/cockroachdb/cockroach/issues/58932).
