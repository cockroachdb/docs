...
old_description: "The optimizer could plan queries that use semi-joins against multi-region REGIONAL BY ROW tables incorrectly"
---
...
The fix has been applied to [21.2.1](/docs/releases/v21.2#v21-2-1).
