...
old_description: "Schema changes may cause cluster unavailability"
---
...
The public issue is tracked as [#44299](https://github.com/cockroachdb/cockroach/issues/44299).
