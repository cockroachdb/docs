...
old_description: "The optimizer has been found to create logically incorrect query plans in some cases."
---
...
Users of CockroachDB are encouraged to upgrade to a maintenance version with the fix applied: [v21.1.17](/docs/releases/v21.1#v21-1-17) and [v21.2.8](/docs/releases/v21.2#v21-2-8).
