...
old_description: "CockroachDB v21.1.9 drops WHERE predicates from prepared statements in specific circumstances"
---
...
This bug was resolved in CockroachDB by PR [71035](https://github.com/cockroachdb/cockroach/pull/71035). The fix has been applied to CockroachDB 21.1.10. This public issue is tracked by [71002](https://github.com/cockroachdb/cockroach/issues/71002).
