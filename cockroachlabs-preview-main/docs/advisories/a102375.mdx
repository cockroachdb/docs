...
old_description: "Some customers may experience spurious privilege errors when trying to run queries due to a bug in the query cache."
---
...
The fix has been applied to the maintenance release of CockroachDB [v22.2.9](/docs/releases/v22.2#v22-2-9).
