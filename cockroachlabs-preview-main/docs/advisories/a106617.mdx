...
old_description: "When the encryption-at-rest registry rolls over, the append-only log file contains a bug that could result in loss of the store."
---
...
The fix has been applied to maintenance releases of CockroachDB [v23.1.8](/docs/releases/v23.1#v23-1-8), [v22.2.13](/docs/releases/v22.2#v22-2-13), v22.1.22.
