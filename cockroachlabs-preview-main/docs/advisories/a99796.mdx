...
old_description: "After upgrading to CockroachDB v22.2.0-v22.2.7, a bug could cause primary index corruption when an ALTER TABLE..ADD COLUMN statement executes concurrently wi..."
---
...
The fix has been applied to maintenance releases of CockroachDB: [v22.2.8](/docs/releases/v22.2#v22-2-8).

This public issue is tracked by [#99796](https://github.com/cockroachdb/cockroach/issues/99796).

## Mitigation

Users of CockroachDB v22.2.0 to v22.2.7 are encouraged to upgrade to [v22.2.8](/docs/releases/v22.2#v22-2-8) or a later version.
...
After upgrading to CockroachDB [v22.2.0](/docs/releases/v22.2#v22-2-0)-[v22.2.7](/docs/releases/v22.2#v22-2-7), a bug could cause primary index corruption when an `ALTER TABLE..ADD COLUMN` statement executes concurrently with an `UPDATE` or `INSERT` command, and the schema change fails and is rolled back.
