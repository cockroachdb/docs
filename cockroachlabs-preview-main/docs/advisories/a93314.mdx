...
old_description: "CockroachDB crashes when a user-defined function is created using any implicit record type which contains a column of user-defined ENUM type as the function’..."
---
...
The fix has been applied to maintenance releases of CockroachDB [v22.2.2](/docs/releases/v22.2#v22-2-2) and later.

This public issue is tracked by [#93314](https://github.com/cockroachdb/cockroach/issues/93314).

## Mitigation

Users of CockroachDB [v22.2.0](/docs/releases/v22.2#v22-2-0) and [v22.2.1](/docs/releases/v22.2#v22-2-1) should avoid creating a [user-defined function (UDF)](https://www.cockroachlabs.com/docs/v22.2/user-defined-functions) using any implicit record type that contains a field of user-defined [`ENUM`](https://www.cockroachlabs.com/docs/v22.2/enum) type as the function’s parameter type or return type.
