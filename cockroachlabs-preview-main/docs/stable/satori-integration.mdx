...
old_description: "Row or column-level access control and dynamic masking of data with Satori"
---

Satori offers tooling to extend CockroachDB's data security capabilities. Satori's Data Access Controller (DAC) can be used in concert with CockroachDB Advanced or CockroachDB self-hosted.
