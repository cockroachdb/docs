...
<LinkedPageTabs
  currentPath="/docs/v26.1/build-a-nodejs-app-with-cockroachdb"
  items={[
    {
      title: "Use node-postgres",
      href: "/docs/v26.1/build-a-nodejs-app-with-cockroachdb",
    },
    {
      title: "Use Sequelize",
      href: "/docs/v26.1/build-a-nodejs-app-with-cockroachdb-sequelize",
    },
    {
      title: "Use Knex.js",
      href: "/docs/v26.1/build-a-nodejs-app-with-cockroachdb-knexjs",
    },
    {
      title: "Use Prisma",
      href: "/docs/v26.1/build-a-nodejs-app-with-cockroachdb-prisma",
    },
    {
      title: "Use TypeORM",
      href: "/docs/v26.1/build-a-typescript-app-with-cockroachdb",
    },
  ]}
/>
...
<Note>
This tutorial assumes you are running under [`SERIALIZABLE`](/docs/v26.1/demo-serializable) isolation, which requires client-side retry handling for [serialization errors](/docs/v26.1/transaction-retry-error-reference).
</Note>
...
All of the database operations are wrapped in a helper function named `retryTxn`. This function attempts to commit statements in the context of an explicit transaction. If a [retry error](/docs/v26.1/transaction-retry-error-reference) is thrown, the wrapper will retry committing the transaction, with [exponential backoff](https://wikipedia.org/wiki/Exponential_backoff), until the maximum number of retries is reached (by default, 15).
...
3. To initialize the example database, use the [`cockroach sql`](/docs/v26.1/cockroach-sql) command to execute the SQL statements in the `dbinit.sql` file:
