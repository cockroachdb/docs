...
- Run at least 3 nodes to [ensure survivability](/docs/v26.1/recommended-production-settings#topology).
...
<Note>
If you would prefer to use HAProxy instead of Azure's managed load balancing, see the [On-Premises](/docs/v26.1/deploy-cockroachdb-on-premises) tutorial for guidance.
</Note>
