...
- [Reserved Keywords](/docs/v26.1/sql-grammar#reserved_keyword)
- [Type Function Name Keywords](/docs/v26.1/sql-grammar#type_func_name_keyword)
- [Column Name Keywords](/docs/v26.1/sql-grammar#col_name_keyword)
- [Unreserved Keywords](/docs/v26.1/sql-grammar#unreserved_keyword)
...
- **Syntax**, covered in our pages [SQL Statements](/docs/v26.1/sql-statements) and [SQL Grammar](/docs/v26.1/sql-grammar)
...
In our [SQL grammar](/docs/v26.1/sql-grammar), all values that accept an `identifier` must:
...
- Not equal any [SQL keyword](#keywords) unless the keyword is accepted by the element's syntax. For example, [`name`](/docs/v26.1/sql-grammar#name) accepts Unreserved or Column Name keywords.
...
<Note>
Some statements have additional requirements for identifiers. For example, each table in a database must have a unique name. These requirements are documented on [each statement's page](/docs/v26.1/sql-statements).
</Note>

## See also

- [SQL Statements](/docs/v26.1/sql-statements)
- [Full SQL Grammar](/docs/v26.1/sql-grammar)
