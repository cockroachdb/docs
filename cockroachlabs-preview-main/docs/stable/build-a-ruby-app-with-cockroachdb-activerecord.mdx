...
<LinkedPageTabs
  currentPath="/docs/v26.1/build-a-ruby-app-with-cockroachdb-activerecord"
  items={[
    {
      title: "Use pg",
      href: "/docs/v26.1/build-a-ruby-app-with-cockroachdb",
    },
    {
      title: "Use ActiveRecord",
      href: "/docs/v26.1/build-a-ruby-app-with-cockroachdb-activerecord",
    },
  ]}
/>
