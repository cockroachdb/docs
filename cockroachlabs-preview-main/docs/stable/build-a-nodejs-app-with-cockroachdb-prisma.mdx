...
<LinkedPageTabs
  currentPath="/docs/v26.1/build-a-nodejs-app-with-cockroachdb-prisma"
  items={[
    {
...
<Note>
In [production](/docs/v26.1/recommended-production-settings#transaction-retries), we recommend implementing [client-side retry handling](/docs/v26.1/transaction-retry-error-reference#client-side-retry-handling) for all database operations.
</Note>
