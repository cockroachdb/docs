...
<LinkedPageTabs
  currentPath="/docs/v26.1/performance-benchmarking-with-tpcc-local"
  items={[
    {
      title: "Local",
...
1. In separate terminal windows, use the [`cockroach start`](/docs/v26.1/cockroach-start) command to start 3 nodes:
...
Use [`cockroach workload`](/docs/v26.1/cockroach-workload) to load the initial schema and data:
