...
CockroachDB [changefeeds](/docs/v26.1/change-data-capture-overview) can stream change data out to [Apache Kafka](https://kafka.apache.org/) using OAuth authentication.
...
- A CockroachDB cluster. You can use a CockroachDB Cloud or CockroachDB self-hosted cluster.
    - If you are using CockroachDB Basic, Standard, or Advanced, see the [Quickstart with CockroachDB](/docs/stable/cockroachcloud/quickstart) guide. For CockroachDB self-hosted clusters, see the [install](/docs/v26.1/install-cockroachdb) page.
...
Since this is a long URI to run, you can create an [external connection](/docs/v26.1/create-external-connection) to represent this URI:
