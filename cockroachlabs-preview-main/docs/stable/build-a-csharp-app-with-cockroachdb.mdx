...
2. Start the [built-in SQL shell](/docs/v26.1/cockroach-sql) using the connection string you got from the CockroachDB Cloud Console:
...
1. If you haven't already, [download the CockroachDB binary](/docs/v26.1/install-cockroachdb).
2. Run the [`cockroach demo`](/docs/v26.1/cockroach-demo) command:
...
However, if you want to verify that funds were transferred from one account to another, use the [built-in SQL client](/docs/v26.1/cockroach-sql):
