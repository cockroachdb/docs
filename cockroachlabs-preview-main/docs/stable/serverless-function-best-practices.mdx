...
Use [connection pools](/docs/v26.1/connection-pooling) to manage the lifecycle of database connections established by serverless functions. Connection pools check connection health and re-establish broken connections in the event of a communication error.
...
- [Create and Deploy an AWS Lambda Function Built on CockroachDB](/docs/v26.1/deploy-lambda-function)
- [Connect to your Cluster](/docs/v26.1/connect-to-the-database)
