...
<Note>
If you would prefer to use HAProxy instead of Digital Ocean's managed load balancing, see the [On-Premises](/docs/v26.1/deploy-cockroachdb-on-premises) tutorial for guidance.
</Note>
