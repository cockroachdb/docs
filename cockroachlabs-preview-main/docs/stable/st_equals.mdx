...
<Note>
  `ST_Equals` will attempt to use any available [spatial index](/docs/v26.1/spatial-indexes) to speed up its operation.
...
<Frame>![ST_Equals - true](/images/v26.1/geospatial/st_equals_true.png)</Frame>
...
<Frame>![ST_Equals - false](/images/v26.1/geospatial/st_equals_false.png)</Frame>
