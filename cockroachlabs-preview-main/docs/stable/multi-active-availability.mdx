...
To get a greater understanding of how CockroachDB is a survivable system that enforces strong consistency, check out our [architecture documentation](/docs/v26.1/architecture/overview).

To see Multi-Active Availability in action, see this [availability demo](/docs/v26.1/demo-cockroachdb-resilience).
