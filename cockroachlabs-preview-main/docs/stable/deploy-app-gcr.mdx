...
1. If you haven't already, [download the CockroachDB SQL Shell binary](/docs/v26.1/install-cockroachdb).
2. Start the [built-in SQL shell](/docs/v26.1/cockroach-sql) using the connection string you got from the CockroachDB Cloud Console earlier:
...
- [Build a Simple Django App with CockroachDB](/docs/v26.1/build-a-python-app-with-cockroachdb-django)
