...
<LinkedPageTabs
  currentPath="/docs/v26.1/build-a-java-app-with-cockroachdb-hibernate"
  items={[
    {
      title: "Use JDBC",
...
<Note>
The version of the CockroachDB Hibernate dialect in `hibernate.cfg.xml` corresponds to a version of CockroachDB. For more information, see [Install Client Drivers: Hibernate](/docs/v26.1/install-client-drivers).
</Note>
