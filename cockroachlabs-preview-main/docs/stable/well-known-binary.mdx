...
- Allow shapes to be transferred between CockroachDB and a [SQL client](/docs/v26.1/cockroach-sql) or [application](/docs/v26.1/build-a-java-app-with-cockroachdb).
...
The Extended Well Known Binary (_EWKB_) format is the same as WKB, with an [SRID](/docs/v26.1/architecture/glossary#srid) representation prepended to the data structure.
