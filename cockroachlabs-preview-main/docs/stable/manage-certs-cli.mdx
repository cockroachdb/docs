...
The CockroachDB CLI's [`cockroach cert`](/docs/v26.1/cockroach-cert) command allows you to generate [private key/public certificate pairs for TLS authentication and encryption](/docs/v26.1/security-reference/transport-layer-security) in communication between CockroachDB nodes, and from SQL clients to the cluster.
