...
This page guides you through deploying an application and database in multiple regions. It is the fifth and final section of the [Develop and Deploy a Global Application](/docs/v23.2/movr#develop-and-deploy-a-global-application) tutorial.

## Before you begin

Before you begin this section, complete the previous section of the tutorial, [Develop a Multi-Region Web Application](/docs/v23.2/movr-flask-application). After you finish developing and debugging your multi-region application in a local development environment, you are ready to deploy the application and database in multiple regions.

In addition to the requirements listed in [Setting Up a Virtual Environment for Developing Multi-Region Applications](/docs/v23.2/movr-flask-setup), make sure that you have the following:
...
<Note>
You can also deploy CockroachDB manually. For instructions, see the [Manual Deployment](/docs/v23.2/manual-deployment) page of the Cockroach Labs documentation site.
</Note>
