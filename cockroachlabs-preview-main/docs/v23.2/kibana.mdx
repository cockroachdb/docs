...
<Note>
This tutorial assumes that you have [started a secure CockroachDB cluster](/docs/v23.2/secure-a-cluster). [CockroachDB Cloud](/docs/cockroachcloud) does not expose a compatible monitoring endpoint.
</Note>
...
For example, if you used [`cockroach cert`](/docs/v23.2/cockroach-cert) to [secure your cluster](/docs/v23.2/secure-a-cluster#step-1-generate-certificates), the YAML should look like:
...
<Frame>
  ![CockroachDB dashboard selection for Metricbeat](/images/v23.2/kibana-crdb-dashboard-selection.png)
</Frame>

Click the dashboard title to open the dashboard, which presents metrics on replicas and query performance:

<Frame>
  ![CockroachDB Overview dashboard for Metricbeat](/images/v23.2/kibana-crdb-dashboard.png)
</Frame>
...
<Frame>
  ![CockroachDB Overview dashboard for Metricbeat with SQL metrics](/images/v23.2/kibana-crdb-dashboard-sql.png)
</Frame>
