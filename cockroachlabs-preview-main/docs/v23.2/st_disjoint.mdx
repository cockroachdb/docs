...
<Note>
`ST_Disjoint` does not make use of [spatial indexes](/docs/v23.2/spatial-indexes).
</Note>

<Note>
This function is the inverse of [`ST_Intersects`](/docs/v23.2/st_intersects).
</Note>
...
<Frame>
  ![ST_Disjoint - true](/images/v23.2/geospatial/st_disjoint_true.png)
</Frame>
...
<Frame>
  ![ST_Disjoint - false](/images/v23.2/geospatial/st_disjoint_false.png)
</Frame>
