...
<LinkedPageTabs
  currentPath="/docs/v23.2/deploy-cockroachdb-on-google-cloud-platform-insecure"
  items={[
    {
      title: "Secure",
...
3. [Connect your application](/docs/v23.2/install-client-drivers). Be sure to connect your application to the GCE load balancer, not to a CockroachDB node.
