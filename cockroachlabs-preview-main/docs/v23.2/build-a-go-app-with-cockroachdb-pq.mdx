...
old_description: "Learn how to use CockroachDB from a simple Go application with the Go pq driver."
---

import { LinkedPageTabs } from "/snippets/LinkedPageTabs.jsx";

<LinkedPageTabs
  currentPath="/docs/v23.2/build-a-go-app-with-cockroachdb-pq"
  items={[
    {
      title: "Use pgx",
      href: "/docs/v23.2/build-a-go-app-with-cockroachdb",
    },
    {
      title: "Use GORM",
      href: "/docs/v23.2/build-a-go-app-with-cockroachdb-gorm",
    },
    {
      title: "Use lib/pq",
      href: "/docs/v23.2/build-a-go-app-with-cockroachdb-pq",
    },
    {
      title: "Use upper/db",
      href: "/docs/v23.2/build-a-go-app-with-cockroachdb-upperdb",
    },
  ]}
/>
...
- Execute a batch of statements as an atomic [transaction](/docs/v23.2/transactions).

    Note that CockroachDB may require the [client to retry a transaction](/docs/v23.2/transactions#transaction-retries) in the case of read/write [contention](/docs/v23.2/performance-best-practices-overview#transaction-contention). The [CockroachDB Go client](https://github.com/cockroachdb/cockroach-go) includes a generic **retry function** (`ExecuteTx()`) that runs inside a transaction and retries it as needed. The code sample shows how you can use this function to wrap SQL statements.
