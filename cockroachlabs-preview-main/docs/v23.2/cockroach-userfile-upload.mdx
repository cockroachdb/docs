...
The `cockroach userfile upload` [command](/docs/v23.2/cockroach-commands) uploads a file to the [user-scoped file storage](/docs/v23.2/use-userfile-storage) using a SQL connection.
...
<Tip>
If you would like to upload and import data from a dump file, consider using [`cockroach import`](/docs/v23.2/cockroach-import) instead.
</Tip>
...
Then, you can use the file to [`IMPORT`](/docs/v23.2/import) or [`IMPORT INTO`](/docs/v23.2/import-into) data.
...
To upload the contents of a directory to userfile storage, specify a source directory and destination. For example, to upload a [backup](/docs/v23.2/backup) directory to userfile storage:
