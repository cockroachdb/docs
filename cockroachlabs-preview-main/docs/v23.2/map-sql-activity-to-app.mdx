...
Once you set the application name, the [DB Console](/docs/v23.2/ui-overview) lets you [filter database workloads by application name](/docs/v23.2/ui-statements-page#filter).

<Frame>
  ![Movr app filter](/images/v23.2/movr-app.png)
</Frame>
...
Often signals to problems start at high-level metrics. The [SQL dashboard](/docs/v23.2/ui-sql-dashboard) has metrics for [SQL sessions](/docs/v23.2/ui-sql-dashboard#open-sql-sessions), [SQL statements](/docs/v23.2/ui-sql-dashboard#active-sql-statements), [SQL statement errors](/docs/v23.2/ui-sql-dashboard#sql-statement-errors), etc., that can quickly signify potential issues with your application.
...
- [SQL Activity](/docs/v23.2/ui-overview#sql-activity)
- [SQL Performance Best Practices](/docs/v23.2/performance-best-practices-overview)
- [Troubleshoot Statement Behavior](/docs/v23.2/query-behavior-troubleshooting)
