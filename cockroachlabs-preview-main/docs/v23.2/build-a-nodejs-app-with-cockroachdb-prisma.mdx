...
<LinkedPageTabs
  currentPath="/docs/v23.2/build-a-nodejs-app-with-cockroachdb-prisma"
  items={[
    {
...
<Note>
In [production](/docs/v23.2/recommended-production-settings#transaction-retries), we recommend implementing [client-side retry handling](/docs/v23.2/transaction-retry-error-reference#client-side-retry-handling) for all database operations.
</Note>
