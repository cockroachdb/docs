...
To view this dashboard, [access the DB Console](/docs/v23.2/ui-overview#db-console-access), click **Metrics** on the left-hand navigation bar, and select **Dashboard** &gt; **Runtime**.
...
<Frame>
  ![DB Console Node Count](/images/v23.2/ui_node_count.png)
</Frame>
...
<Frame>
  ![DB Console Memory Usage](/images/v23.2/ui_memory_usage.png)
</Frame>
...
<Frame>
  ![DB Console CPU Time](/images/v23.2/ui_cpu_time.png)
</Frame>
...
<Frame>
  ![DB Console Clock Offset](/images/v23.2/ui_clock_offset.png)
</Frame>
