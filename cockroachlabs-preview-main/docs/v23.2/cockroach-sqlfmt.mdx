...
The `cockroach sqlfmt` [command](/docs/v23.2/cockroach-commands) changes the textual formatting of one or more SQL queries. It recognizes all SQL extensions supported by CockroachDB.
