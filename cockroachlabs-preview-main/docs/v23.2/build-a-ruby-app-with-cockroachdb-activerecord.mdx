...
<LinkedPageTabs
  currentPath="/docs/v23.2/build-a-ruby-app-with-cockroachdb-activerecord"
  items={[
    {
      title: "Use pg",
      href: "/docs/v23.2/build-a-ruby-app-with-cockroachdb",
    },
    {
      title: "Use ActiveRecord",
      href: "/docs/v23.2/build-a-ruby-app-with-cockroachdb-activerecord",
    },
  ]}
/>
