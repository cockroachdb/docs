...
<Tip>
This tutorial explores the CockroachDB self-hosted integration with Prometheus. For the CockroachDB Cloud integration with Prometheus, refer to [Export Metrics From a CockroachDB Standard Cluster](/docs/cockroachcloud/export-metrics?filters=prometheus-metrics-export) or [Export Metrics From a CockroachDB Advanced Cluster](/docs/cockroachcloud/export-metrics-advanced?filters=prometheus-metrics-export) instead of this page.
</Tip>

## Before you begin

- Make sure you have already started a CockroachDB cluster, either [locally](/docs/v23.2/start-a-local-cluster) or in a [production environment](/docs/v23.2/manual-deployment).
...
7. Now that Alertmanager is configured and running, you can optionally [import pre-existing rules or create your own](/docs/v23.2/monitoring-and-alerting#alertmanager) if you prefer.
