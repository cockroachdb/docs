...
To view this dashboard, [access the DB Console](/docs/v23.2/ui-overview#db-console-access), click **Metrics** in the left-hand navigation, and select **Dashboard** &gt; **Hardware**.
...
<Frame>
  ![DB Console CPU Percent graph](/images/v23.2/ui_host_cpu_percent.png)
</Frame>
...
<Frame>
  ![DB Console Memory Usage graph](/images/v23.2/ui_memory_usage_new.png)
</Frame>
...
<Frame>
  ![DB Console Disk Read Bytes graph](/images/v23.2/ui_disk_read_bytes.png)
</Frame>
...
<Frame>
  ![DB Console Disk Write Bytes graph](/images/v23.2/ui_disk_write_bytes.png)
</Frame>
...
<Frame>
  ![DB Console Disk Read Ops graph](/images/v23.2/ui_disk_read_ops.png)
</Frame>
...
<Frame>
  ![DB Console Disk Write Ops graph](/images/v23.2/ui_disk_write_ops.png)
</Frame>
...
<Frame>
  ![DB Console Disk Capacity graph](/images/v23.2/ui_available_disk_capacity.png)
</Frame>
