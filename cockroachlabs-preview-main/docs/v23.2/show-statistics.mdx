...
import { ShowStatistics2 } from "/snippets/syntax-diagrams/ShowStatistics2.jsx";

The `SHOW STATISTICS` [statement](/docs/v23.2/sql-statements) lists [table statistics](/docs/v23.2/create-statistics) used by the [cost-based optimizer](/docs/v23.2/cost-based-optimizer).

By default, CockroachDB [automatically generates statistics](/docs/v23.2/cost-based-optimizer#table-statistics) on all indexed columns and up to 100 non-indexed columns, and automatically collects [multi-column statistics](/docs/v23.2/create-statistics#create-statistics-on-multiple-columns) on the columns that prefix each index.
...
To list table statistics, the user must have any [privilege](/docs/v23.2/security-reference/authorization#managing-privileges) on the table being inspected.
...
The `WITH FORECAST` option calculates and displays [forecasted statistics](/docs/v23.2/cost-based-optimizer#forecasted-statistics) along with the existing table statistics.
