...
CockroachDB v25.4 is a required [Regular release](/docs/releases#major-versions).
...
- After downloading a supported CockroachDB binary, learn how to [install CockroachDB](/docs/v25.4/install-cockroachdb) or [upgrade your cluster](/docs/v25.4/upgrade-cockroach-version).
...
Before [upgrading to CockroachDB v25.4](/docs/v25.4/upgrade-cockroach-version), be sure to also review the following [Upgrade Details](#v25-4-0-upgrade-details):
...
Changes to [cluster settings](/docs/v25.4/cluster-settings) should be reviewed prior to upgrading. New default cluster setting values will be used unless you have manually set a value for a setting. This can be confirmed by running the SQL statement `SELECT * FROM system.settings` to view the non-default settings.
...
- Casting subqueries to [user-defined types](/docs/v25.4/create-type) (including `ENUM` s) in views is not supported. [#108184](https://github.com/cockroachdb/cockroach/issues/108184)
