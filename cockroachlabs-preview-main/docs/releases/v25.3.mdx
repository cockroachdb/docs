...
CockroachDB v25.3 is an optional [Innovation release](/docs/releases#major-versions). This version can be skipped for CockroachDB Advanced and self-hosted clusters. It is unavailable for CockroachDB Standard and CockroachDB Basic clusters.
...
Before [upgrading to CockroachDB v25.3](https://www.cockroachlabs.com/docs/v25.3/upgrade-cockroach-version), be sure to also review the following [Upgrade Details](#v25-3-0-upgrade-details):
...
Changes to [cluster settings](https://www.cockroachlabs.com/docs/v25.3/cluster-settings) should be reviewed prior to upgrading. New default cluster setting values will be used unless you have manually set a value for a setting. This can be confirmed by running the SQL statement `SELECT * FROM system.settings` to view the non-default settings.
...
For information about new and unresolved limitations in CockroachDB v25.3, with suggested workarounds where applicable, refer to [Known Limitations](https://www.cockroachlabs.com/docs/v25.3/known-limitations).
...
- Introduced the following cluster settings for enabling and configuring [value separation in the storage engine](https://www.cockroachlabs.com/docs/v25.3/architecture/storage-layer#value-separation): `storage.value_separation.enabled`, `storage.value_separation.minimum_size`, and `storage.value_separation.max_reference_depth`. [#148535](https://github.com/cockroachdb/cockroach/pull/148535)
...
- Added new timeseries metrics to the `storage.value_separation.*` namespace for observing the behavior of [storage engine value separation](https://www.cockroachlabs.com/docs/v25.3/architecture/storage-layer#value-separation). [#147728](https://github.com/cockroachdb/cockroach/pull/147728)
