...
Use [connection pools](/docs/v25.4/connection-pooling) to manage the lifecycle of database connections established by serverless functions. Connection pools check connection health and re-establish broken connections in the event of a communication error.
...
- [Create and Deploy an AWS Lambda Function Built on CockroachDB](/docs/v25.4/deploy-lambda-function)
- [Connect to your Cluster](/docs/v25.4/connect-to-the-database)
