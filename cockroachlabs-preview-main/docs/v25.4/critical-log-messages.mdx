...
- **Message**: `disk stall detected: unable to sync log files within`
    ...
    - **See also**: [Disk stalls](/docs/v25.4/cluster-setup-troubleshooting#disk-stalls)
...
- **Message**: `possible decommission stall detected`
    ...
    - **See also**:
        - [Node decommission](/docs/v25.4/cockroach-node#node-decommission)
...
- **Message**: One or more of the following: `ERROR: drain timeout` `error releasing lease`
    ...
    - **Related metrics**: NONE
    - **See also**: [Drain timeout](/docs/v25.4/node-shutdown#drain-timeout)
...
- **Message**: `slow heartbeat took %s; err=context deadline exceeded`
    ...
    - **See also**:
        - [Node liveness issues](/docs/v25.4/cluster-setup-troubleshooting#node-liveness-issues)
        - [`context deadline exceeded`](/docs/v25.4/common-errors#context-deadline-exceeded)
- **Message**: `unable to connect to n%d: failed to connect to n%d at ‹hostname:port›: ‹initial connection heartbeat failed›`
    ...
    - **Related metrics**: NONE
    - **See also**: [Network partition](/docs/v25.4/cluster-setup-troubleshooting#network-partition)
...
- **Message**: `clock synchronization error: this node is more than 500ms away from at least half of the known nodes`
    ...
    - **See also**: [`clock synchronization error: this node is more than 500ms away from at least half of the known nodes`](/docs/v25.4/common-errors#clock-synchronization-error-this-node-is-more-than-500ms-away-from-at-least-half-of-the-known-nodes)
...
- **Message**: `WARNING: The server appears to be unable to contact the other nodes in the cluster.`
    ...
    - **See also**: [Troubleshoot Self-Hosted Setup](/docs/v25.4/cluster-setup-troubleshooting)
...
- **Message**: `raft receive queue for r{nn} is full`
    ...
    - **Related metrics**: NONE
    - **See also**: [Top Ranges page](/docs/v25.4/ui-top-ranges-page)
...
- **Message**: `range unavailable: have been waiting 60.00s for proposing command RequestLease`
    ...
    - **See also**:
        - [KV replication](/docs/v25.4/essential-metrics-self-hosted#kv-replication)
        - [Replication issues](/docs/v25.4/cluster-setup-troubleshooting#replication-issues)

## See also

- [Logging Best Practices](/docs/v25.4/logging-best-practices)
