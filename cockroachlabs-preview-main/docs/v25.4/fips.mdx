...
As an [Innovation release](/docs/releases#major-versions), v26.1 can be skipped by CockroachDB self-hosted clusters.
...
For more information, refer to the [v26.1 FIPS documentation](/docs/v26.1/fips).
</Note>
...
- [Encryption At Rest](/docs/v25.4/security-reference/encryption#encryption-keys-used-by-cockroachdb-self-hosted-clusters)
- [Encrypted Backups](/docs/v25.4/take-and-restore-encrypted-backups)
- [Change Data Capture to Kafka over TLS](/docs/v25.4/create-changefeed#query-parameters)
- [Certificate-based Node-to-Node and Client-to-Node Authentication](/docs/v25.4/authentication)
- [SASL SCRAM-SHA-256 Password Authentication](/docs/v25.4/security-reference/scram-authentication)
- [SQL Cryptographic Built-in Functions](/docs/v25.4/functions-and-operators#cryptographic-functions)
...
<table class="release-table"><thead><tr><td>Version</td><td>Date</td><td>Intel 64-bit Downloads</td><td>Intel 64-bit Docker Images</td></tr></thead><tbody><tr><td><a href="/docs/releases/v25.4#v25-4-6">v25.4.6</a></td><td>2026-03-09</td><td><a href="https://binaries.cockroachdb.com/cockroach-v25.4.6.linux-amd64-fips.tgz">Full Binary</a> (<a href="https://binaries.cockroachdb.com/cockroach-v25.4.6.linux-amd64-fips.tgz.sha256sum">SHA256</a>)<br/><br/><a href="https://binaries.cockroachdb.com/cockroach-sql-v25.4.6.linux-amd64-fips.tgz">SQL Shell Binary</a> (<a href="https://binaries.cockroachdb.com/cockroach-sql-v25.4.6.linux-amd64-fips.tgz.sha256sum">SHA256</a>)</td><td><code>cockroachdb/cockroach:v25.4.6-fips</code></td></tr><tr><td><a href="/docs/releases/v25.4#v25-4-5">v25.4.5</a></td><td>2026-02-19</td><td><a href="https://binaries.cockroachdb.com/cockroach-v25.4.5.linux-amd64-fips.tgz">Full Binary</a> (<a href="https://binaries.cockroachdb.com/cockroach-v25.4.5.linux-amd64-fips.tgz.sha256sum">SHA256</a>)<br/><br/><a href="https://binaries.cockroachdb.com/cockroach-sql-v25.4.5.linux-amd64-fips.tgz">SQL Shell Binary</a> (<a href="https://binaries.cockroachdb.com/cockroach-sql-v25.4.5.linux-amd64-fips.tgz.sha256sum">SHA256</a>)</td><td><code>cockroachdb/cockroach:v25.4.5-fips</code></td></tr><tr><td><a href="/docs/releases/v25.4#v25-4-4">v25.4.4</a></td><td>2026-02-11</td><td><a href="https://binaries.cockroachdb.com/cockroach-v25.4.4.linux-amd64-fips.tgz">Full Binary</a> (<a href="https://binaries.cockroachdb.com/cockroach-v25.4.4.linux-amd64-fips.tgz.sha256sum">SHA256</a>)<br/><br/><a href="https://binaries.cockroachdb.com/cockroach-sql-v25.4.4.linux-amd64-fips.tgz">SQL Shell Binary</a> (<a href="https://binaries.cockroachdb.com/cockroach-sql-v25.4.4.linux-amd64-fips.tgz.sha256sum">SHA256</a>)</td><td><code>cockroachdb/cockroach:v25.4.4-fips</code></td></tr><tr><td><a href="/docs/releases/v25.4#v25-4-3">v25.4.3</a></td><td>2026-01-09</td><td><a href="https://binaries.cockroachdb.com/cockroach-v25.4.3.linux-amd64-fips.tgz">Full Binary</a> (<a href="https://binaries.cockroachdb.com/cockroach-v25.4.3.linux-amd64-fips.tgz.sha256sum">SHA256</a>)<br/><br/><a href="https://binaries.cockroachdb.com/cockroach-sql-v25.4.3.linux-amd64-fips.tgz">SQL Shell Binary</a> (<a href="https://binaries.cockroachdb.com/cockroach-sql-v25.4.3.linux-amd64-fips.tgz.sha256sum">SHA256</a>)</td><td><code>cockroachdb/cockroach:v25.4.3-fips</code></td></tr><tr><td><a href="/docs/releases/v25.4#v25-4-2">v25.4.2</a></td><td>2025-12-12</td><td><a href="https://binaries.cockroachdb.com/cockroach-v25.4.2.linux-amd64-fips.tgz">Full Binary</a> (<a href="https://binaries.cockroachdb.com/cockroach-v25.4.2.linux-amd64-fips.tgz.sha256sum">SHA256</a>)<br/><br/><a href="https://binaries.cockroachdb.com/cockroach-sql-v25.4.2.linux-amd64-fips.tgz">SQL Shell Binary</a> (<a href="https://binaries.cockroachdb.com/cockroach-sql-v25.4.2.linux-amd64-fips.tgz.sha256sum">SHA256</a>)</td><td><code>cockroachdb/cockroach:v25.4.2-fips</code></td></tr><tr><td><a href="/docs/releases/v25.4#v25-4-1">v25.4.1</a></td><td>2025-12-03</td><td><a href="https://binaries.cockroachdb.com/cockroach-v25.4.1.linux-amd64-fips.tgz">Full Binary</a> (<a href="https://binaries.cockroachdb.com/cockroach-v25.4.1.linux-amd64-fips.tgz.sha256sum">SHA256</a>)<br/><br/><a href="https://binaries.cockroachdb.com/cockroach-sql-v25.4.1.linux-amd64-fips.tgz">SQL Shell Binary</a> (<a href="https://binaries.cockroachdb.com/cockroach-sql-v25.4.1.linux-amd64-fips.tgz.sha256sum">SHA256</a>)</td><td><code>cockroachdb/cockroach:v25.4.1-fips</code></td></tr><tr><td><a href="/docs/releases/v25.4#v25-4-0">v25.4.0</a></td><td>2025-11-03</td><td><a href="https://binaries.cockroachdb.com/cockroach-v25.4.0.linux-amd64-fips.tgz">Full Binary</a> (<a href="https://binaries.cockroachdb.com/cockroach-v25.4.0.linux-amd64-fips.tgz.sha256sum">SHA256</a>)<br/><br/><a href="https://binaries.cockroachdb.com/cockroach-sql-v25.4.0.linux-amd64-fips.tgz">SQL Shell Binary</a> (<a href="https://binaries.cockroachdb.com/cockroach-sql-v25.4.0.linux-amd64-fips.tgz.sha256sum">SHA256</a>)</td><td><code>cockroachdb/cockroach:v25.4.0-fips</code></td></tr></tbody></table>

### Testing releases

<table class="release-table"><thead><tr><td>Version</td><td>Date</td><td>Intel 64-bit Downloads</td><td>Intel 64-bit Docker Images</td></tr></thead><tbody><tr><td><a href="/docs/releases/v25.4#v25-4-0-rc-1">v25.4.0-rc.1</a></td><td>2025-10-22</td><td><a href="https://binaries.cockroachdb.com/cockroach-v25.4.0-rc.1.linux-amd64-fips.tgz">Full Binary</a> (<a href="https://binaries.cockroachdb.com/cockroach-v25.4.0-rc.1.linux-amd64-fips.tgz.sha256sum">SHA256</a>)<br/><br/><a href="https://binaries.cockroachdb.com/cockroach-sql-v25.4.0-rc.1.linux-amd64-fips.tgz">SQL Shell Binary</a> (<a href="https://binaries.cockroachdb.com/cockroach-sql-v25.4.0-rc.1.linux-amd64-fips.tgz.sha256sum">SHA256</a>)</td><td><code>cockroachdb/cockroach:v25.4.0-rc.1-fips</code></td></tr><tr><td><a href="/docs/releases/v25.4#v25-4-0-beta-3">v25.4.0-beta.3</a></td><td>2025-10-16</td><td><a href="https://binaries.cockroachdb.com/cockroach-v25.4.0-beta.3.linux-amd64-fips.tgz">Full Binary</a> (<a href="https://binaries.cockroachdb.com/cockroach-v25.4.0-beta.3.linux-amd64-fips.tgz.sha256sum">SHA256</a>)<br/><br/><a href="https://binaries.cockroachdb.com/cockroach-sql-v25.4.0-beta.3.linux-amd64-fips.tgz">SQL Shell Binary</a> (<a href="https://binaries.cockroachdb.com/cockroach-sql-v25.4.0-beta.3.linux-amd64-fips.tgz.sha256sum">SHA256</a>)</td><td><code>cockroachdb/cockroach:v25.4.0-beta.3-fips</code></td></tr><tr><td><a href="/docs/releases/v25.4#v25-4-0-beta-2">v25.4.0-beta.2</a></td><td>2025-10-10</td><td><a href="https://binaries.cockroachdb.com/cockroach-v25.4.0-beta.2.linux-amd64-fips.tgz">Full Binary</a> (<a href="https://binaries.cockroachdb.com/cockroach-v25.4.0-beta.2.linux-amd64-fips.tgz.sha256sum">SHA256</a>)<br/><br/><a href="https://binaries.cockroachdb.com/cockroach-sql-v25.4.0-beta.2.linux-amd64-fips.tgz">SQL Shell Binary</a> (<a href="https://binaries.cockroachdb.com/cockroach-sql-v25.4.0-beta.2.linux-amd64-fips.tgz.sha256sum">SHA256</a>)</td><td><code>cockroachdb/cockroach:v25.4.0-beta.2-fips</code></td></tr><tr><td><a href="/docs/releases/v25.4#v25-4-0-beta-1">v25.4.0-beta.1</a></td><td>2025-10-01</td><td><a href="https://binaries.cockroachdb.com/cockroach-v25.4.0-beta.1.linux-amd64-fips.tgz">Full Binary</a> (<a href="https://binaries.cockroachdb.com/cockroach-v25.4.0-beta.1.linux-amd64-fips.tgz.sha256sum">SHA256</a>)<br/><br/><a href="https://binaries.cockroachdb.com/cockroach-sql-v25.4.0-beta.1.linux-amd64-fips.tgz">SQL Shell Binary</a> (<a href="https://binaries.cockroachdb.com/cockroach-sql-v25.4.0-beta.1.linux-amd64-fips.tgz.sha256sum">SHA256</a>)</td><td><code>cockroachdb/cockroach:v25.4.0-beta.1-fips</code></td></tr><tr><td><a href="/docs/releases/v25.4#v25-4-0-alpha-2">v25.4.0-alpha.2</a></td><td>2025-09-23</td><td><a href="https://binaries.cockroachdb.com/cockroach-v25.4.0-alpha.2.linux-amd64-fips.tgz">Full Binary</a> (<a href="https://binaries.cockroachdb.com/cockroach-v25.4.0-alpha.2.linux-amd64-fips.tgz.sha256sum">SHA256</a>)<br/><br/><a href="https://binaries.cockroachdb.com/cockroach-sql-v25.4.0-alpha.2.linux-amd64-fips.tgz">SQL Shell Binary</a> (<a href="https://binaries.cockroachdb.com/cockroach-sql-v25.4.0-alpha.2.linux-amd64-fips.tgz.sha256sum">SHA256</a>)</td><td><code>cockroachdb/cockroach:v25.4.0-alpha.2-fips</code></td></tr><tr><td><a href="/docs/releases/v25.4#v25-4-0-alpha-1">v25.4.0-alpha.1</a></td><td>2025-09-17</td><td><a href="https://binaries.cockroachdb.com/cockroach-v25.4.0-alpha.1.linux-amd64-fips.tgz">Full Binary</a> (<a href="https://binaries.cockroachdb.com/cockroach-v25.4.0-alpha.1.linux-amd64-fips.tgz.sha256sum">SHA256</a>)<br/><br/><a href="https://binaries.cockroachdb.com/cockroach-sql-v25.4.0-alpha.1.linux-amd64-fips.tgz">SQL Shell Binary</a> (<a href="https://binaries.cockroachdb.com/cockroach-sql-v25.4.0-alpha.1.linux-amd64-fips.tgz.sha256sum">SHA256</a>)</td><td><code>cockroachdb/cockroach:v25.4.0-alpha.1-fips</code></td></tr></tbody></table>

## Install the FIPS-ready CockroachDB runtime

After you [download](#downloads) a FIPS-ready CockroachDB binary, install it in the same way as the standard binary. Refer to [Install CockroachDB on Linux](/docs/v25.4/install-cockroachdb).

<Note>
Upgrading an existing CockroachDB cluster's binary in-place to be FIPS-ready is not supported. Instead, you can [restore your cluster](/docs/v25.4/restore#full-cluster) to a new FIPS-ready cluster.
</Note>
...
Refer to [Using Digital Certificates with CockroachDB](/docs/v25.4/authentication#using-digital-certificates-with-cockroachdb).
...
Refer to [SASL/SCRAM-SHA-256 Secure Password-based Authentication](/docs/v25.4/security-reference/scram-authentication).
...
**Algorithms**: Specified by the [`server.jwt_authentication.jwks` cluster setting](/docs/v25.4/sso-sql#cluster-settings).

Refer to [Cluster Single Sign-on (SSO) using a JSON web token (JWT)](/docs/v25.4/sso-sql).

##### DB Console Authentication via OIDC

**Algorithm**: Specified by the identity provider (IdP) as part of the OIDC handshake process.

Refer to [Single Sign-on (SSO) for DB Console](/docs/v25.4/sso-db-console).
