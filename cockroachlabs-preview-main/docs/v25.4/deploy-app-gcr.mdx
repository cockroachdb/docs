...
2. Start the [built-in SQL shell](/docs/v25.4/cockroach-sql) using the connection string you got from the CockroachDB Cloud Console earlier:
...
- [Build a Simple Django App with CockroachDB](/docs/v25.4/build-a-python-app-with-cockroachdb-django)
- [Deploy a Global Serverless Application](/docs/v25.4/movr-flask-deployment)
