...
<LinkedPageTabs
  currentPath="/docs/v25.4/build-a-nodejs-app-with-cockroachdb-sequelize"
  items={[
    {
...
1. If you haven't already, [sign up for a CockroachDB Cloud account](https://cockroachlabs.cloud/signup?referralId=docs_node_sequelize).
