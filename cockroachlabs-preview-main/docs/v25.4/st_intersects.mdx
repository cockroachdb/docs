...
<Note>
  `ST_Intersects` will attempt to use any available [spatial index](/docs/v25.4/spatial-indexes) to speed up its
  operation. Use the prefixed variant `_ST_Intersects` if you do not want any spatial indexes to be used.
</Note>

<Note>This function is the inverse of [`ST_Disjoint`](/docs/v25.4/st_disjoint).</Note>
...
<Frame>![ST_Intersects - true](/images/v25.4/geospatial/st_intersects_true.png)</Frame>
...
<Frame>![ST_Intersects - false](/images/v25.4/geospatial/st_intersects_false.png)</Frame>
