...
A MultiPolygon can be created from SQL by calling the `st_geomfromtext` function on a MultiPolygon definition expressed in the [Well Known Text (WKT)](/docs/v25.4/architecture/glossary#wkt) format.
