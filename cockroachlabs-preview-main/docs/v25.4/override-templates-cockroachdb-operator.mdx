...
The `cockroachdb.crdbCluster.startFlags` field allows you to customize the [`cockroach start` flags](/docs/v25.4/cockroach-start#flags) used when initializing the CockroachDB cluster.
