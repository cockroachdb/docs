...
<Note>
  `ST_Equals` will attempt to use any available [spatial index](/docs/v25.4/spatial-indexes) to speed up its operation.
...
<Frame>![ST_Equals - true](/images/v25.4/geospatial/st_equals_true.png)</Frame>
...
<Frame>![ST_Equals - false](/images/v25.4/geospatial/st_equals_false.png)</Frame>
