...
<LinkedPageTabs
  currentPath="/docs/v25.4/deploy-cockroachdb-on-microsoft-azure"
  items={[
    {
      title: "Secure",
      href: "/docs/v25.4/deploy-cockroachdb-on-microsoft-azure",
    },
    {
      title: "Insecure",
      href: "/docs/v25.4/deploy-cockroachdb-on-microsoft-azure-insecure",
    },
  ]}
/>
...
- Run at least 3 nodes to [ensure survivability](/docs/v25.4/recommended-production-settings#topology).
...
<Note>
If you would prefer to use HAProxy instead of Azure's managed load balancing, see the [On-Premises](/docs/v25.4/deploy-cockroachdb-on-premises) tutorial for guidance.
</Note>
