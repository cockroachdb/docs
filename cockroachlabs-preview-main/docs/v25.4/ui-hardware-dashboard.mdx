...
To view this dashboard, [access the DB Console](/docs/v25.4/ui-overview#db-console-access), click **Metrics** in the left-hand navigation, and select **Dashboard** &gt; **Hardware**.
...
**CockroachDB Metric Name:** [`sys.cpu.combined.percent-normalized`](/docs/v25.4/essential-metrics-self-hosted#sys-cpu-combined-percent-normalized)
...
**CockroachDB Metric Name:** [`sys.cpu.host.combined.percent-normalized`](/docs/v25.4/essential-metrics-self-hosted#sys-cpu-host-combined-percent-normalized)
...
**CockroachDB Metric Name:** [`sys.rss`](/docs/v25.4/essential-metrics-self-hosted#sys-rss)
...
**CockroachDB Metric Name:** [`sys.host.disk.read.bytes`](/docs/v25.4/essential-metrics-self-hosted#sys-host-disk-read-bytes)
...
**CockroachDB Metric Name:** [`sys.host.disk.write.bytes`](/docs/v25.4/essential-metrics-self-hosted#sys-host-disk-write-bytes)
...
**CockroachDB Metric Name:** [`sys.host.disk.read.count`](/docs/v25.4/essential-metrics-self-hosted#sys-host-disk-read-count)
...
**CockroachDB Metric Name:** [`sys.host.disk.write.count`](/docs/v25.4/essential-metrics-self-hosted#sys-host-disk-write-count)
...
**CockroachDB Metric Name:** [`sys.host.disk.iopsinprogress`](/docs/v25.4/essential-metrics-self-hosted#sys-host-disk-iopsinprogress)
...
**CockroachDB Metric Name:** [`capacity.available`](/docs/v25.4/essential-metrics-self-hosted#capacity-available)
