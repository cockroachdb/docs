...
This page describes how to upgrade a CockroachDB cluster that is [deployed on a Kubernetes cluster](/docs/v25.4/deploy-cockroachdb-with-cockroachdb-operator) with the CockroachDB operator.
