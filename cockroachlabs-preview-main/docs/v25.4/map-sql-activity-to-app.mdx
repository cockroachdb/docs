...
Once you set the application name, the [DB Console](/docs/v25.4/ui-overview) lets you [filter database workloads by application name](/docs/v25.4/ui-statements-page#filter).

<Frame>
  ![Movr app filter](/images/v25.4/movr-app.png)
</Frame>
...
Often signals to problems start at high-level metrics. The [SQL dashboard](/docs/v25.4/ui-sql-dashboard) has metrics for [SQL sessions](/docs/v25.4/ui-sql-dashboard#open-sql-sessions), [SQL statements](/docs/v25.4/ui-sql-dashboard#active-sql-statements), [SQL statement errors](/docs/v25.4/ui-sql-dashboard#sql-statement-errors), etc., that can quickly signify potential issues with your application.
...
- [SQL Activity](/docs/v25.4/ui-overview#sql-activity)
- [SQL Performance Best Practices](/docs/v25.4/performance-best-practices-overview)
- [Troubleshoot Statement Behavior](/docs/v25.4/query-behavior-troubleshooting)
