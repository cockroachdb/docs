...
[DBmarlin](https://www.dbmarlin.com/home) is a monitoring platform for databases. The CockroachDB integration with DBmarlin enables DBmarlin to view CockroachDB metrics stored in the [`crdb_internal` system catalog](/docs/v25.4/monitoring-and-alerting#crdb_internal-system-catalog).
...
<Frame>![CockroachDB Overview dashboard for DBmarlin](/images/v25.4/dbmarlin-crdb-dashboard.png)</Frame>
