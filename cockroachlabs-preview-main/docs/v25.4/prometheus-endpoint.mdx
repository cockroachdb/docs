...
- [Monitor CockroachDB Self-Hosted Clusters with Datadog](/docs/v25.4/datadog)
- [Monitor CockroachDB with Kibana](/docs/v25.4/kibana)
- [Essential Metrics](/docs/v25.4/essential-metrics-self-hosted)
- [Essential Alerts](/docs/v25.4/essential-alerts-self-hosted)
