...
<LinkedPageTabs
  currentPath="/docs/v25.4/deploy-cockroachdb-with-kubernetes"
  items={[
    {
      title: "Secure",
      href: "/docs/v25.4/deploy-cockroachdb-with-kubernetes",
    },
    {
      title: "Insecure",
      href: "/docs/v25.4/deploy-cockroachdb-with-kubernetes-insecure",
    },
  ]}
/>
...
- [Public operator](https://github.com/cockroachdb/cockroach-operator)
    ...
    <Note>
    The Public operator is also available on platforms such as [Red Hat OpenShift](/docs/v25.4/deploy-cockroachdb-with-kubernetes-openshift) and [IBM Cloud Pak for Data](https://www.ibm.com/products/cloud-pak-for-data).
    </Note>
...
The Public operator does not provision or apply a license key. To use CockroachDB with the Public operator, [set a license](/docs/v25.4/licensing-faqs#set-a-license) in the SQL shell.
</Note>
...
<Note>
If you want to continue using this cluster, refer the documentation on [configuring](/docs/v25.4/configure-cockroachdb-kubernetes), [scaling](/docs/v25.4/scale-cockroachdb-kubernetes), [monitoring](/docs/v25.4/monitor-cockroachdb-kubernetes), and [upgrading](/docs/v25.4/upgrade-cockroachdb-kubernetes) the cluster.
</Note>
...
- [Resource management](/docs/v25.4/configure-cockroachdb-kubernetes)
- [Certificate management](/docs/v25.4/secure-cockroachdb-kubernetes)
- [Cluster monitoring](/docs/v25.4/monitor-cockroachdb-kubernetes)
- [Kubernetes Multi-Cluster Deployment](/docs/v25.4/orchestrate-cockroachdb-with-kubernetes-multi-cluster)
- [Optimize Performance on Kubernetes](/docs/v25.4/kubernetes-performance)
