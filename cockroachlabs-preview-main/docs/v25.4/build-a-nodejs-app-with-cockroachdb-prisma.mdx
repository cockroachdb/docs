...
<LinkedPageTabs
  currentPath="/docs/v25.4/build-a-nodejs-app-with-cockroachdb-prisma"
  items={[
    {
...
1. If you haven't already, [sign up for a CockroachDB Cloud account](https://cockroachlabs.cloud/signup?referralId=docs_node_prisma).
...
<Note>
In [production](/docs/v25.4/recommended-production-settings#transaction-retries), we recommend implementing [client-side retry handling](/docs/v25.4/transaction-retry-error-reference#client-side-retry-handling) for all database operations.
</Note>
