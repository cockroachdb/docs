...
To get a greater understanding of how CockroachDB is a survivable system that enforces strong consistency, check out our [architecture documentation](/docs/v25.4/architecture/overview).

To see Multi-Active Availability in action, see this [availability demo](/docs/v25.4/demo-cockroachdb-resilience).
