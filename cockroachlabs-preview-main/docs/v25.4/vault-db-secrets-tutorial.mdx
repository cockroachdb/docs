...
- Either [Create a CockroachDB Standard cluster](/docs/cockroachcloud/create-your-cluster) or [Start a Local Cluster](/docs/v25.4/start-a-local-cluster). Make a note of the cluster's name.

    For a cluster in CockroachDB Cloud, download the cluster's CA certificate locally. Refer to [Connect to your cluster](/docs/cockroachcloud/connect-to-your-cluster).
- Create a SQL user and make a note of the username and password. Refer [Create a SQL user in CockroachDB Cloud](/docs/cockroachcloud/managing-access#create-a-sql-user) or [Create a SQL user in CockroachDB self-hosted](/docs/v25.4/create-user).
