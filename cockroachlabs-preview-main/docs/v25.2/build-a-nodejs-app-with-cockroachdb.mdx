...
<LinkedPageTabs
  currentPath="/docs/v25.2/build-a-nodejs-app-with-cockroachdb"
  items={[
    {
      title: "Use node-postgres",
      href: "/docs/v25.2/build-a-nodejs-app-with-cockroachdb",
    },
    {
      title: "Use Sequelize",
      href: "/docs/v25.2/build-a-nodejs-app-with-cockroachdb-sequelize",
    },
    {
      title: "Use Knex.js",
      href: "/docs/v25.2/build-a-nodejs-app-with-cockroachdb-knexjs",
    },
    {
      title: "Use Prisma",
      href: "/docs/v25.2/build-a-nodejs-app-with-cockroachdb-prisma",
    },
    {
      title: "Use TypeORM",
      href: "/docs/v25.2/build-a-typescript-app-with-cockroachdb",
    },
  ]}
/>
...
All of the database operations are wrapped in a helper function named `retryTxn`. This function attempts to commit statements in the context of an explicit transaction. If a [retry error](/docs/v25.2/transaction-retry-error-reference) is thrown, the wrapper will retry committing the transaction, with [exponential backoff](https://wikipedia.org/wiki/Exponential_backoff), until the maximum number of retries is reached (by default, 15).
...
3. To initialize the example database, use the [`cockroach sql`](/docs/v25.2/cockroach-sql) command to execute the SQL statements in the `dbinit.sql` file:
