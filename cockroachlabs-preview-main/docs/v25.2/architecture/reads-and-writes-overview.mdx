...
<Note>
For a more detailed information about how transactions work in CockroachDB, see the [Transaction Layer](/docs/v25.2/architecture/transaction-layer) documentation.
</Note>
