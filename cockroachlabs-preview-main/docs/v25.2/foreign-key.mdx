...
import { ForeignKey10 } from "/snippets/syntax-diagrams/ForeignKey10.jsx";
import { ForeignKey9 } from "/snippets/syntax-diagrams/ForeignKey9.jsx";
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The foreign key column's <a href="/docs/v25.2/data-types">data type</a>.
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>
        Any other column-level <a href="/docs/v25.2/constraints">constraints</a> you want to apply to this column.
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>
        Any table-level <a href="/docs/v25.2/constraints">constraints</a> you want to apply.
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Any other table-level <a href="/docs/v25.2/constraints">constraints</a> you want to apply.
      </td>
    </tr>
  </tbody>
</table>
...
7. Check to make sure the corresponding `customer_id` value to `id = 101`, was updated to the `DEFAULT` value (i.e., `9999`) in `orders_4`:
   ...
   If the default value for the `customer_id` column is not set, and the column does not have a [`NOT NULL`](/docs/v25.2/not-null) constraint, `ON UPDATE SET DEFAULT` and `ON DELETE SET DEFAULT` actions set referenced column values to `NULL`.
