...
<table>
  <thead>
    <tr>
      <th>Expression</th>
      <th>Data type of the string literal</th>
    </tr>
  </thead>
  <tbody>
    <tr>
    ...
    <tr>
      <td>
        <code>INSERT INTO tb(date&#95;col) VALUES ('2013-01-02')</code>
      </td>
      <td>
        <code>DATE</code>
      </td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>16-bit hexadecimal Unicode character value</td>
    </tr>
    <tr>
      <td>
        <code>\UXXXXXXXX</code>
      </td>
      <td>32-bit hexadecimal Unicode character value</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      <td>Contains a decimal separator</td>
      <td>
        <code>FLOAT</code>, <code>DECIMAL</code>
      </td>
    </tr>
    <tr>
      <td>Contains an exponent</td>
      <td>
        <code>FLOAT</code>, <code>DECIMAL</code>
      </td>
    </tr>
    <tr>
      <td>Contains a value outside of the range -2^63...(2^63)-1</td>
      <td>
        <code>FLOAT</code>, <code>DECIMAL</code>
      </td>
    </tr>
    <tr>
      <td>Otherwise</td>
      <td>
        <code>INT</code>, <code>DECIMAL</code>, <code>FLOAT</code>
      </td>
    </tr>
  </tbody>
</table>
...
Bit array literals are acceptable both when values of types [`BIT`](/docs/v25.2/bit) or [`VARBIT`](/docs/v25.2/bit) (`BIT VARYING`) are expected.
...
Additionally, for compatibility with PostgreSQL, the notation `'string'::type` and `CAST('string' AS type)` is also recognized as an interpreted literal. These are special cases of [cast expressions](/docs/v25.2/scalar-expressions).

For more information about the allowable format of interpreted literals, refer to the "Syntax" section of the respective data types: [`DATE`](/docs/v25.2/date#syntax), [`INET`](/docs/v25.2/inet#syntax), [`INTERVAL`](/docs/v25.2/interval#syntax), [`TIME`](/docs/v25.2/time#syntax), [`TIMESTAMP`/`TIMESTAMPTZ`](/docs/v25.2/timestamp#syntax).
