...
<LinkedPageTabs
  currentPath="/docs/v25.2/deploy-cockroachdb-with-kubernetes"
  items={[
    {
      title: "Secure",
...
The Public operator does not provision or apply a license key. To use CockroachDB with the Public operator, [set a license](/docs/v25.2/licensing-faqs#set-a-license) in the SQL shell.
</Note>
...
<Note>
If you want to continue using this cluster, refer the documentation on [configuring](/docs/v25.2/configure-cockroachdb-kubernetes), [scaling](/docs/v25.2/scale-cockroachdb-kubernetes), [monitoring](/docs/v25.2/monitor-cockroachdb-kubernetes), and [upgrading](/docs/v25.2/upgrade-cockroachdb-kubernetes) the cluster.
</Note>
...
- [Resource management](/docs/v25.2/configure-cockroachdb-kubernetes)
- [Certificate management](/docs/v25.2/secure-cockroachdb-kubernetes)
...
- [Optimize Performance on Kubernetes](/docs/v25.2/kubernetes-performance)
