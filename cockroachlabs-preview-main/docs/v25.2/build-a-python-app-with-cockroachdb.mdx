...
<LinkedPageTabs
  currentPath="/docs/v25.2/build-a-python-app-with-cockroachdb"
  items={[
    {
      title: "Use psycopg3",
...
1. If you haven't already, [sign up for a CockroachDB Cloud account](https://cockroachlabs.cloud/signup?referralId=docs_python_psycopg2).
