...
<LinkedPageTabs
  currentPath="/docs/v25.2/build-a-ruby-app-with-cockroachdb-activerecord"
  items={[
    {
      title: "Use pg",
      href: "/docs/v25.2/build-a-ruby-app-with-cockroachdb",
    },
    {
      title: "Use ActiveRecord",
      href: "/docs/v25.2/build-a-ruby-app-with-cockroachdb-activerecord",
    },
  ]}
/>
...
1. If you haven't already, [sign up for a CockroachDB Cloud account](https://cockroachlabs.cloud/signup?referralId=docs_ruby_activerecord).
