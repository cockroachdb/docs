...
<Note>
This tutorial assumes that you have [started a secure CockroachDB cluster](/docs/v25.2/secure-a-cluster). [CockroachDB Cloud](/docs/cockroachcloud) does not expose a compatible monitoring endpoint.
</Note>
...
For example, if you used [`cockroach cert`](/docs/v25.2/cockroach-cert) to [secure your cluster](/docs/v25.2/secure-a-cluster#step-1-generate-certificates), the YAML should look like:
