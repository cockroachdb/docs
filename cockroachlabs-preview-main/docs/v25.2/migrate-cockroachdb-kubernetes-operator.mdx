...
old_description: "Migration guide detailing how to migrate away from a deployment using the public Kubernetes operator to the CockroachDB operator."
---
...
<Tip>
If your existing cluster was created as a StatefulSet using Helm, refer to the [Helm migration guide](/docs/v25.2/migrate-cockroachdb-kubernetes-helm).
</Tip>
