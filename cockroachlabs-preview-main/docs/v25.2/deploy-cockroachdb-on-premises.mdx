...
<LinkedPageTabs
  currentPath="/docs/v25.2/deploy-cockroachdb-on-premises"
  items={[
    {
      title: "Secure",
      href: "/docs/v25.2/deploy-cockroachdb-on-premises",
    },
    {
      title: "Insecure",
      href: "/docs/v25.2/deploy-cockroachdb-on-premises-insecure",
    },
  ]}
/>
...
1. On your local machine, run the [`cockroach gen haproxy`](/docs/v25.2/cockroach-gen) command with the `--host` flag set to the address of any node and security flags pointing to the CA cert and the client cert and key:
