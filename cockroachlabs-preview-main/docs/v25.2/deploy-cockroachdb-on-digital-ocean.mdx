...
<LinkedPageTabs
  currentPath="/docs/v25.2/deploy-cockroachdb-on-digital-ocean"
  items={[
    {
      title: "Secure",
      href: "/docs/v25.2/deploy-cockroachdb-on-digital-ocean",
    },
    {
      title: "Insecure",
      href: "/docs/v25.2/deploy-cockroachdb-on-digital-ocean-insecure",
    },
  ]}
/>
...
<Note>
If you would prefer to use HAProxy instead of Digital Ocean's managed load balancing, see the [On-Premises](/docs/v25.2/deploy-cockroachdb-on-premises) tutorial for guidance.
</Note>
