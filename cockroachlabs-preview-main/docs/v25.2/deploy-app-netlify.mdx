...
1. Using the Netlify CLI, start the app server locally to preview your site:
   ...
   Interacting with the site triggers the Netlify functions defined in the `netlify/functions` directory. These functions use Prisma Client to run [`SELECT`](/docs/v25.2/selection-queries) and [`INSERT`](/docs/v25.2/insert) queries against the database:
