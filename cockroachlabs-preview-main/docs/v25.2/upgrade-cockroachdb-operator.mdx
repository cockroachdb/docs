...
This page describes how to upgrade a CockroachDB cluster that is [deployed on a Kubernetes cluster](/docs/v25.2/deploy-cockroachdb-with-cockroachdb-operator) with the CockroachDB operator.

<Note>
The CockroachDB operator is in [Preview](/docs/v25.2/cockroachdb-feature-availability).
</Note>
