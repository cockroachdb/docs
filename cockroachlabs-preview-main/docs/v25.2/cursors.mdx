...
import { Cursors13 } from "/snippets/syntax-diagrams/Cursors13.jsx";
import { Cursors14 } from "/snippets/syntax-diagrams/Cursors14.jsx";
import { Cursors15 } from "/snippets/syntax-diagrams/Cursors15.jsx";
...
<Tip>
This document describes cursor usage within SQL transactions. For information about using cursors in PL/pgSQL functions and procedures, see [PL/pgSQL](/docs/v25.2/plpgsql#declare-cursor-variables).
</Tip>

Cursors differ from [keyset pagination](/docs/v25.2/pagination) and [`LIMIT`/`OFFSET`](/docs/v25.2/limit-offset) in that:

- Each cursor is a stateful SQL object that is referred to by a unique name.
- Each cursor requires holding open its own dedicated (read-only) [transaction](/docs/v25.2/transactions).
...
- [`DECLARE`](/docs/v25.2/sql-grammar#declare_cursor_stmt)
- [`WITH HOLD`](#use-a-holdable-cursor)
- [`FETCH`](/docs/v25.2/sql-grammar#fetch_cursor_stmt)
- [`CLOSE`](/docs/v25.2/sql-grammar#close_cursor_stmt)
...
These examples assume the presence of the [MovR data set](/docs/v25.2/movr).
...
- [Keyset pagination](/docs/v25.2/pagination)
- [`LIMIT`/`OFFSET`](/docs/v25.2/limit-offset)
