...
<LinkedPageTabs
  currentPath="/docs/v25.2/deploy-cockroachdb-on-digital-ocean-insecure"
  items={[
    {
      title: "Secure",
...
<Note>
If you would prefer to use HAProxy instead of Digital Ocean's managed load balancing, see the [On-Premises](/docs/v25.2/deploy-cockroachdb-on-premises-insecure) tutorial for guidance.
</Note>
...
3. [Connect your application](/docs/v25.2/install-client-drivers). Be sure to connect your application to the Digital Ocean Load Balancer, not to a CockroachDB node.
