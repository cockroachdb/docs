...
Accounts with CockroachDB Basic clusters receive $15 of free resource utilization (equivalent to 50 million [Request Units](/docs/cockroachcloud/plan-your-cluster-basic#request-units) and 10 GiB storage) across all clusters. This benefit applies as a $15 credit on their monthly invoice.
...
To understand how costs vary per tier and begin to estimate future expenses, refer to [CockroachDB Cloud Costs](/docs/cockroachcloud/costs).

## Add payment methods

During the free trial, a [Billing Coordinator](/docs/cockroachcloud/authorization) can [add a credit card](/docs/cockroachcloud/billing-management) in the CockroachDB Cloud Console or subscribe through the [AWS Marketplace](/docs/cockroachcloud/billing-management?filters=aws) or [Google Cloud Marketplace](/docs/cockroachcloud/billing-management?filters=gcp) for monthly, pay-as-you-go payment. You can also [contact Sales](https://cockroachlabs.com/contact-sales) during the trial to learn more about CockroachDB and consider an initial purchse of credits as part of an annual or multi-year contract.
...
[Create an Account](/docs/cockroachcloud/create-an-account) or learn more about [CockroachDB Cloud](https://www.cockroachlabs.com/docs/cockroachcloud/).