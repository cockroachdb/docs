...
- A cluster or folder created at the root level of the organization has no parent ID. When using the [CockroachDB Cloud API](/docs/cockroachcloud/cloud-api), you can either omit the parent ID for a folder or cluster, or set it to `root`, to create it at or move it to the root level.
...
A role assigned to a folder is inherited on its descendant folders and clusters. All existing organizational roles, such as [Cluster Admin](/docs/cockroachcloud/authorization#cluster-admin) or [Cluster Creator](/docs/cockroachcloud/authorization#cluster-creator), can be assigned at the folder scope.
...
The [Folder Admin](/docs/cockroachcloud/authorization#folder-admin) and [Folder Mover](/docs/cockroachcloud/authorization#folder-mover) roles explicitly allow management of folders and their contents.
...
- [Folder Admin](/docs/cockroachcloud/authorization#folder-admin)

<Tip>
An [Organization Admin](/docs/cockroachcloud/authorization#organization-admin) can assign themselves, another user, or a service account the Folder Admin role.
</Tip>
...
- [Folder Admin](/docs/cockroachcloud/authorization#folder-admin) or [Folder Mover](/docs/cockroachcloud/authorization#folder-mover).
- [Cluster Admin](/docs/cockroachcloud/authorization#cluster-admin), [Cluster Developer](/docs/cockroachcloud/authorization#cluster-developer), [Cluster Creator](/docs/cockroachcloud/authorization#cluster-creator), or [Cluster Operator](/docs/cockroachcloud/authorization#cluster-operator).
...
- [Cluster Admin](/docs/cockroachcloud/authorization#cluster-admin) or [Cluster Creator](/docs/cockroachcloud/authorization#cluster-creator)
...
<Note>
A cluster is [billed](/docs/cockroachcloud/billing-management#view-invoices) to the folder it resides in at the end of the billing period, even if it was moved from one folder to another during the billing period.
</Note>
...
- An organization can have a maximum of 65 folders, regardless of how they are organized.
- You can manage folders using the CockroachDB Cloud Console, the [CockroachDB Cloud API](/docs/cockroachcloud/cloud-api), the [Terraform provider](https://registry.terraform.io/providers/cockroachdb/cockroach) v1.1.0 or above, or the [`ccloud` CLI tool](/docs/cockroachcloud/ccloud-reference#manage-folders).

## See also

- [CockroachDB Cloud Access Management (Authorization) Overview](/docs/cockroachcloud/authorization)
- [Manage Users, Roles, and Service Accounts](/docs/cockroachcloud/managing-access)
