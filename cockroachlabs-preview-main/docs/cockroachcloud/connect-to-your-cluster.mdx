...
<LinkedPageTabs
  currentPath="/docs/cockroachcloud/connect-to-your-cluster"
  items={[
    {
...
This page shows you how to connect to your CockroachDB Standard cluster. This includes the administrative task of configuring allowed networks to support SQL client connections, as well as the steps for connecting to the cluster with CockroachDB's [built-in SQL client](/docs/v25.4/cockroach-sql).

## Before you start

- [Create a cluster](/docs/cockroachcloud/create-your-cluster).
- [Create a SQL user](/docs/cockroachcloud/managing-access#create-a-sql-user).
...
For more information, refer to [Network authorization](/docs/cockroachcloud/network-authorization).
...
<Note>
Self-service VPC peering setup is not supported for CockroachDB Advanced clusters deployed before March 5, 2020. If your cluster was deployed before March 5, 2020, you will have to [create a new cluster](/docs/cockroachcloud/create-your-cluster) with VPC peering enabled, then [export your data](/docs/cockroachcloud/managed-backups) from the old cluster to the new cluster. If your cluster was deployed on or after March 5, 2020, it will be locked into CockroachDB's default IP range (`172.28.0.0/14`) unless you explicitly configured a different IP range during cluster creation.
</Note>
...
To establish an AWS PrivateLink connection, refer to [Managing AWS PrivateLink for a cluster](/docs/cockroachcloud/aws-privatelink). After the connection is established, you can use it to [connect to your cluster](#connect-to-your-cluster).
...
You can connect to your cluster with any [supported version](/docs/releases/release-support-policy#supported-versions) of the full CockroachDB binary or the [built-in SQL client](/docs/v25.4/cockroach-sql).
...
4. Add your copied connection string to your application code. Refer to [Connect to a CockroachDB Cluster](/docs/v25.4/connect-to-the-database).
5. Click **Close**.
...
To connect to your cluster with a [CockroachDB-compatible tool](/docs/v25.4/third-party-database-tools):
