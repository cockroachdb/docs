...
CockroachDB Cloud supports labels as a flexible way to categorize and manage your [clusters](/docs/cockroachcloud/cluster-management) and [folders](/docs/cockroachcloud/folders). Labels help you track usage, analyze [billing](/docs/cockroachcloud/billing-management#view-credits-balance), automate operations, and streamline reporting across your organization.
...
Adding or deleting labels on a cluster requires the [Cluster Admin](/docs/cockroachcloud/authorization#cluster-admin) or [Cluster Operator](/docs/cockroachcloud/authorization#cluster-operator) role.

1. Navigate to the cluster on the [**Clusters** page](/docs/cockroachcloud/cluster-management#view-clusters-page) and click the menu button in the **Action** column. Alternatively, navigate to the [**Overview** page](/docs/cockroachcloud/cluster-management#view-cluster-overview) for the cluster and click **Actions** in the top right corner.
2. In the dropdown menu, select **Edit cluster labels** to open the **Edit labels** window.

Adding or deleting labels on a folder requires the [Folder Admin](/docs/cockroachcloud/authorization#folder-admin) role.

1. Navigate to the folder on the [**Clusters** page](/docs/cockroachcloud/cluster-management#view-clusters-page) and click the menu button in the **Action** column.
...
Labels appear in invoices on the [**Billing** page](/docs/cockroachcloud/billing-management#view-credits-balance).
