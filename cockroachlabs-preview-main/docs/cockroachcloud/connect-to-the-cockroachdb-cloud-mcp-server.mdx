...
- [Create a CockroachDB cluster](/docs/cockroachcloud/create-a-basic-cluster).
    - Note the Cluster ID in the URL of the [Cluster Overview Page](/docs/cockroachcloud/cluster-overview-page): `https://cockroachlabs.cloud/cluster/{your_cluster_id}/overview`.
- If you plan to connect to the MCP server using OAuth, ensure that the user managing the MCP server connection [is able to log in](/docs/cockroachcloud/authentication) to the Cloud Console. Ensure that the user has been assigned the [Cluster Admin](/docs/cockroachcloud/authorization#cluster-admin) role or the [Cluster Operator](/docs/cockroachcloud/authorization#cluster-operator) role.
- If you plan to connect to the MCP server using an API key, create a [service account](/docs/cockroachcloud/managing-access#manage-service-accounts) and an [API key](/docs/cockroachcloud/managing-access#api-access) in the CockroachDB Cloud Console. Ensure that the service account has been assigned the [Cluster Admin](/docs/cockroachcloud/authorization#cluster-admin) role or the [Cluster Operator](/docs/cockroachcloud/authorization#cluster-operator) role.
...
4. If you are a member of multiple CockroachDB Cloud [organizations](/docs/cockroachcloud/authorization), you will be directed to the **Organization Selection** modal in your browser. Select the organization associated with the cluster that you have included in the tool configuration.
...
1. Navigate to the [Cluster Overview Page](/docs/cockroachcloud/cluster-overview-page) for the cluster that you want to manage with the MCP server connection.
...
If the provided API key is active, there should be no further authorization steps. The MCP server connection's access permissions are determined by the [role(s)](/docs/cockroachcloud/authorization#organization-user-roles) associated with this service account.
...
- [Agent Skills for CockroachDB](/docs/v25.4/agent-skills)
- [Docs MCP Server](/docs/v25.4/docs-mcp-integration)
- [Schema Design Overview](/docs/v25.4/schema-design-overview)
- [Managing Access](/docs/cockroachcloud/managing-access)
- [Authorization](/docs/cockroachcloud/authorization)
