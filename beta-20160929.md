...
- Completed the SQL docs for:
    ...
    - Setting and getting the default database for a session: [`SET DATABASE`](set-vars.html) and [`SHOW DATABASE`](show-vars.html). [#671](https://github.com/cockroachdb/docs/pull/671), [#683](https://github.com/cockroachdb/docs/pull/683) 
    - Setting and getting the default time zone for a session: [`SET TIME ZONE`](set-vars.html) and [`SHOW TIME ZONE`](show-vars.html). [#680](https://github.com/cockroachdb/docs/pull/680)
