...
2. Create the `movr` database and set it as the default database:
...
3. Create the `users`, `rides`, and `vehicles` tables.
...
3. Use the [`cockroach workload`](cockroach-demo.html) command to generate user, ride, and vehicle data for the `movr` database:
...
+-----------+---------+----------+----------+--------------+---------------------------------------+
  NULL      | NULL    |       92 | {1,2,7}  |            1 | region=us-east1,datacenter=us-east1-a
(1 row)
~~~    
...
~~~
  start_key | end_key | range_id | replicas | lease_holder |               locality
+-----------+---------+----------+----------+--------------+---------------------------------------+
  NULL      | NULL    |       94 | {1,4,7}  |            4 | region=us-west1,datacenter=us-west1-c
(1 row)
~~~
...
~~~
     start_key     |          end_key           | range_id | replicas | lease_holder |               locality
+------------------+----------------------------+----------+----------+--------------+---------------------------------------+
  /"boston"        | /"boston"/PrefixEnd        |       68 | {1,8,9}  |            1 | region=us-east1,datacenter=us-east1-a
  /"new york"      | /"new york"/PrefixEnd      |       66 | {1,8,9}  |            1 | region=us-east1,datacenter=us-east1-a
  /"seattle"       | /"seattle"/PrefixEnd       |      143 | {2,3,4}  |            4 | region=us-west1,datacenter=us-west1-c
  /"los angeles"   | /"los angeles"/PrefixEnd   |       70 | {5,6,7}  |            5 | region=us-west2,datacenter=us-west2-a
  /"san francisco" | /"san francisco"/PrefixEnd |      145 | {5,6,7}  |            6 | region=us-west2,datacenter=us-west2-b
  /"washington dc" | /"washington dc"/PrefixEnd |      141 | {1,8,9}  |            8 | region=us-east1,datacenter=us-east1-b
(6 rows)
~~~    
...
~~~
     start_key     |          end_key           | range_id | replicas | lease_holder |               locality
+------------------+----------------------------+----------+----------+--------------+---------------------------------------+
  /"boston"        | /"boston"/PrefixEnd        |       97 | {1,8,9}  |            1 | region=us-east1,datacenter=us-east1-a
  /"washington dc" | /"washington dc"/PrefixEnd |       99 | {1,8,9}  |            1 | region=us-east1,datacenter=us-east1-a
  /"seattle"       | /"seattle"/PrefixEnd       |      101 | {2,3,4}  |            3 | region=us-west1,datacenter=us-west1-b
  /"los angeles"   | /"los angeles"/PrefixEnd   |      105 | {5,6,7}  |            6 | region=us-west2,datacenter=us-west2-b
  /"san francisco" | /"san francisco"/PrefixEnd |      103 | {5,6,7}  |            6 | region=us-west2,datacenter=us-west2-b
  /"new york"      | /"new york"/PrefixEnd      |       95 | {1,8,9}  |            8 | region=us-east1,datacenter=us-east1-b
(6 rows)
~~~
