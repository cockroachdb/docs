...
-----------|-------------
 `table_name` | The name of the table that should be unsplit.
 `table_name @ index_name`<br>`standalone_index_name` | The name of the index that should be unsplit.
 `select_stmt` | A [selection query](selection-queries.html) that produces one or more rows at which to unsplit the table or index.
