---
title: Developing and Deploying a Multi-Region Web Application
...
This guide walks you through developing and deploying a multi-region web application built on CockroachDB, using Flask, SQLAlchemy, CockroachCloud, and Google Cloud Platform services.

The following sections make up the guide:

1. [MovR: An Example Multi-Region Use-Case](multi-region-use-case.html)
1. [Creating a Multi-Region Database Schema](multi-region-database.html)
1. [Setting Up a Virtual Environment for Developing Multi-Region Applications](multi-region-setup.html)
1. [Developing a Multi-Region Web Application](multi-region-application.html)
1. [Deploying a Multi-Region Web Application](multi-region-deployment.html)
