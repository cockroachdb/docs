...
You can use the [`SHOW CREATE`](show-create.html) statement to see how the columns in a table are created, including data types, default values, indexes, and constraints.
