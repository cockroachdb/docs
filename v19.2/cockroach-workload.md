...
`--display-every` | <span class="version-tag">New in v19.2:</span> The frequency for printing per-operation statistics. Valid time units are `ns`, `us`, `ms`, `s`, `m`, and `h`.<br><br>**Applicable command:** `run`<br>**Default:** `1s`
