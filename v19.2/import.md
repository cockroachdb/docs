...
`experimental_save_rejected` | `CSV DATA` | Skip faulty rows during import and them in a file called `<original_csv_file>.rejected`. Once the rows are fixed, use this file with [`IMPORT INTO`](import-into.html) to finish the import. **Default:** Off
