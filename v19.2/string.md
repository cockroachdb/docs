...
`STRING` is not a data type supported by PostgreSQL.<br><span class="version-tag">New in v19.2:</span> For PostgreSQL compatibility, CockroachDB supports additional [aliases](#aliases) and [`STRING`-related types](#related-types).
