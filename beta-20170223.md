...
- The underlying implementation of the `DECIMAL` type has been replaced. This changes the default rounding behavior of `DECIMAL` types, which is now consistent with PostgreSQL. [#13551](https://github.com/cockroachdb/cockroach/pull/13551)
...
- Metadata for queries using unqualified table names is not cached, speeding up these queries by 130%. [#13635](https://github.com/cockroachdb/cockroach/pull/13635)
