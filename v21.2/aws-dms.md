...
- Ensure you have a secure, publicly available [{{ site.data.products.dedicated }} cluster](../cockroachcloud/quickstart-trial-cluster.html) or [{{ site.data.products.core }} cluster] running v21.2.13 or higher.
