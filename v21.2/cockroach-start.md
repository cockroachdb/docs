...
<a name="fields-ballast-size"></a> {% include_cached new-in.html version=v21.2 %} `ballast-size` | Configure the size of the automatically created emergency ballast file. Accepts the same value formats as the [`size` field](#store-size).
