...
Now that you've learned about our architecture, [start up a CockroachDB Serverless custer](../../cockroachcloud/quickstart.html) or [local cluster](../install-cockroachdb.html) and start [building an app with CockroachDB](../example-apps.html).
