...
<div class="filters filters-big clearfix">
  <a href="performance-benchmarking-with-tpcc-local.html"><button class="filter-button"><strong>Local</strong></button></a>
  <button class="filter-button current"><strong>Local (Multi-region)</strong></button>
...
Run the workload for ten "warehouses" of data for ten minutes. In order to spread the simulated workload across the 3 regions specified in the previous step, you will need to start each of the following commands from 3 different terminals:
...
_elapsed_______tpmC____efc__avg(ms)__p50(ms)__p90(ms)__p95(ms)__p99(ms)_pMax(ms)
  600.0s       49.1  38.2%    170.6     44.0    536.9    872.4   1543.5   3087.0
~~~
