...
You must have a valid enterprise license to use table partitioning features. For details about requesting and setting a trial or full enterprise license, see [{{ site.data.products.enterprise }} Licensing](enterprise-licensing.html).
