...
### Step 2. Set the {{ site.data.products.enterprise }} license and refresh the DB Console

After [setting the {{ site.data.products.enterprise }} license](enterprise-licensing.html), the Node Map should now be displaying the highest-level localities you defined:
...
The Node Map requires an [{{ site.data.products.enterprise }} license](enterprise-licensing.html).
