...
-----------|-----------|------|---------
 ...
 Stored procedures | ✗ | Common Extension | Execute a procedure explicitly. [GitHub issue tracking support for stored procedures](https://github.com/cockroachdb/cockroach/issues/17511).
 Cursors | ✗ | Standard | Traverse a table's rows.
 Triggers | ✗ | Standard | Execute a set of commands whenever a specified event occurs. [GitHub issue tracking support for triggers](https://github.com/cockroachdb/cockroach/issues/28296).
