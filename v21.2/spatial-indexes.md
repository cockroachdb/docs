...
<img style="display: block; margin-left: auto; margin-right: auto; width: 50%" src="{{ 'images/v21.2/geospatial/s2-cubed-sphere-3d.png' | relative_url }}" alt="S2 Cubed Sphere - 3D">
