...
No [privileges](security-reference/authorization#managing-privileges) are required to initiate a transaction. However, privileges are required for each statement within a transaction.
