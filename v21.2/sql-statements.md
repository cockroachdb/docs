...
[`ALTER DEFAULT PRIVILEGES`](alter-default-privileges.html) | {% include_cached new-in.html version=v21.2 %} Change the default [privileges](security-reference/authorization.html#privileges) for objects created by specific roles/users in the current database.
...
[`SHOW DEFAULT PRIVILEGES`](show-default-privileges.html) | {% include_cached new-in.html version=v21.2 %} Show the default privileges for objects created by specific roles/users in the current database.
