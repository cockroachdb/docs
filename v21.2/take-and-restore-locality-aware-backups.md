...
Locality-aware [`BACKUP`](backup.html) is an [{{ site.data.products.enterprise }}-only](https://www.cockroachlabs.com/product/cockroachdb/) feature. However, you can take [full backups](take-full-and-incremental-backups.html) without an {{ site.data.products.enterprise }} license.
