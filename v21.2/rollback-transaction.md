...
No [privileges](security-reference/authorization#managing-privileges) are required to rollback a transaction. However, privileges are required for each statement within a transaction.
