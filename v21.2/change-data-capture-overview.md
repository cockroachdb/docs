...
The main feature of CDC is the [changefeed](#how-does-a-changefeed-work), which targets an allowlist of tables, called the "watched rows". There are two implementations of changefeeds:
