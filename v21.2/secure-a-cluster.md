...
7. Click [**Metrics**](ui-overview-dashboard.html) to access a variety of time series dashboards, including graphs of SQL queries and service latency over time:
    ...
    <img src="{{ 'images/v21.2/ui_overview_dashboard_3_nodes.png' | relative_url }}" alt="DB Console" style="border:1px solid #eee;max-width:100%" />
...
2. Back on the **Cluster Overview** in the DB Console, you'll now see 5 nodes listed:
    ...
    <img src="{{ 'images/v21.2/ui_cluster_overview_5_nodes.png' | relative_url }}" alt="DB Console" style="border:1px solid #eee;max-width:100%" />
