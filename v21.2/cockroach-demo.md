...
-  <span class="version-tag">New in v21.2:</span> The <a href="#global-flag">`--global`</a> flag is no longer experimental. This flag simulates realistic global latencies in a multi-region cluster by setting the [`--locality` flag on node startup](cockroach-start.html#locality) to three different regions.
