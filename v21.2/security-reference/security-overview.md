...
<table>
 ...
 <tr>
  ...
  <td>✓</td>
  <td>✓</td>
  <td>CockroachDB, as a natively distributed SQL database, is uniquely resilient by nature. Cluster can tolerate node failures as long as the majority of nodes remain functional. See <a href="../demo-fault-tolerance-and-recovery.html">Disaster Recovery.</a></td>
 </tr>
</table>
