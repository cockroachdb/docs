...
| `file-permissions` | {% include_cached new-in.html version="v21.2" %} The `chmod`-style permissions on generated log files, formatted as a 3-digit octal number. The executable bit must not be set. <br><br>**Default:** `644` (readable by all, writable by owner)                                                                                                                                                                                                                                                                                                    |
