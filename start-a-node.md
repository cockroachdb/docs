...
The `start` command supports the following standard flags, as well as some [advanced flags](#advanced-flags) and [logging flags](cockroach-commands.html#logging-flags).
