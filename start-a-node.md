...
`--log-dir` | The directory where you want to store your [error logs](error-logs.html)<br/><br/>**Default:** `[node`[`store`](#store)`path]/logs`
...
`--vmodule | Increase your [error log](error-logs.html)'s verbosity.
