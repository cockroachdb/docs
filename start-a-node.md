...
`--log-dir` | The directory where you want to store your [error logs](debug-and-error-logs.html)<br/><br/>**Default:** `[node`[`store`](#store)`path]/logs`
...
`--vmodule | Increase your [error log](debug-and-error-logs.html)'s verbosity.
