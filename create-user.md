...
You can also create and manage users through the [`cockroach user`](create-and-manage-users.html) command. 
Notably, this is the most efficient way to [remove users](create-and-manage-users.html#remove-a-user).
