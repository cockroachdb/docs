...
A distributed CockroachDB deployment consists of multiple, regional instances of CockroachDB that communicate as a single, logical entity. In [CockroachDB terminology](architecture/index.html#terms), each instance is called a *node*. Together, the nodes form a *cluster*.
