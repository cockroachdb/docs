...
In v21.1, [`cockroach dump --dump-mode=schema`](#dump-just-a-tables-schema) is still supported, but it will be removed in the future. Users should use [`SHOW CREATE ALL TABLES`](show-create.html) instead.
