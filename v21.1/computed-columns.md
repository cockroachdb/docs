...
A computed column stores data generated from other columns by a [scalar expression](scalar-expressions.html) included in the column definition. A virtual computed column is generated by an expression from other columns, but is not stored in the primary index, and are recomputed as neccessary.
