...
`GLOBAL` tables (and the other [multi-region capabilities](multiregion-overview.html)) require an [{{ site.data.products.enterprise }} license](https://www.cockroachlabs.com/get-cockroachdb).
{{site.data.alerts.end}}
