...
This page helps you understand and resolve error messages written to `stderr` or your [logs](logging-system.html).
...
If you're not sure what the IP address/hostname and port values might have been, you can look in the node's [logs](logging-system.html). If necessary, you can also terminate the `cockroach` process and then restart the node:
