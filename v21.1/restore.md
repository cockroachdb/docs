...
{{site.data.alerts.callout_info}}
When you restore a full cluster with an enterprise license, it will restore the [enterprise license](enterprise-licensing.html) of the cluster you are restoring from. If you want to use a different license in the new cluster, make sure to [update the license](licensing.html#set-a-license) _after_ the restore is complete.
{{site.data.alerts.end}}
