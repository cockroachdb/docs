...
1. In the source database, export the [`crdb_region` column](set-locality.html#crdb_region) separately when exporting your data.  For more information about the syntax, see [`EXPORT`](export.html).
