...
- <span class="version-tag">New in v21.1:</span> `row_limit`, which is useful for finding errors quickly before executing a more time-consuming import. Setting `row_limit = "n"` will import the first *n* rows of a table.
