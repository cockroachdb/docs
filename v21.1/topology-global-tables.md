---
title: The Global Table Locality Pattern
summary: Guidance on using the GLOBAL table locality pattern in a multi-region deployment.
toc: true
...
- If rows in the table, and all latency-sensitive queries, can be tied to specific geographies, consider the [`REGIONAL` Table Locality Pattern](topology-regional-tables.html) pattern.
