...
summary: CockroachDB frequently asked questions - What is CockroachDB? How does it work? What makes it different from other databases?
...
For more details, see our [Security Overview](index.html).
...
Yes. The {{ site.data.products.dedicated }} offering is currently in Limited Availability and accepting customers on a qualified basis. The offering provides a running CockroachDB cluster suitable to your needs, fully managed by Cockroach Labs on GCP or AWS. Benefits include:
...
For more details, see the [{{ site.data.products.dedicated }}](../cockroachcloud/quickstart-trial-cluster.html) docs.
