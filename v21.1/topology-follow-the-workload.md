...
If read performance is your main focus for a table, but you want low-latency reads everywhere instead of just in the most active region, consider the [Global Table Locality Pattern](global-tables.html) or [Follower Reads](topology-follower-reads.html) pattern.
