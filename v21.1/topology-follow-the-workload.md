...
Note that if you start using the [multi-region SQL abstractions](multiregion-overview.html), CockroachDB will no longer provide the follow-the-workload behavior described on this page.
