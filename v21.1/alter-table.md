...
[`SET LOCALITY {REGIONAL BY TABLE, REGIONAL BY ROW, GLOBAL}`](set-locality.html) | **New in v21.1:** Set the table locality for a table in a [multi-region database](multiregion-overview.html). | No
