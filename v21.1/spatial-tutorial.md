...
(<strong><font style="size:xx-large" color="red">XXX</font></strong>: THESE URLS WILL BE UPDATED TO POINT TO AWS S3 BUCKETS - REMEMBER TO DM REVIEWERS WITH DRIVE URLS)
...
{% include copy-clipboard.html %}
~~~ sql
IMPORT PGDUMP ('http://localhost:3000/bookstores-and-roads-20210125.sql');
~~~
...
{% include copy-clipboard.html %}
~~~ sql
IMPORT PGDUMP ('http://localhost:3000/birds-20210125.sql');
~~~
