...
+ Performing [joins](joins.html) on spatial data, and how to use [`EXPLAIN`](explain.html) to make sure you are using indexes effectively.
+ How to quickly visualize the output of your queries using free tools like <https://geojson.io>
