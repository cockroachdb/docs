...
1. Open a new terminal, and clone the [`simple-crud-python-sqlalchemy`](https://github.com/cockroachlabs/simple-crud-python-sqlalchemy) GitHub repository:

    {% include copy-clipboard.html %}
    ~~~ shell
    $ git clone git@github.com:cockroachlabs/simple-crud-python-sqlalchemy.git
    ~~~

## Step 3. Install and initialize Alembic

1. Navigate to the `simple-crud-python-sqlalchemy` project directory, and run the following commands to create and start a virtual environment:
...
1. Use the `alembic` command-line tool to initialize Alembic for the project:
    ...
    ~~~
    Creating directory /path/simple-crud-python-
    sqlalchemy/alembic ...  done
    Creating directory /path/simple-crud-python-
    sqlalchemy/alembic/versions ...  done
    Generating /path/simple-crud-python-
    ...
    '/path/simple-crud-python-sqlalchemy/alembic.ini' before
    proceeding.
    ~~~
...
1. Use the `alembic` command-line tool to create the first migration script:
    ...
    ~~~
    Generating /path/simple-crud-python-sqlalchemy/alembic/versions/ad72c7ec8b22_create_accounts_table.py ...  done
    ~~~
...
1. Create a new migration with the `alembic` tool:
    ...
    ~~~
    Generating /path/simple-crud-python-sqlalchemy/alembic/versions/fd88c68af7b5_add_overdrawn_column.py ...  done
    ~~~
...
INFO  [alembic.autogenerate.compare] Detected added column 'accounts.overdrawn'
  Generating /path/simple-crud-python-sqlalchemy/alembic/versions/44fa7043e441_add_overdrawn_column.py ...  done
~~~
