...
In addition to optimizing certain types of reads, follower reads enable use cases such as cluster recovery.  For more information about follower reads and how they work, see [Follower Reads](../follower-reads.html).
