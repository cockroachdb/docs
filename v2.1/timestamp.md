...
{{site.data.alerts.callout_info}}
Because the [`SERIAL`](serial.html) data type represents values automatically generated by CockroachDB to uniquely identify rows, you cannot meaningfully cast other data types as `SERIAL` values.
{{site.data.alerts.end}}
