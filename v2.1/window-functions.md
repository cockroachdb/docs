...
The examples on this page use the "users", "rides", and "vehicles" tables from the 'movr' database used in the [CockroachDB 2.0 demo][demo].  We are planning to open source the movr data set in the 2.1 release timeframe.  When it's out we will update this page with a link to the repo.
{{site.data.alerts.end}}
