...
You use this URL to reach the [Admin UI for your cluster](managed-access-the-admin-ui.html). This URL is typically the combination of the global hostname and port `8080`.
