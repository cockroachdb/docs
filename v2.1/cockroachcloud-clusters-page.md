...
<img src="{{ 'images/v2.1/cockroachcloud/all-clusters-page.png' | relative_url }}" alt="All Clusters" style="border:1px solid #eee;max-width:100%" />
...
<img src="{{ 'images/v2.1/cockroachcloud/access-tab.png' | relative_url }}" alt="Access tab" style="border:1px solid #eee;max-width:100%" />
...
1. Click **Invite User** in the top left corner.
    ...
    <img src="{{ 'images/v2.1/cockroachcloud/invite-team-members-modal.png' | relative_url }}" alt="Invite team members" style="border:1px solid #eee;max-width:100%" />
