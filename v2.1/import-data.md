...
Make sure your MySQL user has permission to execute [`SELECT INTO OUTFILE`](https://dev.mysql.com/doc/refman/8.0/en/select.html), as required by [`mysqldump`](https://dev.mysql.com/doc/refman/8.0/en/mysqldump-sql-format.html). Then issue a command like the following (modified as needed for your environment):
