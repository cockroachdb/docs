...
---------------|--------------|---------------|-----------------------------------------
 ...
 `default_transaction_isolation` | _Read Only_: All transactions execute with `SERIALIZABLE` isolation, meaning you cannot `SET default_transaction_isolation` to any value. See [Transactions: Isolation levels](transactions.html#isolation-levels).| `SERIALIZABLE` | Yes
