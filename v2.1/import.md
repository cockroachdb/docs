...
-----------|-------------
 ...
 `create_table_file` | The URL of a plain text file containing the [`CREATE TABLE`](create-table.html) statement you want to use (see [this example for syntax](#use-a-create-table-statement-from-a-file)).
 `table_elem_list` | The table definition you want to use (see [this example for syntax](#issue-a-create-table-statement-directly)).
...
- Specify the `CREATE TABLE` statement explicitly from the [SQL client](use-the-built-in-sql-client.html).  For an example, see [Issue a `CREATE TABLE` statement directly](#issue-a-create-table-statement-directly) below.
...
### Issue a `CREATE TABLE` statement directly
