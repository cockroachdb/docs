...
summary: Use Kubernetes to orchestrate an secure multi-node CockroachDB cluster locally with each node listening on a different port.
toc: false
---
...
This page shows you how to orchestrate an **secure** multi-node CockroachDB cluster locally using the Kubernetes' [`minikube`](http://kubernetes.io/docs/getting-started-guides/minikube/) tool and beta [StatefulSet](http://kubernetes.io/docs/concepts/abstractions/controllers/statefulsets/) feature.
