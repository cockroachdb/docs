...
<span class="version-tag">New in v1.1:</span> The `PAUSE JOB` [statement](sql-statements.html) lets you resume [paused jobs](pause-job.html), which can enterprise `BACKUP` and `RESTORE` jobs.
...
- [`PAUSE JOBS`](pause-jobs.html)
- [`SHOW JOBS`](show-jobs.html)
- [`CANCEL JOBS`](cancel-jobs.html)
- [`BACKUP`](backup.html)
