...
For the `--device` flag, use `lo0` if you're on Mac or `lo` if you're on Linux. If neither works, check the output of `ifconfig` for the interface responsible for `127.0.0.1`.
