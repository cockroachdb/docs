...
To view the **Tables** view, [access the Admin UI](admin-ui-access-and-navigate.html#access-the-admin-ui) and select **Databases** from the left-hand navigation bar. The **Tables** view is displayed.
...
## Grants View
To view the **Grants** view, [access the Admin UI](admin-ui-access-and-navigate.html#access-the-admin-ui) and select **Databases** from the left-hand navigation bar. Then on the **Database** page, select **Grants** from the **View** drop-down menu.
