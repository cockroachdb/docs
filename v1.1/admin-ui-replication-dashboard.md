...
Applied (Preemptive) | The number of snapshots applied to nodes per second that were anticipated ahead of time (for instance, because a node was about to be added to a raft group).
