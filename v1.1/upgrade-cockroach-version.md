...
releases. Since v1.1 is the second CockroachDB release, you do not
have to go through intermediate releases. You can upgrade to any
v1.1.x release from any v1.0.y release, or from any v1.1.z release,
