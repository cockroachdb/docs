...
On [accessing the CockroachDB Admin UI](admin-ui-access-and-navigate.html#access-the-admin-ui), the first dashboard you see by default is the **Overview** dashboard. The **Overview** dashboard lets you monitor metrics such as SQL Queries, Service Latency, Replicas per Node, and Capacity of your cluster.    
