...
`key_in_value` | N/A | <span class="version-tag">New in v19.1</span>: Makes the [primary key](primary-key.html) of a deleted row recoverable. `key_in_value` is automatically used for cloud storage sinks.
