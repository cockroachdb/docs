...
In a multi-region deployment, the pinned index leaseholders pattern is a good choice for tables with the following requirements:
...
If rows and all latency-sensitive queries **cannot** be tied to specific geographies
