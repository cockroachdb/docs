...
In a multi-region deployment, the geo-partitioned [leaseholder](https://www.cockroachlabs.com/docs/stable/architecture/replication-layer.html#leases)s topology is a good choice for tables with the following requirements:
