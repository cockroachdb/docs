...
This page shows you how to upgrade to the [latest version](https://www.cockroachlabs.com/docs/releases/) i.e. v19.1 release ({{page.release_info.version}}) from v2.1.x, or from any patch release in the v19.1.x series. To upgrade within the v2.1.x series, see [the v2.1 version of this page](https://www.cockroachlabs.com/docs/v2.1/upgrade-cockroach-version.html).
