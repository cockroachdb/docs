...
To check that the new key is active, use the stores report page in the Admin UI to [check the encryption status](#step-4-check-the-encryption-status).
