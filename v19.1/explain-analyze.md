...
toc: true
redirect_from: /v2.2/explain-analyze.html
---
...
<img src="{{ 'images/v19.1/explain-analyze-distsql-plan.png' | relative_url }}" alt="EXPLAIN ANALYZE (DISTSQL)" style="border:1px solid #eee;max-width:100%" />
