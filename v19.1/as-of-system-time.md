...
[`DECIMAL`](decimal.html) | A decimal value representing a [hybrid logical clock](architecture/transaction-layer.html#time-and-hybrid-logical-clocks) value, namely that returned by the [`cluster_logical_timestamp()`](functions-and-operators.html#system-info-functions) built-in function. This offers maximum precision for timestamps.
