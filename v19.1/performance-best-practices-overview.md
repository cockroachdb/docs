...
The first approach does not take advantage of the parallelization possible in a distributed database like CockroachDB, and also causes all new records to be inserted onto the same node.
