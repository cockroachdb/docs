...
block_search: false
redirect_from: /v2.2/training/cluster-upgrade.html
---
...
2. Move the v2.1 binary into the parent `cockroachdb-training` directory:
...
## Step 3. Upgrade the first node to v19.1
...
3. In node 1's terminal, restart the node using the v19.1 binary:
...
## Step 4. Upgrade the rest of the nodes to v19.1
...
3. Restart the node using the v19.1 binary:
...
7. Restart the node using the v19.1 binary:
...
+--+-----------------+-----------------------+----------------------------------+----------------------------------+--------------+---------+
 1 | localhost:26257 | v19.1.0-beta.20190225 | 2018-09-13 22:27:29.290335+00:00 | 2018-09-13 22:37:32.314011+00:00 | true         | true     
 2 | localhost:26259 | v19.1.0-beta.20190225 | 2018-09-13 22:34:17.468613+00:00 | 2018-09-13 22:37:35.491432+00:00 | true         | true     
 3 | localhost:26258 | v19.1.0-beta.20190225 | 2018-09-13 22:36:06.252257+00:00 | 2018-09-13 22:37:31.770426+00:00 | true         | true
(3 rows)
~~~
