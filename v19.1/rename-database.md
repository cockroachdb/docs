...
The workaround is to set a value in a "lock" table (using the values 1 vs 0 in a table cell) to indicate that a rename is in progress. Since table access is transactional, that would create isolation around the rename process.
