...
1. Paste the contents of the CA certificate file under **Value**.
    ...
    <img src="{{ 'images/v23.1/hasura-ca-cert.png' | relative_url }}" alt="Adding the SSL_ROOT_CERT environment variable to the Hasura project" style="border:1px solid #eee;max-width:50%" />
1. Click **Add**.
...
1. In the **Connect Existing Database** tab configure the connection to your cluster.
    ...
    <!-- 1. Select **Environment Variable**, then enter `CRDB_URL` in the **Environment Variable** input box.
        <img src="{{ 'images/v23.1/hasura-data-source.png' | relative_url }}" alt="Adding the connection string to the Hasura Data Manager" style="border:1px solid #eee;max-width:100%" /> -->
...
1. In the Hasura Cloud overview page select **Projects**, then click the **Config** icon for your project.
    ...
    <img src="{{ 'images/v23.1/hasura-project-config.png' | relative_url }}" alt="Click the project Config icon" style="border:1px solid #eee;max-width:100%" />
...
<img src="{{ 'images/v23.1/hasura-execute-query.png' | relative_url }}" alt="Executing the GraphQL query in the Hasura Cloud API Explorer" style="border:1px solid #eee;max-width:100%" />
