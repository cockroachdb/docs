...
<span class="version-tag">New in v23.1:</span><a name="skip_missing_udfs"></a>`skip_missing_udfs` | N/A | Use to skip checking for [UDF](user-defined-functions.html) dependencies during the `RESTORE` job. <br><br>Example: `WITH skip_missing_udfs`
