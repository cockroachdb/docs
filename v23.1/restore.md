...
<span class="version-tag">New in v23.1:</span><a name="skip_missing_udfs"></a>`skip_missing_udfs` | N/A | Use to skip checking [UDF](user-defined-functions.html) dependencies if UDF descriptors are missing. <br><br>Example: `WITH skip_missing_udfs`
