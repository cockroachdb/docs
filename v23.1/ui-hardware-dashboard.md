...
This graph shows the CPU consumption by the host the CockroachDB process is running on, including other processes on the host. To measure the CPU consumption of just the CockroachDB process, use the **PU Percent** graph instead.
