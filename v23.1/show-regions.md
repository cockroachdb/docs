...
`secondary_region` | The [secondary region](multiregion-overview.html#secondary-regions) of the database.
...
The `secondary` column in each row says whether that region has been made a _secondary region_ for failover purposes. For more information, see [Secondary regions](multiregion-overview.html#secondary-regions).
