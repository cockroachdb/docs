...
When you're trying out CockroachDB as a single-node deployment or in a local sandbox, this document helps resolve issues you might encounter.
...
If you're not sure what those values might have been, you can kill the `cockroach` process, and then restart the node:
