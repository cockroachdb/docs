...
| Interface                                                               | Type     | Versioning                                                                             | Notes                                                                                                                                                        | Availability                                                      |
|-------------------------------------------------------------------------|----------|----------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|
...
| [SQL](sql-feature-support.html)                                         | Mixed    | Versioned concurrently with CockroachDB.                                               | SQL statements are stable except for `SHOW` statements, as described in the following row.                                                                   | All products                                                      |
| `SHOW` statements                                                       | Unstable | Versioned concurrently with CockroachDB.                                               | This includes all documented SQL `SHOW` statements, which display unstable output.                                                                           | All products                                                      |
| [`crdb_internal` system catalog](crdb-internal.html)                    | Mixed    | Versioned concurrently with CockroachDB.                                               | A subset of the `crdb_internal` system catalog is stable, as defined [here](crdb-internal.html#tables).                                                      | All products                                                      |
...
| [Built-in functions](functions-and-operators.html#built-in-functions)   | Mixed    | Versioned concurrently with CockroachDB.                                               | Any built-in functions prefixed with `crdb_internal` are unstable.                                                                                           | All products                                                      |
