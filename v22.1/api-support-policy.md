...
| [SQL](sql-feature-support.html)                                         | Mixed            | Versioned concurrently with CockroachDB.                                               | SQL statements are programmable except for `SHOW` statements, as described in the following row.                                                             |
| `SHOW` statements                                                       | Non-programmable | Versioned concurrently with CockroachDB.                                               | This includes all documented SQL `SHOW` statements, which display non-programmable output.                                                                   |
...
| [`information_schema` system catalog](information-schema.html)          | Programmable     | Versioned concurrently with CockroachDB.                                               |                                                                                                                                                              |
| [`pg_catalog` system catalog](pg-catalog.html)                          | Programmable     | Versioned concurrently with CockroachDB.                                               |                                                                                                                                                              |
| [`pg_extension` system catalog](pg-extension.html)                      | Programmable     | Versioned concurrently with CockroachDB.                                               |                                                                                                                                                              |
| [Built-in functions](functions-and-operators.html#built-in-functions)   | Mixed            | Versioned concurrently with CockroachDB.                                               | Any built-in functions prefixed with `crdb_internal` are non-programmable.                                                                                   |
...
| [`cockroach` commands](cockroach-commands.html)                         | Mixed            | Versioned concurrently with CockroachDB.                                               |                                                                                                                                                              |
