...
| Interface                                                           | Type             | Versioning                                | Notes                                                                                                                                                                 |
|---------------------------------------------------------------------|------------------|-------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `ccloud` CLI                                                        | Mixed            | Versioned independently from CockroachDB. | Default output is non-programmable. If the `–json` argument is specified in the CLI, output is formatted in a stable JSON structure, following the versioning scheme. |
