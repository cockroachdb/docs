...
Azure                                                       | `azure`     | Storage container                                | `AZURE_ACCOUNT_KEY`, `AZURE_ACCOUNT_NAME`<br><br>Account key must be [url encoded](https://en.wikipedia.org/wiki/Percent-encoding). For more information, see [Authentication - Azure Storage](#authentication).
