...
On that instance, [generate SCRAM salted password hashes](#managing-users-with-pre-hashed-passwords), manage the CockroachdDB users via CockroachdDB client, as described in the following section, and persist the secrets in the secrets store.
