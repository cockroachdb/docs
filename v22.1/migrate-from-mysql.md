...
To migrate from MySQL to CockroachDB using the AWS Database Migration Service, see [Migrate CockroachDB Data with AWS Database Migration Service (DMS)](aws-dms.html).
