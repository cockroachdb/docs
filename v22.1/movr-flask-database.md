...
A distributed CockroachDB deployment consists of multiple, regional instances of CockroachDB that communicate as a single, logical entity. In [CockroachDB terminology](glossary.html#cockroachdb-architecture), each instance is called a *node*. Together, the nodes form a *cluster*.
...
- [CockroachDB terminology](glossary.html#cockroachdb-architecture)
