...
Before starting, review some basic Kubernetes terminology. Note that CockroachDB [nodes](glossary.html#cockroachdb-architecture-terms) are distinct from Kubernetes "nodes" or "worker nodes".
