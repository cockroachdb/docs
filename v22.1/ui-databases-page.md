...
- <span class="version-tag">New in v22.1:</span> Whether [automatic statistics collection](cost-based-optimizer.html#table-statistics) is enabled for the cluster.
...
- **New in v22.1:** **Table Stats Last Updated**: the last time table statistics were created or updated.
- **New in v22.1:** **Auto Stats Collection**: whether [automatic statistics collection](cost-based-optimizer.html#table-statistics) is enabled.
