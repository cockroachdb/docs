...
To specify a TTL when creating a table, use the SQL syntax shown below. For example, to create a new table with rows that expire after a 3 minute [interval](interval.html), execute a statement like the following:
