...
By default, these metrics are aggregated. If you want to have metrics labelled by table name (at the risk of added cardinality), you must take the following steps:
