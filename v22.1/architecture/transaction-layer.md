...
- Non-blocking transactions use a replication scheme over the [ranges](../glossary.html#cockroachdb-architecture) they operate on that allows all followers in these ranges to serve consistent (non-stale) reads.
