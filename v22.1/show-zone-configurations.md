...
----------|------------
`zone_name` | The name of the system [range](glossary.html#architecture-range) for which to show [replication zone configurations](configure-replication-zones.html).
