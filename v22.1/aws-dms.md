...
1. Enter the **Server name**, **Port**, **User name**, **Password**, and **Database name** of your CockroachDB cluster. For **Secure Socket Layer (SSL) mode**, select NEED VALUE HERE
...
### Step 3.4. Optional configurations

1. You can **Enable CloudWatch logs** for extra insight about the replication.
...
`BatchApplyEnabled` does not work when using **Drop tables on target** as a target table preparation mode.
