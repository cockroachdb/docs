...
| total_ranges            | [`INT8`](int.html) | Total [ranges](glossary.html#architecture-range) in the zone this report entry is referring to.                                       |
...
| report_id      | [`INT8`](int.html)      | The ID of the [report](#system-reports_meta) that generated all of the rows in this table.                                          |
| at_risk_ranges | [`INT8`](int.html)      | The [ranges](glossary.html#architecture-range) that are at risk of becoming unavailable as of the time of this report. |
