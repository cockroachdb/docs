...
{{site.data.alerts.callout_info}}
 Certain [`IMPORT TABLE`](import.html) statements that do not define the table schema in the same file as the data are **not** supported in v22.1+. We recommend using the following example to import data into a new table.
{{site.data.alerts.end}}
