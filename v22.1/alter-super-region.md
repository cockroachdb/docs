...
summary: The ALTER SUPER REGION statement adds a super region made up of a set of regions such that all data from regional tables or regional by row tables with home rows in the super region is stored in the super region
toc: true
