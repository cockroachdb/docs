...
{{site.data.alerts.callout_info}}
This feature is only available to users with an [Enterprise license](enterprise-licensing.html). For insight into how to use this feature to get low latency, consistent reads in multi-region deployments, see the [Duplicate Indexes](topology-duplicate-indexes.html) topology pattern.
{{site.data.alerts.end}}
