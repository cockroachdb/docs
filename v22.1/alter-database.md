...
[`ADD SUPER REGION`](add-super-region.html) | **New in v22.1:** Add a super region made up of a set of [database regions](multiregion-overview.html#super-regions) such that data from [regional tables](regional-tables.html) will be stored in only those regions.
