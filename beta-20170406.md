...
- [`ROLLBACK TO SAVEPOINT`](rollback.html) is now allowed at any time, not only after receiving a "retry transaction" error. [#14538](https://github.com/cockroachdb/cockroach/pull/14538)
...
- [`DECIMAL`](decimal.html) values in primary keys and indexes no longer have zeros truncated. [#14528](https://github.com/cockroachdb/cockroach/pull/14528)
