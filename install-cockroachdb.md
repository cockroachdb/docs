...
<div id="download-the-binary" class="install-option">
  ...
  <ol>
    ...
    <li>
      <p>Move the binary onto your <code>PATH</code> so it's easy to execute <a href="cockroach-commands.html">cockroach commands</a> from any shell:</p>
...
<ol>
  <li>
    ...
    <ul>
      ...
      <li>
        <p>A <a href="http://golang.org/doc/code.html">Go environment</a> with a recent 64-bit version of the toolchain. The Makefile enforces the specific version required, as it is updated frequently.</p>
      </li>
      <li>
        <p>Git 1.8+</p>
      </li>
