	...
	rootCmd := &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			specs := []stmtSpec{
				...
				{name: "rename_index", stmt: "rename_stmt", inline: []string{"table_name_with_index"}, match: regexp.MustCompile("'ALTER' 'INDEX'"), replace: map[string]string{"qualified_name": "table_name", "'@' name": "'@' index_name"}, unlink: []string{"table_name", "index_name"}},
