	...
	rootCmd := &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			specs := []stmtSpec{
				...
				{name: "rename_table", stmt: "rename_stmt", match: []*regexp.Regexp{regexp.MustCompile("'ALTER' 'TABLE' .* 'RENAME' 'TO'")}, replace: map[string]string{"relation_expr": "current_name", "qualified_name": "new_name"}, unlink: []string{"current_name"}, relink:  map[string]string{"new_name": "name"}},
				{
					name:    "restore",
					stmt:    "backup_stmt",
				...
				},
				{
					...
					match:  []*regexp.Regexp{regexp.MustCompile("'SET' var_name .*")},
				},
				{
					name:   "set_time_zone",
					stmt:   "set_stmt",
				...
				{name: "show_all", stmt: "show_stmt", match: []*regexp.Regexp{regexp.MustCompile("'SHOW' 'ALL'")}},
				{
					name:    "show_var",
					stmt:    "show_stmt",
					match:   []*regexp.Regexp{regexp.MustCompile("'SHOW' 'IDENT'")},
