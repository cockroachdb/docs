	...
	rootCmd := &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			specs := []stmtSpec{
				...
				{name: "show_transaction_isolation_level", stmt: "show_stmt", match: regexp.MustCompile("'SHOW' 'TRANSACTION' 'ISOLATION' 'LEVEL'")},
				{name: "show_transaction_priority", stmt: "show_stmt", match: regexp.MustCompile("'SHOW' 'TRANSACTION' 'PRIORITY'")},
