...
The `CREATE TABLE` [statement](sql-statements.html) defines and creates a new table in a database.

{{site.data.alerts.callout_success}}To create a table from the results of a <code>SELECT</code> statement, use <a href="create-table-as.html"><code>CREATE TABLE AS</code></a> instead.
...
**opt_interleave ::=**
{% include sql/diagrams/opt_interleave.html %}
