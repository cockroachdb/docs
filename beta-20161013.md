...
Back in August, we entered a [stability-focused "code yellow"](https://www.cockroachlabs.com/blog/cant-run-100-node-cockroachdb-cluster/), with all work unrelated to stability continuing in a secondary development environment. Since then, we've made great progress, and so we've moved non-stability-focused changes back into our main development environment. This week's release, therefore, includes many user-visible changes and features made since "code yellow" started. 
