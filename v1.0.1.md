...
- The command-line interface no longer prompts for a password twice when [password authentication](create-and-manage-users.html#secure-clusters-with-passwords) is used. [#15919](https://github.com/cockroachdb/cockroach/pull/15919)
- [`CREATE USER WITH PASSWORD`](create-user.html) now works correctly in the [`cockroach sql`](use-the-built-in-sql-client.html) shell. [#15911](https://github.com/cockroachdb/cockroach/pull/15911)
- Fixed bugs in the `MIN()` and `MAX()` [aggregate functions](functions-and-operators.html#aggregate-functions) in the presence of `NULL` values. [#15912](https://github.com/cockroachdb/cockroach/pull/15912)
...
- The `--cache` and `--max-sql-memory` flags of [`cockroach start`](start-a-node.html) now use their default values on OpenBSD. [#15914](https://github.com/cockroachdb/cockroach/pull/15914)
- Attempting to [create a view](create-view.html) involving an array now returns an error instead of crashing the server. [#15913](https://github.com/cockroachdb/cockroach/pull/15913)
- [`cockroach start --insecure`](start-a-node.html) now prints a warning about the consequences of insecure mode. [#15924](https://github.com/cockroachdb/cockroach/pull/15924)
...
- [Collation](collate.html) locales containing capital letters are now parsed correctly. [#15917](https://github.com/cockroachdb/cockroach/pull/15917)
...
- [Dropping a database](drop-database.html) containing views now works correctly. [#15983](https://github.com/cockroachdb/cockroach/pull/15983)
- Fully-qualified column names referring to [views](views.html) now work correctly. [#15984](https://github.com/cockroachdb/cockroach/pull/15984)
...
- Added troubleshooting guidance on [common errors](general-troubleshooting.html), [cluster and node setup](cluster-setup-troubleshooting.html), [SQL query behavior](query-behavior-troubleshooting.html), [using debug and error logs](debug-and-error-logs.html), [finding support resources](support-resources.html), and [filing issues](file-an-issue.html). [#1370](https://github.com/cockroachdb/docs/pull/1370)
- Added [FAQs](operational-faqs.html) on why memory and disk usage increases steadily in new clusters. [#1450](https://github.com/cockroachdb/docs/pull/1450)
