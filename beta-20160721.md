...
- The [`cockroach dump`](sql-dump.html) command now works with tables that have [`DECIMAL`](decimal.html) columns that specify a precision and scale. [#7842](https://github.com/cockroachdb/cockroach/pull/7842)
